...
class Linkage extends DomainResource {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (author != null) {
      final fieldJson9 = author!.toJson();
      json['author'] = fieldJson9['value'];
      if (fieldJson9['_value'] != null) {
        json['_author'] = fieldJson9['_value'];
      }
    }

    final fieldJson10 = item.map((e) => e.toJson()).toList();
    json['item'] = fieldJson10.map((e) => e['value']).toList();
    if (fieldJson10.any((e) => e['_value'] != null)) {
      json['_item'] = fieldJson10.map((e) => e['_value']).toList();
    }
