...
ResearchSubject _$ResearchSubjectFromJson(Map<String, dynamic> json) =>
    ResearchSubject(
      ...
      identifier: (json['identifier'] as List<dynamic>?)
          ...
          .toList(),
      status: $enumDecode(_$ResearchSubjectStatusEnumMap, json['status']),
...
Map<String, dynamic> _$ResearchSubjectToJson(ResearchSubject instance) {
  ...
  writeNotNull('assignedArm', instance.assignedArm?.toJson());
  writeNotNull('_assignedArm', instance.assignedArmElement?.toJson());
  writeNotNull('actualArm', instance.actualArm?.toJson());
