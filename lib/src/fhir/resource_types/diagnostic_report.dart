  ...
  Map<String, dynamic> toJson() {
    ...
    if (resultsInterpreter != null && resultsInterpreter!.isNotEmpty) {
      json['resultsInterpreter'] =
          resultsInterpreter!.map((Reference v) => v.toJson()).toList();
    }
    if (specimen != null && specimen!.isNotEmpty) {
      json['specimen'] = specimen!.map((Reference v) => v.toJson()).toList();
    }
    if (result != null && result!.isNotEmpty) {
      json['result'] = result!.map((Reference v) => v.toJson()).toList();
    }
    if (imagingStudy != null && imagingStudy!.isNotEmpty) {
      json['imagingStudy'] =
          imagingStudy!.map((Reference v) => v.toJson()).toList();
    }
    if (media != null && media!.isNotEmpty) {
      json['media'] =
          media!.map((DiagnosticReportMedia v) => v.toJson()).toList();
    }
    ...
    if (presentedForm != null && presentedForm!.isNotEmpty) {
      json['presentedForm'] =
          presentedForm!.map((Attachment v) => v.toJson()).toList();
    }
    return json;
  }
