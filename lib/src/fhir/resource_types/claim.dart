  ...
  factory Claim.fromJson(
    ...
    return Claim(
      ...
      fundsReserve: json['fundsReserve'] != null
          ...
          : null,
      related: parseList<ClaimRelated>(
...
class ClaimDetail extends BackboneElement {
  ...
  factory ClaimDetail.fromJson(
    ...
    return ClaimDetail(
      ...
      subDetail: parseList<ClaimSubDetail>(
