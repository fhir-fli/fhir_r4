...
ActivityDefinition _$ActivityDefinitionFromJson(Map<String, dynamic> json) =>
    ActivityDefinition(
      ...
      libraryElement: (json['_library'] as List<dynamic>?)
          ...
          .toList(),
      kind: $enumDecodeNullable(_$RequestResourceTypeEnumMap, json['kind']),
      ...
      intent: $enumDecodeNullable(_$RequestIntentEnumMap, json['intent']),
...
const _$SubjectTypeEnumMap = {
  ...
  SubjectType.Binary: 'Binary',
  SubjectType.Bundle: 'Bundle',
  SubjectType.DomainResource: 'DomainResource',
  SubjectType.Account: 'Account',
  SubjectType.ActivityDefinition: 'ActivityDefinition',
  SubjectType.AdministrableProductDefinition: 'AdministrableProductDefinition',
  SubjectType.AdverseEvent: 'AdverseEvent',
  SubjectType.AllergyIntolerance: 'AllergyIntolerance',
  SubjectType.Appointment: 'Appointment',
  SubjectType.AppointmentResponse: 'AppointmentResponse',
  SubjectType.AuditEvent: 'AuditEvent',
  SubjectType.Basic: 'Basic',
  SubjectType.BiologicallyDerivedProduct: 'BiologicallyDerivedProduct',
  SubjectType.BodyStructure: 'BodyStructure',
  SubjectType.CapabilityStatement: 'CapabilityStatement',
  SubjectType.CarePlan: 'CarePlan',
  SubjectType.CareTeam: 'CareTeam',
  SubjectType.CatalogEntry: 'CatalogEntry',
  SubjectType.ChargeItem: 'ChargeItem',
  SubjectType.ChargeItemDefinition: 'ChargeItemDefinition',
  SubjectType.Citation: 'Citation',
  SubjectType.Claim: 'Claim',
  SubjectType.ClaimResponse: 'ClaimResponse',
  SubjectType.ClinicalImpression: 'ClinicalImpression',
  SubjectType.ClinicalUseDefinition: 'ClinicalUseDefinition',
  SubjectType.CodeSystem: 'CodeSystem',
  SubjectType.Communication: 'Communication',
  SubjectType.CommunicationRequest: 'CommunicationRequest',
  SubjectType.CompartmentDefinition: 'CompartmentDefinition',
  SubjectType.Composition: 'Composition',
  SubjectType.ConceptMap: 'ConceptMap',
  SubjectType.Condition: 'Condition',
  SubjectType.Consent: 'Consent',
  SubjectType.Contract: 'Contract',
  SubjectType.Coverage: 'Coverage',
  SubjectType.CoverageEligibilityRequest: 'CoverageEligibilityRequest',
  SubjectType.CoverageEligibilityResponse: 'CoverageEligibilityResponse',
  SubjectType.DetectedIssue: 'DetectedIssue',
  SubjectType.Device: 'Device',
  SubjectType.DeviceDefinition: 'DeviceDefinition',
  SubjectType.DeviceMetric: 'DeviceMetric',
  SubjectType.DeviceRequest: 'DeviceRequest',
  SubjectType.DeviceUseStatement: 'DeviceUseStatement',
  SubjectType.DiagnosticReport: 'DiagnosticReport',
  SubjectType.DocumentManifest: 'DocumentManifest',
  SubjectType.DocumentReference: 'DocumentReference',
  SubjectType.Encounter: 'Encounter',
  SubjectType.Endpoint: 'Endpoint',
  SubjectType.EnrollmentRequest: 'EnrollmentRequest',
  SubjectType.EnrollmentResponse: 'EnrollmentResponse',
  SubjectType.EpisodeOfCare: 'EpisodeOfCare',
  SubjectType.EventDefinition: 'EventDefinition',
  SubjectType.Evidence: 'Evidence',
  SubjectType.EvidenceReport: 'EvidenceReport',
  SubjectType.EvidenceVariable: 'EvidenceVariable',
  SubjectType.ExampleScenario: 'ExampleScenario',
  SubjectType.ExplanationOfBenefit: 'ExplanationOfBenefit',
  SubjectType.FamilyMemberHistory: 'FamilyMemberHistory',
  SubjectType.Flag: 'Flag',
  SubjectType.Goal: 'Goal',
  SubjectType.GraphDefinition: 'GraphDefinition',
  SubjectType.Group: 'Group',
  SubjectType.GuidanceResponse: 'GuidanceResponse',
  SubjectType.HealthcareService: 'HealthcareService',
  SubjectType.ImagingStudy: 'ImagingStudy',
  SubjectType.Immunization: 'Immunization',
  SubjectType.ImmunizationEvaluation: 'ImmunizationEvaluation',
  SubjectType.ImmunizationRecommendation: 'ImmunizationRecommendation',
  SubjectType.ImplementationGuide: 'ImplementationGuide',
  SubjectType.Ingredient: 'Ingredient',
  SubjectType.InsurancePlan: 'InsurancePlan',
  SubjectType.Invoice: 'Invoice',
  SubjectType.Library: 'Library',
  SubjectType.Linkage: 'Linkage',
  SubjectType.List: 'List',
  SubjectType.Location: 'Location',
  SubjectType.ManufacturedItemDefinition: 'ManufacturedItemDefinition',
  SubjectType.Measure: 'Measure',
  SubjectType.MeasureReport: 'MeasureReport',
  SubjectType.Media: 'Media',
  SubjectType.Medication: 'Medication',
  SubjectType.MedicationAdministration: 'MedicationAdministration',
  SubjectType.MedicationDispense: 'MedicationDispense',
  SubjectType.MedicationKnowledge: 'MedicationKnowledge',
  SubjectType.MedicationRequest: 'MedicationRequest',
  SubjectType.MedicationStatement: 'MedicationStatement',
  SubjectType.MedicinalProductDefinition: 'MedicinalProductDefinition',
  SubjectType.MessageDefinition: 'MessageDefinition',
  SubjectType.MessageHeader: 'MessageHeader',
  SubjectType.MolecularSequence: 'MolecularSequence',
  SubjectType.NamingSystem: 'NamingSystem',
  SubjectType.NutritionOrder: 'NutritionOrder',
  SubjectType.NutritionProduct: 'NutritionProduct',
  SubjectType.Observation: 'Observation',
  SubjectType.ObservationDefinition: 'ObservationDefinition',
  SubjectType.OperationDefinition: 'OperationDefinition',
  SubjectType.OperationOutcome: 'OperationOutcome',
  SubjectType.Organization: 'Organization',
  SubjectType.OrganizationAffiliation: 'OrganizationAffiliation',
  SubjectType.PackagedProductDefinition: 'PackagedProductDefinition',
  SubjectType.Patient: 'Patient',
  SubjectType.PaymentNotice: 'PaymentNotice',
  SubjectType.PaymentReconciliation: 'PaymentReconciliation',
  SubjectType.Person: 'Person',
  SubjectType.PlanDefinition: 'PlanDefinition',
  SubjectType.Practitioner: 'Practitioner',
  SubjectType.PractitionerRole: 'PractitionerRole',
  SubjectType.Procedure: 'Procedure',
  SubjectType.Provenance: 'Provenance',
  SubjectType.Questionnaire: 'Questionnaire',
  SubjectType.QuestionnaireResponse: 'QuestionnaireResponse',
  SubjectType.RegulatedAuthorization: 'RegulatedAuthorization',
  SubjectType.RelatedPerson: 'RelatedPerson',
  SubjectType.RequestGroup: 'RequestGroup',
  SubjectType.ResearchDefinition: 'ResearchDefinition',
  SubjectType.ResearchElementDefinition: 'ResearchElementDefinition',
  SubjectType.ResearchStudy: 'ResearchStudy',
  SubjectType.ResearchSubject: 'ResearchSubject',
  SubjectType.RiskAssessment: 'RiskAssessment',
  SubjectType.Schedule: 'Schedule',
  SubjectType.SearchParameter: 'SearchParameter',
  SubjectType.ServiceRequest: 'ServiceRequest',
  SubjectType.Slot: 'Slot',
  SubjectType.Specimen: 'Specimen',
  SubjectType.SpecimenDefinition: 'SpecimenDefinition',
  SubjectType.StructureDefinition: 'StructureDefinition',
  SubjectType.StructureMap: 'StructureMap',
  SubjectType.Subscription: 'Subscription',
  SubjectType.SubscriptionStatus: 'SubscriptionStatus',
  SubjectType.SubscriptionTopic: 'SubscriptionTopic',
  SubjectType.Substance: 'Substance',
  SubjectType.SubstanceDefinition: 'SubstanceDefinition',
  SubjectType.SupplyDelivery: 'SupplyDelivery',
  SubjectType.SupplyRequest: 'SupplyRequest',
  SubjectType.Task: 'Task',
  SubjectType.TerminologyCapabilities: 'TerminologyCapabilities',
  SubjectType.TestReport: 'TestReport',
  SubjectType.TestScript: 'TestScript',
  SubjectType.ValueSet: 'ValueSet',
  SubjectType.VerificationResult: 'VerificationResult',
  SubjectType.VisionPrescription: 'VisionPrescription',
  SubjectType.Parameters: 'Parameters',
};

const _$RequestResourceTypeEnumMap = {
  RequestResourceType.Appointment: 'Appointment',
  RequestResourceType.AppointmentResponse: 'AppointmentResponse',
  RequestResourceType.CarePlan: 'CarePlan',
  RequestResourceType.Claim: 'Claim',
  RequestResourceType.CommunicationRequest: 'CommunicationRequest',
  RequestResourceType.Contract: 'Contract',
  RequestResourceType.DeviceRequest: 'DeviceRequest',
  RequestResourceType.EnrollmentRequest: 'EnrollmentRequest',
  RequestResourceType.ImmunizationRecommendation: 'ImmunizationRecommendation',
  RequestResourceType.MedicationRequest: 'MedicationRequest',
  RequestResourceType.NutritionOrder: 'NutritionOrder',
  RequestResourceType.ServiceRequest: 'ServiceRequest',
  RequestResourceType.SupplyRequest: 'SupplyRequest',
  RequestResourceType.Task: 'Task',
  RequestResourceType.VisionPrescription: 'VisionPrescription',
};
