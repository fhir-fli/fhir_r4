...
Substance _$SubstanceFromJson(Map<String, dynamic> json) => Substance(
      ...
      identifier: (json['identifier'] as List<dynamic>?)
          ...
          .toList(),
      status: $enumDecodeNullable(_$FHIRSubstanceStatusEnumMap, json['status']),
...
const _$FHIRSubstanceStatusEnumMap = {
  FHIRSubstanceStatus.active: 'active',
  FHIRSubstanceStatus.inactive: 'inactive',
  FHIRSubstanceStatus.entered_in_error: 'entered-in-error',
};
