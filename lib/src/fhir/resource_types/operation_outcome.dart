...
class OperationOutcome extends DomainResource {
  ...
  Map<String, dynamic> toJson() {
    ...
    final fieldJson8 = issue.map((e) => e.toJson()).toList();
    json['issue'] = fieldJson8.map((e) => e['value']).toList();
    if (fieldJson8.any((e) => e['_value'] != null)) {
      json['_issue'] = fieldJson8.map((e) => e['_value']).toList();
    }
...
class OperationOutcomeIssue extends BackboneElement {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (diagnostics != null) {
      final fieldJson6 = diagnostics!.toJson();
      json['diagnostics'] = fieldJson6['value'];
      if (fieldJson6['_value'] != null) {
        json['_diagnostics'] = fieldJson6['_value'];
      }
    }

    if (location != null && location!.isNotEmpty) {
      final fieldJson7 = location!.map((e) => e.toJson()).toList();
      json['location'] = fieldJson7.map((e) => e['value']).toList();
      if (fieldJson7.any((e) => e['_value'] != null)) {
        json['_location'] = fieldJson7.map((e) => e['_value']).toList();
      }
    }

    if (expression != null && expression!.isNotEmpty) {
      final fieldJson8 = expression!.map((e) => e.toJson()).toList();
      json['expression'] = fieldJson8.map((e) => e['value']).toList();
      if (fieldJson8.any((e) => e['_value'] != null)) {
        json['_expression'] = fieldJson8.map((e) => e['_value']).toList();
      }
    }
