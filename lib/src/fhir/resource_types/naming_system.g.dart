...
NamingSystem _$NamingSystemFromJson(Map<String, dynamic> json) => NamingSystem(
      ...
      kind: $enumDecode(_$NamingSystemTypeEnumMap, json['kind']),
...
const _$NamingSystemTypeEnumMap = {
...
NamingSystemUniqueId _$NamingSystemUniqueIdFromJson(
    ...
    NamingSystemUniqueId(
      ...
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)
          ?.map((e) => FhirExtension.fromJson(e as Map<String, dynamic>))
          .toList(),
      type: $enumDecode(_$NamingSystemIdentifierTypeEnumMap, json['type']),
...
const _$NamingSystemIdentifierTypeEnumMap = {
