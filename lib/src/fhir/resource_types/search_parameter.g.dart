...
SearchParameter _$SearchParameterFromJson(Map<String, dynamic> json) =>
    SearchParameter(
      ...
      xpathUsage:
          $enumDecodeNullable(_$XPathUsageTypeEnumMap, json['xpathUsage']),
      ...
      comparator: (json['comparator'] as List<dynamic>?)
          ?.map((e) => $enumDecode(_$SearchComparatorEnumMap, e))
          .toList(),
      comparatorElement: (json['_comparator'] as List<dynamic>?)
          ?.map((e) => Element.fromJson(e as Map<String, dynamic>))
          .toList(),
      modifier: (json['modifier'] as List<dynamic>?)
          ?.map((e) => $enumDecode(_$SearchModifierCodeEnumMap, e))
          .toList(),
...
const _$XPathUsageTypeEnumMap = {
  XPathUsageType.normal: 'normal',
  XPathUsageType.phonetic: 'phonetic',
  XPathUsageType.nearby: 'nearby',
  XPathUsageType.distance: 'distance',
  XPathUsageType.other: 'other',
};

const _$SearchComparatorEnumMap = {
...
const _$SearchModifierCodeEnumMap = {
  ...
  SearchModifierCode.in_: 'in',
  SearchModifierCode.not_in: 'not-in',
  SearchModifierCode.below: 'below',
  SearchModifierCode.above: 'above',
  SearchModifierCode.type: 'type',
