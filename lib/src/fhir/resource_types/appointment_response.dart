...
class AppointmentResponse extends DomainResource {
  ...
  Map<String, dynamic> toJson() {
    ...
    final fieldJson9 = appointment.toJson();
    json['appointment'] = fieldJson9['value'];
    if (fieldJson9['_value'] != null) {
      json['_appointment'] = fieldJson9['_value'];
    }

    if (start != null) {
      final fieldJson10 = start!.toJson();
      json['start'] = fieldJson10['value'];
      if (fieldJson10['_value'] != null) {
        json['_start'] = fieldJson10['_value'];
      }
    }

    if (end != null) {
      final fieldJson11 = end!.toJson();
      json['end'] = fieldJson11['value'];
      if (fieldJson11['_value'] != null) {
        json['_end'] = fieldJson11['_value'];
      }
    }

    if (participantType != null && participantType!.isNotEmpty) {
      final fieldJson12 = participantType!.map((e) => e.toJson()).toList();
      json['participantType'] = fieldJson12.map((e) => e['value']).toList();
      if (fieldJson12.any((e) => e['_value'] != null)) {
        json['_participantType'] = fieldJson12.map((e) => e['_value']).toList();
      }
    }

    if (actor != null) {
      final fieldJson13 = actor!.toJson();
      json['actor'] = fieldJson13['value'];
      if (fieldJson13['_value'] != null) {
        json['_actor'] = fieldJson13['_value'];
      }
    }

    final fieldJson14 = participantStatus.toJson();
    json['participantStatus'] = fieldJson14['value'];
    if (fieldJson14['_value'] != null) {
      json['_participantStatus'] = fieldJson14['_value'];
    }
