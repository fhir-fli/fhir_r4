...
Device _$DeviceFromJson(Map<String, dynamic> json) => Device(
      ...
      udiCarrier: (json['udiCarrier'] as List<dynamic>?)
          ...
          .toList(),
      status: $enumDecodeNullable(_$FHIRDeviceStatusEnumMap, json['status']),
...
const _$FHIRDeviceStatusEnumMap = {
  FHIRDeviceStatus.active: 'active',
  FHIRDeviceStatus.inactive: 'inactive',
  FHIRDeviceStatus.entered_in_error: 'entered-in-error',
...
DeviceDeviceName _$DeviceDeviceNameFromJson(Map<String, dynamic> json) =>
    DeviceDeviceName(
      ...
      type: $enumDecode(_$DeviceNameTypeEnumMap, json['type']),
