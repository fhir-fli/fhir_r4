...
class Organization extends DomainResource {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (address != null && address!.isNotEmpty) {
      final fieldJson14 = address!.map((e) => e.toJson()).toList();
      json['address'] = fieldJson14.map((e) => e['value']).toList();
      if (fieldJson14.any((e) => e['_value'] != null)) {
        json['_address'] = fieldJson14.map((e) => e['_value']).toList();
      }
    }

    if (partOf != null) {
      final fieldJson15 = partOf!.toJson();
      json['partOf'] = fieldJson15['value'];
      if (fieldJson15['_value'] != null) {
        json['_partOf'] = fieldJson15['_value'];
      }
    }
