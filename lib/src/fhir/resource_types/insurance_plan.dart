    ...
    dynamic yaml,
      ...
      yaml is String
          ...
          : yaml is YamlMap
              ...
              : throw ArgumentError(
                  'InsurancePlan cannot be constructed from '
    ...
    dynamic yaml,
      ...
      yaml is String
          ...
          : yaml is YamlMap
              ...
              : throw ArgumentError(
                  'InsurancePlanLimit cannot be constructed from '
                  'input provided, it is neither a yaml string nor a yaml map.',
                );
    ...
    dynamic yaml,
      ...
      yaml is String
          ...
          : yaml is YamlMap
              ...
              : throw ArgumentError(
                  'InsurancePlanPlan cannot be constructed from '
                  'input provided, it is neither a yaml string nor a yaml map.',
                );
    ...
    dynamic yaml,
      ...
      yaml is String
          ...
          : yaml is YamlMap
              ...
              : throw ArgumentError(
                  'InsurancePlanCost cannot be constructed from '
                  'input provided, it is neither a yaml string nor a yaml map.',
                );
