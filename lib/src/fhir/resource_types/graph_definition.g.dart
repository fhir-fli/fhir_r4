...
GraphDefinitionCompartment _$GraphDefinitionCompartmentFromJson(
    ...
    GraphDefinitionCompartment(
      ...
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)
          ?.map((e) => FhirExtension.fromJson(e as Map<String, dynamic>))
          .toList(),
      use: $enumDecode(_$GraphCompartmentUseEnumMap, json['use']),
      useElement: json['_use'] == null
          ? null
          : Element.fromJson(json['_use'] as Map<String, dynamic>),
      code: $enumDecode(_$CompartmentTypeEnumMap, json['code']),
      codeElement: json['_code'] == null
          ? null
          : Element.fromJson(json['_code'] as Map<String, dynamic>),
      rule: $enumDecode(_$GraphCompartmentRuleEnumMap, json['rule']),
...
const _$GraphCompartmentUseEnumMap = {
  GraphCompartmentUse.condition: 'condition',
  GraphCompartmentUse.requirement: 'requirement',
};

const _$CompartmentTypeEnumMap = {
...
const _$GraphCompartmentRuleEnumMap = {
