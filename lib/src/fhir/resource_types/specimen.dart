  ...
  factory Specimen.fromJson(
    ...
    return Specimen(
      ...
      accessionIdentifier: json['accessionIdentifier'] != null
          ...
          : null,
      status: parseField<SpecimenStatus>(
        json['status'],
        json['_status'],
      ...
      subject: json['subject'] != null
          ...
          : null,
      receivedTime: parseField<FhirDateTime>(
        json['receivedTime'],
        json['_receivedTime'],
