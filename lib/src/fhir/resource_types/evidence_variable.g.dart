...
EvidenceVariable _$EvidenceVariableFromJson(Map<String, dynamic> json) =>
    EvidenceVariable(
      ...
      characteristicCombination: $enumDecodeNullable(
          _$CharacteristicCombinationEnumMap,
...
const _$CharacteristicCombinationEnumMap = {
  CharacteristicCombination.intersection: 'intersection',
  CharacteristicCombination.union: 'union',
};
...
EvidenceVariableCharacteristic _$EvidenceVariableCharacteristicFromJson(
    ...
    EvidenceVariableCharacteristic(
      ...
      groupMeasure:
          $enumDecodeNullable(_$GroupMeasureEnumMap, json['groupMeasure']),
