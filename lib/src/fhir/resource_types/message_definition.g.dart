...
MessageDefinition _$MessageDefinitionFromJson(Map<String, dynamic> json) =>
    MessageDefinition(
      ...
      replaces: (json['replaces'] as List<dynamic>?)
          ...
          .toList(),
      replacesElement: (json['_replaces'] as List<dynamic>?)
      ...
      category: $enumDecodeNullable(
          _$MessageSignificanceCategoryEnumMap, json['category']),
      ...
      responseRequired: $enumDecodeNullable(
          _$MessageheaderResponseRequestEnumMap, json['responseRequired']),
      ...
      graph: (json['graph'] as List<dynamic>?)
          ?.map(FhirCanonical.fromJson)
          .toList(),
      graphElement: (json['_graph'] as List<dynamic>?)
          ?.map((e) => Element.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$MessageDefinitionToJson(MessageDefinition instance) {
  ...
  writeNotNull(
      '_replaces', instance.replacesElement?.map((e) => e.toJson()).toList());
  ...
  writeNotNull(
      '_graph', instance.graphElement?.map((e) => e.toJson()).toList());
  return val;
}
...
const _$MessageSignificanceCategoryEnumMap = {
  MessageSignificanceCategory.consequence: 'consequence',
  MessageSignificanceCategory.currency: 'currency',
  MessageSignificanceCategory.notification: 'notification',
};

const _$MessageheaderResponseRequestEnumMap = {
  MessageheaderResponseRequest.always: 'always',
  MessageheaderResponseRequest.on_error: 'on-error',
  MessageheaderResponseRequest.never: 'never',
  MessageheaderResponseRequest.on_success: 'on-success',
};
