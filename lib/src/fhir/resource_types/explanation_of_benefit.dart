...
class ExplanationOfBenefit extends DomainResource {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (fundsReserveRequested != null) {
      final fieldJson20 = fundsReserveRequested!.toJson();
      json['fundsReserveRequested'] = fieldJson20['value'];
      if (fieldJson20['_value'] != null) {
        json['_fundsReserveRequested'] = fieldJson20['_value'];
      }
    }

    if (fundsReserve != null) {
      final fieldJson21 = fundsReserve!.toJson();
      json['fundsReserve'] = fieldJson21['value'];
      if (fieldJson21['_value'] != null) {
        json['_fundsReserve'] = fieldJson21['_value'];
      }
    }

    if (related != null && related!.isNotEmpty) {
      final fieldJson22 = related!.map((e) => e.toJson()).toList();
      json['related'] = fieldJson22.map((e) => e['value']).toList();
      if (fieldJson22.any((e) => e['_value'] != null)) {
        json['_related'] = fieldJson22.map((e) => e['_value']).toList();
      }
    }

    if (prescription != null) {
      final fieldJson23 = prescription!.toJson();
      json['prescription'] = fieldJson23['value'];
      if (fieldJson23['_value'] != null) {
        json['_prescription'] = fieldJson23['_value'];
      }
    }

    if (originalPrescription != null) {
      final fieldJson24 = originalPrescription!.toJson();
      json['originalPrescription'] = fieldJson24['value'];
      if (fieldJson24['_value'] != null) {
        json['_originalPrescription'] = fieldJson24['_value'];
      }
    }

    if (payee != null) {
      final fieldJson25 = payee!.toJson();
      json['payee'] = fieldJson25['value'];
      if (fieldJson25['_value'] != null) {
        json['_payee'] = fieldJson25['_value'];
      }
    }

    if (referral != null) {
      final fieldJson26 = referral!.toJson();
      json['referral'] = fieldJson26['value'];
      if (fieldJson26['_value'] != null) {
        json['_referral'] = fieldJson26['_value'];
      }
    }

    if (facility != null) {
      final fieldJson27 = facility!.toJson();
      json['facility'] = fieldJson27['value'];
      if (fieldJson27['_value'] != null) {
        json['_facility'] = fieldJson27['_value'];
      }
    }

    if (claim != null) {
      final fieldJson28 = claim!.toJson();
      json['claim'] = fieldJson28['value'];
      if (fieldJson28['_value'] != null) {
        json['_claim'] = fieldJson28['_value'];
      }
    }

    if (claimResponse != null) {
      final fieldJson29 = claimResponse!.toJson();
      json['claimResponse'] = fieldJson29['value'];
      if (fieldJson29['_value'] != null) {
        json['_claimResponse'] = fieldJson29['_value'];
      }
    }

    final fieldJson30 = outcome.toJson();
    json['outcome'] = fieldJson30['value'];
    if (fieldJson30['_value'] != null) {
      json['_outcome'] = fieldJson30['_value'];
    }

    if (disposition != null) {
      final fieldJson31 = disposition!.toJson();
      json['disposition'] = fieldJson31['value'];
      if (fieldJson31['_value'] != null) {
        json['_disposition'] = fieldJson31['_value'];
      }
    }

    if (preAuthRef != null && preAuthRef!.isNotEmpty) {
      final fieldJson32 = preAuthRef!.map((e) => e.toJson()).toList();
      json['preAuthRef'] = fieldJson32.map((e) => e['value']).toList();
      if (fieldJson32.any((e) => e['_value'] != null)) {
        json['_preAuthRef'] = fieldJson32.map((e) => e['_value']).toList();
      }
    }

    if (preAuthRefPeriod != null && preAuthRefPeriod!.isNotEmpty) {
      final fieldJson33 = preAuthRefPeriod!.map((e) => e.toJson()).toList();
      json['preAuthRefPeriod'] = fieldJson33.map((e) => e['value']).toList();
      if (fieldJson33.any((e) => e['_value'] != null)) {
        json['_preAuthRefPeriod'] =
            fieldJson33.map((e) => e['_value']).toList();
      }
    }

    if (careTeam != null && careTeam!.isNotEmpty) {
      final fieldJson34 = careTeam!.map((e) => e.toJson()).toList();
      json['careTeam'] = fieldJson34.map((e) => e['value']).toList();
      if (fieldJson34.any((e) => e['_value'] != null)) {
        json['_careTeam'] = fieldJson34.map((e) => e['_value']).toList();
      }
    }
    ...
    if (diagnosis != null && diagnosis!.isNotEmpty) {
      final fieldJson36 = diagnosis!.map((e) => e.toJson()).toList();
      json['diagnosis'] = fieldJson36.map((e) => e['value']).toList();
      if (fieldJson36.any((e) => e['_value'] != null)) {
        json['_diagnosis'] = fieldJson36.map((e) => e['_value']).toList();
      }
    }

    if (procedure != null && procedure!.isNotEmpty) {
      final fieldJson37 = procedure!.map((e) => e.toJson()).toList();
      json['procedure'] = fieldJson37.map((e) => e['value']).toList();
      if (fieldJson37.any((e) => e['_value'] != null)) {
        json['_procedure'] = fieldJson37.map((e) => e['_value']).toList();
      }
    }

    if (precedence != null) {
      final fieldJson38 = precedence!.toJson();
      json['precedence'] = fieldJson38['value'];
      if (fieldJson38['_value'] != null) {
        json['_precedence'] = fieldJson38['_value'];
      }
    }
    ...
    if (accident != null) {
      final fieldJson40 = accident!.toJson();
      json['accident'] = fieldJson40['value'];
      if (fieldJson40['_value'] != null) {
        json['_accident'] = fieldJson40['_value'];
      }
    }

    if (item != null && item!.isNotEmpty) {
      final fieldJson41 = item!.map((e) => e.toJson()).toList();
      json['item'] = fieldJson41.map((e) => e['value']).toList();
      if (fieldJson41.any((e) => e['_value'] != null)) {
        json['_item'] = fieldJson41.map((e) => e['_value']).toList();
      }
    }

    if (addItem != null && addItem!.isNotEmpty) {
      final fieldJson42 = addItem!.map((e) => e.toJson()).toList();
      json['addItem'] = fieldJson42.map((e) => e['value']).toList();
      if (fieldJson42.any((e) => e['_value'] != null)) {
        json['_addItem'] = fieldJson42.map((e) => e['_value']).toList();
      }
    }

    if (total != null && total!.isNotEmpty) {
      final fieldJson43 = total!.map((e) => e.toJson()).toList();
      json['total'] = fieldJson43.map((e) => e['value']).toList();
      if (fieldJson43.any((e) => e['_value'] != null)) {
        json['_total'] = fieldJson43.map((e) => e['_value']).toList();
      }
    }

    if (payment != null) {
      final fieldJson44 = payment!.toJson();
      json['payment'] = fieldJson44['value'];
      if (fieldJson44['_value'] != null) {
        json['_payment'] = fieldJson44['_value'];
      }
    }

    if (formCode != null) {
      final fieldJson45 = formCode!.toJson();
      json['formCode'] = fieldJson45['value'];
      if (fieldJson45['_value'] != null) {
        json['_formCode'] = fieldJson45['_value'];
      }
    }

    if (form != null) {
      final fieldJson46 = form!.toJson();
      json['form'] = fieldJson46['value'];
      if (fieldJson46['_value'] != null) {
        json['_form'] = fieldJson46['_value'];
      }
    }

    if (processNote != null && processNote!.isNotEmpty) {
      final fieldJson47 = processNote!.map((e) => e.toJson()).toList();
      json['processNote'] = fieldJson47.map((e) => e['value']).toList();
      if (fieldJson47.any((e) => e['_value'] != null)) {
        json['_processNote'] = fieldJson47.map((e) => e['_value']).toList();
      }
    }

    if (benefitPeriod != null) {
      final fieldJson48 = benefitPeriod!.toJson();
      json['benefitPeriod'] = fieldJson48['value'];
      if (fieldJson48['_value'] != null) {
        json['_benefitPeriod'] = fieldJson48['_value'];
      }
    }

    if (benefitBalance != null && benefitBalance!.isNotEmpty) {
      final fieldJson49 = benefitBalance!.map((e) => e.toJson()).toList();
      json['benefitBalance'] = fieldJson49.map((e) => e['value']).toList();
      if (fieldJson49.any((e) => e['_value'] != null)) {
        json['_benefitBalance'] = fieldJson49.map((e) => e['_value']).toList();
      }
    }
...
class ExplanationOfBenefitInsurance extends BackboneElement {
  ...
  Map<String, dynamic> toJson() {
    ...
    final fieldJson4 = coverage.toJson();
    json['coverage'] = fieldJson4['value'];
    if (fieldJson4['_value'] != null) {
      json['_coverage'] = fieldJson4['_value'];
    }

    if (preAuthRef != null && preAuthRef!.isNotEmpty) {
      final fieldJson5 = preAuthRef!.map((e) => e.toJson()).toList();
      json['preAuthRef'] = fieldJson5.map((e) => e['value']).toList();
      if (fieldJson5.any((e) => e['_value'] != null)) {
        json['_preAuthRef'] = fieldJson5.map((e) => e['_value']).toList();
      }
    }
...
class ExplanationOfBenefitItem extends BackboneElement {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (noteNumber != null && noteNumber!.isNotEmpty) {
      final fieldJson26 = noteNumber!.map((e) => e.toJson()).toList();
      json['noteNumber'] = fieldJson26.map((e) => e['value']).toList();
      if (fieldJson26.any((e) => e['_value'] != null)) {
        json['_noteNumber'] = fieldJson26.map((e) => e['_value']).toList();
      }
    }

    if (adjudication != null && adjudication!.isNotEmpty) {
      final fieldJson27 = adjudication!.map((e) => e.toJson()).toList();
      json['adjudication'] = fieldJson27.map((e) => e['value']).toList();
      if (fieldJson27.any((e) => e['_value'] != null)) {
        json['_adjudication'] = fieldJson27.map((e) => e['_value']).toList();
      }
    }

    if (detail != null && detail!.isNotEmpty) {
      final fieldJson28 = detail!.map((e) => e.toJson()).toList();
      json['detail'] = fieldJson28.map((e) => e['value']).toList();
      if (fieldJson28.any((e) => e['_value'] != null)) {
        json['_detail'] = fieldJson28.map((e) => e['_value']).toList();
      }
    }
...
class ExplanationOfBenefitDetail extends BackboneElement {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (noteNumber != null && noteNumber!.isNotEmpty) {
      final fieldJson14 = noteNumber!.map((e) => e.toJson()).toList();
      json['noteNumber'] = fieldJson14.map((e) => e['value']).toList();
      if (fieldJson14.any((e) => e['_value'] != null)) {
        json['_noteNumber'] = fieldJson14.map((e) => e['_value']).toList();
      }
    }

    if (subDetail != null && subDetail!.isNotEmpty) {
      final fieldJson15 = subDetail!.map((e) => e.toJson()).toList();
      json['subDetail'] = fieldJson15.map((e) => e['value']).toList();
      if (fieldJson15.any((e) => e['_value'] != null)) {
        json['_subDetail'] = fieldJson15.map((e) => e['_value']).toList();
      }
    }
...
class ExplanationOfBenefitBenefitBalance extends BackboneElement {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (excluded != null) {
      final fieldJson4 = excluded!.toJson();
      json['excluded'] = fieldJson4['value'];
      if (fieldJson4['_value'] != null) {
        json['_excluded'] = fieldJson4['_value'];
      }
    }
    ...
    if (network != null) {
      final fieldJson7 = network!.toJson();
      json['network'] = fieldJson7['value'];
      if (fieldJson7['_value'] != null) {
        json['_network'] = fieldJson7['_value'];
      }
    }

    if (unit != null) {
      final fieldJson8 = unit!.toJson();
      json['unit'] = fieldJson8['value'];
      if (fieldJson8['_value'] != null) {
        json['_unit'] = fieldJson8['_value'];
      }
    }

    if (term != null) {
      final fieldJson9 = term!.toJson();
      json['term'] = fieldJson9['value'];
      if (fieldJson9['_value'] != null) {
        json['_term'] = fieldJson9['_value'];
      }
    }

    if (financial != null && financial!.isNotEmpty) {
      final fieldJson10 = financial!.map((e) => e.toJson()).toList();
      json['financial'] = fieldJson10.map((e) => e['value']).toList();
      if (fieldJson10.any((e) => e['_value'] != null)) {
        json['_financial'] = fieldJson10.map((e) => e['_value']).toList();
      }
    }
...
class ExplanationOfBenefitFinancial extends BackboneElement {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (allowedUnsignedInt != null) {
      final fieldJson4 = allowedUnsignedInt!.toJson();
      json['allowedUnsignedInt'] = fieldJson4['value'];
      if (fieldJson4['_value'] != null) {
        json['_allowedUnsignedInt'] = fieldJson4['_value'];
      }
    }

    if (allowedString != null) {
      final fieldJson5 = allowedString!.toJson();
      json['allowedString'] = fieldJson5['value'];
      if (fieldJson5['_value'] != null) {
        json['_allowedString'] = fieldJson5['_value'];
      }
    }

    if (allowedMoney != null) {
      final fieldJson6 = allowedMoney!.toJson();
      json['allowedMoney'] = fieldJson6['value'];
      if (fieldJson6['_value'] != null) {
        json['_allowedMoney'] = fieldJson6['_value'];
      }
    }

    if (usedUnsignedInt != null) {
      final fieldJson7 = usedUnsignedInt!.toJson();
      json['usedUnsignedInt'] = fieldJson7['value'];
      if (fieldJson7['_value'] != null) {
        json['_usedUnsignedInt'] = fieldJson7['_value'];
      }
    }

    if (usedMoney != null) {
      final fieldJson8 = usedMoney!.toJson();
      json['usedMoney'] = fieldJson8['value'];
      if (fieldJson8['_value'] != null) {
        json['_usedMoney'] = fieldJson8['_value'];
      }
    }
