...
OperationOutcomeIssue _$OperationOutcomeIssueFromJson(
    ...
    OperationOutcomeIssue(
      ...
      code: $enumDecode(_$IssueTypeEnumMap, json['code']),
...
const _$IssueTypeEnumMap = {
  ...
  IssueType.not_supported: 'not-supported',
  IssueType.duplicate: 'duplicate',
  IssueType.multiple_matches: 'multiple-matches',
  IssueType.not_found: 'not-found',
  IssueType.deleted: 'deleted',
  IssueType.too_long: 'too-long',
  IssueType.code_invalid: 'code-invalid',
  IssueType.extension_: 'extension',
  IssueType.too_costly: 'too-costly',
  IssueType.business_rule: 'business-rule',
  IssueType.conflict: 'conflict',
  IssueType.transient: 'transient',
  IssueType.lock_error: 'lock-error',
  IssueType.no_store: 'no-store',
