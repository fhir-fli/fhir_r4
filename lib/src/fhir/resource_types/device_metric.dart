...
class DeviceMetric extends DomainResource {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (unit != null) {
      final fieldJson10 = unit!.toJson();
      json['unit'] = fieldJson10['value'];
      if (fieldJson10['_value'] != null) {
        json['_unit'] = fieldJson10['_value'];
      }
    }

    if (source != null) {
      final fieldJson11 = source!.toJson();
      json['source'] = fieldJson11['value'];
      if (fieldJson11['_value'] != null) {
        json['_source'] = fieldJson11['_value'];
      }
    }

    if (parent != null) {
      final fieldJson12 = parent!.toJson();
      json['parent'] = fieldJson12['value'];
      if (fieldJson12['_value'] != null) {
        json['_parent'] = fieldJson12['_value'];
      }
    }

    if (operationalStatus != null) {
      final fieldJson13 = operationalStatus!.toJson();
      json['operationalStatus'] = fieldJson13['value'];
      if (fieldJson13['_value'] != null) {
        json['_operationalStatus'] = fieldJson13['_value'];
      }
    }
    ...
    if (measurementPeriod != null) {
      final fieldJson16 = measurementPeriod!.toJson();
      json['measurementPeriod'] = fieldJson16['value'];
      if (fieldJson16['_value'] != null) {
        json['_measurementPeriod'] = fieldJson16['_value'];
      }
    }

    if (calibration != null && calibration!.isNotEmpty) {
      final fieldJson17 = calibration!.map((e) => e.toJson()).toList();
      json['calibration'] = fieldJson17.map((e) => e['value']).toList();
      if (fieldJson17.any((e) => e['_value'] != null)) {
        json['_calibration'] = fieldJson17.map((e) => e['_value']).toList();
      }
    }
...
class DeviceMetricCalibration extends BackboneElement {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (state != null) {
      final fieldJson4 = state!.toJson();
      json['state'] = fieldJson4['value'];
      if (fieldJson4['_value'] != null) {
        json['_state'] = fieldJson4['_value'];
      }
    }

    if (time != null) {
      final fieldJson5 = time!.toJson();
      json['time'] = fieldJson5['value'];
      if (fieldJson5['_value'] != null) {
        json['_time'] = fieldJson5['_value'];
      }
    }
