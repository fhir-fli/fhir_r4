  ...
  Map<String, dynamic> toJson() {
    ...
    if (parameter != null && parameter!.isNotEmpty) {
      json['parameter'] = parameter!
          .map<dynamic>((ParameterDefinition v) => v.toJson())
          .toList();
    }
    ...
    if (content != null && content!.isNotEmpty) {
      json['content'] =
          content!.map<dynamic>((Attachment v) => v.toJson()).toList();
    }
    return json;
  }
    ...
    return Library(
      ...
      parameter: json['parameter'] != null
          ? (json['parameter'] as List<dynamic>)
              .map<ParameterDefinition>((dynamic v) =>
                  ParameterDefinition.fromJson(v as Map<String, dynamic>))
              .toList()
          : null,
