...
class Library extends DomainResource {
      ...
      parameter: json['parameter'] != null
          ? (json['parameter'] as List<dynamic>)
              .map<ParameterDefinition>(
                (dynamic v) => ParameterDefinition.fromJson(
                  v as Map<String, dynamic>,
                ),
              )
              .toList()
  ...
  /// Deserialize [Library] from a [String] or [YamlMap] object
  factory Library.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ...
          : throw ArgumentError('Library cannot be constructed from input '
              'provided, it is neither a yaml string nor a yaml map.');

  /// Factory constructor for [Library] that takes in a [String]
  ...
  Map<String, dynamic> toJson() {
    ...
    if (parameter != null && parameter!.isNotEmpty) {
      json['parameter'] =
          parameter!.map((ParameterDefinition v) => v.toJson()).toList();
    }
    if (dataRequirement != null && dataRequirement!.isNotEmpty) {
      json['dataRequirement'] =
          dataRequirement!.map((DataRequirement v) => v.toJson()).toList();
    }
    if (content != null && content!.isNotEmpty) {
      json['content'] = content!.map((Attachment v) => v.toJson()).toList();
    }
    return json;
  }
