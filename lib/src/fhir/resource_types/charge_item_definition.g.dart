...
ChargeItemDefinition _$ChargeItemDefinitionFromJson(
    ...
    ChargeItemDefinition(
      ...
      partOf: (json['partOf'] as List<dynamic>?)
          ...
          .toList(),
      partOfElement: (json['_partOf'] as List<dynamic>?)
          ?.map((e) => Element.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$ChargeItemDefinitionToJson(
  ...
  writeNotNull(
      '_partOf', instance.partOfElement?.map((e) => e.toJson()).toList());
...
ChargeItemDefinitionPriceComponent _$ChargeItemDefinitionPriceComponentFromJson(
    ...
    ChargeItemDefinitionPriceComponent(
      ...
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)
          ?.map((e) => FhirExtension.fromJson(e as Map<String, dynamic>))
          .toList(),
      type: $enumDecode(_$InvoicePriceComponentTypeEnumMap, json['type']),
