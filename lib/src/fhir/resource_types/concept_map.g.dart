...
ConceptMapTarget _$ConceptMapTargetFromJson(Map<String, dynamic> json) =>
    ConceptMapTarget(
      ...
      displayElement: json['_display'] == null
          ...
          : Element.fromJson(json['_display'] as Map<String, dynamic>),
      equivalence:
          $enumDecode(_$ConceptMapEquivalenceEnumMap, json['equivalence']),
...
ConceptMapUnmapped _$ConceptMapUnmappedFromJson(Map<String, dynamic> json) =>
    ConceptMapUnmapped(
      ...
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)
          ?.map((e) => FhirExtension.fromJson(e as Map<String, dynamic>))
          .toList(),
      mode: $enumDecode(_$ConceptMapGroupUnmappedModeEnumMap, json['mode']),
...
const _$ConceptMapGroupUnmappedModeEnumMap = {
