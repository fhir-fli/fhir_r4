...
class Basic extends DomainResource {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (subject != null) {
      final fieldJson10 = subject!.toJson();
      json['subject'] = fieldJson10['value'];
      if (fieldJson10['_value'] != null) {
        json['_subject'] = fieldJson10['_value'];
      }
    }
    ...
    if (author != null) {
      final fieldJson12 = author!.toJson();
      json['author'] = fieldJson12['value'];
      if (fieldJson12['_value'] != null) {
        json['_author'] = fieldJson12['_value'];
      }
    }
