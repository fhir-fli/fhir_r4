...
TestReport _$TestReportFromJson(Map<String, dynamic> json) => TestReport(
      ...
      status: $enumDecode(_$TestReportStatusEnumMap, json['status']),
      statusElement: json['_status'] == null
          ? null
          : Element.fromJson(json['_status'] as Map<String, dynamic>),
      testScript:
          Reference.fromJson(json['testScript'] as Map<String, dynamic>),
      result: $enumDecode(_$TestReportResultEnumMap, json['result']),
      ...
      tester:
          json['tester'] == null ? null : FhirString.fromJson(json['tester']),
...
Map<String, dynamic> _$TestReportToJson(TestReport instance) {
  ...
  writeNotNull('tester', instance.tester?.toJson());
...
TestReportParticipant _$TestReportParticipantFromJson(
    ...
    TestReportParticipant(
      ...
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)
          ?.map((e) => FhirExtension.fromJson(e as Map<String, dynamic>))
          .toList(),
      type: $enumDecode(_$TestReportParticipantTypeEnumMap, json['type']),
...
TestReportOperation _$TestReportOperationFromJson(Map<String, dynamic> json) =>
    TestReportOperation(
      ...
      modifierExtension: (json['modifierExtension'] as List<dynamic>?)
          ?.map((e) => FhirExtension.fromJson(e as Map<String, dynamic>))
          .toList(),
      result: $enumDecode(_$TestReportActionResultEnumMap, json['result']),
      resultElement: json['_result'] == null
          ? null
          : Element.fromJson(json['_result'] as Map<String, dynamic>),
...
const _$TestReportActionResultEnumMap = {
...
TestReportAssert _$TestReportAssertFromJson(Map<String, dynamic> json) =>
    TestReportAssert(
      ...
      messageElement: json['_message'] == null
          ...
          : Element.fromJson(json['_message'] as Map<String, dynamic>),
      detail:
          json['detail'] == null ? null : FhirString.fromJson(json['detail']),
      detailElement: json['_detail'] == null
          ? null
          : Element.fromJson(json['_detail'] as Map<String, dynamic>),
      userData: json['userData'] as Map<String, dynamic>?,
