...
class EnrollmentRequest extends DomainResource {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (insurer != null) {
      final fieldJson11 = insurer!.toJson();
      json['insurer'] = fieldJson11['value'];
      if (fieldJson11['_value'] != null) {
        json['_insurer'] = fieldJson11['_value'];
      }
    }

    if (provider != null) {
      final fieldJson12 = provider!.toJson();
      json['provider'] = fieldJson12['value'];
      if (fieldJson12['_value'] != null) {
        json['_provider'] = fieldJson12['_value'];
      }
    }

    if (candidate != null) {
      final fieldJson13 = candidate!.toJson();
      json['candidate'] = fieldJson13['value'];
      if (fieldJson13['_value'] != null) {
        json['_candidate'] = fieldJson13['_value'];
      }
    }

    if (coverage != null) {
      final fieldJson14 = coverage!.toJson();
      json['coverage'] = fieldJson14['value'];
      if (fieldJson14['_value'] != null) {
        json['_coverage'] = fieldJson14['_value'];
      }
    }
