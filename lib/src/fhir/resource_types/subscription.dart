...
class Subscription extends DomainResource {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (contact != null && contact!.isNotEmpty) {
      final fieldJson9 = contact!.map((e) => e.toJson()).toList();
      json['contact'] = fieldJson9.map((e) => e['value']).toList();
      if (fieldJson9.any((e) => e['_value'] != null)) {
        json['_contact'] = fieldJson9.map((e) => e['_value']).toList();
      }
    }
    ...
    final fieldJson11 = reason.toJson();
    json['reason'] = fieldJson11['value'];
    if (fieldJson11['_value'] != null) {
      json['_reason'] = fieldJson11['_value'];
    }

    final fieldJson12 = criteria.toJson();
    json['criteria'] = fieldJson12['value'];
    if (fieldJson12['_value'] != null) {
      json['_criteria'] = fieldJson12['_value'];
    }

    if (error != null) {
      final fieldJson13 = error!.toJson();
      json['error'] = fieldJson13['value'];
      if (fieldJson13['_value'] != null) {
        json['_error'] = fieldJson13['_value'];
      }
    }

    final fieldJson14 = channel.toJson();
    json['channel'] = fieldJson14['value'];
    if (fieldJson14['_value'] != null) {
      json['_channel'] = fieldJson14['_value'];
    }
...
class SubscriptionChannel extends BackboneElement {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (payload != null) {
      final fieldJson5 = payload!.toJson();
      json['payload'] = fieldJson5['value'];
      if (fieldJson5['_value'] != null) {
        json['_payload'] = fieldJson5['_value'];
      }
    }

    if (header != null && header!.isNotEmpty) {
      final fieldJson6 = header!.map((e) => e.toJson()).toList();
      json['header'] = fieldJson6.map((e) => e['value']).toList();
      if (fieldJson6.any((e) => e['_value'] != null)) {
        json['_header'] = fieldJson6.map((e) => e['_value']).toList();
      }
    }
