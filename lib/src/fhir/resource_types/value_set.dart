...
class ValueSet extends DomainResource {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (immutable != null) {
      final fieldJson21 = immutable!.toJson();
      json['immutable'] = fieldJson21['value'];
      if (fieldJson21['_value'] != null) {
        json['_immutable'] = fieldJson21['_value'];
      }
    }
    ...
    if (compose != null) {
      final fieldJson24 = compose!.toJson();
      json['compose'] = fieldJson24['value'];
      if (fieldJson24['_value'] != null) {
        json['_compose'] = fieldJson24['_value'];
      }
    }

    if (expansion != null) {
      final fieldJson25 = expansion!.toJson();
      json['expansion'] = fieldJson25['value'];
      if (fieldJson25['_value'] != null) {
        json['_expansion'] = fieldJson25['_value'];
      }
    }
...
class ValueSetCompose extends BackboneElement {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (lockedDate != null) {
      final fieldJson3 = lockedDate!.toJson();
      json['lockedDate'] = fieldJson3['value'];
      if (fieldJson3['_value'] != null) {
        json['_lockedDate'] = fieldJson3['_value'];
      }
    }
    ...
    final fieldJson5 = include.map((e) => e.toJson()).toList();
    json['include'] = fieldJson5.map((e) => e['value']).toList();
    if (fieldJson5.any((e) => e['_value'] != null)) {
      json['_include'] = fieldJson5.map((e) => e['_value']).toList();
    }
...
class ValueSetInclude extends BackboneElement {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (concept != null && concept!.isNotEmpty) {
      final fieldJson5 = concept!.map((e) => e.toJson()).toList();
      json['concept'] = fieldJson5.map((e) => e['value']).toList();
      if (fieldJson5.any((e) => e['_value'] != null)) {
        json['_concept'] = fieldJson5.map((e) => e['_value']).toList();
      }
    }

    if (filter != null && filter!.isNotEmpty) {
      final fieldJson6 = filter!.map((e) => e.toJson()).toList();
      json['filter'] = fieldJson6.map((e) => e['value']).toList();
      if (fieldJson6.any((e) => e['_value'] != null)) {
        json['_filter'] = fieldJson6.map((e) => e['_value']).toList();
      }
    }

    if (valueSet != null && valueSet!.isNotEmpty) {
      final fieldJson7 = valueSet!.map((e) => e.toJson()).toList();
      json['valueSet'] = fieldJson7.map((e) => e['value']).toList();
      if (fieldJson7.any((e) => e['_value'] != null)) {
        json['_valueSet'] = fieldJson7.map((e) => e['_value']).toList();
      }
    }
...
class ValueSetConcept extends BackboneElement {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (designation != null && designation!.isNotEmpty) {
      final fieldJson5 = designation!.map((e) => e.toJson()).toList();
      json['designation'] = fieldJson5.map((e) => e['value']).toList();
      if (fieldJson5.any((e) => e['_value'] != null)) {
        json['_designation'] = fieldJson5.map((e) => e['_value']).toList();
      }
    }
...
class ValueSetFilter extends BackboneElement {
  ...
  Map<String, dynamic> toJson() {
    ...
    final fieldJson3 = property.toJson();
    json['property'] = fieldJson3['value'];
    if (fieldJson3['_value'] != null) {
      json['_property'] = fieldJson3['_value'];
    }

    final fieldJson4 = op.toJson();
    json['op'] = fieldJson4['value'];
    if (fieldJson4['_value'] != null) {
      json['_op'] = fieldJson4['_value'];
    }
...
class ValueSetExpansion extends BackboneElement {
  ...
  Map<String, dynamic> toJson() {
    ...
    final fieldJson4 = timestamp.toJson();
    json['timestamp'] = fieldJson4['value'];
    if (fieldJson4['_value'] != null) {
      json['_timestamp'] = fieldJson4['_value'];
    }

    if (total != null) {
      final fieldJson5 = total!.toJson();
      json['total'] = fieldJson5['value'];
      if (fieldJson5['_value'] != null) {
        json['_total'] = fieldJson5['_value'];
      }
    }

    if (offset != null) {
      final fieldJson6 = offset!.toJson();
      json['offset'] = fieldJson6['value'];
      if (fieldJson6['_value'] != null) {
        json['_offset'] = fieldJson6['_value'];
      }
    }

    if (parameter != null && parameter!.isNotEmpty) {
      final fieldJson7 = parameter!.map((e) => e.toJson()).toList();
      json['parameter'] = fieldJson7.map((e) => e['value']).toList();
      if (fieldJson7.any((e) => e['_value'] != null)) {
        json['_parameter'] = fieldJson7.map((e) => e['_value']).toList();
      }
    }

    if (contains != null && contains!.isNotEmpty) {
      final fieldJson8 = contains!.map((e) => e.toJson()).toList();
      json['contains'] = fieldJson8.map((e) => e['value']).toList();
      if (fieldJson8.any((e) => e['_value'] != null)) {
        json['_contains'] = fieldJson8.map((e) => e['_value']).toList();
      }
    }
...
class ValueSetParameter extends BackboneElement {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (valueUri != null) {
      final fieldJson8 = valueUri!.toJson();
      json['valueUri'] = fieldJson8['value'];
      if (fieldJson8['_value'] != null) {
        json['_valueUri'] = fieldJson8['_value'];
      }
    }

    if (valueCode != null) {
      final fieldJson9 = valueCode!.toJson();
      json['valueCode'] = fieldJson9['value'];
      if (fieldJson9['_value'] != null) {
        json['_valueCode'] = fieldJson9['_value'];
      }
    }

    if (valueDateTime != null) {
      final fieldJson10 = valueDateTime!.toJson();
      json['valueDateTime'] = fieldJson10['value'];
      if (fieldJson10['_value'] != null) {
        json['_valueDateTime'] = fieldJson10['_value'];
      }
    }
...
class ValueSetContains extends BackboneElement {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (abstract_ != null) {
      final fieldJson4 = abstract_!.toJson();
      json['abstract'] = fieldJson4['value'];
      if (fieldJson4['_value'] != null) {
        json['_abstract'] = fieldJson4['_value'];
      }
    }

    if (inactive != null) {
      final fieldJson5 = inactive!.toJson();
      json['inactive'] = fieldJson5['value'];
      if (fieldJson5['_value'] != null) {
        json['_inactive'] = fieldJson5['_value'];
      }
    }
    ...
    if (code != null) {
      final fieldJson7 = code!.toJson();
      json['code'] = fieldJson7['value'];
      if (fieldJson7['_value'] != null) {
        json['_code'] = fieldJson7['_value'];
      }
    }

    if (display != null) {
      final fieldJson8 = display!.toJson();
      json['display'] = fieldJson8['value'];
      if (fieldJson8['_value'] != null) {
        json['_display'] = fieldJson8['_value'];
      }
    }
