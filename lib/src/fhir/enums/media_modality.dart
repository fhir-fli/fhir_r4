...
String toJson() => toString();
  MediaModality fromString(String str) {
    switch(str) {
      case 'diagram': return MediaModality.diagram;
      case 'fax': return MediaModality.fax;
      case 'scan': return MediaModality.scan;
      case 'retina': return MediaModality.retina;
      case 'fingerprint': return MediaModality.fingerprint;
      case 'iris': return MediaModality.iris;
      case 'palm': return MediaModality.palm;
      case 'face': return MediaModality.face;
