...
enum ImmunizationFunctionCodes {
  ...
  /// Converts a list of JSON values to a list of [ImmunizationFunctionCodes] instances.
  static ImmunizationFunctionCodes fromJson(
    ...
    if (value == null && element != null) {
      return ImmunizationFunctionCodes.elementOnly.withElement(
        element,
      );
    }
