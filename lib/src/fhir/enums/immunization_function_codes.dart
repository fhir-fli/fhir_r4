...
class ImmunizationFunctionCodes {
  ...
  ImmunizationFunctionCodes({this.fhirCode, this.element})
      : assert(
  ...
  static final ImmunizationFunctionCodes OP = ImmunizationFunctionCodes(
    fhirCode: 'OP',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ImmunizationFunctionCodes AP = ImmunizationFunctionCodes(
    fhirCode: 'AP',
  );
  ...
  ImmunizationFunctionCodes withElement(Element? newElement) {
    return ImmunizationFunctionCodes(
      fhirCode: fhirCode,
      element: newElement,
    );
  }
