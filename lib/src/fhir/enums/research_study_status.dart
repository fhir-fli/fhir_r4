...
@override
  String toString() {
      switch(this) {
        ...
        case administratively_completed: return 'administratively-completed';
        case approved: return 'approved';
        case closed_to_accrual: return 'closed-to-accrual';
        case closed_to_accrual_and_intervention: return 'closed-to-accrual-and-intervention';
        case completed: return 'completed';
        case disapproved: return 'disapproved';
        case in_review: return 'in-review';
        case temporarily_closed_to_accrual: return 'temporarily-closed-to-accrual';
        case temporarily_closed_to_accrual_and_intervention: return 'temporarily-closed-to-accrual-and-intervention';
...
String toJson() => toString();
  ResearchStudyStatus fromString(String str) {
    switch(str) {
      case 'active': return ResearchStudyStatus.active;
      case 'administratively-completed': return ResearchStudyStatus.administratively_completed;
      case 'approved': return ResearchStudyStatus.approved;
      case 'closed-to-accrual': return ResearchStudyStatus.closed_to_accrual;
      case 'closed-to-accrual-and-intervention': return ResearchStudyStatus.closed_to_accrual_and_intervention;
      case 'completed': return ResearchStudyStatus.completed;
      case 'disapproved': return ResearchStudyStatus.disapproved;
      case 'in-review': return ResearchStudyStatus.in_review;
      case 'temporarily-closed-to-accrual': return ResearchStudyStatus.temporarily_closed_to_accrual;
      case 'temporarily-closed-to-accrual-and-intervention': return ResearchStudyStatus.temporarily_closed_to_accrual_and_intervention;
      case 'withdrawn': return ResearchStudyStatus.withdrawn;
