...
@override
  String toString() {
      switch(this) {
        ...
        case health_unknown: return 'health-unknown';
      }
      }
String toJson() => toString();
  FamilyHistoryStatus fromString(String str) {
    switch(str) {
      case 'partial': return FamilyHistoryStatus.partial;
      case 'completed': return FamilyHistoryStatus.completed;
      case 'entered-in-error': return FamilyHistoryStatus.entered_in_error;
      case 'health-unknown': return FamilyHistoryStatus.health_unknown;
