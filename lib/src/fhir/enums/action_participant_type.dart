...
@override
  String toString() {
      switch(this) {
        ...
        case related_person: return 'related-person';
...
String toJson() => toString();
  ActionParticipantType fromString(String str) {
    switch(str) {
      case 'patient': return ActionParticipantType.patient;
      case 'practitioner': return ActionParticipantType.practitioner;
      case 'related-person': return ActionParticipantType.related_person;
      case 'device': return ActionParticipantType.device;
