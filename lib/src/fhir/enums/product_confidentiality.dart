...
enum ProductConfidentiality {
  ...
  /// Converts a list of JSON values to a list of [ProductConfidentiality] instances.
  static ProductConfidentiality fromJson(
    ...
    if (value == null && element != null) {
      return ProductConfidentiality.elementOnly.withElement(
        element,
      );
    }
