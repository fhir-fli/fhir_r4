...
enum GraphCompartmentRule {
  ...
  /// Converts a list of JSON values to a list of [GraphCompartmentRule] instances.
  static GraphCompartmentRule fromJson(
    ...
    if (value == null && element != null) {
      return GraphCompartmentRule.elementOnly.withElement(
        element,
      );
    }
