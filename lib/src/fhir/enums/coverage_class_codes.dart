...
String toJson() => toString();
  CoverageClassCodes fromString(String str) {
    switch(str) {
      case 'group': return CoverageClassCodes.group;
      case 'subgroup': return CoverageClassCodes.subgroup;
      case 'plan': return CoverageClassCodes.plan;
      case 'subplan': return CoverageClassCodes.subplan;
      case 'class': return CoverageClassCodes.class_;
      case 'subclass': return CoverageClassCodes.subclass;
      case 'sequence': return CoverageClassCodes.sequence;
      case 'rxbin': return CoverageClassCodes.rxbin;
      case 'rxpcn': return CoverageClassCodes.rxpcn;
      case 'rxid': return CoverageClassCodes.rxid;
      case 'rxgroup': return CoverageClassCodes.rxgroup;
