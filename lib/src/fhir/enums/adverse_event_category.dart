...
@override
  String toString() {
      switch(this) {
        case product_problem: return 'product-problem';
        case product_quality: return 'product-quality';
        case product_use_error: return 'product-use-error';
        case medical_device_use_error: return 'medical-device-use-error';
        case problem_different_manufacturer: return 'problem-different-manufacturer';
        case unsafe_physical_environment: return 'unsafe-physical-environment';
      }
      }
String toJson() => toString();
  AdverseEventCategory fromString(String str) {
    switch(str) {
      case 'product-problem': return AdverseEventCategory.product_problem;
      case 'product-quality': return AdverseEventCategory.product_quality;
      case 'product-use-error': return AdverseEventCategory.product_use_error;
      case 'medical-device-use-error': return AdverseEventCategory.medical_device_use_error;
      case 'problem-different-manufacturer': return AdverseEventCategory.problem_different_manufacturer;
      case 'unsafe-physical-environment': return AdverseEventCategory.unsafe_physical_environment;
