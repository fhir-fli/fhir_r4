...
@override
  String toString() {
      switch(this) {
        ...
        case busy_unavailable: return 'busy-unavailable';
        case busy_tentative: return 'busy-tentative';
...
String toJson() => toString();
  SlotStatus fromString(String str) {
    switch(str) {
      case 'busy': return SlotStatus.busy;
      case 'free': return SlotStatus.free;
      case 'busy-unavailable': return SlotStatus.busy_unavailable;
      case 'busy-tentative': return SlotStatus.busy_tentative;
      case 'entered-in-error': return SlotStatus.entered_in_error;
