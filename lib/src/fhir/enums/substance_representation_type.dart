...
String toJson() => toString();
  SubstanceRepresentationType fromString(String str) {
    switch(str) {
      case 'Systematic': return SubstanceRepresentationType.Systematic;
      case 'Scientific': return SubstanceRepresentationType.Scientific;
      case 'Brand': return SubstanceRepresentationType.Brand;
