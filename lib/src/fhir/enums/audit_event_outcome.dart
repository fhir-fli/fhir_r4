...
String toJson() => toString();
  AuditEventOutcome fromString(String str) {
    switch(str) {
      case '0': return AuditEventOutcome.value0;
      case '4': return AuditEventOutcome.value4;
      case '8': return AuditEventOutcome.value8;
      case '12': return AuditEventOutcome.value12;
