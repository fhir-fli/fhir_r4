...
@override
  String toString() {
      switch(this) {
        ...
        case family_objection: return 'family-objection';
        case patient_objection: return 'patient-objection';
      }
      }
String toJson() => toString();
  CommunicationNotDoneReason fromString(String str) {
    switch(str) {
      case 'unknown': return CommunicationNotDoneReason.unknown;
      case 'system-error': return CommunicationNotDoneReason.system_error;
      case 'invalid-phone-number': return CommunicationNotDoneReason.invalid_phone_number;
      case 'recipient-unavailable': return CommunicationNotDoneReason.recipient_unavailable;
      case 'family-objection': return CommunicationNotDoneReason.family_objection;
      case 'patient-objection': return CommunicationNotDoneReason.patient_objection;
