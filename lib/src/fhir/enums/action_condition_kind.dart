...
class ActionConditionKind {
  ...
  ActionConditionKind({this.fhirCode, this.element})
      : assert(
  ...
  static final ActionConditionKind applicability = ActionConditionKind(
    fhirCode: 'applicability',
  );

  /// start
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ActionConditionKind start = ActionConditionKind(
    fhirCode: 'start',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ActionConditionKind stop = ActionConditionKind(
    fhirCode: 'stop',
  );

  /// For instances where an Element is present but not value

  static final ActionConditionKind elementOnly = ActionConditionKind();
