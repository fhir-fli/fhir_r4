...
@override
  String toString() {
      switch(this) {
        ...
        case offline_digital_storage: return 'offline-digital-storage';
        case internet_without_issue: return 'internet-without-issue';
        case print_without_issue: return 'print-without-issue';
        case offline_digital_storage_without_issue: return 'offline-digital-storage-without-issue';
      }
      }
String toJson() => toString();
  CitedMedium fromString(String str) {
    switch(str) {
      case 'internet': return CitedMedium.internet;
      case 'print': return CitedMedium.print;
      case 'offline-digital-storage': return CitedMedium.offline_digital_storage;
      case 'internet-without-issue': return CitedMedium.internet_without_issue;
      case 'print-without-issue': return CitedMedium.print_without_issue;
      case 'offline-digital-storage-without-issue': return CitedMedium.offline_digital_storage_without_issue;
