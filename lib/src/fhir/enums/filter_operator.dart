...
@override
  String toString() {
      switch(this) {
        ...
        case descendent_of: return 'descendent-of';
        case is_not_a: return 'is-not-a';
...
String toJson() => toString();
  FilterOperator fromString(String str) {
    switch(str) {
      case '=': return FilterOperator.equals;
      case 'is-a': return FilterOperator.is_a;
      case 'descendent-of': return FilterOperator.descendent_of;
      case 'is-not-a': return FilterOperator.is_not_a;
      case 'regex': return FilterOperator.regex;
      case 'in': return FilterOperator.in_;
      case 'not-in': return FilterOperator.not_in;
      case 'generalizes': return FilterOperator.generalizes;
      case 'exists': return FilterOperator.exists;
