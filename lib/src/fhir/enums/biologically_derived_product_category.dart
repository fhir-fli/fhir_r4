...
String toJson() => toString();
  BiologicallyDerivedProductCategory fromString(String str) {
    switch(str) {
      case 'organ': return BiologicallyDerivedProductCategory.organ;
      case 'tissue': return BiologicallyDerivedProductCategory.tissue;
      case 'fluid': return BiologicallyDerivedProductCategory.fluid;
      case 'cells': return BiologicallyDerivedProductCategory.cells;
      case 'biologicalAgent': return BiologicallyDerivedProductCategory.biologicalAgent;
