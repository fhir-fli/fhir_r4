...
@override
  String toString() {
      switch(this) {
        case InUtero: return 'InUtero';
        case PretermNewborn: return 'PretermNewborn';
        case TermNewborn: return 'TermNewborn';
        case Infants: return 'Infants';
        case Children: return 'Children';
        case Adolescents: return 'Adolescents';
        case Adults: return 'Adults';
        case Elderly: return 'Elderly';
        case Neonate: return 'Neonate';
        case PediatricPopulation: return 'PediatricPopulation';
        case All: return 'All';
        case Prepubertal: return 'Prepubertal';
        case AdultsAndElderly: return 'AdultsAndElderly';
        case PubertalAndPostpubertal: return 'PubertalAndPostpubertal';
      }
      }
String toJson() => toString();
  PediatricUse fromString(String str) {
    switch(str) {
      case 'InUtero': return PediatricUse.InUtero;
      case 'PretermNewborn': return PediatricUse.PretermNewborn;
      case 'TermNewborn': return PediatricUse.TermNewborn;
      case 'Infants': return PediatricUse.Infants;
      case 'Children': return PediatricUse.Children;
      case 'Adolescents': return PediatricUse.Adolescents;
      case 'Adults': return PediatricUse.Adults;
      case 'Elderly': return PediatricUse.Elderly;
      case 'Neonate': return PediatricUse.Neonate;
      case 'PediatricPopulation': return PediatricUse.PediatricPopulation;
      case 'All': return PediatricUse.All;
      case 'Prepubertal': return PediatricUse.Prepubertal;
      case 'AdultsAndElderly': return PediatricUse.AdultsAndElderly;
      case 'PubertalAndPostpubertal': return PediatricUse.PubertalAndPostpubertal;
