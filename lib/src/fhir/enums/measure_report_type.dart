...
@override
  String toString() {
      switch(this) {
        ...
        case subject_list: return 'subject-list';
...
String toJson() => toString();
  MeasureReportType fromString(String str) {
    switch(str) {
      case 'individual': return MeasureReportType.individual;
      case 'subject-list': return MeasureReportType.subject_list;
      case 'summary': return MeasureReportType.summary;
      case 'data-collection': return MeasureReportType.data_collection;
