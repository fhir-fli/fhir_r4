...
@override
  String toString() {
      switch(this) {
        case supplemental_data: return 'supplemental-data';
        case risk_adjustment_factor: return 'risk-adjustment-factor';
      }
      }
String toJson() => toString();
  MeasureDataUsage fromString(String str) {
    switch(str) {
      case 'supplemental-data': return MeasureDataUsage.supplemental_data;
      case 'risk-adjustment-factor': return MeasureDataUsage.risk_adjustment_factor;
