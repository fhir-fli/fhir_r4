...
String toJson() => toString();
  RequestStatus fromString(String str) {
    switch(str) {
      ...
      case 'active': return RequestStatus.active;
      case 'on-hold': return RequestStatus.on_hold;
      case 'revoked': return RequestStatus.revoked;
      case 'completed': return RequestStatus.completed;
      case 'entered-in-error': return RequestStatus.entered_in_error;
