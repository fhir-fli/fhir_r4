...
String toJson() => toString();
  AllergyIntoleranceType fromString(String str) {
    switch(str) {
      case 'allergy': return AllergyIntoleranceType.allergy;
      case 'intolerance': return AllergyIntoleranceType.intolerance;
    default: throw ArgumentError('Unknown enum value: $str');
    }
      }
 AllergyIntoleranceType fromJson(dynamic jsonValue) {
