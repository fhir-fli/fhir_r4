...
class AllergyIntoleranceType {
  ...
  AllergyIntoleranceType({this.fhirCode, this.element})
      : assert(
  ...
  static final AllergyIntoleranceType allergy = AllergyIntoleranceType(
    fhirCode: 'allergy',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final AllergyIntoleranceType intolerance = AllergyIntoleranceType(
    fhirCode: 'intolerance',
  );

  /// For instances where an Element is present but not value

  static final AllergyIntoleranceType elementOnly = AllergyIntoleranceType();
