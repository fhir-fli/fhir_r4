...
String toJson() => toString();
  AllergyIntoleranceCategory fromString(String str) {
    switch(str) {
      case 'food': return AllergyIntoleranceCategory.food;
      case 'medication': return AllergyIntoleranceCategory.medication;
      case 'environment': return AllergyIntoleranceCategory.environment;
      case 'biologic': return AllergyIntoleranceCategory.biologic;
