...
@override
  String toString() {
      switch(this) {
        case not_calibrated: return 'not-calibrated';
        case calibration_required: return 'calibration-required';
...
String toJson() => toString();
  DeviceMetricCalibrationState fromString(String str) {
    switch(str) {
      case 'not-calibrated': return DeviceMetricCalibrationState.not_calibrated;
      case 'calibration-required': return DeviceMetricCalibrationState.calibration_required;
      case 'calibrated': return DeviceMetricCalibrationState.calibrated;
      case 'unspecified': return DeviceMetricCalibrationState.unspecified;
