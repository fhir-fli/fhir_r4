...
class OperationParameterUse {
  ...
  OperationParameterUse({this.fhirCode, this.element})
      : assert(
  ...
  static final OperationParameterUse in_ = OperationParameterUse(
    fhirCode: 'in',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final OperationParameterUse out = OperationParameterUse(
    fhirCode: 'out',
  );

  /// For instances where an Element is present but not value

  static final OperationParameterUse elementOnly = OperationParameterUse();
