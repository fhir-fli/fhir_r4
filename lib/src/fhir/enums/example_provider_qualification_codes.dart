...
enum ExampleProviderQualificationCodes {
  ...
  /// Converts a list of JSON values to a list of [ExampleProviderQualificationCodes] instances.
  static ExampleProviderQualificationCodes fromJson(
    ...
    if (value == null && element != null) {
      return ExampleProviderQualificationCodes.elementOnly.withElement(
        element,
      );
    }
