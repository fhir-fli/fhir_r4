...
enum ConsentContentClass {
  ...
  /// Definition:
  application_hl7_cda_xml('application/hl7-cda+xml'),
  ...
  const ConsentContentClass(this.fhirCode, [this.element]);
  ...
  /// Converts a list of JSON values to a list of [ConsentContentClass] instances.
  static ConsentContentClass fromJson(
  ...
  ConsentContentClass withElement(Element? newElement) {
    return ConsentContentClass.fromJson({
      'value': fhirCode,
