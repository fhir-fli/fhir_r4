...
class SourceMaterialType {
  ...
  SourceMaterialType({this.fhirCode, this.element})
      : assert(
  ...
  static final SourceMaterialType Animal = SourceMaterialType(
    fhirCode: 'Animal',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final SourceMaterialType Plant = SourceMaterialType(
    fhirCode: 'Plant',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final SourceMaterialType Mineral = SourceMaterialType(
    fhirCode: 'Mineral',
  );

  /// For instances where an Element is present but not value

  static final SourceMaterialType elementOnly = SourceMaterialType();
