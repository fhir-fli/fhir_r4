...
String toJson() => toString();
  TestReportStatus fromString(String str) {
    switch(str) {
      case 'completed': return TestReportStatus.completed;
      case 'in-progress': return TestReportStatus.in_progress;
      case 'waiting': return TestReportStatus.waiting;
      case 'stopped': return TestReportStatus.stopped;
      case 'entered-in-error': return TestReportStatus.entered_in_error;
    default: throw ArgumentError('Unknown enum value: $str');
    }
      }
 TestReportStatus fromJson(dynamic jsonValue) {
