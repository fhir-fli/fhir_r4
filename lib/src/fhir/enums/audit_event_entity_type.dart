...
enum AuditEventEntityType {
  ...
  const AuditEventEntityType(this.fhirCode, [this.element]);
  ...
  /// Converts a list of JSON values to a list of [AuditEventEntityType] instances.
  static AuditEventEntityType fromJson(
    ...
    if (value == null && element != null) {
      return AuditEventEntityType.elementOnly.withElement(
        element,
      );
    }
  ...
  AuditEventEntityType withElement(Element? newElement) {
    return AuditEventEntityType.fromJson({
      'value': fhirCode,
