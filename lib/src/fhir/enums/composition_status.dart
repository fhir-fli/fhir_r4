...
String toJson() => toString();
  CompositionStatus fromString(String str) {
    switch(str) {
      case 'preliminary': return CompositionStatus.preliminary;
      case 'final': return CompositionStatus.final_;
      case 'amended': return CompositionStatus.amended;
      case 'entered-in-error': return CompositionStatus.entered_in_error;
