...
class OpticalActivity {
  ...
  OpticalActivity({this.fhirCode, this.element})
      : assert(
  ...
  static final OpticalActivity plus = OpticalActivity(
    fhirCode: '+',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final OpticalActivity minus = OpticalActivity(
    fhirCode: '-',
  );

  /// For instances where an Element is present but not value

  static final OpticalActivity elementOnly = OpticalActivity();
