...
@override
  String toString() {
      switch(this) {
        ...
        case must_unless_documented: return 'must-unless-documented';
      }
      }
String toJson() => toString();
  ActionRequiredBehavior fromString(String str) {
    switch(str) {
      case 'must': return ActionRequiredBehavior.must;
      case 'could': return ActionRequiredBehavior.could;
      case 'must-unless-documented': return ActionRequiredBehavior.must_unless_documented;
