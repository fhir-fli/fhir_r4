...
String toJson() => toString();
  AllergyIntoleranceCriticality fromString(String str) {
    switch(str) {
      case 'low': return AllergyIntoleranceCriticality.low;
      case 'high': return AllergyIntoleranceCriticality.high;
      case 'unable-to-assess': return AllergyIntoleranceCriticality.unable_to_assess;
