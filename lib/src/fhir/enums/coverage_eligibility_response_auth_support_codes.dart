...
String toJson() => toString();
  CoverageEligibilityResponseAuthSupportCodes fromString(String str) {
    switch(str) {
      case 'laborder': return CoverageEligibilityResponseAuthSupportCodes.laborder;
      case 'labreport': return CoverageEligibilityResponseAuthSupportCodes.labreport;
      case 'diagnosticimageorder': return CoverageEligibilityResponseAuthSupportCodes.diagnosticimageorder;
      case 'diagnosticimagereport': return CoverageEligibilityResponseAuthSupportCodes.diagnosticimagereport;
      case 'professionalreport': return CoverageEligibilityResponseAuthSupportCodes.professionalreport;
      case 'accidentreport': return CoverageEligibilityResponseAuthSupportCodes.accidentreport;
      case 'model': return CoverageEligibilityResponseAuthSupportCodes.model;
      case 'picture': return CoverageEligibilityResponseAuthSupportCodes.picture;
