...
class ConditionCategoryCodes {
  ...
  ConditionCategoryCodes({this.fhirCode, this.element})
      : assert(
  ...
  static final ConditionCategoryCodes encounter_diagnosis =
      ConditionCategoryCodes(
    fhirCode: 'encounter-diagnosis',
  );

  /// For instances where an Element is present but not value

  static final ConditionCategoryCodes elementOnly = ConditionCategoryCodes();
  ...
  @override
  String toString() => 'ConditionCategoryCodes.$fhirCode';
}
