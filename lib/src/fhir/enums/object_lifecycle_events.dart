...
enum ObjectLifecycleEvents {
  ...
  /// Returns a [String] from a [ObjectLifecycleEvents] enum.
  String toJson() => toString();

  /// Returns a [ObjectLifecycleEvents] from a [String] enum.
  ...
  /// Returns a [ObjectLifecycleEvents] from a json [String] (although it will accept any dynamic and throw an error if it is not a String due to requirements for serializing/deserializing
