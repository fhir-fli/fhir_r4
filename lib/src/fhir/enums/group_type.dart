...
String toJson() => toString();
  GroupType fromString(String str) {
    switch(str) {
      case 'person': return GroupType.person;
      case 'animal': return GroupType.animal;
      case 'practitioner': return GroupType.practitioner;
      case 'device': return GroupType.device;
      case 'medication': return GroupType.medication;
      case 'substance': return GroupType.substance;
