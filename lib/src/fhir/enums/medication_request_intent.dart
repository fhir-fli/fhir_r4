...
String toJson() => toString();
  MedicationRequestIntent fromString(String str) {
    switch(str) {
      case 'proposal': return MedicationRequestIntent.proposal;
      case 'plan': return MedicationRequestIntent.plan;
      case 'order': return MedicationRequestIntent.order;
      case 'original-order': return MedicationRequestIntent.original_order;
      case 'reflex-order': return MedicationRequestIntent.reflex_order;
      case 'filler-order': return MedicationRequestIntent.filler_order;
      case 'instance-order': return MedicationRequestIntent.instance_order;
      case 'option': return MedicationRequestIntent.option;
