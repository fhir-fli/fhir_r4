...
@override
  String toString() {
      switch(this) {
        case oneTailedTest: return 'oneTailedTest';
        case twoTailedTest: return 'twoTailedTest';
        case zTest: return 'zTest';
        case oneSampleTTest: return 'oneSampleTTest';
        case twoSampleTTest: return 'twoSampleTTest';
        case pairedTTest: return 'pairedTTest';
        case chiSquareTest: return 'chiSquareTest';
        case chiSquareTestTrend: return 'chiSquareTestTrend';
        case pearsonCorrelation: return 'pearsonCorrelation';
        case anova: return 'anova';
        case anovaOneWay: return 'anovaOneWay';
        case anovaTwoWay: return 'anovaTwoWay';
        case anovaTwoWayReplication: return 'anovaTwoWayReplication';
        case manova: return 'manova';
        case anovaThreeWay: return 'anovaThreeWay';
        case signTest: return 'signTest';
        case wilcoxonSignedRankTest: return 'wilcoxonSignedRankTest';
        case wilcoxonRankSumTest: return 'wilcoxonRankSumTest';
        case mannWhitneyUTest: return 'mannWhitneyUTest';
        case fishersExactTest: return 'fishersExactTest';
        case mcnemarsTest: return 'mcnemarsTest';
        case kruskalWallisTest: return 'kruskalWallisTest';
        case spearmanCorrelation: return 'spearmanCorrelation';
        case kendallCorrelation: return 'kendallCorrelation';
        case friedmanTest: return 'friedmanTest';
        case goodmanKruskasGamma: return 'goodmanKruskasGamma';
        case glm: return 'glm';
        case glmProbit: return 'glmProbit';
        case glmLogit: return 'glmLogit';
        case glmIdentity: return 'glmIdentity';
        case glmLog: return 'glmLog';
        case glmGeneralizedLogit: return 'glmGeneralizedLogit';
        case glmm: return 'glmm';
        case glmmProbit: return 'glmmProbit';
        case glmmLogit: return 'glmmLogit';
        case glmmIdentity: return 'glmmIdentity';
        case glmmLog: return 'glmmLog';
        case glmmGeneralizedLogit: return 'glmmGeneralizedLogit';
        ...
        case coxProportionalHazards: return 'coxProportionalHazards';
        case binomialDistributionRegression: return 'binomialDistributionRegression';
        case multinomialDistributionRegression: return 'multinomialDistributionRegression';
        case poissonRegression: return 'poissonRegression';
        case negativeBinomialRegression: return 'negativeBinomialRegression';
        case zeroCellConstant: return 'zeroCellConstant';
        case zeroCellContinuityCorrection: return 'zeroCellContinuityCorrection';
        case adjusted: return 'adjusted';
        case interactionTerm: return 'interactionTerm';
        case manteHaenszelMethod: return 'manteHaenszelMethod';
        case metaAnalysis: return 'metaAnalysis';
        case inverseVariance: return 'inverseVariance';
        case petoMethod: return 'petoMethod';
        case hartungKnapp: return 'hartungKnapp';
        case modifiedHartungKnapp: return 'modifiedHartungKnapp';
        case effectsFixed: return 'effectsFixed';
        case effectsRandom: return 'effectsRandom';
        case chiSquareTestHomogeneity: return 'chiSquareTestHomogeneity';
        case dersimonianLairdMethod: return 'dersimonianLairdMethod';
        case pauleMandelMethod: return 'pauleMandelMethod';
        case restrictedLikelihood: return 'restrictedLikelihood';
        case maximumLikelihood: return 'maximumLikelihood';
        case empiricalBayes: return 'empiricalBayes';
        case hunterSchmidt: return 'hunterSchmidt';
        case sidikJonkman: return 'sidikJonkman';
        case hedgesMethod: return 'hedgesMethod';
        case tauDersimonianLaird: return 'tauDersimonianLaird';
        case tauPauleMandel: return 'tauPauleMandel';
        case tauRestrictedMaximumLikelihood: return 'tauRestrictedMaximumLikelihood';
        case tauMaximumLikelihood: return 'tauMaximumLikelihood';
        case tauEmpiricalBayes: return 'tauEmpiricalBayes';
        case tauHunterSchmidt: return 'tauHunterSchmidt';
        case tauSidikJonkman: return 'tauSidikJonkman';
        case tauHedges: return 'tauHedges';
        case poolMantelHaenzsel: return 'poolMantelHaenzsel';
        case poolInverseVariance: return 'poolInverseVariance';
        case poolPeto: return 'poolPeto';
        case poolGeneralizedLinearMixedModel: return 'poolGeneralizedLinearMixedModel';
      }
      }
String toJson() => toString();
  StatisticModelCode fromString(String str) {
    switch(str) {
      case 'oneTailedTest': return StatisticModelCode.oneTailedTest;
      case 'twoTailedTest': return StatisticModelCode.twoTailedTest;
      case 'zTest': return StatisticModelCode.zTest;
      case 'oneSampleTTest': return StatisticModelCode.oneSampleTTest;
      case 'twoSampleTTest': return StatisticModelCode.twoSampleTTest;
      case 'pairedTTest': return StatisticModelCode.pairedTTest;
      case 'chiSquareTest': return StatisticModelCode.chiSquareTest;
      case 'chiSquareTestTrend': return StatisticModelCode.chiSquareTestTrend;
      case 'pearsonCorrelation': return StatisticModelCode.pearsonCorrelation;
      case 'anova': return StatisticModelCode.anova;
      case 'anovaOneWay': return StatisticModelCode.anovaOneWay;
      case 'anovaTwoWay': return StatisticModelCode.anovaTwoWay;
      case 'anovaTwoWayReplication': return StatisticModelCode.anovaTwoWayReplication;
      case 'manova': return StatisticModelCode.manova;
      case 'anovaThreeWay': return StatisticModelCode.anovaThreeWay;
      case 'signTest': return StatisticModelCode.signTest;
      case 'wilcoxonSignedRankTest': return StatisticModelCode.wilcoxonSignedRankTest;
      case 'wilcoxonRankSumTest': return StatisticModelCode.wilcoxonRankSumTest;
      case 'mannWhitneyUTest': return StatisticModelCode.mannWhitneyUTest;
      case 'fishersExactTest': return StatisticModelCode.fishersExactTest;
      case 'mcnemarsTest': return StatisticModelCode.mcnemarsTest;
      case 'kruskalWallisTest': return StatisticModelCode.kruskalWallisTest;
      case 'spearmanCorrelation': return StatisticModelCode.spearmanCorrelation;
      case 'kendallCorrelation': return StatisticModelCode.kendallCorrelation;
      case 'friedmanTest': return StatisticModelCode.friedmanTest;
      case 'goodmanKruskasGamma': return StatisticModelCode.goodmanKruskasGamma;
      case 'glm': return StatisticModelCode.glm;
      case 'glmProbit': return StatisticModelCode.glmProbit;
      case 'glmLogit': return StatisticModelCode.glmLogit;
      case 'glmIdentity': return StatisticModelCode.glmIdentity;
      case 'glmLog': return StatisticModelCode.glmLog;
      case 'glmGeneralizedLogit': return StatisticModelCode.glmGeneralizedLogit;
      case 'glmm': return StatisticModelCode.glmm;
      case 'glmmProbit': return StatisticModelCode.glmmProbit;
      case 'glmmLogit': return StatisticModelCode.glmmLogit;
      case 'glmmIdentity': return StatisticModelCode.glmmIdentity;
      case 'glmmLog': return StatisticModelCode.glmmLog;
      case 'glmmGeneralizedLogit': return StatisticModelCode.glmmGeneralizedLogit;
      case 'linearRegression': return StatisticModelCode.linearRegression;
      case 'logisticRegression': return StatisticModelCode.logisticRegression;
      case 'polynomialRegression': return StatisticModelCode.polynomialRegression;
      case 'coxProportionalHazards': return StatisticModelCode.coxProportionalHazards;
      case 'binomialDistributionRegression': return StatisticModelCode.binomialDistributionRegression;
      case 'multinomialDistributionRegression': return StatisticModelCode.multinomialDistributionRegression;
      case 'poissonRegression': return StatisticModelCode.poissonRegression;
      case 'negativeBinomialRegression': return StatisticModelCode.negativeBinomialRegression;
      case 'zeroCellConstant': return StatisticModelCode.zeroCellConstant;
      case 'zeroCellContinuityCorrection': return StatisticModelCode.zeroCellContinuityCorrection;
      case 'adjusted': return StatisticModelCode.adjusted;
      case 'interactionTerm': return StatisticModelCode.interactionTerm;
      case 'manteHaenszelMethod': return StatisticModelCode.manteHaenszelMethod;
      case 'metaAnalysis': return StatisticModelCode.metaAnalysis;
      case 'inverseVariance': return StatisticModelCode.inverseVariance;
      case 'petoMethod': return StatisticModelCode.petoMethod;
      case 'hartungKnapp': return StatisticModelCode.hartungKnapp;
      case 'modifiedHartungKnapp': return StatisticModelCode.modifiedHartungKnapp;
      case 'effectsFixed': return StatisticModelCode.effectsFixed;
      case 'effectsRandom': return StatisticModelCode.effectsRandom;
      case 'chiSquareTestHomogeneity': return StatisticModelCode.chiSquareTestHomogeneity;
      case 'dersimonianLairdMethod': return StatisticModelCode.dersimonianLairdMethod;
      case 'pauleMandelMethod': return StatisticModelCode.pauleMandelMethod;
      case 'restrictedLikelihood': return StatisticModelCode.restrictedLikelihood;
      case 'maximumLikelihood': return StatisticModelCode.maximumLikelihood;
      case 'empiricalBayes': return StatisticModelCode.empiricalBayes;
      case 'hunterSchmidt': return StatisticModelCode.hunterSchmidt;
      case 'sidikJonkman': return StatisticModelCode.sidikJonkman;
      case 'hedgesMethod': return StatisticModelCode.hedgesMethod;
      case 'tauDersimonianLaird': return StatisticModelCode.tauDersimonianLaird;
      case 'tauPauleMandel': return StatisticModelCode.tauPauleMandel;
      case 'tauRestrictedMaximumLikelihood': return StatisticModelCode.tauRestrictedMaximumLikelihood;
      case 'tauMaximumLikelihood': return StatisticModelCode.tauMaximumLikelihood;
      case 'tauEmpiricalBayes': return StatisticModelCode.tauEmpiricalBayes;
      case 'tauHunterSchmidt': return StatisticModelCode.tauHunterSchmidt;
      case 'tauSidikJonkman': return StatisticModelCode.tauSidikJonkman;
      case 'tauHedges': return StatisticModelCode.tauHedges;
      case 'poolMantelHaenzsel': return StatisticModelCode.poolMantelHaenzsel;
      case 'poolInverseVariance': return StatisticModelCode.poolInverseVariance;
      case 'poolPeto': return StatisticModelCode.poolPeto;
      case 'poolGeneralizedLinearMixedModel': return StatisticModelCode.poolGeneralizedLinearMixedModel;
