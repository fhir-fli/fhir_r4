...
enum AdverseEventCausalityAssessment {
  ...
  String toString() {
    switch (this) {
      case Certain:
        return 'Certain';
      case Probably_Likely:
        return 'Probably-Likely';
      case Possible:
        return 'Possible';
      case Unlikely:
        return 'Unlikely';
      case Conditional_Classified:
        return 'Conditional-Classified';
      case Unassessable_Unclassifiable:
        return 'Unassessable-Unclassifiable';
    }
  }

  /// Returns a [String] from a [AdverseEventCausalityAssessment] enum.
  String toJson() => toString();

  /// Returns a [AdverseEventCausalityAssessment] from a [String] enum.
  static AdverseEventCausalityAssessment fromString(String str) {
    switch (str) {
      case 'Certain':
        return AdverseEventCausalityAssessment.Certain;
      case 'Probably-Likely':
        return AdverseEventCausalityAssessment.Probably_Likely;
      case 'Possible':
        return AdverseEventCausalityAssessment.Possible;
      case 'Unlikely':
        return AdverseEventCausalityAssessment.Unlikely;
      case 'Conditional-Classified':
        return AdverseEventCausalityAssessment.Conditional_Classified;
      case 'Unassessable-Unclassifiable':
        return AdverseEventCausalityAssessment.Unassessable_Unclassifiable;
      default:
        throw ArgumentError('Unknown enum value: $str');
    }
  }

  /// Returns a [AdverseEventCausalityAssessment] from a json [String] (although it will accept any dynamic and throw an error if it is not a String due to requirements for serializing/deserializing
