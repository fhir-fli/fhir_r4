...
class FocusCharacteristicCode {
  ...
  FocusCharacteristicCode({this.fhirCode, this.element})
      : assert(
  ...
  static final FocusCharacteristicCode citation = FocusCharacteristicCode(
    fhirCode: 'citation',
  );
  ...
  static final FocusCharacteristicCode clinical_outcomes_observed =
    ...
    fhirCode: 'clinical-outcomes-observed',
  );

  /// population
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final FocusCharacteristicCode population = FocusCharacteristicCode(
    fhirCode: 'population',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final FocusCharacteristicCode exposure = FocusCharacteristicCode(
    fhirCode: 'exposure',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final FocusCharacteristicCode comparator = FocusCharacteristicCode(
    fhirCode: 'comparator',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final FocusCharacteristicCode outcome = FocusCharacteristicCode(
    fhirCode: 'outcome',
  );
  ...
  static final FocusCharacteristicCode medication_exposures =
      FocusCharacteristicCode(
    fhirCode: 'medication-exposures',
  );

  /// study_type
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final FocusCharacteristicCode study_type = FocusCharacteristicCode(
    fhirCode: 'study-type',
  );

  /// For instances where an Element is present but not value

  static final FocusCharacteristicCode elementOnly = FocusCharacteristicCode();
  ...
  FocusCharacteristicCode withElement(Element? newElement) {
    return FocusCharacteristicCode(
      fhirCode: fhirCode,
      element: newElement,
    );
  }
