...
String toJson() => toString();
  ObservationStatus fromString(String str) {
    switch(str) {
      case 'registered': return ObservationStatus.registered;
      case 'preliminary': return ObservationStatus.preliminary;
      case 'final': return ObservationStatus.final_;
      case 'amended': return ObservationStatus.amended;
      case 'cancelled': return ObservationStatus.cancelled;
      case 'entered-in-error': return ObservationStatus.entered_in_error;
