...
class TestReportParticipantType {
  ...
  TestReportParticipantType({this.fhirCode, this.element})
      : assert(
  ...
  static final TestReportParticipantType test_engine =
    ...
    fhirCode: 'test-engine',
  );

  /// client
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final TestReportParticipantType client = TestReportParticipantType(
    fhirCode: 'client',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final TestReportParticipantType server = TestReportParticipantType(
    fhirCode: 'server',
  );
