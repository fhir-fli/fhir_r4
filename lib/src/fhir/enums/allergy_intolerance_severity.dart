...
String toJson() => toString();
  AllergyIntoleranceSeverity fromString(String str) {
    switch(str) {
      case 'mild': return AllergyIntoleranceSeverity.mild;
      case 'moderate': return AllergyIntoleranceSeverity.moderate;
      case 'severe': return AllergyIntoleranceSeverity.severe;
