...
enum DocumentReferenceFormatCodeSet {
  ...
  /// Returns a [String] from a [DocumentReferenceFormatCodeSet] enum.
  String toJson() => toString();

  /// Returns a [DocumentReferenceFormatCodeSet] from a [String] enum.
  ...
  /// Returns a [DocumentReferenceFormatCodeSet] from a json [String] (although it will accept any dynamic and throw an error if it is not a String due to requirements for serializing/deserializing
