...
String toJson() => toString();
  MedicationUsageCategoryCodes fromString(String str) {
    switch(str) {
      case 'inpatient': return MedicationUsageCategoryCodes.inpatient;
      case 'outpatient': return MedicationUsageCategoryCodes.outpatient;
      case 'community': return MedicationUsageCategoryCodes.community;
      case 'patientspecified': return MedicationUsageCategoryCodes.patientspecified;
