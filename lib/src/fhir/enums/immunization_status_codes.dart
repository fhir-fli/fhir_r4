...
class ImmunizationStatusCodes extends PrimitiveType<String> {
  ...
  @override
  ImmunizationStatusCodes clone() =>
      ImmunizationStatusCodes._(value, element?.clone() as Element?);

  /// Sets a property on the associated [Element], returning a new instance.
  @override
  ImmunizationStatusCodes setElement(String name, dynamic elementValue) {
