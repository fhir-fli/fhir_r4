...
class AdjudicationErrorCodes {
  ...
  AdjudicationErrorCodes({this.fhirCode, this.element})
      : assert(
  ...
  static final AdjudicationErrorCodes a001 = AdjudicationErrorCodes(
    fhirCode: 'a001',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final AdjudicationErrorCodes a002 = AdjudicationErrorCodes(
    fhirCode: 'a002',
  );

  /// For instances where an Element is present but not value

  static final AdjudicationErrorCodes elementOnly = AdjudicationErrorCodes();
