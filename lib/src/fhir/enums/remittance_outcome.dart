...
enum RemittanceOutcome {
  ...
  /// Converts a list of JSON values to a list of [RemittanceOutcome] instances.
  static RemittanceOutcome fromJson(
    ...
    if (value == null && element != null) {
      return RemittanceOutcome.elementOnly.withElement(
        element,
      );
    }
