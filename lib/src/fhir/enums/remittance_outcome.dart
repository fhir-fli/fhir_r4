...
String toJson() => toString();
  RemittanceOutcome fromString(String str) {
    switch(str) {
      case 'queued': return RemittanceOutcome.queued;
      case 'complete': return RemittanceOutcome.complete;
      case 'error': return RemittanceOutcome.error;
      case 'partial': return RemittanceOutcome.partial;
