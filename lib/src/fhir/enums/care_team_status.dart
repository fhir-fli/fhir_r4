...
String toJson() => toString();
  CareTeamStatus fromString(String str) {
    switch(str) {
      case 'proposed': return CareTeamStatus.proposed;
      case 'active': return CareTeamStatus.active;
      case 'suspended': return CareTeamStatus.suspended;
      case 'inactive': return CareTeamStatus.inactive;
      case 'entered-in-error': return CareTeamStatus.entered_in_error;
