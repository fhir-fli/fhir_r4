...
@override
  String toString() {
      switch(this) {
        ...
        case other_map: return 'other-map';
      }
      }
String toJson() => toString();
  ConceptMapGroupUnmappedMode fromString(String str) {
    switch(str) {
      case 'provided': return ConceptMapGroupUnmappedMode.provided;
      case 'fixed': return ConceptMapGroupUnmappedMode.fixed;
      case 'other-map': return ConceptMapGroupUnmappedMode.other_map;
