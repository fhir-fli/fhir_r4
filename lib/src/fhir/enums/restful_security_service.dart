...
@override
  String toString() {
      switch(this) {
        ...
        case SMART_on_FHIR: return 'SMART-on-FHIR';
...
String toJson() => toString();
  RestfulSecurityService fromString(String str) {
    switch(str) {
      case 'OAuth': return RestfulSecurityService.OAuth;
      case 'SMART-on-FHIR': return RestfulSecurityService.SMART_on_FHIR;
      case 'NTLM': return RestfulSecurityService.NTLM;
      case 'Basic': return RestfulSecurityService.Basic;
      case 'Kerberos': return RestfulSecurityService.Kerberos;
      case 'Certificates': return RestfulSecurityService.Certificates;
