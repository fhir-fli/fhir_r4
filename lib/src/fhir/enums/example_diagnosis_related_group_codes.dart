...
String toJson() => toString();
  ExampleDiagnosisRelatedGroupCodes fromString(String str) {
    switch(str) {
      case '100': return ExampleDiagnosisRelatedGroupCodes.value100;
      case '101': return ExampleDiagnosisRelatedGroupCodes.value101;
      case '300': return ExampleDiagnosisRelatedGroupCodes.value300;
      case '400': return ExampleDiagnosisRelatedGroupCodes.value400;
