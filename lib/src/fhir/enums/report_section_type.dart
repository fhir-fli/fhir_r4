...
@override
  String toString() {
      switch(this) {
        ...
        case Intervention_group_alone_Evidence: return 'Intervention-group-alone-Evidence';
        case Intervention_vs_Control_Evidence: return 'Intervention-vs-Control-Evidence';
        case Control_group_alone_Evidence: return 'Control-group-alone-Evidence';
        case EvidenceVariable: return 'EvidenceVariable';
        case EvidenceVariable_observed: return 'EvidenceVariable-observed';
        case EvidenceVariable_intended: return 'EvidenceVariable-intended';
        case EvidenceVariable_population: return 'EvidenceVariable-population';
        case EvidenceVariable_exposure: return 'EvidenceVariable-exposure';
        case EvidenceVariable_outcome: return 'EvidenceVariable-outcome';
        case Efficacy_outcomes: return 'Efficacy-outcomes';
        case Harms_outcomes: return 'Harms-outcomes';
        case SampleSize: return 'SampleSize';
        case References: return 'References';
        case Assertion: return 'Assertion';
        case Reasons: return 'Reasons';
        case Certainty_of_Evidence: return 'Certainty-of-Evidence';
        case Evidence_Classifier: return 'Evidence-Classifier';
        case Warnings: return 'Warnings';
        case Text_Summary: return 'Text-Summary';
        case SummaryOfBodyOfEvidenceFindings: return 'SummaryOfBodyOfEvidenceFindings';
        case SummaryOfIndividualStudyFindings: return 'SummaryOfIndividualStudyFindings';
        case Header: return 'Header';
        case Tables: return 'Tables';
        case Table: return 'Table';
        case Row_Headers: return 'Row-Headers';
        case Column_Header: return 'Column-Header';
        case Column_Headers: return 'Column-Headers';
      }
      }
String toJson() => toString();
  ReportSectionType fromString(String str) {
    switch(str) {
      case 'Evidence': return ReportSectionType.Evidence;
      case 'Intervention-group-alone-Evidence': return ReportSectionType.Intervention_group_alone_Evidence;
      case 'Intervention-vs-Control-Evidence': return ReportSectionType.Intervention_vs_Control_Evidence;
      case 'Control-group-alone-Evidence': return ReportSectionType.Control_group_alone_Evidence;
      case 'EvidenceVariable': return ReportSectionType.EvidenceVariable;
      case 'EvidenceVariable-observed': return ReportSectionType.EvidenceVariable_observed;
      case 'EvidenceVariable-intended': return ReportSectionType.EvidenceVariable_intended;
      case 'EvidenceVariable-population': return ReportSectionType.EvidenceVariable_population;
      case 'EvidenceVariable-exposure': return ReportSectionType.EvidenceVariable_exposure;
      case 'EvidenceVariable-outcome': return ReportSectionType.EvidenceVariable_outcome;
      case 'Efficacy-outcomes': return ReportSectionType.Efficacy_outcomes;
      case 'Harms-outcomes': return ReportSectionType.Harms_outcomes;
      case 'SampleSize': return ReportSectionType.SampleSize;
      case 'References': return ReportSectionType.References;
      case 'Assertion': return ReportSectionType.Assertion;
      case 'Reasons': return ReportSectionType.Reasons;
      case 'Certainty-of-Evidence': return ReportSectionType.Certainty_of_Evidence;
      case 'Evidence-Classifier': return ReportSectionType.Evidence_Classifier;
      case 'Warnings': return ReportSectionType.Warnings;
      case 'Text-Summary': return ReportSectionType.Text_Summary;
      case 'SummaryOfBodyOfEvidenceFindings': return ReportSectionType.SummaryOfBodyOfEvidenceFindings;
      case 'SummaryOfIndividualStudyFindings': return ReportSectionType.SummaryOfIndividualStudyFindings;
      case 'Header': return ReportSectionType.Header;
      case 'Tables': return ReportSectionType.Tables;
      case 'Table': return ReportSectionType.Table;
      case 'Row-Headers': return ReportSectionType.Row_Headers;
      case 'Column-Header': return ReportSectionType.Column_Header;
      case 'Column-Headers': return ReportSectionType.Column_Headers;
