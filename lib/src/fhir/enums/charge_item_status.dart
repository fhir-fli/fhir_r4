...
@override
  String toString() {
      switch(this) {
        ...
        case not_billable: return 'not-billable';
...
String toJson() => toString();
  ChargeItemStatus fromString(String str) {
    switch(str) {
      case 'planned': return ChargeItemStatus.planned;
      case 'billable': return ChargeItemStatus.billable;
      case 'not-billable': return ChargeItemStatus.not_billable;
      case 'aborted': return ChargeItemStatus.aborted;
      case 'billed': return ChargeItemStatus.billed;
      case 'entered-in-error': return ChargeItemStatus.entered_in_error;
      case 'unknown': return ChargeItemStatus.unknown;
