...
String toJson() => toString();
  TaskCode fromString(String str) {
    switch(str) {
      case 'approve': return TaskCode.approve;
      case 'fulfill': return TaskCode.fulfill;
      case 'abort': return TaskCode.abort;
      case 'replace': return TaskCode.replace;
      case 'change': return TaskCode.change;
      case 'suspend': return TaskCode.suspend;
      case 'resume': return TaskCode.resume;
