...
enum ImmunizationEvaluationStatusCodes {
  ...
  /// Returns a [String] from a [ImmunizationEvaluationStatusCodes] enum.
  String toJson() => toString();

  /// Returns a [ImmunizationEvaluationStatusCodes] from a [String] enum.
  static ImmunizationEvaluationStatusCodes fromString(String str) {
    switch (str) {
      case 'in-progress':
  ...
  /// Returns a [ImmunizationEvaluationStatusCodes] from a json [String] (although it will accept any dynamic and throw an error if it is not a String due to requirements for serializing/deserializing
  static ImmunizationEvaluationStatusCodes fromJson(dynamic jsonValue) {
