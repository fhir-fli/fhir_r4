...
@override
  String toString() {
      switch(this) {
        ...
        case DriveAndMachines: return 'DriveAndMachines';
      }
      }
String toJson() => toString();
  ClinicalUseDefinitionCategory fromString(String str) {
    switch(str) {
      case 'Pregnancy': return ClinicalUseDefinitionCategory.Pregnancy;
      case 'Overdose': return ClinicalUseDefinitionCategory.Overdose;
      case 'DriveAndMachines': return ClinicalUseDefinitionCategory.DriveAndMachines;
