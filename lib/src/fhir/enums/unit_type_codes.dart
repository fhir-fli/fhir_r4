...
@Entity()
class UnitTypeCodes extends FhirCode {
  ...
  factory UnitTypeCodes.fromJson(Map<String, dynamic> json) {
    ...
    if (value == null && element != null) {
      return UnitTypeCodes.elementOnly(element);
    }
    if (values.contains(value)) {
      return UnitTypeCodes._(value, element);
    }
    throw ArgumentError(
      'UnitTypeCodes.fromJson: JSON value is not a valid value',
    );
  }
  ...
  UnitTypeCodes.individual([this.element])
      : dbValue = 'individual',
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  UnitTypeCodes.family([this.element])
      : dbValue = 'family',
        super('family', element);

  /// For instances where an Element is present but not value

  UnitTypeCodes.elementOnly(this.element)
      : dbValue = null,
        super(null, element);

  /// Private constructor for internal use (like enum)
  UnitTypeCodes._(super.input, [super.element])
      : dbValue = input,
  ...
  @override
  String toString() => 'UnitTypeCodes.$value';
}
