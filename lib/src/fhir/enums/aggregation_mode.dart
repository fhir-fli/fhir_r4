...
class AggregationMode {
  ...
  AggregationMode({this.fhirCode, this.element})
      : assert(
  ...
  static final AggregationMode contained = AggregationMode(
    fhirCode: 'contained',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final AggregationMode referenced = AggregationMode(
    fhirCode: 'referenced',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final AggregationMode bundled = AggregationMode(
    fhirCode: 'bundled',
  );

  /// For instances where an Element is present but not value

  static final AggregationMode elementOnly = AggregationMode();
