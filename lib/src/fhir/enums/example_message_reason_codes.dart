...
String toJson() => toString();
  ExampleMessageReasonCodes fromString(String str) {
    switch(str) {
      case 'admit': return ExampleMessageReasonCodes.admit;
      case 'discharge': return ExampleMessageReasonCodes.discharge;
      case 'absent': return ExampleMessageReasonCodes.absent;
      case 'return': return ExampleMessageReasonCodes.return_;
      case 'moved': return ExampleMessageReasonCodes.moved;
      case 'edit': return ExampleMessageReasonCodes.edit;
