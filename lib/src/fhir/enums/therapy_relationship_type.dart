...
@override
  String toString() {
      switch(this) {
        case contraindicated_only_with: return 'contraindicated-only-with';
        case contraindicated_except_with: return 'contraindicated-except-with';
        case indicated_only_with: return 'indicated-only-with';
        case indicated_except_with: return 'indicated-except-with';
        case indicated_only_before: return 'indicated-only-before';
        case replace_other_therapy: return 'replace-other-therapy';
        case replace_other_therapy_contraindicated: return 'replace-other-therapy-contraindicated';
        case replace_other_therapy_not_tolerated: return 'replace-other-therapy-not-tolerated';
        case replace_other_therapy_not_effective: return 'replace-other-therapy-not-effective';
      }
      }
String toJson() => toString();
  TherapyRelationshipType fromString(String str) {
    switch(str) {
      case 'contraindicated-only-with': return TherapyRelationshipType.contraindicated_only_with;
      case 'contraindicated-except-with': return TherapyRelationshipType.contraindicated_except_with;
      case 'indicated-only-with': return TherapyRelationshipType.indicated_only_with;
      case 'indicated-except-with': return TherapyRelationshipType.indicated_except_with;
      case 'indicated-only-before': return TherapyRelationshipType.indicated_only_before;
      case 'replace-other-therapy': return TherapyRelationshipType.replace_other_therapy;
      case 'replace-other-therapy-contraindicated': return TherapyRelationshipType.replace_other_therapy_contraindicated;
      case 'replace-other-therapy-not-tolerated': return TherapyRelationshipType.replace_other_therapy_not_tolerated;
      case 'replace-other-therapy-not-effective': return TherapyRelationshipType.replace_other_therapy_not_effective;
