...
String toJson() => toString();
  ContractResourcePublicationStatusCodes fromString(String str) {
    switch(str) {
      case 'amended': return ContractResourcePublicationStatusCodes.amended;
      case 'appended': return ContractResourcePublicationStatusCodes.appended;
      case 'cancelled': return ContractResourcePublicationStatusCodes.cancelled;
      case 'disputed': return ContractResourcePublicationStatusCodes.disputed;
      case 'entered-in-error': return ContractResourcePublicationStatusCodes.entered_in_error;
      case 'executable': return ContractResourcePublicationStatusCodes.executable;
      case 'executed': return ContractResourcePublicationStatusCodes.executed;
      case 'negotiable': return ContractResourcePublicationStatusCodes.negotiable;
      case 'offered': return ContractResourcePublicationStatusCodes.offered;
      case 'policy': return ContractResourcePublicationStatusCodes.policy;
      case 'rejected': return ContractResourcePublicationStatusCodes.rejected;
      case 'renewed': return ContractResourcePublicationStatusCodes.renewed;
      case 'revoked': return ContractResourcePublicationStatusCodes.revoked;
      case 'resolved': return ContractResourcePublicationStatusCodes.resolved;
      case 'terminated': return ContractResourcePublicationStatusCodes.terminated;
