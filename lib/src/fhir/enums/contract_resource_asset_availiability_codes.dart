...
enum ContractResourceAssetAvailiabilityCodes {
  ...
  /// Converts a list of JSON values to a list of [ContractResourceAssetAvailiabilityCodes] instances.
  static ContractResourceAssetAvailiabilityCodes fromJson(
    ...
    if (value == null && element != null) {
      return ContractResourceAssetAvailiabilityCodes.elementOnly.withElement(
        element,
      );
    }
