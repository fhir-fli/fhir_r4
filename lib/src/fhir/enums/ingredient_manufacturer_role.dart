...
class IngredientManufacturerRole {
  ...
  IngredientManufacturerRole({this.fhirCode, this.element})
      : assert(
  ...
  static final IngredientManufacturerRole allowed = IngredientManufacturerRole(
    fhirCode: 'allowed',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final IngredientManufacturerRole possible = IngredientManufacturerRole(
    fhirCode: 'possible',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final IngredientManufacturerRole actual = IngredientManufacturerRole(
    fhirCode: 'actual',
  );
