...
@Entity()
class ContractResourceAssetTypeCodes extends FhirCode {
  ...
  factory ContractResourceAssetTypeCodes.fromJson(Map<String, dynamic> json) {
    ...
    if (value == null && element != null) {
      return ContractResourceAssetTypeCodes.elementOnly(element);
    }
    if (values.contains(value)) {
      return ContractResourceAssetTypeCodes._(value, element);
    }
    throw ArgumentError(
      'ContractResourceAssetTypeCodes.fromJson: JSON value is not a valid value',
    );
  }
  ...
  ContractResourceAssetTypeCodes.participation([this.element])
      : dbValue = 'participation',
        super('participation', element);

  /// For instances where an Element is present but not value

  ContractResourceAssetTypeCodes.elementOnly(this.element)
      : dbValue = null,
        super(null, element);

  /// Private constructor for internal use (like enum)
  ContractResourceAssetTypeCodes._(super.input, [super.element])
      : dbValue = input,
  ...
  @override
  String toString() => 'ContractResourceAssetTypeCodes.$value';
}
