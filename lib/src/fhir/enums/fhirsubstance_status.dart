...
String toJson() => toString();
  FHIRSubstanceStatus fromString(String str) {
    switch(str) {
      case 'active': return FHIRSubstanceStatus.active;
      case 'inactive': return FHIRSubstanceStatus.inactive;
      case 'entered-in-error': return FHIRSubstanceStatus.entered_in_error;
