...
@override
  String toString() {
      switch(this) {
        ...
        case type_and_types: return 'type-and-types';
      }
      }
String toJson() => toString();
  StructureMapGroupTypeMode fromString(String str) {
    switch(str) {
      case 'none': return StructureMapGroupTypeMode.none;
      case 'types': return StructureMapGroupTypeMode.types;
      case 'type-and-types': return StructureMapGroupTypeMode.type_and_types;
