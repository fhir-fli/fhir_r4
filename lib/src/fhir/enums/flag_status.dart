...
class FlagStatus {
  ...
  FlagStatus({this.fhirCode, this.element})
      : assert(
  ...
  static final FlagStatus active = FlagStatus(
    fhirCode: 'active',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final FlagStatus inactive = FlagStatus(
    fhirCode: 'inactive',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final FlagStatus entered_in_error = FlagStatus(
    fhirCode: 'entered-in-error',
  );

  /// For instances where an Element is present but not value

  static final FlagStatus elementOnly = FlagStatus();
