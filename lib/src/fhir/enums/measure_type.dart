...
@override
  String toString() {
      switch(this) {
        ...
        case patient_reported_outcome: return 'patient-reported-outcome';
...
String toJson() => toString();
  MeasureType fromString(String str) {
    switch(str) {
      case 'process': return MeasureType.process;
      case 'outcome': return MeasureType.outcome;
      case 'structure': return MeasureType.structure;
      case 'patient-reported-outcome': return MeasureType.patient_reported_outcome;
      case 'composite': return MeasureType.composite;
