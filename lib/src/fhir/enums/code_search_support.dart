...
class CodeSearchSupport {
  ...
  CodeSearchSupport({this.fhirCode, this.element})
      : assert(
  ...
  static final CodeSearchSupport explicit = CodeSearchSupport(
    fhirCode: 'explicit',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final CodeSearchSupport all = CodeSearchSupport(
    fhirCode: 'all',
  );

  /// For instances where an Element is present but not value

  static final CodeSearchSupport elementOnly = CodeSearchSupport();
