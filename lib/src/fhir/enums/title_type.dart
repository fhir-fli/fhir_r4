...
@override
  String toString() {
      switch(this) {
        ...
        case short_title: return 'short-title';
        case acronym: return 'acronym';
        case earlier_title: return 'earlier-title';
        case language: return 'language';
        case autotranslated: return 'autotranslated';
        case human_use: return 'human-use';
        case machine_use: return 'machine-use';
...
String toJson() => toString();
  TitleType fromString(String str) {
    switch(str) {
      case 'primary': return TitleType.primary;
      case 'official': return TitleType.official;
      case 'scientific': return TitleType.scientific;
      case 'plain-language': return TitleType.plain_language;
      case 'subtitle': return TitleType.subtitle;
      case 'short-title': return TitleType.short_title;
      case 'acronym': return TitleType.acronym;
      case 'earlier-title': return TitleType.earlier_title;
      case 'language': return TitleType.language;
      case 'autotranslated': return TitleType.autotranslated;
      case 'human-use': return TitleType.human_use;
      case 'machine-use': return TitleType.machine_use;
      case 'duplicate-uid': return TitleType.duplicate_uid;
