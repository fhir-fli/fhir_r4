...
enum MeasureReportStatus {
  ...
  /// Converts a list of JSON values to a list of [MeasureReportStatus] instances.
  static MeasureReportStatus fromJson(
    ...
    if (value == null && element != null) {
      return MeasureReportStatus.elementOnly.withElement(
        element,
      );
    }
