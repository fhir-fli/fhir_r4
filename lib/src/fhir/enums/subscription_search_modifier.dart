...
@override
  String toString() {
      switch(this) {
        ...
        case of_type: return 'of-type';
      }
      }
String toJson() => toString();
  SubscriptionSearchModifier fromString(String str) {
    switch(str) {
      case '=': return SubscriptionSearchModifier.equals;
      case 'eq': return SubscriptionSearchModifier.eq;
      case 'ne': return SubscriptionSearchModifier.ne;
      case 'gt': return SubscriptionSearchModifier.gt;
      case 'lt': return SubscriptionSearchModifier.lt;
      case 'ge': return SubscriptionSearchModifier.ge;
      case 'le': return SubscriptionSearchModifier.le;
      case 'sa': return SubscriptionSearchModifier.sa;
      case 'eb': return SubscriptionSearchModifier.eb;
      case 'ap': return SubscriptionSearchModifier.ap;
      case 'above': return SubscriptionSearchModifier.above;
      case 'below': return SubscriptionSearchModifier.below;
      case 'in': return SubscriptionSearchModifier.in_;
      case 'not-in': return SubscriptionSearchModifier.not_in;
      case 'of-type': return SubscriptionSearchModifier.of_type;
