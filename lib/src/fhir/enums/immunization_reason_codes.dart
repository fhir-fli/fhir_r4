...
enum ImmunizationReasonCodes {
  ...
  /// Converts a list of JSON values to a list of [ImmunizationReasonCodes] instances.
  static ImmunizationReasonCodes fromJson(
    ...
    if (value == null && element != null) {
      return ImmunizationReasonCodes.elementOnly.withElement(
        element,
      );
    }
