...
class ExampleScenarioActorType {
  ...
  ExampleScenarioActorType({this.fhirCode, this.element})
      : assert(
  ...
  static final ExampleScenarioActorType person = ExampleScenarioActorType(
    fhirCode: 'person',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ExampleScenarioActorType entity = ExampleScenarioActorType(
    fhirCode: 'entity',
  );
