...
class ImmunizationEvaluationTargetDiseaseCodes {
  ...
  ImmunizationEvaluationTargetDiseaseCodes({this.fhirCode, this.element})
      : assert(
  ...
  ImmunizationEvaluationTargetDiseaseCodes withElement(Element? newElement) {
    return ImmunizationEvaluationTargetDiseaseCodes(
      fhirCode: fhirCode,
      element: newElement,
    );
  }
  ...
  @override
  String toString() => 'ImmunizationEvaluationTargetDiseaseCodes.$fhirCode';
}
