...
String toJson() => toString();
  MedicationStatusCodes fromString(String str) {
    switch(str) {
      case 'active': return MedicationStatusCodes.active;
      case 'inactive': return MedicationStatusCodes.inactive;
      case 'entered-in-error': return MedicationStatusCodes.entered_in_error;
