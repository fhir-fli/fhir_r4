...
class MedicationStatusCodes {
  ...
  MedicationStatusCodes({this.fhirCode, this.element})
      : assert(
  ...
  static final MedicationStatusCodes active = MedicationStatusCodes(
    fhirCode: 'active',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final MedicationStatusCodes inactive = MedicationStatusCodes(
    fhirCode: 'inactive',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final MedicationStatusCodes entered_in_error = MedicationStatusCodes(
    fhirCode: 'entered-in-error',
  );

  /// For instances where an Element is present but not value

  static final MedicationStatusCodes elementOnly = MedicationStatusCodes();
