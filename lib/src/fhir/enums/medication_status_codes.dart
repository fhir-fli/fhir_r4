...
enum MedicationStatusCodes {
  ...
  /// Converts a list of JSON values to a list of [MedicationStatusCodes] instances.
  static MedicationStatusCodes fromJson(
    ...
    if (value == null && element != null) {
      return MedicationStatusCodes.elementOnly.withElement(
        element,
      );
    }
