...
@override
  String toString() {
      switch(this) {
        ...
        case query_status: return 'query-status';
        case query_event: return 'query-event';
      }
      }
String toJson() => toString();
  SubscriptionNotificationType fromString(String str) {
    switch(str) {
      case 'handshake': return SubscriptionNotificationType.handshake;
      case 'heartbeat': return SubscriptionNotificationType.heartbeat;
      case 'event-notification': return SubscriptionNotificationType.event_notification;
      case 'query-status': return SubscriptionNotificationType.query_status;
      case 'query-event': return SubscriptionNotificationType.query_event;
