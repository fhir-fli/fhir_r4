...
class NutrientModifierCodes {
  ...
  NutrientModifierCodes({this.fhirCode, this.element})
      : assert(
  ...
  static final NutrientModifierCodes value33463005 = NutrientModifierCodes(
    fhirCode: '33463005',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final NutrientModifierCodes value39972003 = NutrientModifierCodes(
    fhirCode: '39972003',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final NutrientModifierCodes value88480006 = NutrientModifierCodes(
    fhirCode: '88480006',
  );

  /// For instances where an Element is present but not value

  static final NutrientModifierCodes elementOnly = NutrientModifierCodes();
