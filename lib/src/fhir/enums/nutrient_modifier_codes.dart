...
@override
  String toString() {
      switch(this) {
        case value33463005: return '33463005';
        case value39972003: return '39972003';
        case value88480006: return '88480006';
      }
      }
String toJson() => toString();
  NutrientModifierCodes fromString(String str) {
    switch(str) {
      case '33463005': return NutrientModifierCodes.value33463005;
      case '39972003': return NutrientModifierCodes.value39972003;
      case '88480006': return NutrientModifierCodes.value88480006;
