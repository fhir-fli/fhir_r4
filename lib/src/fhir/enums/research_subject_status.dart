...
@override
  String toString() {
      switch(this) {
        ...
        case off_study: return 'off-study';
        case on_study: return 'on-study';
        case on_study_intervention: return 'on-study-intervention';
        case on_study_observation: return 'on-study-observation';
        case pending_on_study: return 'pending-on-study';
        case potential_candidate: return 'potential-candidate';
...
String toJson() => toString();
  ResearchSubjectStatus fromString(String str) {
    switch(str) {
      case 'candidate': return ResearchSubjectStatus.candidate;
      case 'eligible': return ResearchSubjectStatus.eligible;
      case 'follow-up': return ResearchSubjectStatus.follow_up;
      case 'ineligible': return ResearchSubjectStatus.ineligible;
      case 'not-registered': return ResearchSubjectStatus.not_registered;
      case 'off-study': return ResearchSubjectStatus.off_study;
      case 'on-study': return ResearchSubjectStatus.on_study;
      case 'on-study-intervention': return ResearchSubjectStatus.on_study_intervention;
      case 'on-study-observation': return ResearchSubjectStatus.on_study_observation;
      case 'pending-on-study': return ResearchSubjectStatus.pending_on_study;
      case 'potential-candidate': return ResearchSubjectStatus.potential_candidate;
      case 'screening': return ResearchSubjectStatus.screening;
      case 'withdrawn': return ResearchSubjectStatus.withdrawn;
