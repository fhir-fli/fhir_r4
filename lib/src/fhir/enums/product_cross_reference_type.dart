...
@override
  String toString() {
      switch(this) {
        case InvestigationalProduct: return 'InvestigationalProduct';
        case VirtualProduct: return 'VirtualProduct';
        case ActualProduct: return 'ActualProduct';
        case BrandedProduct: return 'BrandedProduct';
        case GenericProduct: return 'GenericProduct';
...
String toJson() => toString();
  ProductCrossReferenceType fromString(String str) {
    switch(str) {
      case 'InvestigationalProduct': return ProductCrossReferenceType.InvestigationalProduct;
      case 'VirtualProduct': return ProductCrossReferenceType.VirtualProduct;
      case 'ActualProduct': return ProductCrossReferenceType.ActualProduct;
      case 'BrandedProduct': return ProductCrossReferenceType.BrandedProduct;
      case 'GenericProduct': return ProductCrossReferenceType.GenericProduct;
      case 'Parallel': return ProductCrossReferenceType.Parallel;
