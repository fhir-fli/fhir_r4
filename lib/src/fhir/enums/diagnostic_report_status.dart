...
String toJson() => toString();
  DiagnosticReportStatus fromString(String str) {
    switch(str) {
      case 'registered': return DiagnosticReportStatus.registered;
      case 'partial': return DiagnosticReportStatus.partial;
      case 'final': return DiagnosticReportStatus.final_;
      case 'amended': return DiagnosticReportStatus.amended;
      case 'cancelled': return DiagnosticReportStatus.cancelled;
      case 'entered-in-error': return DiagnosticReportStatus.entered_in_error;
      case 'unknown': return DiagnosticReportStatus.unknown;
    default: throw ArgumentError('Unknown enum value: $str');
    }
      }
 DiagnosticReportStatus fromJson(dynamic jsonValue) {
