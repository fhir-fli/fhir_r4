...
enum CarePlanActivityKind {
  ...
  /// Display:
  /// Definition:
  CommunicationRequest_1('CommunicationRequest'),

  /// Display:
  /// Definition:
  DeviceRequest_1('DeviceRequest'),

  /// Display:
  /// Definition:
  MedicationRequest_1('MedicationRequest'),

  /// Display:
  /// Definition:
  NutritionOrder_1('NutritionOrder'),
  ...
  /// Display:
  /// Definition:
  VisionPrescription_1('VisionPrescription'),
  ...
  const CarePlanActivityKind(this.fhirCode, [this.element]);
  ...
  /// Converts a list of JSON values to a list of [CarePlanActivityKind] instances.
  static CarePlanActivityKind fromJson(
    ...
    if (value == null && element != null) {
      return CarePlanActivityKind.elementOnly.withElement(
        element,
      );
    }
  ...
  CarePlanActivityKind withElement(Element? newElement) {
    return CarePlanActivityKind.fromJson({
      'value': fhirCode,
