...
@override
  String toString() {
      switch(this) {
        ...
        case no_concern: return 'no-concern';
        case serious_concern: return 'serious-concern';
        case very_serious_concern: return 'very-serious-concern';
        case extremely_serious_concern: return 'extremely-serious-concern';
...
String toJson() => toString();
  EvidenceCertaintyRating fromString(String str) {
    switch(str) {
      case 'high': return EvidenceCertaintyRating.high;
      case 'moderate': return EvidenceCertaintyRating.moderate;
      case 'low': return EvidenceCertaintyRating.low;
      case 'very-low': return EvidenceCertaintyRating.very_low;
      case 'no-concern': return EvidenceCertaintyRating.no_concern;
      case 'serious-concern': return EvidenceCertaintyRating.serious_concern;
      case 'very-serious-concern': return EvidenceCertaintyRating.very_serious_concern;
      case 'extremely-serious-concern': return EvidenceCertaintyRating.extremely_serious_concern;
      case 'present': return EvidenceCertaintyRating.present;
      case 'absent': return EvidenceCertaintyRating.absent;
      case 'no-change': return EvidenceCertaintyRating.no_change;
      case 'downcode1': return EvidenceCertaintyRating.downcode1;
      case 'downcode2': return EvidenceCertaintyRating.downcode2;
      case 'downcode3': return EvidenceCertaintyRating.downcode3;
      case 'upcode1': return EvidenceCertaintyRating.upcode1;
      case 'upcode2': return EvidenceCertaintyRating.upcode2;
