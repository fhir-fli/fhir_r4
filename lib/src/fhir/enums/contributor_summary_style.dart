...
@override
  String toString() {
      switch(this) {
        case a1full: return 'a1full';
        case a1init: return 'a1init';
        case a3full: return 'a3full';
        case a3init: return 'a3init';
        case a6full: return 'a6full';
        case a6init: return 'a6init';
        case aallfull: return 'aallfull';
        case aallfullwithand: return 'aallfullwithand';
        case aallfullwithampersand: return 'aallfullwithampersand';
        case aallinit: return 'aallinit';
        case aallinitwithand: return 'aallinitwithand';
        case aallinitwithampersand: return 'aallinitwithampersand';
        case contr_full_by_person: return 'contr-full-by-person';
        case contr_init_by_person: return 'contr-init-by-person';
        case contr_full_by_contr: return 'contr-full-by-contr';
        case contr_init_by_contr: return 'contr-init-by-contr';
      }
      }
String toJson() => toString();
  ContributorSummaryStyle fromString(String str) {
    switch(str) {
      case 'a1full': return ContributorSummaryStyle.a1full;
      case 'a1init': return ContributorSummaryStyle.a1init;
      case 'a3full': return ContributorSummaryStyle.a3full;
      case 'a3init': return ContributorSummaryStyle.a3init;
      case 'a6full': return ContributorSummaryStyle.a6full;
      case 'a6init': return ContributorSummaryStyle.a6init;
      case 'aallfull': return ContributorSummaryStyle.aallfull;
      case 'aallfullwithand': return ContributorSummaryStyle.aallfullwithand;
      case 'aallfullwithampersand': return ContributorSummaryStyle.aallfullwithampersand;
      case 'aallinit': return ContributorSummaryStyle.aallinit;
      case 'aallinitwithand': return ContributorSummaryStyle.aallinitwithand;
      case 'aallinitwithampersand': return ContributorSummaryStyle.aallinitwithampersand;
      case 'contr-full-by-person': return ContributorSummaryStyle.contr_full_by_person;
      case 'contr-init-by-person': return ContributorSummaryStyle.contr_init_by_person;
      case 'contr-full-by-contr': return ContributorSummaryStyle.contr_full_by_contr;
      case 'contr-init-by-contr': return ContributorSummaryStyle.contr_init_by_contr;
