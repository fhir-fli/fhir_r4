...
class ContributorSummaryStyle {
  ...
  ContributorSummaryStyle({this.fhirCode, this.element})
      : assert(
  ...
  static final ContributorSummaryStyle a1full = ContributorSummaryStyle(
    fhirCode: 'a1full',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ContributorSummaryStyle a1init = ContributorSummaryStyle(
    fhirCode: 'a1init',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ContributorSummaryStyle a3full = ContributorSummaryStyle(
    fhirCode: 'a3full',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ContributorSummaryStyle a3init = ContributorSummaryStyle(
    fhirCode: 'a3init',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ContributorSummaryStyle a6full = ContributorSummaryStyle(
    fhirCode: 'a6full',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ContributorSummaryStyle a6init = ContributorSummaryStyle(
    fhirCode: 'a6init',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ContributorSummaryStyle aallfull = ContributorSummaryStyle(
    fhirCode: 'aallfull',
  );
  ...
  static final ContributorSummaryStyle aallfullwithampersand =
      ContributorSummaryStyle(
    fhirCode: 'aallfullwithampersand',
  );

  /// aallinit
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ContributorSummaryStyle aallinit = ContributorSummaryStyle(
    fhirCode: 'aallinit',
  );
  ...
  static final ContributorSummaryStyle aallinitwithampersand =
      ContributorSummaryStyle(
    fhirCode: 'aallinitwithampersand',
  );
  ...
  static final ContributorSummaryStyle contr_init_by_contr =
      ContributorSummaryStyle(
    fhirCode: 'contr-init-by-contr',
  );

  /// For instances where an Element is present but not value

  static final ContributorSummaryStyle elementOnly = ContributorSummaryStyle();
  ...
  ContributorSummaryStyle withElement(Element? newElement) {
    return ContributorSummaryStyle(
      fhirCode: fhirCode,
      element: newElement,
    );
  }
