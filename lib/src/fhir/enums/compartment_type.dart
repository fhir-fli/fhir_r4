...
String toJson() => toString();
  CompartmentType fromString(String str) {
    switch(str) {
      case 'Patient': return CompartmentType.Patient;
      case 'Encounter': return CompartmentType.Encounter;
      case 'RelatedPerson': return CompartmentType.RelatedPerson;
      case 'Practitioner': return CompartmentType.Practitioner;
      case 'Device': return CompartmentType.Device;
