...
String toJson() => toString();
  ImmunizationRecommendationStatusCodes fromString(String str) {
    switch(str) {
      case 'due': return ImmunizationRecommendationStatusCodes.due;
      case 'overdue': return ImmunizationRecommendationStatusCodes.overdue;
      case 'immune': return ImmunizationRecommendationStatusCodes.immune;
      case 'contraindicated': return ImmunizationRecommendationStatusCodes.contraindicated;
      case 'complete': return ImmunizationRecommendationStatusCodes.complete;
    default: throw ArgumentError('Unknown enum value: $str');
    }
      }
 ImmunizationRecommendationStatusCodes fromJson(dynamic jsonValue) {
