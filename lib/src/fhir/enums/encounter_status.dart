...
String toJson() => toString();
  EncounterStatus fromString(String str) {
    switch(str) {
      case 'planned': return EncounterStatus.planned;
      case 'arrived': return EncounterStatus.arrived;
      case 'triaged': return EncounterStatus.triaged;
      case 'in-progress': return EncounterStatus.in_progress;
      case 'onleave': return EncounterStatus.onleave;
      case 'finished': return EncounterStatus.finished;
      case 'cancelled': return EncounterStatus.cancelled;
      case 'entered-in-error': return EncounterStatus.entered_in_error;
      case 'unknown': return EncounterStatus.unknown;
