...
class SubscriptionChannelType {
  ...
  SubscriptionChannelType({this.fhirCode, this.element})
      : assert(
  ...
  static final SubscriptionChannelType rest_hook = SubscriptionChannelType(
    fhirCode: 'rest-hook',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final SubscriptionChannelType websocket = SubscriptionChannelType(
    fhirCode: 'websocket',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final SubscriptionChannelType email = SubscriptionChannelType(
    fhirCode: 'email',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final SubscriptionChannelType sms = SubscriptionChannelType(
    fhirCode: 'sms',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final SubscriptionChannelType message = SubscriptionChannelType(
    fhirCode: 'message',
  );

  /// For instances where an Element is present but not value

  static final SubscriptionChannelType elementOnly = SubscriptionChannelType();
