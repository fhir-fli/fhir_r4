...
@override
  String toString() {
      switch(this) {
        case rest_hook: return 'rest-hook';
...
String toJson() => toString();
  SubscriptionChannelType fromString(String str) {
    switch(str) {
      case 'rest-hook': return SubscriptionChannelType.rest_hook;
      case 'websocket': return SubscriptionChannelType.websocket;
      case 'email': return SubscriptionChannelType.email;
      case 'sms': return SubscriptionChannelType.sms;
      case 'message': return SubscriptionChannelType.message;
