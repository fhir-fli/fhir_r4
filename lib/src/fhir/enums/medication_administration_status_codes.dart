...
String toJson() => toString();
  MedicationAdministrationStatusCodes fromString(String str) {
    switch(str) {
      case 'in-progress': return MedicationAdministrationStatusCodes.in_progress;
      case 'not-done': return MedicationAdministrationStatusCodes.not_done;
      case 'on-hold': return MedicationAdministrationStatusCodes.on_hold;
      case 'completed': return MedicationAdministrationStatusCodes.completed;
      case 'entered-in-error': return MedicationAdministrationStatusCodes.entered_in_error;
      case 'stopped': return MedicationAdministrationStatusCodes.stopped;
      case 'unknown': return MedicationAdministrationStatusCodes.unknown;
    default: throw ArgumentError('Unknown enum value: $str');
    }
      }
 MedicationAdministrationStatusCodes fromJson(dynamic jsonValue) {
