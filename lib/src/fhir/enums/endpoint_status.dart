...
enum EndpointStatus {
  ...
  /// Returns a [String] from a [EndpointStatus] enum.
  String toJson() => toString();

  /// Returns a [EndpointStatus] from a [String] enum.
  ...
  /// Returns a [EndpointStatus] from a json [String] (although it will accept any dynamic and throw an error if it is not a String due to requirements for serializing/deserializing
