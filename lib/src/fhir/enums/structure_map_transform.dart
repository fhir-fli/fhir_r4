...
String toJson() => toString();
  StructureMapTransform fromString(String str) {
    switch(str) {
      case 'create': return StructureMapTransform.create;
      case 'copy': return StructureMapTransform.copy;
      case 'truncate': return StructureMapTransform.truncate;
      case 'escape': return StructureMapTransform.escape;
      case 'cast': return StructureMapTransform.cast;
      case 'append': return StructureMapTransform.append;
      case 'translate': return StructureMapTransform.translate;
      case 'reference': return StructureMapTransform.reference;
      case 'dateOp': return StructureMapTransform.dateOp;
      case 'uuid': return StructureMapTransform.uuid;
      case 'pointer': return StructureMapTransform.pointer;
      case 'evaluate': return StructureMapTransform.evaluate;
      case 'cc': return StructureMapTransform.cc;
      case 'c': return StructureMapTransform.c;
      case 'qty': return StructureMapTransform.qty;
      case 'id': return StructureMapTransform.id;
      case 'cp': return StructureMapTransform.cp;
