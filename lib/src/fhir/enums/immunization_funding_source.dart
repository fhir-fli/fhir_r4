...
class ImmunizationFundingSource {
  ...
  ImmunizationFundingSource({this.fhirCode, this.element})
      : assert(
  ...
  static final ImmunizationFundingSource private = ImmunizationFundingSource(
    fhirCode: 'private',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ImmunizationFundingSource public = ImmunizationFundingSource(
    fhirCode: 'public',
  );
  ...
  ImmunizationFundingSource withElement(Element? newElement) {
    return ImmunizationFundingSource(
      fhirCode: fhirCode,
      element: newElement,
    );
  }
