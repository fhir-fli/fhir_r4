...
class ImmunizationProgramEligibility extends PrimitiveType<String> {
  ...
  ImmunizationProgramEligibility._(super.value, [super.element]);
  ...
  @override
  ImmunizationProgramEligibility clone() =>
      ImmunizationProgramEligibility._(value, element?.clone() as Element?);

  /// Sets a property on the associated [Element], returning a new instance.
  @override
  ImmunizationProgramEligibility setElement(String name, dynamic elementValue) {
