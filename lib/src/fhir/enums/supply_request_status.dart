...
String toJson() => toString();
  SupplyRequestStatus fromString(String str) {
    switch(str) {
      case 'draft': return SupplyRequestStatus.draft;
      case 'active': return SupplyRequestStatus.active;
      case 'suspended': return SupplyRequestStatus.suspended;
      case 'cancelled': return SupplyRequestStatus.cancelled;
      case 'completed': return SupplyRequestStatus.completed;
      case 'entered-in-error': return SupplyRequestStatus.entered_in_error;
      case 'unknown': return SupplyRequestStatus.unknown;
