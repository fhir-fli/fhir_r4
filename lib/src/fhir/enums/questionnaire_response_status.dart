...
String toJson() => toString();
  QuestionnaireResponseStatus fromString(String str) {
    switch(str) {
      case 'in-progress': return QuestionnaireResponseStatus.in_progress;
      case 'completed': return QuestionnaireResponseStatus.completed;
      case 'amended': return QuestionnaireResponseStatus.amended;
      case 'entered-in-error': return QuestionnaireResponseStatus.entered_in_error;
      case 'stopped': return QuestionnaireResponseStatus.stopped;
