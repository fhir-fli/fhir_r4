...
String toJson() => toString();
  EligibilityResponsePurpose fromString(String str) {
    switch(str) {
      case 'auth-requirements': return EligibilityResponsePurpose.auth_requirements;
      case 'benefits': return EligibilityResponsePurpose.benefits;
      case 'discovery': return EligibilityResponsePurpose.discovery;
      case 'validation': return EligibilityResponsePurpose.validation;
