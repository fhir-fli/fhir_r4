...
class EligibilityResponsePurpose extends PrimitiveType<String> {
  ...
  @override
  EligibilityResponsePurpose clone() =>
      EligibilityResponsePurpose._(value, element?.clone() as Element?);

  /// Sets a property on the associated [Element], returning a new instance.
  @override
  EligibilityResponsePurpose setElement(String name, dynamic elementValue) {
