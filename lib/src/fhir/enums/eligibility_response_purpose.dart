...
enum EligibilityResponsePurpose {
  ...
  /// Converts a list of JSON values to a list of [EligibilityResponsePurpose] instances.
  static EligibilityResponsePurpose fromJson(
    ...
    if (value == null && element != null) {
      return EligibilityResponsePurpose.elementOnly.withElement(
        element,
      );
    }
