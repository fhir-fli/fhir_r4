...
@override
  String toString() {
      switch(this) {
        ...
        case copay_percent: return 'copay-percent';
        case copay_maximum: return 'copay-maximum';
        case vision_exam: return 'vision-exam';
        case vision_glasses: return 'vision-glasses';
        case vision_contacts: return 'vision-contacts';
        case medical_primarycare: return 'medical-primarycare';
        case pharmacy_dispense: return 'pharmacy-dispense';
      }
      }
String toJson() => toString();
  BenefitTypeCodes fromString(String str) {
    switch(str) {
      case 'benefit': return BenefitTypeCodes.benefit;
      case 'deductible': return BenefitTypeCodes.deductible;
      case 'visit': return BenefitTypeCodes.visit;
      case 'room': return BenefitTypeCodes.room;
      case 'copay': return BenefitTypeCodes.copay;
      case 'copay-percent': return BenefitTypeCodes.copay_percent;
      case 'copay-maximum': return BenefitTypeCodes.copay_maximum;
      case 'vision-exam': return BenefitTypeCodes.vision_exam;
      case 'vision-glasses': return BenefitTypeCodes.vision_glasses;
      case 'vision-contacts': return BenefitTypeCodes.vision_contacts;
      case 'medical-primarycare': return BenefitTypeCodes.medical_primarycare;
      case 'pharmacy-dispense': return BenefitTypeCodes.pharmacy_dispense;
