...
String toJson() => toString();
  SubscriptionStatusCodes fromString(String str) {
    switch(str) {
      case 'requested': return SubscriptionStatusCodes.requested;
      case 'active': return SubscriptionStatusCodes.active;
      case 'error': return SubscriptionStatusCodes.error;
      case 'off': return SubscriptionStatusCodes.off;
