...
@override
  String toString() {
      switch(this) {
        case C106046: return 'C106046';
        case C106045: return 'C106045';
        case C106047: return 'C106047';
        case C113844: return 'C113844';
        case C101673: return 'C101673';
        case C106038: return 'C106038';
      }
      }
String toJson() => toString();
  DeviceSafety fromString(String str) {
    switch(str) {
      case 'C106046': return DeviceSafety.C106046;
      case 'C106045': return DeviceSafety.C106045;
      case 'C106047': return DeviceSafety.C106047;
      case 'C113844': return DeviceSafety.C113844;
      case 'C101673': return DeviceSafety.C101673;
      case 'C106038': return DeviceSafety.C106038;
