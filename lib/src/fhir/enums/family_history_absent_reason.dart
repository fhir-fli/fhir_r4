...
@override
  String toString() {
      switch(this) {
        case subject_unknown: return 'subject-unknown';
        case withheld: return 'withheld';
        case unable_to_obtain: return 'unable-to-obtain';
        case deferred_: return 'deferred';
      }
      }
String toJson() => toString();
  FamilyHistoryAbsentReason fromString(String str) {
    switch(str) {
      case 'subject-unknown': return FamilyHistoryAbsentReason.subject_unknown;
      case 'withheld': return FamilyHistoryAbsentReason.withheld;
      case 'unable-to-obtain': return FamilyHistoryAbsentReason.unable_to_obtain;
      case 'deferred': return FamilyHistoryAbsentReason.deferred_;
