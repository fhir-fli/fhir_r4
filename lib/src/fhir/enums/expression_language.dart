...
@override
  String toString() {
      switch(this) {
        ...
        case application_x_fhir_query: return 'application/x-fhir-query';
        case text_cql_identifier: return 'text/cql-identifier';
        case text_cql_expression: return 'text/cql-expression';
      }
      }
String toJson() => toString();
  ExpressionLanguage fromString(String str) {
    switch(str) {
      case 'text/cql': return ExpressionLanguage.text_cql;
      case 'text/fhirpath': return ExpressionLanguage.text_fhirpath;
      case 'application/x-fhir-query': return ExpressionLanguage.application_x_fhir_query;
      case 'text/cql-identifier': return ExpressionLanguage.text_cql_identifier;
      case 'text/cql-expression': return ExpressionLanguage.text_cql_expression;
