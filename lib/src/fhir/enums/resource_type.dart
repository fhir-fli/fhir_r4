...
enum ResourceType {
  ...
  /// Returns a [String] from a [ResourceType] enum.
  String toJson() => toString();

  /// Returns a [ResourceType] from a [String] enum.
  ...
  /// Returns a [ResourceType] from a json [String] (although it will accept any dynamic and throw an error if it is not a String due to requirements for serializing/deserializing
