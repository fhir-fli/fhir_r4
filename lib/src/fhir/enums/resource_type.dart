...
enum ResourceType {
  ...
  const ResourceType(this.fhirCode, [this.element]);
  ...
  /// Converts a list of JSON values to a list of [ResourceType] instances.
  static ResourceType fromJson(
