...
String toJson() => toString();
  DeviceMetricOperationalStatus fromString(String str) {
    switch(str) {
      case 'on': return DeviceMetricOperationalStatus.on_;
      case 'off': return DeviceMetricOperationalStatus.off;
      case 'standby': return DeviceMetricOperationalStatus.standby;
      case 'entered-in-error': return DeviceMetricOperationalStatus.entered_in_error;
