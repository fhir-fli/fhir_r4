...
String toJson() => toString();
  EvidenceCertaintyType fromString(String str) {
    switch(str) {
      case 'Overall': return EvidenceCertaintyType.Overall;
      case 'RiskOfBias': return EvidenceCertaintyType.RiskOfBias;
      case 'Inconsistency': return EvidenceCertaintyType.Inconsistency;
      case 'Indirectness': return EvidenceCertaintyType.Indirectness;
      case 'Imprecision': return EvidenceCertaintyType.Imprecision;
      case 'PublicationBias': return EvidenceCertaintyType.PublicationBias;
      case 'DoseResponseGradient': return EvidenceCertaintyType.DoseResponseGradient;
      case 'PlausibleConfounding': return EvidenceCertaintyType.PlausibleConfounding;
      case 'LargeEffect': return EvidenceCertaintyType.LargeEffect;
