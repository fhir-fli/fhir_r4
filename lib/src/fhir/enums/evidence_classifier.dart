...
enum EvidenceClassifier {
  ...
  /// Returns a [String] from a [EvidenceClassifier] enum.
  String toJson() => toString();

  /// Returns a [EvidenceClassifier] from a [String] enum.
  ...
  /// Returns a [EvidenceClassifier] from a json [String] (although it will accept any dynamic and throw an error if it is not a String due to requirements for serializing/deserializing
