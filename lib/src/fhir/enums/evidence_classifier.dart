...
@override
  String toString() {
      switch(this) {
        case COVID19Specific: return 'COVID19Specific';
        case COVID19Relevant: return 'COVID19Relevant';
        case COVID19HumanResearch: return 'COVID19HumanResearch';
        case OriginalResearch: return 'OriginalResearch';
        case ResearchSynthesis: return 'ResearchSynthesis';
        case Guideline: return 'Guideline';
        case ResearchProtocol: return 'ResearchProtocol';
        case NotResearchNotGuideline: return 'NotResearchNotGuideline';
        case Treatment: return 'Treatment';
        case PreventionAndControl: return 'PreventionAndControl';
        case Diagnosis: return 'Diagnosis';
        case PrognosisPrediction: return 'PrognosisPrediction';
        case RatedAsYes: return 'RatedAsYes';
        case RatedAsNo: return 'RatedAsNo';
        case NotAssessed: return 'NotAssessed';
        case RatedAsRCT: return 'RatedAsRCT';
        case RatedAsControlledTrial: return 'RatedAsControlledTrial';
        case RatedAsComparativeCohort: return 'RatedAsComparativeCohort';
        case RatedAsCaseControl: return 'RatedAsCaseControl';
        case RatedAsUncontrolledSeries: return 'RatedAsUncontrolledSeries';
        case RatedAsMixedMethods: return 'RatedAsMixedMethods';
        case RatedAsOther: return 'RatedAsOther';
        case RiskOfBias: return 'RiskOfBias';
        case NoBlinding: return 'NoBlinding';
        case AllocConcealNotStated: return 'AllocConcealNotStated';
        case EarlyTrialTermination: return 'EarlyTrialTermination';
        case NoITT: return 'NoITT';
        case Preprint: return 'Preprint';
        case PreliminaryAnalysis: return 'PreliminaryAnalysis';
        case BaselineImbalance: return 'BaselineImbalance';
        case SubgroupAnalysis: return 'SubgroupAnalysis';
      }
      }
String toJson() => toString();
  EvidenceClassifier fromString(String str) {
    switch(str) {
      case 'COVID19Specific': return EvidenceClassifier.COVID19Specific;
      case 'COVID19Relevant': return EvidenceClassifier.COVID19Relevant;
      case 'COVID19HumanResearch': return EvidenceClassifier.COVID19HumanResearch;
      case 'OriginalResearch': return EvidenceClassifier.OriginalResearch;
      case 'ResearchSynthesis': return EvidenceClassifier.ResearchSynthesis;
      case 'Guideline': return EvidenceClassifier.Guideline;
      case 'ResearchProtocol': return EvidenceClassifier.ResearchProtocol;
      case 'NotResearchNotGuideline': return EvidenceClassifier.NotResearchNotGuideline;
      case 'Treatment': return EvidenceClassifier.Treatment;
      case 'PreventionAndControl': return EvidenceClassifier.PreventionAndControl;
      case 'Diagnosis': return EvidenceClassifier.Diagnosis;
      case 'PrognosisPrediction': return EvidenceClassifier.PrognosisPrediction;
      case 'RatedAsYes': return EvidenceClassifier.RatedAsYes;
      case 'RatedAsNo': return EvidenceClassifier.RatedAsNo;
      case 'NotAssessed': return EvidenceClassifier.NotAssessed;
      case 'RatedAsRCT': return EvidenceClassifier.RatedAsRCT;
      case 'RatedAsControlledTrial': return EvidenceClassifier.RatedAsControlledTrial;
      case 'RatedAsComparativeCohort': return EvidenceClassifier.RatedAsComparativeCohort;
      case 'RatedAsCaseControl': return EvidenceClassifier.RatedAsCaseControl;
      case 'RatedAsUncontrolledSeries': return EvidenceClassifier.RatedAsUncontrolledSeries;
      case 'RatedAsMixedMethods': return EvidenceClassifier.RatedAsMixedMethods;
      case 'RatedAsOther': return EvidenceClassifier.RatedAsOther;
      case 'RiskOfBias': return EvidenceClassifier.RiskOfBias;
      case 'NoBlinding': return EvidenceClassifier.NoBlinding;
      case 'AllocConcealNotStated': return EvidenceClassifier.AllocConcealNotStated;
      case 'EarlyTrialTermination': return EvidenceClassifier.EarlyTrialTermination;
      case 'NoITT': return EvidenceClassifier.NoITT;
      case 'Preprint': return EvidenceClassifier.Preprint;
      case 'PreliminaryAnalysis': return EvidenceClassifier.PreliminaryAnalysis;
      case 'BaselineImbalance': return EvidenceClassifier.BaselineImbalance;
      case 'SubgroupAnalysis': return EvidenceClassifier.SubgroupAnalysis;
