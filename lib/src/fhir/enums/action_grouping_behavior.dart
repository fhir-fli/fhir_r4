...
@override
  String toString() {
      switch(this) {
        case visual_group: return 'visual-group';
        case logical_group: return 'logical-group';
        case sentence_group: return 'sentence-group';
      }
      }
String toJson() => toString();
  ActionGroupingBehavior fromString(String str) {
    switch(str) {
      case 'visual-group': return ActionGroupingBehavior.visual_group;
      case 'logical-group': return ActionGroupingBehavior.logical_group;
      case 'sentence-group': return ActionGroupingBehavior.sentence_group;
