...
class ActionGroupingBehavior {
  ...
  ActionGroupingBehavior({this.fhirCode, this.element})
      : assert(
  ...
  static final ActionGroupingBehavior visual_group = ActionGroupingBehavior(
    fhirCode: 'visual-group',
  );

  /// logical_group
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ActionGroupingBehavior logical_group = ActionGroupingBehavior(
    fhirCode: 'logical-group',
  );

  /// sentence_group
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ActionGroupingBehavior sentence_group = ActionGroupingBehavior(
    fhirCode: 'sentence-group',
  );

  /// For instances where an Element is present but not value

  static final ActionGroupingBehavior elementOnly = ActionGroupingBehavior();
