  ...
  static MeasurePopulationType fromString(String str) {
    switch (str) {
      ...
      case 'numerator-exclusion':
        return MeasurePopulationType.numerator_exclusion;
      case 'denominator':
        return MeasurePopulationType.denominator;
      case 'denominator-exclusion':
        return MeasurePopulationType.denominator_exclusion;
      case 'denominator-exception':
        return MeasurePopulationType.denominator_exception;
      case 'measure-population':
        return MeasurePopulationType.measure_population;
      case 'measure-population-exclusion':
        return MeasurePopulationType.measure_population_exclusion;
      case 'measure-observation':
        return MeasurePopulationType.measure_observation;
      default:
