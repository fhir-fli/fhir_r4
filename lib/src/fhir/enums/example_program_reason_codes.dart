...
enum ExampleProgramReasonCodes {
  ...
  /// Returns a [String] from a [ExampleProgramReasonCodes] enum.
  String toJson() => toString();

  /// Returns a [ExampleProgramReasonCodes] from a [String] enum.
  ...
  /// Returns a [ExampleProgramReasonCodes] from a json [String] (although it will accept any dynamic and throw an error if it is not a String due to requirements for serializing/deserializing
