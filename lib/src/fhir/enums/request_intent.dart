...
String toJson() => toString();
  RequestIntent fromString(String str) {
    switch(str) {
      case 'proposal': return RequestIntent.proposal;
      case 'plan': return RequestIntent.plan;
      case 'directive': return RequestIntent.directive;
      case 'order': return RequestIntent.order;
      case 'option': return RequestIntent.option;
