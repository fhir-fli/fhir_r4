...
enum RequestIntent {
  ...
  const RequestIntent(this.fhirCode, [this.element]);
  ...
  /// Converts a list of JSON values to a list of [RequestIntent] instances.
  static RequestIntent fromJson(
