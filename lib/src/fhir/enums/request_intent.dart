...
enum RequestIntent {
  ...
  /// Returns a [String] from a [RequestIntent] enum.
  String toJson() => toString();

  /// Returns a [RequestIntent] from a [String] enum.
  ...
  /// Returns a [RequestIntent] from a json [String] (although it will accept any dynamic and throw an error if it is not a String due to requirements for serializing/deserializing
