...
@override
  String toString() {
      switch(this) {
        ...
        case mean_of_mean: return 'mean-of-mean';
        case mean_of_median: return 'mean-of-median';
        case median_of_mean: return 'median-of-mean';
        case median_of_median: return 'median-of-median';
      }
      }
String toJson() => toString();
  GroupMeasure fromString(String str) {
    switch(str) {
      case 'mean': return GroupMeasure.mean;
      case 'median': return GroupMeasure.median;
      case 'mean-of-mean': return GroupMeasure.mean_of_mean;
      case 'mean-of-median': return GroupMeasure.mean_of_median;
      case 'median-of-mean': return GroupMeasure.median_of_mean;
      case 'median-of-median': return GroupMeasure.median_of_median;
