...
enum GroupMeasure {
  ...
  /// Returns a [String] from a [GroupMeasure] enum.
  String toJson() => toString();

  /// Returns a [GroupMeasure] from a [String] enum.
  ...
  /// Returns a [GroupMeasure] from a json [String] (although it will accept any dynamic and throw an error if it is not a String due to requirements for serializing/deserializing
