...
enum ServiceRequestCategoryCodes {
  ...
  /// Converts a list of JSON values to a list of [ServiceRequestCategoryCodes] instances.
  static ServiceRequestCategoryCodes fromJson(
    ...
    if (value == null && element != null) {
      return ServiceRequestCategoryCodes.elementOnly.withElement(
        element,
      );
    }
