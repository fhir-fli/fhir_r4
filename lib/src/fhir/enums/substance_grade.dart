...
@override
  String toString() {
      switch(this) {
        case USP_NF: return 'USP-NF';
        case Ph_Eur: return 'Ph.Eur';
        case JP: return 'JP';
        case BP: return 'BP';
        case CompanyStandard: return 'CompanyStandard';
      }
      }
String toJson() => toString();
  SubstanceGrade fromString(String str) {
    switch(str) {
      case 'USP-NF': return SubstanceGrade.USP_NF;
      case 'Ph.Eur': return SubstanceGrade.Ph_Eur;
      case 'JP': return SubstanceGrade.JP;
      case 'BP': return SubstanceGrade.BP;
      case 'CompanyStandard': return SubstanceGrade.CompanyStandard;
