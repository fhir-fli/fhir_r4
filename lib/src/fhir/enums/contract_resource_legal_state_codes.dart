...
enum ContractResourceLegalStateCodes {
  ...
  const ContractResourceLegalStateCodes(this.fhirCode, [this.element]);
  ...
  /// Converts a list of JSON values to a list of [ContractResourceLegalStateCodes] instances.
  static ContractResourceLegalStateCodes fromJson(
    ...
    if (value == null && element != null) {
      return ContractResourceLegalStateCodes.elementOnly.withElement(
        element,
      );
    }
  ...
  ContractResourceLegalStateCodes withElement(Element? newElement) {
    return ContractResourceLegalStateCodes.fromJson({
      'value': fhirCode,
