...
enum ContractResourceLegalStateCodes {
  ...
  ContractResourceLegalStateCodes fromString(String str) {
    switch (str) {
      case 'amended':
        return ContractResourceLegalStateCodes.amended;
      case 'appended':
        return ContractResourceLegalStateCodes.appended;
      case 'cancelled':
        return ContractResourceLegalStateCodes.cancelled;
      case 'disputed':
        return ContractResourceLegalStateCodes.disputed;
      case 'entered-in-error':
        return ContractResourceLegalStateCodes.entered_in_error;
      case 'executable':
        return ContractResourceLegalStateCodes.executable;
      case 'executed':
        return ContractResourceLegalStateCodes.executed;
      case 'negotiable':
        return ContractResourceLegalStateCodes.negotiable;
      case 'offered':
        return ContractResourceLegalStateCodes.offered;
      case 'policy':
        return ContractResourceLegalStateCodes.policy;
      case 'rejected':
        return ContractResourceLegalStateCodes.rejected;
      case 'renewed':
        return ContractResourceLegalStateCodes.renewed;
      case 'revoked':
        return ContractResourceLegalStateCodes.revoked;
      case 'resolved':
        return ContractResourceLegalStateCodes.resolved;
      case 'terminated':
        return ContractResourceLegalStateCodes.terminated;
      default:
