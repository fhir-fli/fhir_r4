...
class ContractResourceLegalStateCodes extends PrimitiveType<String> {
  ...
  ContractResourceLegalStateCodes._(super.value, [super.element]);
  ...
  @override
  ContractResourceLegalStateCodes clone() =>
      ContractResourceLegalStateCodes._(value, element?.clone() as Element?);

  /// Sets a property on the associated [Element], returning a new instance.
  @override
  ContractResourceLegalStateCodes setElement(
