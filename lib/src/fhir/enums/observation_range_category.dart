...
String toJson() => toString();
  ObservationRangeCategory fromString(String str) {
    switch(str) {
      case 'reference': return ObservationRangeCategory.reference;
      case 'critical': return ObservationRangeCategory.critical;
      case 'absolute': return ObservationRangeCategory.absolute;
