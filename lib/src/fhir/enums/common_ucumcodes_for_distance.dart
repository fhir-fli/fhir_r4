...
String toJson() => toString();
  CommonUCUMCodesForDistance fromString(String str) {
    switch(str) {
      case 'nm': return CommonUCUMCodesForDistance.nm;
      case 'um': return CommonUCUMCodesForDistance.um;
      case 'mm': return CommonUCUMCodesForDistance.mm;
      case 'm': return CommonUCUMCodesForDistance.m;
      case 'km': return CommonUCUMCodesForDistance.km;
