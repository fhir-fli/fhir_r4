...
enum MedicationStatementStatusCodes {
  ...
  /// Returns a [String] from a [MedicationStatementStatusCodes] enum.
  String toJson() => toString();

  /// Returns a [MedicationStatementStatusCodes] from a [String] enum.
  ...
  /// Returns a [MedicationStatementStatusCodes] from a json [String] (although it will accept any dynamic and throw an error if it is not a String due to requirements for serializing/deserializing
