...
String toJson() => toString();
  SearchComparator fromString(String str) {
    switch(str) {
      case 'eq': return SearchComparator.eq;
      case 'ne': return SearchComparator.ne;
      case 'gt': return SearchComparator.gt;
      case 'lt': return SearchComparator.lt;
      case 'ge': return SearchComparator.ge;
      case 'le': return SearchComparator.le;
      case 'sa': return SearchComparator.sa;
      case 'eb': return SearchComparator.eb;
      case 'ap': return SearchComparator.ap;
