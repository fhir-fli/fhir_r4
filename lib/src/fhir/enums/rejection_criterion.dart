...
@override
  String toString() {
      switch(this) {
        ...
        case wrong_temperature: return 'wrong-temperature';
      }
      }
String toJson() => toString();
  RejectionCriterion fromString(String str) {
    switch(str) {
      case 'hemolized': return RejectionCriterion.hemolized;
      case 'insufficient': return RejectionCriterion.insufficient;
      case 'broken': return RejectionCriterion.broken;
      case 'clotted': return RejectionCriterion.clotted;
      case 'wrong-temperature': return RejectionCriterion.wrong_temperature;
