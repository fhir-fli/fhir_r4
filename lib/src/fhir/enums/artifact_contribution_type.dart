...
enum ArtifactContributionType {
  ...
  /// Returns a [String] from a [ArtifactContributionType] enum.
  String toJson() => toString();

  /// Returns a [ArtifactContributionType] from a [String] enum.
  ...
  /// Returns a [ArtifactContributionType] from a json [String] (although it will accept any dynamic and throw an error if it is not a String due to requirements for serializing/deserializing
