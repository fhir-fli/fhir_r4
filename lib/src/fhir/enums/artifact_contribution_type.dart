...
@override
  String toString() {
      switch(this) {
        ...
        case data_curation: return 'data-curation';
        case formal_analysis: return 'formal-analysis';
        case funding_acquisition: return 'funding-acquisition';
        case investigation: return 'investigation';
        case methodology: return 'methodology';
        case project_administration: return 'project-administration';
        case resources: return 'resources';
        case software: return 'software';
        case supervision: return 'supervision';
        case validation: return 'validation';
        case visualization: return 'visualization';
        case writing_original_draft: return 'writing-original-draft';
        case writing_review_editing: return 'writing-review-editing';
      }
      }
String toJson() => toString();
  ArtifactContributionType fromString(String str) {
    switch(str) {
      case 'conceptualization': return ArtifactContributionType.conceptualization;
      case 'data-curation': return ArtifactContributionType.data_curation;
      case 'formal-analysis': return ArtifactContributionType.formal_analysis;
      case 'funding-acquisition': return ArtifactContributionType.funding_acquisition;
      case 'investigation': return ArtifactContributionType.investigation;
      case 'methodology': return ArtifactContributionType.methodology;
      case 'project-administration': return ArtifactContributionType.project_administration;
      case 'resources': return ArtifactContributionType.resources;
      case 'software': return ArtifactContributionType.software;
      case 'supervision': return ArtifactContributionType.supervision;
      case 'validation': return ArtifactContributionType.validation;
      case 'visualization': return ArtifactContributionType.visualization;
      case 'writing-original-draft': return ArtifactContributionType.writing_original_draft;
      case 'writing-review-editing': return ArtifactContributionType.writing_review_editing;
