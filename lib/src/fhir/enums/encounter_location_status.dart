...
class EncounterLocationStatus extends PrimitiveType<String> {
  ...
  @override
  EncounterLocationStatus clone() =>
      EncounterLocationStatus._(value, element?.clone() as Element?);

  /// Sets a property on the associated [Element], returning a new instance.
  @override
  EncounterLocationStatus setElement(String name, dynamic elementValue) {
