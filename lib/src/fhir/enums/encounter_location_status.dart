...
String toJson() => toString();
  EncounterLocationStatus fromString(String str) {
    switch(str) {
      case 'planned': return EncounterLocationStatus.planned;
      case 'active': return EncounterLocationStatus.active;
      case 'reserved': return EncounterLocationStatus.reserved;
      case 'completed': return EncounterLocationStatus.completed;
    default: throw ArgumentError('Unknown enum value: $str');
    }
      }
 EncounterLocationStatus fromJson(dynamic jsonValue) {
