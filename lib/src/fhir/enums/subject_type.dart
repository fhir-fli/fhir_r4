...
enum SubjectType {
  ...
  static SubjectType fromString(String str) {
    switch (str) {
      ...
      case 'Binary':
        return SubjectType.Binary;
      case 'Bundle':
        return SubjectType.Bundle;
      case 'DomainResource':
        return SubjectType.DomainResource;
      case 'Account':
        return SubjectType.Account;
      case 'ActivityDefinition':
        return SubjectType.ActivityDefinition;
      case 'AdministrableProductDefinition':
        return SubjectType.AdministrableProductDefinition;
      case 'AdverseEvent':
        return SubjectType.AdverseEvent;
      case 'AllergyIntolerance':
        return SubjectType.AllergyIntolerance;
      case 'Appointment':
        return SubjectType.Appointment;
      case 'AppointmentResponse':
        return SubjectType.AppointmentResponse;
      case 'AuditEvent':
        return SubjectType.AuditEvent;
      case 'Basic':
        return SubjectType.Basic;
      case 'BiologicallyDerivedProduct':
        return SubjectType.BiologicallyDerivedProduct;
      case 'BodyStructure':
        return SubjectType.BodyStructure;
      case 'CapabilityStatement':
        return SubjectType.CapabilityStatement;
      case 'CarePlan':
        return SubjectType.CarePlan;
      case 'CareTeam':
        return SubjectType.CareTeam;
      case 'CatalogEntry':
        return SubjectType.CatalogEntry;
      case 'ChargeItem':
        return SubjectType.ChargeItem;
      case 'ChargeItemDefinition':
        return SubjectType.ChargeItemDefinition;
      case 'Citation':
        return SubjectType.Citation;
      case 'Claim':
        return SubjectType.Claim;
      case 'ClaimResponse':
        return SubjectType.ClaimResponse;
      case 'ClinicalImpression':
        return SubjectType.ClinicalImpression;
      case 'ClinicalUseDefinition':
        return SubjectType.ClinicalUseDefinition;
      case 'CodeSystem':
        return SubjectType.CodeSystem;
      case 'Communication':
        return SubjectType.Communication;
      case 'CommunicationRequest':
        return SubjectType.CommunicationRequest;
      case 'CompartmentDefinition':
        return SubjectType.CompartmentDefinition;
      case 'Composition':
        return SubjectType.Composition;
      case 'ConceptMap':
        return SubjectType.ConceptMap;
      case 'Condition':
        return SubjectType.Condition;
      case 'Consent':
        return SubjectType.Consent;
      case 'Contract':
        return SubjectType.Contract;
      case 'Coverage':
        return SubjectType.Coverage;
      case 'CoverageEligibilityRequest':
        return SubjectType.CoverageEligibilityRequest;
      case 'CoverageEligibilityResponse':
        return SubjectType.CoverageEligibilityResponse;
      case 'DetectedIssue':
        return SubjectType.DetectedIssue;
      case 'Device':
        return SubjectType.Device;
      case 'DeviceDefinition':
        return SubjectType.DeviceDefinition;
      case 'DeviceMetric':
        return SubjectType.DeviceMetric;
      case 'DeviceRequest':
        return SubjectType.DeviceRequest;
      case 'DeviceUseStatement':
        return SubjectType.DeviceUseStatement;
      case 'DiagnosticReport':
        return SubjectType.DiagnosticReport;
      case 'DocumentManifest':
        return SubjectType.DocumentManifest;
      case 'DocumentReference':
        return SubjectType.DocumentReference;
      case 'Encounter':
        return SubjectType.Encounter;
      case 'Endpoint':
        return SubjectType.Endpoint;
      case 'EnrollmentRequest':
        return SubjectType.EnrollmentRequest;
      case 'EnrollmentResponse':
        return SubjectType.EnrollmentResponse;
      case 'EpisodeOfCare':
        return SubjectType.EpisodeOfCare;
      case 'EventDefinition':
        return SubjectType.EventDefinition;
      case 'Evidence':
        return SubjectType.Evidence;
      case 'EvidenceReport':
        return SubjectType.EvidenceReport;
      case 'EvidenceVariable':
        return SubjectType.EvidenceVariable;
      case 'ExampleScenario':
        return SubjectType.ExampleScenario;
      case 'ExplanationOfBenefit':
        return SubjectType.ExplanationOfBenefit;
      case 'FamilyMemberHistory':
        return SubjectType.FamilyMemberHistory;
      case 'Flag':
        return SubjectType.Flag;
      case 'Goal':
        return SubjectType.Goal;
      case 'GraphDefinition':
        return SubjectType.GraphDefinition;
      case 'Group':
        return SubjectType.Group;
      case 'GuidanceResponse':
        return SubjectType.GuidanceResponse;
      case 'HealthcareService':
        return SubjectType.HealthcareService;
      case 'ImagingStudy':
        return SubjectType.ImagingStudy;
      case 'Immunization':
        return SubjectType.Immunization;
      case 'ImmunizationEvaluation':
        return SubjectType.ImmunizationEvaluation;
      case 'ImmunizationRecommendation':
        return SubjectType.ImmunizationRecommendation;
      case 'ImplementationGuide':
        return SubjectType.ImplementationGuide;
      case 'Ingredient':
        return SubjectType.Ingredient;
      case 'InsurancePlan':
        return SubjectType.InsurancePlan;
      case 'Invoice':
        return SubjectType.Invoice;
      case 'Library':
        return SubjectType.Library;
      case 'Linkage':
        return SubjectType.Linkage;
      case 'List':
        return SubjectType.List;
      case 'Location':
        return SubjectType.Location;
      case 'ManufacturedItemDefinition':
        return SubjectType.ManufacturedItemDefinition;
      case 'Measure':
        return SubjectType.Measure;
      case 'MeasureReport':
        return SubjectType.MeasureReport;
      case 'Media':
        return SubjectType.Media;
      case 'Medication':
        return SubjectType.Medication;
      case 'MedicationAdministration':
        return SubjectType.MedicationAdministration;
      case 'MedicationDispense':
        return SubjectType.MedicationDispense;
      case 'MedicationKnowledge':
        return SubjectType.MedicationKnowledge;
      case 'MedicationRequest':
        return SubjectType.MedicationRequest;
      case 'MedicationStatement':
        return SubjectType.MedicationStatement;
      case 'MedicinalProductDefinition':
        return SubjectType.MedicinalProductDefinition;
      case 'MessageDefinition':
        return SubjectType.MessageDefinition;
      case 'MessageHeader':
        return SubjectType.MessageHeader;
      case 'MolecularSequence':
        return SubjectType.MolecularSequence;
      case 'NamingSystem':
        return SubjectType.NamingSystem;
      case 'NutritionOrder':
        return SubjectType.NutritionOrder;
      case 'NutritionProduct':
        return SubjectType.NutritionProduct;
      case 'Observation':
        return SubjectType.Observation;
      case 'ObservationDefinition':
        return SubjectType.ObservationDefinition;
      case 'OperationDefinition':
        return SubjectType.OperationDefinition;
      case 'OperationOutcome':
        return SubjectType.OperationOutcome;
      case 'Organization':
        return SubjectType.Organization;
      case 'OrganizationAffiliation':
        return SubjectType.OrganizationAffiliation;
      case 'PackagedProductDefinition':
        return SubjectType.PackagedProductDefinition;
      case 'Patient':
        return SubjectType.Patient;
      case 'PaymentNotice':
        return SubjectType.PaymentNotice;
      case 'PaymentReconciliation':
        return SubjectType.PaymentReconciliation;
      case 'Person':
        return SubjectType.Person;
      case 'PlanDefinition':
        return SubjectType.PlanDefinition;
      case 'Practitioner':
        return SubjectType.Practitioner;
      case 'PractitionerRole':
        return SubjectType.PractitionerRole;
      case 'Procedure':
        return SubjectType.Procedure;
      case 'Provenance':
        return SubjectType.Provenance;
      case 'Questionnaire':
        return SubjectType.Questionnaire;
      case 'QuestionnaireResponse':
        return SubjectType.QuestionnaireResponse;
      case 'RegulatedAuthorization':
        return SubjectType.RegulatedAuthorization;
      case 'RelatedPerson':
        return SubjectType.RelatedPerson;
      case 'RequestGroup':
        return SubjectType.RequestGroup;
      case 'ResearchDefinition':
        return SubjectType.ResearchDefinition;
      case 'ResearchElementDefinition':
        return SubjectType.ResearchElementDefinition;
      case 'ResearchStudy':
        return SubjectType.ResearchStudy;
      case 'ResearchSubject':
        return SubjectType.ResearchSubject;
      case 'RiskAssessment':
        return SubjectType.RiskAssessment;
      case 'Schedule':
        return SubjectType.Schedule;
      case 'SearchParameter':
        return SubjectType.SearchParameter;
      case 'ServiceRequest':
        return SubjectType.ServiceRequest;
      case 'Slot':
        return SubjectType.Slot;
      case 'Specimen':
        return SubjectType.Specimen;
      case 'SpecimenDefinition':
        return SubjectType.SpecimenDefinition;
      case 'StructureDefinition':
        return SubjectType.StructureDefinition;
      case 'StructureMap':
        return SubjectType.StructureMap;
      case 'Subscription':
        return SubjectType.Subscription;
      case 'SubscriptionStatus':
        return SubjectType.SubscriptionStatus;
      case 'SubscriptionTopic':
        return SubjectType.SubscriptionTopic;
      case 'Substance':
        return SubjectType.Substance;
      case 'SubstanceDefinition':
        return SubjectType.SubstanceDefinition;
      case 'SupplyDelivery':
        return SubjectType.SupplyDelivery;
      case 'SupplyRequest':
        return SubjectType.SupplyRequest;
      case 'Task':
        return SubjectType.Task;
      case 'TerminologyCapabilities':
        return SubjectType.TerminologyCapabilities;
      case 'TestReport':
        return SubjectType.TestReport;
      case 'TestScript':
        return SubjectType.TestScript;
      case 'ValueSet':
        return SubjectType.ValueSet;
      case 'VerificationResult':
        return SubjectType.VerificationResult;
      case 'VisionPrescription':
        return SubjectType.VisionPrescription;
      case 'Parameters':
        return SubjectType.Parameters;
      default:
