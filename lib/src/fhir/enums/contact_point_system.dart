...
String toJson() => toString();
  ContactPointSystem fromString(String str) {
    switch(str) {
      case 'phone': return ContactPointSystem.phone;
      case 'fax': return ContactPointSystem.fax;
      case 'email': return ContactPointSystem.email;
      case 'pager': return ContactPointSystem.pager;
      case 'url': return ContactPointSystem.url;
      case 'sms': return ContactPointSystem.sms;
      case 'other': return ContactPointSystem.other;
