...
String toJson() => toString();
  TestReportActionResult fromString(String str) {
    switch(str) {
      case 'pass': return TestReportActionResult.pass;
      case 'skip': return TestReportActionResult.skip;
      case 'fail': return TestReportActionResult.fail;
      case 'warning': return TestReportActionResult.warning;
      case 'error': return TestReportActionResult.error;
