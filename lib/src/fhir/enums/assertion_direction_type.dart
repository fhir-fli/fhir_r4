...
enum AssertionDirectionType {
  ...
  /// Converts a list of JSON values to a list of [AssertionDirectionType] instances.
  static AssertionDirectionType fromJson(
    ...
    if (value == null && element != null) {
      return AssertionDirectionType.elementOnly.withElement(
        element,
      );
    }
