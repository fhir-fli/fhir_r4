...
String toJson() => toString();
  SpecimenStatus fromString(String str) {
    switch(str) {
      case 'available': return SpecimenStatus.available;
      case 'unavailable': return SpecimenStatus.unavailable;
      case 'unsatisfactory': return SpecimenStatus.unsatisfactory;
      case 'entered-in-error': return SpecimenStatus.entered_in_error;
