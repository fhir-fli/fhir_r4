...
String toJson() => toString();
  IdentityAssuranceLevel fromString(String str) {
    switch(str) {
      case 'level1': return IdentityAssuranceLevel.level1;
      case 'level2': return IdentityAssuranceLevel.level2;
      case 'level3': return IdentityAssuranceLevel.level3;
      case 'level4': return IdentityAssuranceLevel.level4;
