...
enum ContractResourceDefinitionTypeCodes {
  ...
  /// Converts a list of JSON values to a list of [ContractResourceDefinitionTypeCodes] instances.
  static ContractResourceDefinitionTypeCodes fromJson(
    ...
    if (value == null && element != null) {
      return ContractResourceDefinitionTypeCodes.elementOnly.withElement(
        element,
      );
    }
