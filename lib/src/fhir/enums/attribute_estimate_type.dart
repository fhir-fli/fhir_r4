...
@override
  String toString() {
      switch(this) {
        case value0000419: return '0000419';
        case C53324: return 'C53324';
        case value0000455: return '0000455';
        case value0000420: return '0000420';
        case C53245: return 'C53245';
        case C44185: return 'C44185';
        case C38013: return 'C38013';
        case C53322: return 'C53322';
        case value0000037: return '0000037';
        case value0000421: return '0000421';
        case C48918: return 'C48918';
      }
      }
String toJson() => toString();
  AttributeEstimateType fromString(String str) {
    switch(str) {
      case '0000419': return AttributeEstimateType.value0000419;
      case 'C53324': return AttributeEstimateType.C53324;
      case '0000455': return AttributeEstimateType.value0000455;
      case '0000420': return AttributeEstimateType.value0000420;
      case 'C53245': return AttributeEstimateType.C53245;
      case 'C44185': return AttributeEstimateType.C44185;
      case 'C38013': return AttributeEstimateType.C38013;
      case 'C53322': return AttributeEstimateType.C53322;
      case '0000037': return AttributeEstimateType.value0000037;
      case '0000421': return AttributeEstimateType.value0000421;
      case 'C48918': return AttributeEstimateType.C48918;
