...
@override
  String toString() {
      switch(this) {
        case primitive_type: return 'primitive-type';
        case complex_type: return 'complex-type';
...
String toJson() => toString();
  StructureDefinitionKind fromString(String str) {
    switch(str) {
      case 'primitive-type': return StructureDefinitionKind.primitive_type;
      case 'complex-type': return StructureDefinitionKind.complex_type;
      case 'resource': return StructureDefinitionKind.resource;
      case 'logical': return StructureDefinitionKind.logical;
