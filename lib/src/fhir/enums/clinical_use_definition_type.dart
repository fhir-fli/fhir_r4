...
class ClinicalUseDefinitionType {
  ...
  ClinicalUseDefinitionType({this.fhirCode, this.element})
      : assert(
  ...
  static final ClinicalUseDefinitionType indication = ClinicalUseDefinitionType(
    fhirCode: 'indication',
  );
  ...
  static final ClinicalUseDefinitionType undesirable_effect =
      ClinicalUseDefinitionType(
    fhirCode: 'undesirable-effect',
  );

  /// warning
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ClinicalUseDefinitionType warning = ClinicalUseDefinitionType(
    fhirCode: 'warning',
  );
