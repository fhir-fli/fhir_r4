...
String toJson() => toString();
  ListEmptyReasons fromString(String str) {
    switch(str) {
      case 'nilknown': return ListEmptyReasons.nilknown;
      case 'notasked': return ListEmptyReasons.notasked;
      case 'withheld': return ListEmptyReasons.withheld;
      case 'unavailable': return ListEmptyReasons.unavailable;
      case 'notstarted': return ListEmptyReasons.notstarted;
      case 'closed': return ListEmptyReasons.closed;
