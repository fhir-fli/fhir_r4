...
@override
  String toString() {
      switch(this) {
        case std_MA: return 'std-MA';
        case IPD_MA: return 'IPD-MA';
        case indirect_NMA: return 'indirect-NMA';
        case combined_NMA: return 'combined-NMA';
...
String toJson() => toString();
  SynthesisType fromString(String str) {
    switch(str) {
      case 'std-MA': return SynthesisType.std_MA;
      case 'IPD-MA': return SynthesisType.IPD_MA;
      case 'indirect-NMA': return SynthesisType.indirect_NMA;
      case 'combined-NMA': return SynthesisType.combined_NMA;
      case 'range': return SynthesisType.range;
      case 'classification': return SynthesisType.classification;
      case 'NotApplicable': return SynthesisType.NotApplicable;
