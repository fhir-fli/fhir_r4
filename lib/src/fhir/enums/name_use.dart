...
String toJson() => toString();
  NameUse fromString(String str) {
    switch(str) {
      case 'usual': return NameUse.usual;
      case 'official': return NameUse.official;
      case 'temp': return NameUse.temp;
      case 'nickname': return NameUse.nickname;
      case 'anonymous': return NameUse.anonymous;
      case 'old': return NameUse.old;
