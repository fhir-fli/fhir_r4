...
String toJson() => toString();
  AdjudicationValueCodes fromString(String str) {
    switch(str) {
      case 'submitted': return AdjudicationValueCodes.submitted;
      case 'copay': return AdjudicationValueCodes.copay;
      case 'eligible': return AdjudicationValueCodes.eligible;
      case 'deductible': return AdjudicationValueCodes.deductible;
      case 'unallocdeduct': return AdjudicationValueCodes.unallocdeduct;
      case 'eligpercent': return AdjudicationValueCodes.eligpercent;
      case 'tax': return AdjudicationValueCodes.tax;
      case 'benefit': return AdjudicationValueCodes.benefit;
