...
enum AdjudicationValueCodes {
  ...
  /// Returns a [String] from a [AdjudicationValueCodes] enum.
  String toJson() => toString();

  /// Returns a [AdjudicationValueCodes] from a [String] enum.
  ...
  /// Returns a [AdjudicationValueCodes] from a json [String] (although it will accept any dynamic and throw an error if it is not a String due to requirements for serializing/deserializing
