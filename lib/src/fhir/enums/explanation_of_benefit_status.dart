...
String toJson() => toString();
  ExplanationOfBenefitStatus fromString(String str) {
    switch(str) {
      case 'active': return ExplanationOfBenefitStatus.active;
      case 'cancelled': return ExplanationOfBenefitStatus.cancelled;
      case 'draft': return ExplanationOfBenefitStatus.draft;
      case 'entered-in-error': return ExplanationOfBenefitStatus.entered_in_error;
