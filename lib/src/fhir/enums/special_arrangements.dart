...
class SpecialArrangements {
  ...
  SpecialArrangements({this.fhirCode, this.element})
      : assert(
  ...
  static final SpecialArrangements wheel = SpecialArrangements(
    fhirCode: 'wheel',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final SpecialArrangements add_bed = SpecialArrangements(
    fhirCode: 'add-bed',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final SpecialArrangements int_ = SpecialArrangements(
    fhirCode: 'int',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final SpecialArrangements att = SpecialArrangements(
    fhirCode: 'att',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final SpecialArrangements dog = SpecialArrangements(
    fhirCode: 'dog',
  );

  /// For instances where an Element is present but not value

  static final SpecialArrangements elementOnly = SpecialArrangements();
