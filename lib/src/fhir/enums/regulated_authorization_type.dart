...
@override
  String toString() {
      switch(this) {
        case MarketingAuth: return 'MarketingAuth';
...
String toJson() => toString();
  RegulatedAuthorizationType fromString(String str) {
    switch(str) {
      case 'MarketingAuth': return RegulatedAuthorizationType.MarketingAuth;
      case 'Orphan': return RegulatedAuthorizationType.Orphan;
      case 'Pediatric': return RegulatedAuthorizationType.Pediatric;
