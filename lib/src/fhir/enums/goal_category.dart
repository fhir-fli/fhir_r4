...
String toJson() => toString();
  GoalCategory fromString(String str) {
    switch(str) {
      case 'dietary': return GoalCategory.dietary;
      case 'safety': return GoalCategory.safety;
      case 'behavioral': return GoalCategory.behavioral;
      case 'nursing': return GoalCategory.nursing;
      case 'physiotherapy': return GoalCategory.physiotherapy;
