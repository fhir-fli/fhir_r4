...
String toJson() => toString();
  EpisodeOfCareType fromString(String str) {
    switch(str) {
      case 'hacc': return EpisodeOfCareType.hacc;
      case 'pac': return EpisodeOfCareType.pac;
      case 'diab': return EpisodeOfCareType.diab;
      case 'da': return EpisodeOfCareType.da;
      case 'cacp': return EpisodeOfCareType.cacp;
