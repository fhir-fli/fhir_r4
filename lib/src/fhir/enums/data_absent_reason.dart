...
String toJson() => toString();
  DataAbsentReason fromString(String str) {
    switch(str) {
      case 'unknown': return DataAbsentReason.unknown;
      case 'masked': return DataAbsentReason.masked;
      case 'not-applicable': return DataAbsentReason.not_applicable;
      case 'unsupported': return DataAbsentReason.unsupported;
      case 'as-text': return DataAbsentReason.as_text;
      case 'error': return DataAbsentReason.error;
      case 'not-performed': return DataAbsentReason.not_performed;
      case 'not-permitted': return DataAbsentReason.not_permitted;
