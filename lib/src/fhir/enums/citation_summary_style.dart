...
@override
  String toString() {
      switch(this) {
        ...
        case ama11: return 'ama11';
        case apa7: return 'apa7';
        case apa6: return 'apa6';
        case asa6: return 'asa6';
        case mla8: return 'mla8';
        case cochrane: return 'cochrane';
        case elsevier_harvard: return 'elsevier-harvard';
        case nature: return 'nature';
        case acs: return 'acs';
        case chicago_a_17: return 'chicago-a-17';
        case chicago_b_17: return 'chicago-b-17';
        case ieee: return 'ieee';
        case comppub: return 'comppub';
      }
      }
String toJson() => toString();
  CitationSummaryStyle fromString(String str) {
    switch(str) {
      case 'vancouver': return CitationSummaryStyle.vancouver;
      case 'ama11': return CitationSummaryStyle.ama11;
      case 'apa7': return CitationSummaryStyle.apa7;
      case 'apa6': return CitationSummaryStyle.apa6;
      case 'asa6': return CitationSummaryStyle.asa6;
      case 'mla8': return CitationSummaryStyle.mla8;
      case 'cochrane': return CitationSummaryStyle.cochrane;
      case 'elsevier-harvard': return CitationSummaryStyle.elsevier_harvard;
      case 'nature': return CitationSummaryStyle.nature;
      case 'acs': return CitationSummaryStyle.acs;
      case 'chicago-a-17': return CitationSummaryStyle.chicago_a_17;
      case 'chicago-b-17': return CitationSummaryStyle.chicago_b_17;
      case 'ieee': return CitationSummaryStyle.ieee;
      case 'comppub': return CitationSummaryStyle.comppub;
