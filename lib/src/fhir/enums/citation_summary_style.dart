...
enum CitationSummaryStyle {
  ...
  /// Returns a [String] from a [CitationSummaryStyle] enum.
  String toJson() => toString();

  /// Returns a [CitationSummaryStyle] from a [String] enum.
  ...
  /// Returns a [CitationSummaryStyle] from a json [String] (although it will accept any dynamic and throw an error if it is not a String due to requirements for serializing/deserializing
