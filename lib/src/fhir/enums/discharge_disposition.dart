...
enum DischargeDisposition {
  ...
  static DischargeDisposition fromString(String str) {
    switch (str) {
      ...
      case 'alt-home':
        return DischargeDisposition.alt_home;
      case 'other-hcf':
        return DischargeDisposition.other_hcf;
      case 'hosp':
        return DischargeDisposition.hosp;
      case 'long':
        return DischargeDisposition.long;
      case 'aadvice':
        return DischargeDisposition.aadvice;
      case 'exp':
        return DischargeDisposition.exp;
      case 'psy':
        return DischargeDisposition.psy;
      case 'rehab':
        return DischargeDisposition.rehab;
      case 'snf':
        return DischargeDisposition.snf;
      case 'oth':
        return DischargeDisposition.oth;
      default:
