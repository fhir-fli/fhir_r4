...
String toJson() => toString();
  ProvenanceParticipantType fromString(String str) {
    switch(str) {
      case 'enterer': return ProvenanceParticipantType.enterer;
      case 'performer': return ProvenanceParticipantType.performer;
      case 'author': return ProvenanceParticipantType.author;
      case 'verifier': return ProvenanceParticipantType.verifier;
      case 'attester': return ProvenanceParticipantType.attester;
      case 'informant': return ProvenanceParticipantType.informant;
      case 'custodian': return ProvenanceParticipantType.custodian;
      case 'assembler': return ProvenanceParticipantType.assembler;
      case 'composer': return ProvenanceParticipantType.composer;
