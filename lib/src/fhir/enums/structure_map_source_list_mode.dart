...
@override
  String toString() {
      switch(this) {
        ...
        case not_first: return 'not_first';
        case last: return 'last';
        case not_last: return 'not_last';
        case only_one: return 'only_one';
      }
      }
String toJson() => toString();
  StructureMapSourceListMode fromString(String str) {
    switch(str) {
      case 'first': return StructureMapSourceListMode.first;
      case 'not_first': return StructureMapSourceListMode.not_first;
      case 'last': return StructureMapSourceListMode.last;
      case 'not_last': return StructureMapSourceListMode.not_last;
      case 'only_one': return StructureMapSourceListMode.only_one;
