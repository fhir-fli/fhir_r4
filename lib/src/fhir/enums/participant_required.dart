...
String toJson() => toString();
  ParticipantRequired fromString(String str) {
    switch(str) {
      case 'required': return ParticipantRequired.required_;
      case 'optional': return ParticipantRequired.optional;
      case 'information-only': return ParticipantRequired.information_only;
