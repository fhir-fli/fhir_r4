...
String toJson() => toString();
  MedicationrequestStatus fromString(String str) {
    switch(str) {
      case 'active': return MedicationrequestStatus.active;
      case 'on-hold': return MedicationrequestStatus.on_hold;
      case 'cancelled': return MedicationrequestStatus.cancelled;
      case 'completed': return MedicationrequestStatus.completed;
      case 'entered-in-error': return MedicationrequestStatus.entered_in_error;
      case 'stopped': return MedicationrequestStatus.stopped;
      case 'draft': return MedicationrequestStatus.draft;
      case 'unknown': return MedicationrequestStatus.unknown;
    default: throw ArgumentError('Unknown enum value: $str');
    }
      }
 MedicationrequestStatus fromJson(dynamic jsonValue) {
