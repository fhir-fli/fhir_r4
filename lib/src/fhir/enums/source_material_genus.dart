...
enum SourceMaterialGenus {
  ...
  /// Converts a list of JSON values to a list of [SourceMaterialGenus] instances.
  static SourceMaterialGenus fromJson(
    ...
    if (value == null && element != null) {
      return SourceMaterialGenus.elementOnly.withElement(
        element,
      );
    }
