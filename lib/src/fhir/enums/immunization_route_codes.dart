...
String toJson() => toString();
  ImmunizationRouteCodes fromString(String str) {
    switch(str) {
      case 'IDINJ': return ImmunizationRouteCodes.IDINJ;
      case 'IM': return ImmunizationRouteCodes.IM;
      case 'NASINHLC': return ImmunizationRouteCodes.NASINHLC;
      case 'IVINJ': return ImmunizationRouteCodes.IVINJ;
      case 'PO': return ImmunizationRouteCodes.PO;
      case 'SQ': return ImmunizationRouteCodes.SQ;
      case 'TRNSDERM': return ImmunizationRouteCodes.TRNSDERM;
