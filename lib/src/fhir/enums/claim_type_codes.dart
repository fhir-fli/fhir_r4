...
String toJson() => toString();
  ClaimTypeCodes fromString(String str) {
    switch(str) {
      case 'institutional': return ClaimTypeCodes.institutional;
      case 'oral': return ClaimTypeCodes.oral;
      case 'pharmacy': return ClaimTypeCodes.pharmacy;
      case 'professional': return ClaimTypeCodes.professional;
      case 'vision': return ClaimTypeCodes.vision;
