...
@override
  String toString() {
      switch(this) {
        case FHIR_Server: return 'FHIR-Server';
        case FHIR_SDC_FormManager: return 'FHIR-SDC-FormManager';
        case FHIR_SDC_FormProcessor: return 'FHIR-SDC-FormProcessor';
        case FHIR_SDC_FormReceiver: return 'FHIR-SDC-FormReceiver';
      }
      }
String toJson() => toString();
  TestScriptProfileDestinationType fromString(String str) {
    switch(str) {
      case 'FHIR-Server': return TestScriptProfileDestinationType.FHIR_Server;
      case 'FHIR-SDC-FormManager': return TestScriptProfileDestinationType.FHIR_SDC_FormManager;
      case 'FHIR-SDC-FormProcessor': return TestScriptProfileDestinationType.FHIR_SDC_FormProcessor;
      case 'FHIR-SDC-FormReceiver': return TestScriptProfileDestinationType.FHIR_SDC_FormReceiver;
