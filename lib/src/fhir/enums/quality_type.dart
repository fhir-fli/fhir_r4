...
class QualityType {
  ...
  QualityType({this.fhirCode, this.element})
      : assert(
  ...
  static final QualityType indel = QualityType(
    fhirCode: 'indel',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final QualityType snp = QualityType(
    fhirCode: 'snp',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final QualityType unknown = QualityType(
    fhirCode: 'unknown',
  );

  /// For instances where an Element is present but not value

  static final QualityType elementOnly = QualityType();
