...
class PaymentStatusCodes {
  ...
  PaymentStatusCodes({this.fhirCode, this.element})
      : assert(
  ...
  static final PaymentStatusCodes paid = PaymentStatusCodes(
    fhirCode: 'paid',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final PaymentStatusCodes cleared = PaymentStatusCodes(
    fhirCode: 'cleared',
  );

  /// For instances where an Element is present but not value

  static final PaymentStatusCodes elementOnly = PaymentStatusCodes();
