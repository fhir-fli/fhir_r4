...
String toJson() => toString();
  CarePlanActivityStatus fromString(String str) {
    switch(str) {
      case 'not-started': return CarePlanActivityStatus.not_started;
      case 'scheduled': return CarePlanActivityStatus.scheduled;
      case 'in-progress': return CarePlanActivityStatus.in_progress;
      case 'on-hold': return CarePlanActivityStatus.on_hold;
      case 'completed': return CarePlanActivityStatus.completed;
      case 'cancelled': return CarePlanActivityStatus.cancelled;
      case 'unknown': return CarePlanActivityStatus.unknown;
      case 'entered-in-error': return CarePlanActivityStatus.entered_in_error;
