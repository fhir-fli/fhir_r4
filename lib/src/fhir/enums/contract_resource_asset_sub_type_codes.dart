...
enum ContractResourceAssetSubTypeCodes {
  ...
  /// Converts a list of JSON values to a list of [ContractResourceAssetSubTypeCodes] instances.
  static ContractResourceAssetSubTypeCodes fromJson(
    ...
    if (value == null && element != null) {
      return ContractResourceAssetSubTypeCodes.elementOnly.withElement(
        element,
      );
    }
