...
String toJson() => toString();
  ClaimInformationCategoryCodes fromString(String str) {
    switch(str) {
      case 'info': return ClaimInformationCategoryCodes.info;
      case 'discharge': return ClaimInformationCategoryCodes.discharge;
      case 'onset': return ClaimInformationCategoryCodes.onset;
      case 'related': return ClaimInformationCategoryCodes.related;
      case 'exception': return ClaimInformationCategoryCodes.exception;
      case 'material': return ClaimInformationCategoryCodes.material;
      case 'attachment': return ClaimInformationCategoryCodes.attachment;
      case 'missingtooth': return ClaimInformationCategoryCodes.missingtooth;
      case 'prosthesis': return ClaimInformationCategoryCodes.prosthesis;
      case 'other': return ClaimInformationCategoryCodes.other;
      case 'hospitalized': return ClaimInformationCategoryCodes.hospitalized;
      case 'employmentimpacted': return ClaimInformationCategoryCodes.employmentimpacted;
      case 'externalcause': return ClaimInformationCategoryCodes.externalcause;
      case 'patientreasonforvisit': return ClaimInformationCategoryCodes.patientreasonforvisit;
