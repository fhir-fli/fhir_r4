...
enum EventStatus {
  ...
  /// Returns a [String] from a [EventStatus] enum.
  String toJson() => toString();

  /// Returns a [EventStatus] from a [String] enum.
  ...
  /// Returns a [EventStatus] from a json [String] (although it will accept any dynamic and throw an error if it is not a String due to requirements for serializing/deserializing
