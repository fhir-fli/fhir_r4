...
String toJson() => toString();
  FHIRDefinedType fromString(String str) {
    switch(str) {
      case 'Address': return FHIRDefinedType.Address;
      case 'Age': return FHIRDefinedType.Age;
      case 'Annotation': return FHIRDefinedType.Annotation;
      case 'Attachment': return FHIRDefinedType.Attachment;
      case 'BackboneElement': return FHIRDefinedType.BackboneElement;
      case 'CodeableConcept': return FHIRDefinedType.CodeableConcept;
      case 'CodeableReference': return FHIRDefinedType.CodeableReference;
      case 'Coding': return FHIRDefinedType.Coding;
      case 'ContactDetail': return FHIRDefinedType.ContactDetail;
      case 'ContactPoint': return FHIRDefinedType.ContactPoint;
      case 'Contributor': return FHIRDefinedType.Contributor;
      case 'Count': return FHIRDefinedType.Count;
      case 'DataRequirement': return FHIRDefinedType.DataRequirement;
      case 'Distance': return FHIRDefinedType.Distance;
      case 'Dosage': return FHIRDefinedType.Dosage;
      case 'Duration': return FHIRDefinedType.Duration;
      case 'Element': return FHIRDefinedType.Element;
      case 'ElementDefinition': return FHIRDefinedType.ElementDefinition;
      case 'Expression': return FHIRDefinedType.Expression;
      case 'Extension': return FHIRDefinedType.Extension;
      case 'HumanName': return FHIRDefinedType.HumanName;
      case 'Identifier': return FHIRDefinedType.Identifier;
      case 'MarketingStatus': return FHIRDefinedType.MarketingStatus;
      case 'Meta': return FHIRDefinedType.Meta;
      case 'Money': return FHIRDefinedType.Money;
      case 'MoneyQuantity': return FHIRDefinedType.MoneyQuantity;
      case 'Narrative': return FHIRDefinedType.Narrative;
      case 'ParameterDefinition': return FHIRDefinedType.ParameterDefinition;
      case 'Period': return FHIRDefinedType.Period;
      case 'Population': return FHIRDefinedType.Population;
      case 'ProdCharacteristic': return FHIRDefinedType.ProdCharacteristic;
      case 'ProductShelfLife': return FHIRDefinedType.ProductShelfLife;
      case 'Quantity': return FHIRDefinedType.Quantity;
      case 'Range': return FHIRDefinedType.Range;
      case 'Ratio': return FHIRDefinedType.Ratio;
      case 'RatioRange': return FHIRDefinedType.RatioRange;
      case 'Reference': return FHIRDefinedType.Reference;
      case 'RelatedArtifact': return FHIRDefinedType.RelatedArtifact;
      case 'SampledData': return FHIRDefinedType.SampledData;
      case 'Signature': return FHIRDefinedType.Signature;
      case 'SimpleQuantity': return FHIRDefinedType.SimpleQuantity;
      case 'Timing': return FHIRDefinedType.Timing;
      case 'TriggerDefinition': return FHIRDefinedType.TriggerDefinition;
      case 'UsageContext': return FHIRDefinedType.UsageContext;
      case 'base64Binary': return FHIRDefinedType.base64Binary;
      case 'boolean': return FHIRDefinedType.boolean;
      case 'canonical': return FHIRDefinedType.canonical;
      case 'code': return FHIRDefinedType.code;
      case 'date': return FHIRDefinedType.date;
      case 'dateTime': return FHIRDefinedType.dateTime;
      case 'decimal': return FHIRDefinedType.decimal;
      case 'id': return FHIRDefinedType.id;
      case 'instant': return FHIRDefinedType.instant;
      case 'integer': return FHIRDefinedType.integer;
      case 'markdown': return FHIRDefinedType.markdown;
      case 'oid': return FHIRDefinedType.oid;
      case 'positiveInt': return FHIRDefinedType.positiveInt;
      case 'string': return FHIRDefinedType.string;
      case 'time': return FHIRDefinedType.time;
      case 'unsignedInt': return FHIRDefinedType.unsignedInt;
      case 'uri': return FHIRDefinedType.uri;
      case 'url': return FHIRDefinedType.url;
      case 'uuid': return FHIRDefinedType.uuid;
      case 'xhtml': return FHIRDefinedType.xhtml;
      case 'Resource': return FHIRDefinedType.Resource;
    default: throw ArgumentError('Unknown enum value: $str');
    }
      }
 FHIRDefinedType fromJson(dynamic jsonValue) {
