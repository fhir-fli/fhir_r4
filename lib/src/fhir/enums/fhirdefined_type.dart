...
enum FHIRDefinedType {
  ...
  const FHIRDefinedType(this.fhirCode, [this.element]);
  ...
  /// Converts a list of JSON values to a list of [FHIRDefinedType] instances.
  static FHIRDefinedType fromJson(
    ...
    if (value == null && element != null) {
      return FHIRDefinedType.elementOnly.withElement(
        element,
      );
    }
  ...
  FHIRDefinedType withElement(Element? newElement) {
    return FHIRDefinedType.fromJson({
      'value': fhirCode,
