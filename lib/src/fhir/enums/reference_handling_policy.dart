...
String toJson() => toString();
  ReferenceHandlingPolicy fromString(String str) {
    switch(str) {
      case 'literal': return ReferenceHandlingPolicy.literal;
      case 'logical': return ReferenceHandlingPolicy.logical;
      case 'resolves': return ReferenceHandlingPolicy.resolves;
      case 'enforced': return ReferenceHandlingPolicy.enforced;
      case 'local': return ReferenceHandlingPolicy.local;
    default: throw ArgumentError('Unknown enum value: $str');
    }
      }
 ReferenceHandlingPolicy fromJson(dynamic jsonValue) {
