...
class ReferenceHandlingPolicy {
  ...
  ReferenceHandlingPolicy({this.fhirCode, this.element})
      : assert(
  ...
  static final ReferenceHandlingPolicy literal = ReferenceHandlingPolicy(
    fhirCode: 'literal',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ReferenceHandlingPolicy logical = ReferenceHandlingPolicy(
    fhirCode: 'logical',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ReferenceHandlingPolicy resolves = ReferenceHandlingPolicy(
    fhirCode: 'resolves',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ReferenceHandlingPolicy enforced = ReferenceHandlingPolicy(
    fhirCode: 'enforced',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ReferenceHandlingPolicy local = ReferenceHandlingPolicy(
    fhirCode: 'local',
  );

  /// For instances where an Element is present but not value

  static final ReferenceHandlingPolicy elementOnly = ReferenceHandlingPolicy();
