...
String toJson() => toString();
  StructureMapTargetListMode fromString(String str) {
    switch(str) {
      case 'first': return StructureMapTargetListMode.first;
      case 'share': return StructureMapTargetListMode.share;
      case 'last': return StructureMapTargetListMode.last;
      case 'collate': return StructureMapTargetListMode.collate;
