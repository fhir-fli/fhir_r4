...
String toJson() => toString();
  GoalPriority fromString(String str) {
    switch(str) {
      case 'high-priority': return GoalPriority.high_priority;
      case 'medium-priority': return GoalPriority.medium_priority;
      case 'low-priority': return GoalPriority.low_priority;
