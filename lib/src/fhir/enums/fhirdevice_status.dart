...
String toJson() => toString();
  FHIRDeviceStatus fromString(String str) {
    switch(str) {
      case 'active': return FHIRDeviceStatus.active;
      case 'inactive': return FHIRDeviceStatus.inactive;
      case 'entered-in-error': return FHIRDeviceStatus.entered_in_error;
      case 'unknown': return FHIRDeviceStatus.unknown;
