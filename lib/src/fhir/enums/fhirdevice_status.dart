...
class FHIRDeviceStatus {
  ...
  FHIRDeviceStatus({this.fhirCode, this.element})
      : assert(
  ...
  static final FHIRDeviceStatus active = FHIRDeviceStatus(
    fhirCode: 'active',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final FHIRDeviceStatus inactive = FHIRDeviceStatus(
    fhirCode: 'inactive',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final FHIRDeviceStatus entered_in_error = FHIRDeviceStatus(
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final FHIRDeviceStatus unknown = FHIRDeviceStatus(
    fhirCode: 'unknown',
  );

  /// For instances where an Element is present but not value

  static final FHIRDeviceStatus elementOnly = FHIRDeviceStatus();
