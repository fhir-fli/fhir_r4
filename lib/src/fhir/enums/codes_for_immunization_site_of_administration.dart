...
@Entity()
class CodesForImmunizationSiteOfAdministration extends FhirCode {
  ...
  factory CodesForImmunizationSiteOfAdministration.fromJson(
    ...
    if (value == null && element != null) {
      return CodesForImmunizationSiteOfAdministration.elementOnly(element);
    }
    if (values.contains(value)) {
      return CodesForImmunizationSiteOfAdministration._(value, element);
    }
    throw ArgumentError(
      'CodesForImmunizationSiteOfAdministration.fromJson: JSON value is not a valid value',
    );
  }
  ...
  CodesForImmunizationSiteOfAdministration.LA([this.element])
      : dbValue = 'LA',
        super('LA', element);
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  CodesForImmunizationSiteOfAdministration.RA([this.element])
      : dbValue = 'RA',
        super('RA', element);

  /// For instances where an Element is present but not value

  CodesForImmunizationSiteOfAdministration.elementOnly(this.element)
      : dbValue = null,
        super(null, element);

  /// Private constructor for internal use (like enum)
  CodesForImmunizationSiteOfAdministration._(super.input, [super.element])
      : dbValue = input,
  ...
  @override
  String toString() => 'CodesForImmunizationSiteOfAdministration.$value';
}
