  ...
  ActionCode fromString(String str) {
    switch (str) {
      ...
      case 'collect-information':
        return ActionCode.collect_information;
      case 'prescribe-medication':
        return ActionCode.prescribe_medication;
      case 'recommend-immunization':
        return ActionCode.recommend_immunization;
      case 'order-service':
        return ActionCode.order_service;
      case 'propose-diagnosis':
        return ActionCode.propose_diagnosis;
      case 'record-detected-issue':
        return ActionCode.record_detected_issue;
      case 'record-inference':
        return ActionCode.record_inference;
      case 'report-flag':
        return ActionCode.report_flag;
      default:
