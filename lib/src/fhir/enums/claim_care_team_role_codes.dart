...
String toJson() => toString();
  ClaimCareTeamRoleCodes fromString(String str) {
    switch(str) {
      case 'primary': return ClaimCareTeamRoleCodes.primary;
      case 'assist': return ClaimCareTeamRoleCodes.assist;
      case 'supervisor': return ClaimCareTeamRoleCodes.supervisor;
      case 'other': return ClaimCareTeamRoleCodes.other;
