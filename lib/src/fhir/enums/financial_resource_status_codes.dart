...
String toJson() => toString();
  FinancialResourceStatusCodes fromString(String str) {
    switch(str) {
      case 'active': return FinancialResourceStatusCodes.active;
      case 'cancelled': return FinancialResourceStatusCodes.cancelled;
      case 'draft': return FinancialResourceStatusCodes.draft;
      case 'entered-in-error': return FinancialResourceStatusCodes.entered_in_error;
