...
class FinancialResourceStatusCodes extends PrimitiveType<String> {
  ...
  @override
  FinancialResourceStatusCodes clone() =>
      FinancialResourceStatusCodes._(value, element?.clone() as Element?);

  /// Sets a property on the associated [Element], returning a new instance.
  @override
  FinancialResourceStatusCodes setElement(String name, dynamic elementValue) {
