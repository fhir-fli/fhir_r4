...
String toJson() => toString();
  ImagingStudyStatus fromString(String str) {
    switch(str) {
      case 'registered': return ImagingStudyStatus.registered;
      case 'available': return ImagingStudyStatus.available;
      case 'cancelled': return ImagingStudyStatus.cancelled;
      case 'entered-in-error': return ImagingStudyStatus.entered_in_error;
      case 'unknown': return ImagingStudyStatus.unknown;
