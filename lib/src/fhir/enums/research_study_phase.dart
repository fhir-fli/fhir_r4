...
enum ResearchStudyPhase {
  ...
  String toString() {
    switch (this) {
      ...
      case phase_1:
        return 'phase-1';
      case phase_1_phase_2:
        return 'phase-1-phase-2';
      case phase_2:
        return 'phase-2';
      case phase_2_phase_3:
  ...
  /// Returns a [String] from a [ResearchStudyPhase] enum.
  String toJson() => toString();

  /// Returns a [ResearchStudyPhase] from a [String] enum.
  static ResearchStudyPhase fromString(String str) {
    switch (str) {
      case 'n-a':
        return ResearchStudyPhase.n_a;
      case 'early-phase-1':
        return ResearchStudyPhase.early_phase_1;
      case 'phase-1':
        return ResearchStudyPhase.phase_1;
      case 'phase-1-phase-2':
        return ResearchStudyPhase.phase_1_phase_2;
      case 'phase-2':
        return ResearchStudyPhase.phase_2;
      case 'phase-2-phase-3':
        return ResearchStudyPhase.phase_2_phase_3;
      case 'phase-3':
        return ResearchStudyPhase.phase_3;
      case 'phase-4':
        return ResearchStudyPhase.phase_4;
      default:
        throw ArgumentError('Unknown enum value: $str');
    }
  }

  /// Returns a [ResearchStudyPhase] from a json [String] (although it will accept any dynamic and throw an error if it is not a String due to requirements for serializing/deserializing
  static ResearchStudyPhase fromJson(dynamic jsonValue) {
