...
class ConsentScopeCodes extends PrimitiveType<String> {
  ...
  ConsentScopeCodes._(super.value, [super.element]);
  ...
  @override
  ConsentScopeCodes clone() =>
      ConsentScopeCodes._(value, element?.clone() as Element?);

  /// Sets a property on the associated [Element], returning a new instance.
  @override
  ConsentScopeCodes setElement(String name, dynamic elementValue) {
