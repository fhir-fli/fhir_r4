...
@override
  String toString() {
      switch(this) {
        ...
        case patient_privacy: return 'patient-privacy';
...
String toJson() => toString();
  ConsentScopeCodes fromString(String str) {
    switch(str) {
      case 'adr': return ConsentScopeCodes.adr;
      case 'research': return ConsentScopeCodes.research;
      case 'patient-privacy': return ConsentScopeCodes.patient_privacy;
      case 'treatment': return ConsentScopeCodes.treatment;
