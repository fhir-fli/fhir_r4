...
@override
  String toString() {
      switch(this) {
        case value261023001: return '261023001';
        case value260998006: return '260998006';
      }
      }
String toJson() => toString();
  ConditionStageType fromString(String str) {
    switch(str) {
      case '261023001': return ConditionStageType.value261023001;
      case '260998006': return ConditionStageType.value260998006;
