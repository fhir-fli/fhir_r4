...
String toJson() => toString();
  FHIRAllTypes fromString(String str) {
    switch(str) {
      case 'Address': return FHIRAllTypes.Address;
      case 'Age': return FHIRAllTypes.Age;
      case 'Annotation': return FHIRAllTypes.Annotation;
      case 'Attachment': return FHIRAllTypes.Attachment;
      case 'BackboneElement': return FHIRAllTypes.BackboneElement;
      case 'CodeableConcept': return FHIRAllTypes.CodeableConcept;
      case 'CodeableReference': return FHIRAllTypes.CodeableReference;
      case 'Coding': return FHIRAllTypes.Coding;
      case 'ContactDetail': return FHIRAllTypes.ContactDetail;
      case 'ContactPoint': return FHIRAllTypes.ContactPoint;
      case 'Contributor': return FHIRAllTypes.Contributor;
      case 'Count': return FHIRAllTypes.Count;
      case 'DataRequirement': return FHIRAllTypes.DataRequirement;
      case 'Distance': return FHIRAllTypes.Distance;
      case 'Dosage': return FHIRAllTypes.Dosage;
      case 'Duration': return FHIRAllTypes.Duration;
      case 'Element': return FHIRAllTypes.Element;
      case 'ElementDefinition': return FHIRAllTypes.ElementDefinition;
      case 'Expression': return FHIRAllTypes.Expression;
      case 'Extension': return FHIRAllTypes.Extension;
      case 'HumanName': return FHIRAllTypes.HumanName;
      case 'Identifier': return FHIRAllTypes.Identifier;
      case 'MarketingStatus': return FHIRAllTypes.MarketingStatus;
      case 'Meta': return FHIRAllTypes.Meta;
      case 'Money': return FHIRAllTypes.Money;
      case 'MoneyQuantity': return FHIRAllTypes.MoneyQuantity;
      case 'Narrative': return FHIRAllTypes.Narrative;
      case 'ParameterDefinition': return FHIRAllTypes.ParameterDefinition;
      case 'Period': return FHIRAllTypes.Period;
      case 'Population': return FHIRAllTypes.Population;
      case 'ProdCharacteristic': return FHIRAllTypes.ProdCharacteristic;
      case 'ProductShelfLife': return FHIRAllTypes.ProductShelfLife;
      case 'Quantity': return FHIRAllTypes.Quantity;
      case 'Range': return FHIRAllTypes.Range;
      case 'Ratio': return FHIRAllTypes.Ratio;
      case 'RatioRange': return FHIRAllTypes.RatioRange;
      case 'Reference': return FHIRAllTypes.Reference;
      case 'RelatedArtifact': return FHIRAllTypes.RelatedArtifact;
      case 'SampledData': return FHIRAllTypes.SampledData;
      case 'Signature': return FHIRAllTypes.Signature;
      case 'SimpleQuantity': return FHIRAllTypes.SimpleQuantity;
      case 'Timing': return FHIRAllTypes.Timing;
      case 'TriggerDefinition': return FHIRAllTypes.TriggerDefinition;
      case 'UsageContext': return FHIRAllTypes.UsageContext;
      case 'base64Binary': return FHIRAllTypes.base64Binary;
      case 'boolean': return FHIRAllTypes.boolean;
      case 'canonical': return FHIRAllTypes.canonical;
      case 'code': return FHIRAllTypes.code;
      case 'date': return FHIRAllTypes.date;
      case 'dateTime': return FHIRAllTypes.dateTime;
      case 'decimal': return FHIRAllTypes.decimal;
      case 'id': return FHIRAllTypes.id;
      case 'instant': return FHIRAllTypes.instant;
      case 'integer': return FHIRAllTypes.integer;
      case 'markdown': return FHIRAllTypes.markdown;
      case 'oid': return FHIRAllTypes.oid;
      case 'positiveInt': return FHIRAllTypes.positiveInt;
      case 'string': return FHIRAllTypes.string;
      case 'time': return FHIRAllTypes.time;
      case 'unsignedInt': return FHIRAllTypes.unsignedInt;
      case 'uri': return FHIRAllTypes.uri;
      case 'url': return FHIRAllTypes.url;
      case 'uuid': return FHIRAllTypes.uuid;
      case 'xhtml': return FHIRAllTypes.xhtml;
      case 'Resource': return FHIRAllTypes.Resource;
      case 'Type': return FHIRAllTypes.Type;
      case 'Any': return FHIRAllTypes.Any;
