...
enum FHIRAllTypes {
  ...
  /// Returns a [String] from a [FHIRAllTypes] enum.
  String toJson() => toString();

  /// Returns a [FHIRAllTypes] from a [String] enum.
  ...
  /// Returns a [FHIRAllTypes] from a json [String] (although it will accept any dynamic and throw an error if it is not a String due to requirements for serializing/deserializing
