...
enum FHIRAllTypes {
  ...
  const FHIRAllTypes(this.fhirCode, [this.element]);
  ...
  /// Converts a list of JSON values to a list of [FHIRAllTypes] instances.
  static FHIRAllTypes fromJson(
