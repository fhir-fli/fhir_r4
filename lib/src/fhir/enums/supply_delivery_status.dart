...
String toJson() => toString();
  SupplyDeliveryStatus fromString(String str) {
    switch(str) {
      case 'in-progress': return SupplyDeliveryStatus.in_progress;
      case 'completed': return SupplyDeliveryStatus.completed;
      case 'abandoned': return SupplyDeliveryStatus.abandoned;
      case 'entered-in-error': return SupplyDeliveryStatus.entered_in_error;
