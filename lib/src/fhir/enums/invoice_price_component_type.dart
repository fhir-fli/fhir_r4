...
String toJson() => toString();
  InvoicePriceComponentType fromString(String str) {
    switch(str) {
      case 'base': return InvoicePriceComponentType.base;
      case 'surcharge': return InvoicePriceComponentType.surcharge;
      case 'deduction': return InvoicePriceComponentType.deduction;
      case 'discount': return InvoicePriceComponentType.discount;
      case 'tax': return InvoicePriceComponentType.tax;
      case 'informational': return InvoicePriceComponentType.informational;
