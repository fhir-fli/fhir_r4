...
String toJson() => toString();
  ProvenanceParticipantRole fromString(String str) {
    switch(str) {
      case 'enterer': return ProvenanceParticipantRole.enterer;
      case 'performer': return ProvenanceParticipantRole.performer;
      case 'author': return ProvenanceParticipantRole.author;
      case 'verifier': return ProvenanceParticipantRole.verifier;
      case 'attester': return ProvenanceParticipantRole.attester;
      case 'informant': return ProvenanceParticipantRole.informant;
      case 'custodian': return ProvenanceParticipantRole.custodian;
      case 'assembler': return ProvenanceParticipantRole.assembler;
      case 'composer': return ProvenanceParticipantRole.composer;
