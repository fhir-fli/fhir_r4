...
@override
  String toString() {
      switch(this) {
        case before_start: return 'before-start';
        case before: return 'before';
        case before_end: return 'before-end';
        case concurrent_with_start: return 'concurrent-with-start';
        case concurrent: return 'concurrent';
        case concurrent_with_end: return 'concurrent-with-end';
        case after_start: return 'after-start';
        case after: return 'after';
        case after_end: return 'after-end';
      }
      }
String toJson() => toString();
  ActionRelationshipType fromString(String str) {
    switch(str) {
      case 'before-start': return ActionRelationshipType.before_start;
      case 'before': return ActionRelationshipType.before;
      case 'before-end': return ActionRelationshipType.before_end;
      case 'concurrent-with-start': return ActionRelationshipType.concurrent_with_start;
      case 'concurrent': return ActionRelationshipType.concurrent;
      case 'concurrent-with-end': return ActionRelationshipType.concurrent_with_end;
      case 'after-start': return ActionRelationshipType.after_start;
      case 'after': return ActionRelationshipType.after;
      case 'after-end': return ActionRelationshipType.after_end;
