...
@override
  String toString() {
      switch(this) {
        ...
        case supportive_care: return 'supportive-care';
        case screening: return 'screening';
        case health_services_research: return 'health-services-research';
        case basic_science: return 'basic-science';
        case device_feasibility: return 'device-feasibility';
      }
      }
String toJson() => toString();
  ResearchStudyPrimaryPurposeType fromString(String str) {
    switch(str) {
      case 'treatment': return ResearchStudyPrimaryPurposeType.treatment;
      case 'prevention': return ResearchStudyPrimaryPurposeType.prevention;
      case 'diagnostic': return ResearchStudyPrimaryPurposeType.diagnostic;
      case 'supportive-care': return ResearchStudyPrimaryPurposeType.supportive_care;
      case 'screening': return ResearchStudyPrimaryPurposeType.screening;
      case 'health-services-research': return ResearchStudyPrimaryPurposeType.health_services_research;
      case 'basic-science': return ResearchStudyPrimaryPurposeType.basic_science;
      case 'device-feasibility': return ResearchStudyPrimaryPurposeType.device_feasibility;
