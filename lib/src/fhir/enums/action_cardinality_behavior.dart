...
class ActionCardinalityBehavior {
  ...
  ActionCardinalityBehavior({this.fhirCode, this.element})
      : assert(
  ...
  static final ActionCardinalityBehavior single = ActionCardinalityBehavior(
    fhirCode: 'single',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final ActionCardinalityBehavior multiple = ActionCardinalityBehavior(
    fhirCode: 'multiple',
  );
