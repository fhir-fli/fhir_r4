...
@override
  String toString() {
      switch(this) {
        case patient_care: return 'patient-care';
        case ward_stock: return 'ward-stock';
      }
      }
String toJson() => toString();
  SupplyRequestReason fromString(String str) {
    switch(str) {
      case 'patient-care': return SupplyRequestReason.patient_care;
      case 'ward-stock': return SupplyRequestReason.ward_stock;
