...
String toJson() => toString();
  RelatedArtifactType fromString(String str) {
    switch(str) {
      case 'documentation': return RelatedArtifactType.documentation;
      case 'justification': return RelatedArtifactType.justification;
      case 'citation': return RelatedArtifactType.citation;
      case 'predecessor': return RelatedArtifactType.predecessor;
      case 'successor': return RelatedArtifactType.successor;
      case 'derived-from': return RelatedArtifactType.derived_from;
      case 'depends-on': return RelatedArtifactType.depends_on;
      case 'composed-of': return RelatedArtifactType.composed_of;
