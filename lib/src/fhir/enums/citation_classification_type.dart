...
@override
  String toString() {
      switch(this) {
        case citation_source: return 'citation-source';
        case medline_owner: return 'medline-owner';
        case fevir_platform_use: return 'fevir-platform-use';
      }
      }
String toJson() => toString();
  CitationClassificationType fromString(String str) {
    switch(str) {
      case 'citation-source': return CitationClassificationType.citation_source;
      case 'medline-owner': return CitationClassificationType.medline_owner;
      case 'fevir-platform-use': return CitationClassificationType.fevir_platform_use;
