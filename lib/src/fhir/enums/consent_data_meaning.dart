...
String toJson() => toString();
  ConsentDataMeaning fromString(String str) {
    switch(str) {
      case 'instance': return ConsentDataMeaning.instance;
      case 'related': return ConsentDataMeaning.related;
      case 'dependents': return ConsentDataMeaning.dependents;
      case 'authoredby': return ConsentDataMeaning.authoredby;
