...
String toJson() => toString();
  ContactPointUse fromString(String str) {
    switch(str) {
      case 'home': return ContactPointUse.home;
      case 'work': return ContactPointUse.work;
      case 'temp': return ContactPointUse.temp;
      case 'old': return ContactPointUse.old;
      case 'mobile': return ContactPointUse.mobile;
