...
class MeasureStratifierExample extends PrimitiveType<String> {
  ...
  @override
  MeasureStratifierExample clone() =>
      MeasureStratifierExample._(value, element?.clone() as Element?);

  /// Sets a property on the associated [Element], returning a new instance.
  @override
  MeasureStratifierExample setElement(String name, dynamic elementValue) {
