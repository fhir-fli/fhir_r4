...
String toJson() => toString();
  ConditionVerificationStatus fromString(String str) {
    switch(str) {
      case 'unconfirmed': return ConditionVerificationStatus.unconfirmed;
      case 'confirmed': return ConditionVerificationStatus.confirmed;
      case 'refuted': return ConditionVerificationStatus.refuted;
      case 'entered-in-error': return ConditionVerificationStatus.entered_in_error;
