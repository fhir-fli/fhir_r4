...
String toJson() => toString();
  DiscriminatorType fromString(String str) {
    switch(str) {
      case 'value': return DiscriminatorType.value;
      case 'exists': return DiscriminatorType.exists;
      case 'pattern': return DiscriminatorType.pattern;
      case 'type': return DiscriminatorType.type;
      case 'profile': return DiscriminatorType.profile;
