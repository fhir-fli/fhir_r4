...
String toJson() => toString();
  DiagnosisRole fromString(String str) {
    switch(str) {
      case 'AD': return DiagnosisRole.AD;
      case 'DD': return DiagnosisRole.DD;
      case 'CC': return DiagnosisRole.CC;
      case 'CM': return DiagnosisRole.CM;
      case 'pre-op': return DiagnosisRole.pre_op;
      case 'post-op': return DiagnosisRole.post_op;
      case 'billing': return DiagnosisRole.billing;
