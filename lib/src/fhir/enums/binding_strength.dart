...
enum BindingStrength {
  ...
  /// Returns a [String] from a [BindingStrength] enum.
  String toJson() => toString();

  /// Returns a [BindingStrength] from a [String] enum.
  ...
  /// Returns a [BindingStrength] from a json [String] (although it will accept any dynamic and throw an error if it is not a String due to requirements for serializing/deserializing
