...
enum MedicationRequestStatusReasonCodes {
  ...
  /// Returns a [String] from a [MedicationRequestStatusReasonCodes] enum.
  String toJson() => toString();

  /// Returns a [MedicationRequestStatusReasonCodes] from a [String] enum.
  static MedicationRequestStatusReasonCodes fromString(String str) {
    switch (str) {
      case 'altchoice':
        return MedicationRequestStatusReasonCodes.altchoice;
      case 'clarif':
        return MedicationRequestStatusReasonCodes.clarif;
      case 'drughigh':
        return MedicationRequestStatusReasonCodes.drughigh;
      case 'hospadm':
        return MedicationRequestStatusReasonCodes.hospadm;
      case 'labint':
        return MedicationRequestStatusReasonCodes.labint;
      case 'non-avail':
        return MedicationRequestStatusReasonCodes.non_avail;
      case 'preg':
        return MedicationRequestStatusReasonCodes.preg;
      case 'salg':
        return MedicationRequestStatusReasonCodes.salg;
      case 'sddi':
        return MedicationRequestStatusReasonCodes.sddi;
      case 'sdupther':
        return MedicationRequestStatusReasonCodes.sdupther;
      case 'sintol':
        return MedicationRequestStatusReasonCodes.sintol;
      case 'surg':
        return MedicationRequestStatusReasonCodes.surg;
      case 'washout':
        return MedicationRequestStatusReasonCodes.washout;
      default:
        throw ArgumentError('Unknown enum value: $str');
    }
  }

  /// Returns a [MedicationRequestStatusReasonCodes] from a json [String] (although it will accept any dynamic and throw an error if it is not a String due to requirements for serializing/deserializing
  static MedicationRequestStatusReasonCodes fromJson(dynamic jsonValue) {
