...
String toJson() => toString();
  AuditEventAgentNetworkType fromString(String str) {
    switch(str) {
      case '1': return AuditEventAgentNetworkType.value1;
      case '2': return AuditEventAgentNetworkType.value2;
      case '3': return AuditEventAgentNetworkType.value3;
      case '4': return AuditEventAgentNetworkType.value4;
      case '5': return AuditEventAgentNetworkType.value5;
    default: throw ArgumentError('Unknown enum value: $str');
    }
      }
 AuditEventAgentNetworkType fromJson(dynamic jsonValue) {
