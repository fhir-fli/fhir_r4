...
@override
  String toString() {
      switch(this) {
        case auth_requirements: return 'auth-requirements';
...
String toJson() => toString();
  EligibilityRequestPurpose fromString(String str) {
    switch(str) {
      case 'auth-requirements': return EligibilityRequestPurpose.auth_requirements;
      case 'benefits': return EligibilityRequestPurpose.benefits;
      case 'discovery': return EligibilityRequestPurpose.discovery;
      case 'validation': return EligibilityRequestPurpose.validation;
    default: throw ArgumentError('Unknown enum value: $str');
    }
      }
 EligibilityRequestPurpose fromJson(dynamic jsonValue) {
