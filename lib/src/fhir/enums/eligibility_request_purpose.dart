...
class EligibilityRequestPurpose extends PrimitiveType<String> {
  ...
  @override
  EligibilityRequestPurpose clone() =>
      EligibilityRequestPurpose._(value, element?.clone() as Element?);

  /// Sets a property on the associated [Element], returning a new instance.
  @override
  EligibilityRequestPurpose setElement(String name, dynamic elementValue) {
