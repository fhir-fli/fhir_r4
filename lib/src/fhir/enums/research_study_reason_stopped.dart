...
@override
  String toString() {
      switch(this) {
        case accrual_goal_met: return 'accrual-goal-met';
        case closed_due_to_toxicity: return 'closed-due-to-toxicity';
        case closed_due_to_lack_of_study_progress: return 'closed-due-to-lack-of-study-progress';
        case temporarily_closed_per_study_design: return 'temporarily-closed-per-study-design';
      }
      }
String toJson() => toString();
  ResearchStudyReasonStopped fromString(String str) {
    switch(str) {
      case 'accrual-goal-met': return ResearchStudyReasonStopped.accrual_goal_met;
      case 'closed-due-to-toxicity': return ResearchStudyReasonStopped.closed_due_to_toxicity;
      case 'closed-due-to-lack-of-study-progress': return ResearchStudyReasonStopped.closed_due_to_lack_of_study_progress;
      case 'temporarily-closed-per-study-design': return ResearchStudyReasonStopped.temporarily_closed_per_study_design;
