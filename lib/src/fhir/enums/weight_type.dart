...
class WeightType {
  ...
  WeightType({this.fhirCode, this.element})
      : assert(
  ...
  static final WeightType Exact = WeightType(
    fhirCode: 'Exact',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final WeightType Average = WeightType(
    fhirCode: 'Average',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final WeightType WeightAverage = WeightType(
    fhirCode: 'WeightAverage',
  );

  /// For instances where an Element is present but not value

  static final WeightType elementOnly = WeightType();
