...
enum AdverseEventCausalityMethod {
  ...
  /// Converts a list of JSON values to a list of [AdverseEventCausalityMethod] instances.
  static AdverseEventCausalityMethod fromJson(
    ...
    if (value == null && element != null) {
      return AdverseEventCausalityMethod.elementOnly.withElement(
        element,
      );
    }
