...
String toJson() => toString();
  MedicationDispensePerformerFunctionCodes fromString(String str) {
    switch(str) {
      case 'dataenterer': return MedicationDispensePerformerFunctionCodes.dataenterer;
      case 'packager': return MedicationDispensePerformerFunctionCodes.packager;
      case 'checker': return MedicationDispensePerformerFunctionCodes.checker;
      case 'finalchecker': return MedicationDispensePerformerFunctionCodes.finalchecker;
    default: throw ArgumentError('Unknown enum value: $str');
    }
      }
 MedicationDispensePerformerFunctionCodes fromJson(dynamic jsonValue) {
