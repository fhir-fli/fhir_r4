...
@override
  String toString() {
      switch(this) {
        ...
        case case_control: return 'case-control';
...
String toJson() => toString();
  StudyType fromString(String str) {
    switch(str) {
      case 'RCT': return StudyType.RCT;
      case 'CCT': return StudyType.CCT;
      case 'cohort': return StudyType.cohort;
      case 'case-control': return StudyType.case_control;
      case 'series': return StudyType.series;
      case 'case-report': return StudyType.case_report;
      case 'mixed': return StudyType.mixed;
