...
@override
  String toString() {
      switch(this) {
        case named_event: return 'named-event';
        case periodic: return 'periodic';
        case data_changed: return 'data-changed';
        case data_accessed: return 'data-accessed';
        case data_access_ended: return 'data-access-ended';
      }
      }
String toJson() => toString();
  TriggerType fromString(String str) {
    switch(str) {
      case 'named-event': return TriggerType.named_event;
      case 'periodic': return TriggerType.periodic;
      case 'data-changed': return TriggerType.data_changed;
      case 'data-accessed': return TriggerType.data_accessed;
      case 'data-access-ended': return TriggerType.data_access_ended;
