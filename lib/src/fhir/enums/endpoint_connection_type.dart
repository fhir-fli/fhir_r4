...
@override
  String toString() {
      switch(this) {
        case ihe_xcpd: return 'ihe-xcpd';
        case ihe_xca: return 'ihe-xca';
        case ihe_xdr: return 'ihe-xdr';
        case ihe_xds: return 'ihe-xds';
        case ihe_iid: return 'ihe-iid';
        case dicom_wado_rs: return 'dicom-wado-rs';
        case dicom_qido_rs: return 'dicom-qido-rs';
        case dicom_stow_rs: return 'dicom-stow-rs';
        case dicom_wado_uri: return 'dicom-wado-uri';
        case hl7_fhir_rest: return 'hl7-fhir-rest';
        case hl7_fhir_msg: return 'hl7-fhir-msg';
        case hl7v2_mllp: return 'hl7v2-mllp';
        case secure_email: return 'secure-email';
        case direct_project: return 'direct-project';
      }
      }
String toJson() => toString();
  EndpointConnectionType fromString(String str) {
    switch(str) {
      case 'ihe-xcpd': return EndpointConnectionType.ihe_xcpd;
      case 'ihe-xca': return EndpointConnectionType.ihe_xca;
      case 'ihe-xdr': return EndpointConnectionType.ihe_xdr;
      case 'ihe-xds': return EndpointConnectionType.ihe_xds;
      case 'ihe-iid': return EndpointConnectionType.ihe_iid;
      case 'dicom-wado-rs': return EndpointConnectionType.dicom_wado_rs;
      case 'dicom-qido-rs': return EndpointConnectionType.dicom_qido_rs;
      case 'dicom-stow-rs': return EndpointConnectionType.dicom_stow_rs;
      case 'dicom-wado-uri': return EndpointConnectionType.dicom_wado_uri;
      case 'hl7-fhir-rest': return EndpointConnectionType.hl7_fhir_rest;
      case 'hl7-fhir-msg': return EndpointConnectionType.hl7_fhir_msg;
      case 'hl7v2-mllp': return EndpointConnectionType.hl7v2_mllp;
      case 'secure-email': return EndpointConnectionType.secure_email;
      case 'direct-project': return EndpointConnectionType.direct_project;
