...
class SupplyType {
  ...
  SupplyType({this.fhirCode, this.element})
      : assert(
  ...
  static final SupplyType central = SupplyType(
    fhirCode: 'central',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final SupplyType nonstock = SupplyType(
    fhirCode: 'nonstock',
  );

  /// For instances where an Element is present but not value

  static final SupplyType elementOnly = SupplyType();
