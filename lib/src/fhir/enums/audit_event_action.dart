...
String toJson() => toString();
  AuditEventAction fromString(String str) {
    switch(str) {
      case 'C': return AuditEventAction.C;
      case 'R': return AuditEventAction.R;
      case 'U': return AuditEventAction.U;
      case 'D': return AuditEventAction.D;
      case 'E': return AuditEventAction.E;
