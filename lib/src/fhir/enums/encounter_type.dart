...
@override
  String toString() {
      switch(this) {
        ...
        case BD_BM_clin: return 'BD/BM-clin';
...
String toJson() => toString();
  EncounterType fromString(String str) {
    switch(str) {
      case 'ADMS': return EncounterType.ADMS;
      case 'BD/BM-clin': return EncounterType.BD_BM_clin;
      case 'CCS60': return EncounterType.CCS60;
      case 'OKI': return EncounterType.OKI;
