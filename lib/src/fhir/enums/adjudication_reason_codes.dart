...
class AdjudicationReasonCodes {
  ...
  AdjudicationReasonCodes({this.fhirCode, this.element})
      : assert(
  ...
  static final AdjudicationReasonCodes ar001 = AdjudicationReasonCodes(
    fhirCode: 'ar001',
  );
  ...
  /// Instance of 'EnumValue'.display
  /// Instance of 'EnumValue'.definition
  static final AdjudicationReasonCodes ar002 = AdjudicationReasonCodes(
    fhirCode: 'ar002',
  );

  /// For instances where an Element is present but not value

  static final AdjudicationReasonCodes elementOnly = AdjudicationReasonCodes();
  ...
  AdjudicationReasonCodes withElement(Element? newElement) {
    return AdjudicationReasonCodes(
      fhirCode: fhirCode,
      element: newElement,
    );
  }
  ...
  @override
  String toString() => 'AdjudicationReasonCodes.$fhirCode';
}
