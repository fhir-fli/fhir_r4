...
String toJson() => toString();
  MedicationDispenseStatusReasonCodes fromString(String str) {
    switch(str) {
      case 'frr01': return MedicationDispenseStatusReasonCodes.frr01;
      case 'frr02': return MedicationDispenseStatusReasonCodes.frr02;
      case 'frr03': return MedicationDispenseStatusReasonCodes.frr03;
      case 'frr04': return MedicationDispenseStatusReasonCodes.frr04;
      case 'frr05': return MedicationDispenseStatusReasonCodes.frr05;
      case 'frr06': return MedicationDispenseStatusReasonCodes.frr06;
      case 'altchoice': return MedicationDispenseStatusReasonCodes.altchoice;
      case 'clarif': return MedicationDispenseStatusReasonCodes.clarif;
      case 'drughigh': return MedicationDispenseStatusReasonCodes.drughigh;
      case 'hospadm': return MedicationDispenseStatusReasonCodes.hospadm;
      case 'labint': return MedicationDispenseStatusReasonCodes.labint;
      case 'non-avail': return MedicationDispenseStatusReasonCodes.non_avail;
      case 'preg': return MedicationDispenseStatusReasonCodes.preg;
      case 'saig': return MedicationDispenseStatusReasonCodes.saig;
      case 'sddi': return MedicationDispenseStatusReasonCodes.sddi;
      case 'sdupther': return MedicationDispenseStatusReasonCodes.sdupther;
      case 'sintol': return MedicationDispenseStatusReasonCodes.sintol;
      case 'surg': return MedicationDispenseStatusReasonCodes.surg;
      case 'washout': return MedicationDispenseStatusReasonCodes.washout;
      case 'outofstock': return MedicationDispenseStatusReasonCodes.outofstock;
      case 'offmarket': return MedicationDispenseStatusReasonCodes.offmarket;
