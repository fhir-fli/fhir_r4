...
String toJson() => toString();
  ParticipantType fromString(String str) {
    switch(str) {
      case 'SPRF': return ParticipantType.SPRF;
      case 'PPRF': return ParticipantType.PPRF;
      case 'PART': return ParticipantType.PART;
      case 'translator': return ParticipantType.translator;
      case 'emergency': return ParticipantType.emergency;
