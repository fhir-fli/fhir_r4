...
@override
  String toString() {
      switch(this) {
        ...
        case abstract_version: return 'abstract-version';
        case doi_based: return 'doi-based';
        case full_text: return 'full-text';
        case full_text_version: return 'full-text-version';
        case pdf: return 'pdf';
        case pdf_version: return 'pdf-version';
        case webpage: return 'webpage';
        case not_specified: return 'not-specified';
        case json: return 'json';
        case json_version: return 'json-version';
        case xml: return 'xml';
        case xml_version: return 'xml-version';
        case supplement: return 'supplement';
        case supplementary_file_directory: return 'supplementary-file-directory';
        case compressed_file: return 'compressed-file';
      }
      }
String toJson() => toString();
  ArticleUrlType fromString(String str) {
    switch(str) {
      case 'abstract': return ArticleUrlType.abstract_;
      case 'abstract-version': return ArticleUrlType.abstract_version;
      case 'doi-based': return ArticleUrlType.doi_based;
      case 'full-text': return ArticleUrlType.full_text;
      case 'full-text-version': return ArticleUrlType.full_text_version;
      case 'pdf': return ArticleUrlType.pdf;
      case 'pdf-version': return ArticleUrlType.pdf_version;
      case 'webpage': return ArticleUrlType.webpage;
      case 'not-specified': return ArticleUrlType.not_specified;
      case 'json': return ArticleUrlType.json;
      case 'json-version': return ArticleUrlType.json_version;
      case 'xml': return ArticleUrlType.xml;
      case 'xml-version': return ArticleUrlType.xml_version;
      case 'supplement': return ArticleUrlType.supplement;
      case 'supplementary-file-directory': return ArticleUrlType.supplementary_file_directory;
      case 'compressed-file': return ArticleUrlType.compressed_file;
