...
class HumanNameDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> familyElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> given = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> givenElement =
      ToMany<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> prefix = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> prefixElement =
      ToMany<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> suffix = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> suffixElement =
      ToMany<PrimitiveElementDbObject>();
