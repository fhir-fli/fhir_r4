...
class ProdCharacteristicDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> shapeElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> color = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> colorElement =
      ToMany<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> imprint = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> imprintElement =
      ToMany<PrimitiveElementDbObject>();
