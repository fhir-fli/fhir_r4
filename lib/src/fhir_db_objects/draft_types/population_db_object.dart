...
class PopulationDbObject {
  ...
  final ToOne<CodeableConceptDbObject> ageCodeableConcept =
      ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> gender =
      ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> race = ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> physiologicalCondition =
      ToOne<CodeableConceptDbObject>();
