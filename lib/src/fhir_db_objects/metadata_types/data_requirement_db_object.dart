...
class DataRequirementDbObject {
  ...
  final ToMany<PrimitiveElementDbObject> mustSupportElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<DataRequirementCodeFilterDbObject> codeFilter = ToMany<DataRequirementCodeFilterDbObject>();
  final ToMany<DataRequirementDateFilterDbObject> dateFilter = ToMany<DataRequirementDateFilterDbObject>();
  final ToOne<FhirPositiveIntDbObject> limit = ToOne<FhirPositiveIntDbObject>();
  final ToOne<PrimitiveElementDbObject> limitElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<DataRequirementSortDbObject> sort = ToMany<DataRequirementSortDbObject>();
...
class DataRequirementCodeFilterDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> searchParamElement = ToOne<PrimitiveElementDbObject>();
...
class DataRequirementDateFilterDbObject {
  ...
  final ToOne<FhirDurationDbObject> valueDuration = ToOne<FhirDurationDbObject>();
...
class DataRequirementSortDbObject {
  ...
  final ToOne<StringDbObject> path = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> pathElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<DataRequirementSortDirectionDbObject> direction = ToOne<DataRequirementSortDirectionDbObject>();
