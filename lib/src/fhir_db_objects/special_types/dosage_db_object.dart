...
class DosageDbObject {
  ...
  final ToMany<CodeableConceptDbObject> additionalInstruction = ToMany<CodeableConceptDbObject>();
  ...
  final ToMany<DosageDoseAndRateDbObject> doseAndRate = ToMany<DosageDoseAndRateDbObject>();
  final ToOne<RatioDbObject> maxDosePerPeriod = ToOne<RatioDbObject>();
  final ToOne<QuantityDbObject> maxDosePerAdministration = ToOne<QuantityDbObject>();
