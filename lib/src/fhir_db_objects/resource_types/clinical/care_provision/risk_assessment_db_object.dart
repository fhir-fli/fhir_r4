...
class RiskAssessmentDbObject {
  ...
  final ToMany<RiskAssessmentPredictionDbObject> prediction = ToMany<RiskAssessmentPredictionDbObject>();
  final ToOne<StringDbObject> mitigation = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> mitigationElement = ToOne<PrimitiveElementDbObject>();
...
class RiskAssessmentPredictionDbObject {
  ...
  final ToOne<FhirDecimalDbObject> probabilityDecimal = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> probabilityDecimalElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<RangeDbObject> probabilityRange = ToOne<RangeDbObject>();
  final ToOne<CodeableConceptDbObject> qualitativeRisk = ToOne<CodeableConceptDbObject>();
  final ToOne<FhirDecimalDbObject> relativeRisk = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> relativeRiskElement = ToOne<PrimitiveElementDbObject>();
