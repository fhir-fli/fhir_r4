...
class CarePlanDbObject {
  ...
  final ToMany<CarePlanActivityDbObject> activity =
      ToMany<CarePlanActivityDbObject>();
...
class CarePlanActivityDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToMany<CodeableConceptDbObject> outcomeCodeableConcept =
      ToMany<CodeableConceptDbObject>();
...
class CarePlanDetailDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> scheduledStringElement =
      ToOne<PrimitiveElementDbObject>();
