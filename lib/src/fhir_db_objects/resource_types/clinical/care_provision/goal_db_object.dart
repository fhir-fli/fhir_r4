...
class GoalDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> lifecycleStatusElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> achievementStatus =
  ...
  final ToOne<PrimitiveElementDbObject> startDateElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> startCodeableConcept =
      ToOne<CodeableConceptDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> statusReasonElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<CodeableConceptDbObject> outcomeCode =
      ToMany<CodeableConceptDbObject>();
  final ToMany<ReferenceDbObject> outcomeReference =
