...
class NutritionOrderDbObject {
  ...
  final ToMany<PrimitiveElementDbObject> instantiatesElement =
      ToMany<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> dateTimeElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<ReferenceDbObject> orderer = ToOne<ReferenceDbObject>();
  final ToMany<ReferenceDbObject> allergyIntolerance =
      ToMany<ReferenceDbObject>();
  final ToMany<CodeableConceptDbObject> foodPreferenceModifier =
      ToMany<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> excludeFoodModifier =
      ToMany<CodeableConceptDbObject>();
  final ToOne<NutritionOrderOralDietDbObject> oralDiet =
      ToOne<NutritionOrderOralDietDbObject>();
  final ToMany<NutritionOrderSupplementDbObject> supplement =
      ToMany<NutritionOrderSupplementDbObject>();
  final ToOne<NutritionOrderEnteralFormulaDbObject> enteralFormula =
      ToOne<NutritionOrderEnteralFormulaDbObject>();
...
class NutritionOrderOralDietDbObject {
  ...
  final ToMany<NutritionOrderNutrientDbObject> nutrient =
      ToMany<NutritionOrderNutrientDbObject>();
  final ToMany<NutritionOrderTextureDbObject> texture =
      ToMany<NutritionOrderTextureDbObject>();
  final ToMany<CodeableConceptDbObject> fluidConsistencyType =
      ToMany<CodeableConceptDbObject>();
...
class NutritionOrderNutrientDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> modifier =
...
class NutritionOrderTextureDbObject {
  ...
  final ToOne<CodeableConceptDbObject> modifier =
      ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> foodType =
      ToOne<CodeableConceptDbObject>();
...
class NutritionOrderEnteralFormulaDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> baseFormulaType =
      ToOne<CodeableConceptDbObject>();
  final ToOne<StringDbObject> baseFormulaProductName = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> baseFormulaProductNameElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> additiveType =
      ToOne<CodeableConceptDbObject>();
  final ToOne<StringDbObject> additiveProductName = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> additiveProductNameElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<QuantityDbObject> caloricDensity = ToOne<QuantityDbObject>();
  final ToOne<CodeableConceptDbObject> routeofAdministration =
      ToOne<CodeableConceptDbObject>();
  final ToMany<NutritionOrderAdministrationDbObject> administration =
      ToMany<NutritionOrderAdministrationDbObject>();
  final ToOne<QuantityDbObject> maxVolumeToDeliver = ToOne<QuantityDbObject>();
  final ToOne<StringDbObject> administrationInstruction =
      ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> administrationInstructionElement =
      ToOne<PrimitiveElementDbObject>();
