...
class RequestGroupDbObject {
  ...
  final ToMany<RequestGroupActionDbObject> action =
      ToMany<RequestGroupActionDbObject>();
...
class RequestGroupActionDbObject {
  ...
  final ToMany<RequestGroupConditionDbObject> condition =
      ToMany<RequestGroupConditionDbObject>();
  final ToMany<RequestGroupRelatedActionDbObject> relatedAction =
      ToMany<RequestGroupRelatedActionDbObject>();
