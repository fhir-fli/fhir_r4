...
class VisionPrescriptionDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> dateWrittenElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<ReferenceDbObject> prescriber = ToOne<ReferenceDbObject>();
  final ToMany<VisionPrescriptionLensSpecificationDbObject> lensSpecification = ToMany<VisionPrescriptionLensSpecificationDbObject>();
...
class VisionPrescriptionLensSpecificationDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> product = ToOne<CodeableConceptDbObject>();
  final ToOne<FhirCodeDbObject> eye = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> eyeElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDecimalDbObject> sphere = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> sphereElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDecimalDbObject> cylinder = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> cylinderElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirIntegerDbObject> axis = ToOne<FhirIntegerDbObject>();
  final ToOne<PrimitiveElementDbObject> axisElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<VisionPrescriptionPrismDbObject> prism = ToMany<VisionPrescriptionPrismDbObject>();
  final ToOne<FhirDecimalDbObject> add = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> addElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDecimalDbObject> power = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> powerElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDecimalDbObject> backCurve = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> backCurveElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDecimalDbObject> diameter = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> diameterElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> brandElement = ToOne<PrimitiveElementDbObject>();
...
class VisionPrescriptionPrismDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> amountElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> base = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> baseElement = ToOne<PrimitiveElementDbObject>();
