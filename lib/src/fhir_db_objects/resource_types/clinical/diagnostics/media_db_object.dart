...
class MediaDbObject {
  ...
  final ToOne<CodeableConceptDbObject> modality =
  ...
  final ToOne<FhirDateTimeDbObject> createdDateTime =
      ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> createdDateTimeElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> deviceNameElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<ReferenceDbObject> device = ToOne<ReferenceDbObject>();
  final ToOne<FhirPositiveIntDbObject> height =
      ToOne<FhirPositiveIntDbObject>();
  final ToOne<PrimitiveElementDbObject> heightElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirPositiveIntDbObject> width = ToOne<FhirPositiveIntDbObject>();
  final ToOne<PrimitiveElementDbObject> widthElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirPositiveIntDbObject> frames =
      ToOne<FhirPositiveIntDbObject>();
  final ToOne<PrimitiveElementDbObject> framesElement =
      ToOne<PrimitiveElementDbObject>();
