...
class MolecularSequenceDbObject {
  ...
  final ToOne<FhirIntegerDbObject> coordinateSystem = ToOne<FhirIntegerDbObject>();
  final ToOne<PrimitiveElementDbObject> coordinateSystemElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<MolecularSequenceReferenceSeqDbObject> referenceSeq = ToOne<MolecularSequenceReferenceSeqDbObject>();
  final ToMany<MolecularSequenceVariantDbObject> variant = ToMany<MolecularSequenceVariantDbObject>();
  final ToOne<StringDbObject> observedSeq = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> observedSeqElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<MolecularSequenceQualityDbObject> quality = ToMany<MolecularSequenceQualityDbObject>();
  final ToOne<FhirIntegerDbObject> readCoverage = ToOne<FhirIntegerDbObject>();
  final ToOne<PrimitiveElementDbObject> readCoverageElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<MolecularSequenceRepositoryDbObject> repository = ToMany<MolecularSequenceRepositoryDbObject>();
  final ToMany<ReferenceDbObject> pointer = ToMany<ReferenceDbObject>();
  final ToMany<MolecularSequenceStructureVariantDbObject> structureVariant = ToMany<MolecularSequenceStructureVariantDbObject>();
...
class MolecularSequenceReferenceSeqDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> chromosome = ToOne<CodeableConceptDbObject>();
  final ToOne<StringDbObject> genomeBuild = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> genomeBuildElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> orientation = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> orientationElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> referenceSeqId = ToOne<CodeableConceptDbObject>();
  final ToOne<ReferenceDbObject> referenceSeqPointer = ToOne<ReferenceDbObject>();
  final ToOne<StringDbObject> referenceSeqString = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> referenceSeqStringElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> strand = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> strandElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirIntegerDbObject> windowStart = ToOne<FhirIntegerDbObject>();
  final ToOne<PrimitiveElementDbObject> windowStartElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirIntegerDbObject> windowEnd = ToOne<FhirIntegerDbObject>();
  final ToOne<PrimitiveElementDbObject> windowEndElement = ToOne<PrimitiveElementDbObject>();
...
class MolecularSequenceVariantDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> observedAlleleElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> referenceAllele = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> referenceAlleleElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> cigar = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> cigarElement = ToOne<PrimitiveElementDbObject>();
...
class MolecularSequenceQualityDbObject {
  ...
  final ToOne<FhirCodeDbObject> type = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> typeElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> standardSequence = ToOne<CodeableConceptDbObject>();
  final ToOne<FhirIntegerDbObject> start = ToOne<FhirIntegerDbObject>();
  final ToOne<PrimitiveElementDbObject> startElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirIntegerDbObject> end = ToOne<FhirIntegerDbObject>();
  final ToOne<PrimitiveElementDbObject> endElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> truthTPElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDecimalDbObject> queryTP = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> queryTPElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDecimalDbObject> truthFN = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> truthFNElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDecimalDbObject> queryFP = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> queryFPElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDecimalDbObject> gtFP = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> gtFPElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDecimalDbObject> precision = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> precisionElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDecimalDbObject> recall = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> recallElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDecimalDbObject> fScore = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> fScoreElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<MolecularSequenceRocDbObject> roc = ToOne<MolecularSequenceRocDbObject>();
...
class MolecularSequenceRocDbObject {
  ...
  final ToMany<PrimitiveElementDbObject> scoreElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<FhirIntegerDbObject> numTP = ToMany<FhirIntegerDbObject>();
  final ToMany<PrimitiveElementDbObject> numTPElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<FhirIntegerDbObject> numFP = ToMany<FhirIntegerDbObject>();
  final ToMany<PrimitiveElementDbObject> numFPElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<FhirIntegerDbObject> numFN = ToMany<FhirIntegerDbObject>();
  final ToMany<PrimitiveElementDbObject> numFNElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<FhirDecimalDbObject> precision = ToMany<FhirDecimalDbObject>();
  final ToMany<PrimitiveElementDbObject> precisionElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<FhirDecimalDbObject> sensitivity = ToMany<FhirDecimalDbObject>();
  final ToMany<PrimitiveElementDbObject> sensitivityElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<FhirDecimalDbObject> fMeasure = ToMany<FhirDecimalDbObject>();
  final ToMany<PrimitiveElementDbObject> fMeasureElement = ToMany<PrimitiveElementDbObject>();
...
class MolecularSequenceRepositoryDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> datasetIdElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> variantsetId = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> variantsetIdElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> readsetId = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> readsetIdElement = ToOne<PrimitiveElementDbObject>();
...
class MolecularSequenceStructureVariantDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> variantType = ToOne<CodeableConceptDbObject>();
  final ToOne<FhirBooleanDbObject> exact = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> exactElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirIntegerDbObject> length = ToOne<FhirIntegerDbObject>();
  final ToOne<PrimitiveElementDbObject> lengthElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<MolecularSequenceOuterDbObject> outer = ToOne<MolecularSequenceOuterDbObject>();
  final ToOne<MolecularSequenceInnerDbObject> inner = ToOne<MolecularSequenceInnerDbObject>();
