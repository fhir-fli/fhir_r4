...
class SpecimenDbObject {
  ...
  final ToOne<IdentifierDbObject> accessionIdentifier = ToOne<IdentifierDbObject>();
  ...
  final ToOne<FhirDateTimeDbObject> receivedTime = ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> receivedTimeElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<SpecimenCollectionDbObject> collection = ToOne<SpecimenCollectionDbObject>();
  final ToMany<SpecimenProcessingDbObject> processing = ToMany<SpecimenProcessingDbObject>();
  final ToMany<SpecimenContainerDbObject> container = ToMany<SpecimenContainerDbObject>();
  final ToMany<CodeableConceptDbObject> condition = ToMany<CodeableConceptDbObject>();
...
class SpecimenCollectionDbObject {
  ...
  final ToOne<CodeableConceptDbObject> fastingStatusCodeableConcept = ToOne<CodeableConceptDbObject>();
  final ToOne<FhirDurationDbObject> fastingStatusDuration = ToOne<FhirDurationDbObject>();
