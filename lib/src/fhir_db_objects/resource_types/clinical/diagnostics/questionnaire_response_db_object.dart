...
class QuestionnaireResponseDbObject {
  ...
  final ToOne<FhirCanonicalDbObject> questionnaire = ToOne<FhirCanonicalDbObject>();
  final ToOne<PrimitiveElementDbObject> questionnaireElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> authoredElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<ReferenceDbObject> author = ToOne<ReferenceDbObject>();
  final ToOne<ReferenceDbObject> source = ToOne<ReferenceDbObject>();
  final ToMany<QuestionnaireResponseItemDbObject> item = ToMany<QuestionnaireResponseItemDbObject>();
...
class QuestionnaireResponseItemDbObject {
  ...
  final ToMany<QuestionnaireResponseAnswerDbObject> answer = ToMany<QuestionnaireResponseAnswerDbObject>();
  final ToMany<QuestionnaireResponseItemDbObject> item = ToMany<QuestionnaireResponseItemDbObject>();
