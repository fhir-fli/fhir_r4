...
class ImagingStudyDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> startedElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<FhirUnsignedIntDbObject> numberOfSeries = ToOne<FhirUnsignedIntDbObject>();
  final ToOne<PrimitiveElementDbObject> numberOfSeriesElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirUnsignedIntDbObject> numberOfInstances = ToOne<FhirUnsignedIntDbObject>();
  final ToOne<PrimitiveElementDbObject> numberOfInstancesElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<ReferenceDbObject> procedureReference = ToOne<ReferenceDbObject>();
  final ToMany<CodeableConceptDbObject> procedureCode = ToMany<CodeableConceptDbObject>();
  ...
  final ToMany<ImagingStudySeriesDbObject> series = ToMany<ImagingStudySeriesDbObject>();
...
class ImagingStudySeriesDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> uidElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirUnsignedIntDbObject> number = ToOne<FhirUnsignedIntDbObject>();
  ...
  final ToOne<FhirDateTimeDbObject> started = ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> startedElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<ImagingStudyPerformerDbObject> performer = ToMany<ImagingStudyPerformerDbObject>();
  final ToMany<ImagingStudyInstanceDbObject> instance = ToMany<ImagingStudyInstanceDbObject>();
