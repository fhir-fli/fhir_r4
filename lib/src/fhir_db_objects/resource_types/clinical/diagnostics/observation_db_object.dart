...
class ObservationDbObject {
  ...
  final ToOne<FhirInstantDbObject> effectiveInstant =
      ToOne<FhirInstantDbObject>();
  final ToOne<PrimitiveElementDbObject> effectiveInstantElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<CodeableConceptDbObject> dataAbsentReason =
      ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> interpretation =
      ToMany<CodeableConceptDbObject>();
  ...
  final ToMany<ObservationReferenceRangeDbObject> referenceRange =
      ToMany<ObservationReferenceRangeDbObject>();
  ...
  final ToMany<ObservationComponentDbObject> component =
      ToMany<ObservationComponentDbObject>();
