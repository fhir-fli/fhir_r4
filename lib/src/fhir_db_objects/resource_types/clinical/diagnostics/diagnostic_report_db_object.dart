...
class DiagnosticReportDbObject {
  ...
  final ToMany<ReferenceDbObject> resultsInterpreter = ToMany<ReferenceDbObject>();
  ...
  final ToMany<DiagnosticReportMediaDbObject> media = ToMany<DiagnosticReportMediaDbObject>();
  final ToOne<StringDbObject> conclusion = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> conclusionElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<CodeableConceptDbObject> conclusionCode = ToMany<CodeableConceptDbObject>();
