...
class AdverseEventDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> actualityElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> detectedElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<ReferenceDbObject> resultingCondition = ToMany<ReferenceDbObject>();
  final ToOne<ReferenceDbObject> location = ToOne<ReferenceDbObject>();
  final ToOne<CodeableConceptDbObject> seriousness = ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> severity = ToOne<CodeableConceptDbObject>();
  ...
  final ToMany<AdverseEventSuspectEntityDbObject> suspectEntity = ToMany<AdverseEventSuspectEntityDbObject>();
  final ToMany<ReferenceDbObject> subjectMedicalHistory = ToMany<ReferenceDbObject>();
  final ToMany<ReferenceDbObject> referenceDocument = ToMany<ReferenceDbObject>();
...
class AdverseEventSuspectEntityDbObject {
  ...
  final ToMany<AdverseEventCausalityDbObject> causality = ToMany<AdverseEventCausalityDbObject>();
...
class AdverseEventCausalityDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> assessment = ToOne<CodeableConceptDbObject>();
  final ToOne<StringDbObject> productRelatedness = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> productRelatednessElement = ToOne<PrimitiveElementDbObject>();
