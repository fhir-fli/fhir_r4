...
class FamilyMemberHistoryDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> bornDateElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> bornString = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> bornStringElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> ageStringElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> estimatedAge = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> estimatedAgeElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> deceasedBoolean = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> deceasedBooleanElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> deceasedDateElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> deceasedString = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> deceasedStringElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<FamilyMemberHistoryConditionDbObject> condition = ToMany<FamilyMemberHistoryConditionDbObject>();
...
class FamilyMemberHistoryConditionDbObject {
  ...
  final ToOne<CodeableConceptDbObject> outcome = ToOne<CodeableConceptDbObject>();
  final ToOne<FhirBooleanDbObject> contributedToDeath = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> contributedToDeathElement = ToOne<PrimitiveElementDbObject>();
