...
class DetectedIssueDbObject {
  ...
  final ToOne<FhirDateTimeDbObject> identifiedDateTime =
      ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> identifiedDateTimeElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<DetectedIssueEvidenceDbObject> evidence =
      ToMany<DetectedIssueEvidenceDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> referenceElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<DetectedIssueMitigationDbObject> mitigation =
      ToMany<DetectedIssueMitigationDbObject>();
