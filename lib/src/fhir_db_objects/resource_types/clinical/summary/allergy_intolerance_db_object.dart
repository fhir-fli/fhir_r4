...
class AllergyIntoleranceDbObject {
  ...
  final ToMany<PrimitiveElementDbObject> categoryElement =
      ToMany<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> criticality = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> criticalityElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<FhirDateTimeDbObject> lastOccurrence =
      ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> lastOccurrenceElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<AnnotationDbObject> note = ToMany<AnnotationDbObject>();
  final ToMany<AllergyIntoleranceReactionDbObject> reaction =
      ToMany<AllergyIntoleranceReactionDbObject>();
...
class AllergyIntoleranceReactionDbObject {
  ...
  final ToOne<CodeableConceptDbObject> substance =
      ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> manifestation =
