...
class ClinicalImpressionDbObject {
  ...
  final ToMany<ClinicalImpressionInvestigationDbObject> investigation =
      ToMany<ClinicalImpressionInvestigationDbObject>();
  final ToMany<FhirUriDbObject> protocol = ToMany<FhirUriDbObject>();
  final ToMany<PrimitiveElementDbObject> protocolElement =
      ToMany<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> summary = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> summaryElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<ClinicalImpressionFindingDbObject> finding =
      ToMany<ClinicalImpressionFindingDbObject>();
  final ToMany<CodeableConceptDbObject> prognosisCodeableConcept =
      ToMany<CodeableConceptDbObject>();
  final ToMany<ReferenceDbObject> prognosisReference =
...
class ClinicalImpressionFindingDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> basisElement =
      ToOne<PrimitiveElementDbObject>();
