...
class ConditionDbObject {
  ...
  final ToOne<FhirDateTimeDbObject> abatementDateTime = ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> abatementDateTimeElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> abatementStringElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<ConditionEvidenceDbObject> evidence = ToMany<ConditionEvidenceDbObject>();
...
class ConditionStageDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> summary = ToOne<CodeableConceptDbObject>();
