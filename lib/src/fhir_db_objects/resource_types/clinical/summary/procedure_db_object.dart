...
class ProcedureDbObject {
  ...
  final ToOne<FhirDateTimeDbObject> performedDateTime = ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> performedDateTimeElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> performedStringElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<ProcedurePerformerDbObject> performer = ToMany<ProcedurePerformerDbObject>();
  ...
  final ToMany<CodeableConceptDbObject> complication = ToMany<CodeableConceptDbObject>();
  final ToMany<ReferenceDbObject> complicationDetail = ToMany<ReferenceDbObject>();
  final ToMany<CodeableConceptDbObject> followUp = ToMany<CodeableConceptDbObject>();
  final ToMany<AnnotationDbObject> note = ToMany<AnnotationDbObject>();
  final ToMany<ProcedureFocalDeviceDbObject> focalDevice = ToMany<ProcedureFocalDeviceDbObject>();
  final ToMany<ReferenceDbObject> usedReference = ToMany<ReferenceDbObject>();
  final ToMany<CodeableConceptDbObject> usedCode = ToMany<CodeableConceptDbObject>();
