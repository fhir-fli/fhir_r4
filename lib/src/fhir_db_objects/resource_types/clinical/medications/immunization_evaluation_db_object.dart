...
class ImmunizationEvaluationDbObject {
  ...
  final ToOne<CodeableConceptDbObject> doseStatus = ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> doseStatusReason = ToMany<CodeableConceptDbObject>();
