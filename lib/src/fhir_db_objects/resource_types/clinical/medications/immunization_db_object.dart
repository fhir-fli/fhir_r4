...
class ImmunizationDbObject {
  ...
  final ToOne<CodeableConceptDbObject> vaccineCode =
      ToOne<CodeableConceptDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> occurrenceStringElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> primarySourceElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> reportOrigin =
      ToOne<CodeableConceptDbObject>();
  ...
  final ToMany<ImmunizationPerformerDbObject> performer =
      ToMany<ImmunizationPerformerDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> isSubpotentElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<CodeableConceptDbObject> subpotentReason =
      ToMany<CodeableConceptDbObject>();
  final ToMany<ImmunizationEducationDbObject> education =
      ToMany<ImmunizationEducationDbObject>();
  final ToMany<CodeableConceptDbObject> programEligibility =
      ToMany<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> fundingSource =
      ToOne<CodeableConceptDbObject>();
  final ToMany<ImmunizationReactionDbObject> reaction =
      ToMany<ImmunizationReactionDbObject>();
  final ToMany<ImmunizationProtocolAppliedDbObject> protocolApplied =
      ToMany<ImmunizationProtocolAppliedDbObject>();
...
class ImmunizationEducationDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> documentTypeElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> publicationDateElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDateTimeDbObject> presentationDate =
      ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> presentationDateElement =
      ToOne<PrimitiveElementDbObject>();
...
class ImmunizationReactionDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> reportedElement =
      ToOne<PrimitiveElementDbObject>();
...
class ImmunizationProtocolAppliedDbObject {
  ...
  final ToMany<CodeableConceptDbObject> targetDisease =
      ToMany<CodeableConceptDbObject>();
