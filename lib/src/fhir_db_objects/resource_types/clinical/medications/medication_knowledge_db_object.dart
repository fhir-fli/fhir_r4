...
class MedicationKnowledgeDbObject {
  ...
  final ToOne<CodeableConceptDbObject> doseForm = ToOne<CodeableConceptDbObject>();
  final ToOne<QuantityDbObject> amount = ToOne<QuantityDbObject>();
  final ToOne<StringDbObject> synonym = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> synonymElement = ToMany<PrimitiveElementDbObject>();
List<MedicationKnowledgeRelatedMedicationKnowledge>?
relatedMedicationKnowledge,
  final ToMany<ReferenceDbObject> associatedMedication = ToMany<ReferenceDbObject>();
  final ToMany<CodeableConceptDbObject> productType = ToMany<CodeableConceptDbObject>();
  final ToMany<MedicationKnowledgeMonographDbObject> monograph = ToMany<MedicationKnowledgeMonographDbObject>();
  final ToMany<MedicationKnowledgeIngredientDbObject> ingredient = ToMany<MedicationKnowledgeIngredientDbObject>();
  final ToOne<FhirMarkdownDbObject> preparationInstruction = ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> preparationInstructionElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<CodeableConceptDbObject> intendedRoute = ToMany<CodeableConceptDbObject>();
  final ToMany<MedicationKnowledgeCostDbObject> cost = ToMany<MedicationKnowledgeCostDbObject>();
  final ToMany<MedicationKnowledgeMonitoringProgramDbObject> monitoringProgram = ToMany<MedicationKnowledgeMonitoringProgramDbObject>();
  final ToMany<MedicationKnowledgeAdministrationGuidelinesDbObject> administrationGuidelines = ToMany<MedicationKnowledgeAdministrationGuidelinesDbObject>();
  final ToMany<MedicationKnowledgeMedicineClassificationDbObject> medicineClassification = ToMany<MedicationKnowledgeMedicineClassificationDbObject>();
  final ToOne<MedicationKnowledgePackagingDbObject> packaging = ToOne<MedicationKnowledgePackagingDbObject>();
  final ToMany<MedicationKnowledgeDrugCharacteristicDbObject> drugCharacteristic = ToMany<MedicationKnowledgeDrugCharacteristicDbObject>();
  final ToMany<ReferenceDbObject> contraindication = ToMany<ReferenceDbObject>();
  final ToMany<MedicationKnowledgeRegulatoryDbObject> regulatory = ToMany<MedicationKnowledgeRegulatoryDbObject>();
  final ToMany<MedicationKnowledgeKineticsDbObject> kinetics = ToMany<MedicationKnowledgeKineticsDbObject>();
...
class MedicationKnowledgeIngredientDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> isActiveElement = ToOne<PrimitiveElementDbObject>();
...
class MedicationKnowledgeAdministrationGuidelinesDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToMany<MedicationKnowledgeDosageDbObject> dosage = ToMany<MedicationKnowledgeDosageDbObject>();
  final ToOne<CodeableConceptDbObject> indicationCodeableConcept = ToOne<CodeableConceptDbObject>();
  final ToOne<ReferenceDbObject> indicationReference = ToOne<ReferenceDbObject>();
  final ToMany<MedicationKnowledgePatientCharacteristicsDbObject> patientCharacteristics = ToMany<MedicationKnowledgePatientCharacteristicsDbObject>();
...
class MedicationKnowledgePatientCharacteristicsDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> characteristicCodeableConcept = ToOne<CodeableConceptDbObject>();
  final ToOne<QuantityDbObject> characteristicQuantity = ToOne<QuantityDbObject>();
  final ToOne<StringDbObject> value = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> valueElement = ToMany<PrimitiveElementDbObject>();
...
class MedicationKnowledgeRegulatoryDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<ReferenceDbObject> regulatoryAuthority = ToOne<ReferenceDbObject>();
  final ToMany<MedicationKnowledgeSubstitutionDbObject> substitution = ToMany<MedicationKnowledgeSubstitutionDbObject>();
  final ToMany<MedicationKnowledgeScheduleDbObject> schedule = ToMany<MedicationKnowledgeScheduleDbObject>();
  final ToOne<MedicationKnowledgeMaxDispenseDbObject> maxDispense = ToOne<MedicationKnowledgeMaxDispenseDbObject>();
...
class MedicationKnowledgeSubstitutionDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> allowedElement = ToOne<PrimitiveElementDbObject>();
...
class MedicationKnowledgeScheduleDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> schedule = ToOne<CodeableConceptDbObject>();
...
class MedicationKnowledgeKineticsDbObject {
  ...
  final ToOne<FhirDurationDbObject> halfLifePeriod = ToOne<FhirDurationDbObject>();
