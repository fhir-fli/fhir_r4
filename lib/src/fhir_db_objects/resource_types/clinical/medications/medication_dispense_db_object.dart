...
class MedicationDispenseDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> statusElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> statusReasonCodeableConcept =
      ToOne<CodeableConceptDbObject>();
  final ToOne<ReferenceDbObject> statusReasonReference =
  ...
  final ToMany<MedicationDispensePerformerDbObject> performer =
      ToMany<MedicationDispensePerformerDbObject>();
  final ToOne<ReferenceDbObject> location = ToOne<ReferenceDbObject>();
  final ToMany<ReferenceDbObject> authorizingPrescription =
      ToMany<ReferenceDbObject>();
  ...
  final ToOne<FhirDateTimeDbObject> whenPrepared =
      ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> whenPreparedElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDateTimeDbObject> whenHandedOver =
      ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> whenHandedOverElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<MedicationDispenseSubstitutionDbObject> substitution =
      ToOne<MedicationDispenseSubstitutionDbObject>();
...
class MedicationDispenseSubstitutionDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<FhirBooleanDbObject> wasSubstituted =
      ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> wasSubstitutedElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> type = ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> reason =
      ToMany<CodeableConceptDbObject>();
  final ToMany<ReferenceDbObject> responsibleParty =
      ToMany<ReferenceDbObject>();
