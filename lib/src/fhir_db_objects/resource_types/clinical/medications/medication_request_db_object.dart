...
class MedicationRequestDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> doNotPerformElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> reportedBoolean =
      ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> reportedBooleanElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<ReferenceDbObject> reportedReference = ToOne<ReferenceDbObject>();
  final ToOne<CodeableConceptDbObject> medicationCodeableConcept =
      ToOne<CodeableConceptDbObject>();
  final ToOne<ReferenceDbObject> medicationReference =
  ...
  final ToOne<CodeableConceptDbObject> courseOfTherapyType =
      ToOne<CodeableConceptDbObject>();
  ...
  final ToOne<MedicationRequestDispenseRequestDbObject> dispenseRequest =
      ToOne<MedicationRequestDispenseRequestDbObject>();
  final ToOne<MedicationRequestSubstitutionDbObject> substitution =
      ToOne<MedicationRequestSubstitutionDbObject>();
...
class MedicationRequestDispenseRequestDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<MedicationRequestInitialFillDbObject> initialFill =
      ToOne<MedicationRequestInitialFillDbObject>();
  final ToOne<FhirDurationDbObject> dispenseInterval =
      ToOne<FhirDurationDbObject>();
  final ToOne<PeriodDbObject> validityPeriod = ToOne<PeriodDbObject>();
  final ToOne<FhirUnsignedIntDbObject> numberOfRepeatsAllowed =
      ToOne<FhirUnsignedIntDbObject>();
  final ToOne<PrimitiveElementDbObject> numberOfRepeatsAllowedElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<QuantityDbObject> quantity = ToOne<QuantityDbObject>();
  final ToOne<FhirDurationDbObject> expectedSupplyDuration =
      ToOne<FhirDurationDbObject>();
  final ToOne<ReferenceDbObject> performer = ToOne<ReferenceDbObject>();
...
class MedicationRequestSubstitutionDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<FhirBooleanDbObject> allowedBoolean =
      ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> allowedBooleanElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> allowedCodeableConcept =
      ToOne<CodeableConceptDbObject>();
