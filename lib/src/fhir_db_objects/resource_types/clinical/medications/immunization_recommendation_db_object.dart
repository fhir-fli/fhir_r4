...
class ImmunizationRecommendationDbObject {
  ...
  final ToMany<ImmunizationRecommendationRecommendationDbObject>
      recommendation =
      ToMany<ImmunizationRecommendationRecommendationDbObject>();
...
class ImmunizationRecommendationRecommendationDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToMany<CodeableConceptDbObject> vaccineCode =
      ToMany<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> targetDisease =
      ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> contraindicatedVaccineCode =
      ToMany<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> forecastStatus =
      ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> forecastReason =
      ToMany<CodeableConceptDbObject>();
  final ToMany<ImmunizationRecommendationDateCriterionDbObject> dateCriterion =
      ToMany<ImmunizationRecommendationDateCriterionDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> seriesDosesStringElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<ReferenceDbObject> supportingImmunization =
      ToMany<ReferenceDbObject>();
  final ToMany<ReferenceDbObject> supportingPatientInformation =
      ToMany<ReferenceDbObject>();
