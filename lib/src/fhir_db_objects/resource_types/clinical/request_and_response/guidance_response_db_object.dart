...
class GuidanceResponseDbObject {
  ...
  final ToOne<IdentifierDbObject> requestIdentifier = ToOne<IdentifierDbObject>();
  final ToMany<IdentifierDbObject> identifier = ToMany<IdentifierDbObject>();
  final ToOne<FhirUriDbObject> moduleUri = ToOne<FhirUriDbObject>();
  final ToOne<PrimitiveElementDbObject> moduleUriElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCanonicalDbObject> moduleCanonical = ToOne<FhirCanonicalDbObject>();
  final ToOne<PrimitiveElementDbObject> moduleCanonicalElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> moduleCodeableConcept = ToOne<CodeableConceptDbObject>();
  ...
  final ToMany<ReferenceDbObject> evaluationMessage = ToMany<ReferenceDbObject>();
  ...
  final ToMany<DataRequirementDbObject> dataRequirement = ToMany<DataRequirementDbObject>();
