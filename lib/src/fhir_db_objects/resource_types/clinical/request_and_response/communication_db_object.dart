...
class CommunicationDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> sentElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDateTimeDbObject> received = ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> receivedElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<CommunicationPayloadDbObject> payload =
      ToMany<CommunicationPayloadDbObject>();
