...
class TestReportDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> resultElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> testerElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDateTimeDbObject> issued = ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> issuedElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<TestReportParticipantDbObject> participant =
      ToMany<TestReportParticipantDbObject>();
  ...
  final ToOne<TestReportTeardownDbObject> teardown =
      ToOne<TestReportTeardownDbObject>();
...
class TestReportSetupDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToMany<TestReportActionDbObject> action =
      ToMany<TestReportActionDbObject>();
...
class TestReportActionDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<TestReportOperationDbObject> operation =
      ToOne<TestReportOperationDbObject>();
  final ToOne<TestReportAssertDbObject> assert_ =
      ToOne<TestReportAssertDbObject>();
...
class TestReportOperationDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> messageElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirUriDbObject> detail = ToOne<FhirUriDbObject>();
  final ToOne<PrimitiveElementDbObject> detailElement =
      ToOne<PrimitiveElementDbObject>();
...
class TestReportTestDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> descriptionElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<TestReportAction1DbObject> action =
      ToMany<TestReportAction1DbObject>();
...
class TestReportTeardownDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToMany<TestReportAction2DbObject> action =
      ToMany<TestReportAction2DbObject>();
