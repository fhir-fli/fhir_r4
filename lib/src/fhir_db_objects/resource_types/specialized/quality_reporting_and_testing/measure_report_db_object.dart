...
class MeasureReportDbObject {
  ...
  final ToMany<MeasureReportGroupDbObject> group =
      ToMany<MeasureReportGroupDbObject>();
  final ToMany<ReferenceDbObject> evaluatedResource =
...
class MeasureReportGroupDbObject {
  ...
  final ToMany<MeasureReportPopulationDbObject> population =
      ToMany<MeasureReportPopulationDbObject>();
  final ToOne<QuantityDbObject> measureScore = ToOne<QuantityDbObject>();
  final ToMany<MeasureReportStratifierDbObject> stratifier =
      ToMany<MeasureReportStratifierDbObject>();
...
class MeasureReportStratifierDbObject {
  ...
  final ToMany<MeasureReportStratumDbObject> stratum =
      ToMany<MeasureReportStratumDbObject>();
...
class MeasureReportStratumDbObject {
  ...
  final ToMany<MeasureReportComponentDbObject> component =
      ToMany<MeasureReportComponentDbObject>();
  final ToMany<MeasureReportPopulation1DbObject> population =
      ToMany<MeasureReportPopulation1DbObject>();
  final ToOne<QuantityDbObject> measureScore = ToOne<QuantityDbObject>();
