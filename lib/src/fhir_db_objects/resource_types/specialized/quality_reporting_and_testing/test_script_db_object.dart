...
class TestScriptDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> copyrightElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<TestScriptOriginDbObject> origin =
      ToMany<TestScriptOriginDbObject>();
  final ToMany<TestScriptDestinationDbObject> destination =
      ToMany<TestScriptDestinationDbObject>();
  final ToOne<TestScriptMetadataDbObject> metadata =
      ToOne<TestScriptMetadataDbObject>();
  final ToMany<TestScriptFixtureDbObject> fixture =
      ToMany<TestScriptFixtureDbObject>();
  final ToMany<ReferenceDbObject> profile = ToMany<ReferenceDbObject>();
  final ToMany<TestScriptVariableDbObject> variable =
      ToMany<TestScriptVariableDbObject>();
  ...
  final ToOne<TestScriptTeardownDbObject> teardown =
      ToOne<TestScriptTeardownDbObject>();
...
class TestScriptOriginDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> indexElement =
      ToOne<PrimitiveElementDbObject>();
...
class TestScriptMetadataDbObject {
  ...
  final ToMany<TestScriptCapabilityDbObject> capability =
      ToMany<TestScriptCapabilityDbObject>();
...
class TestScriptCapabilityDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> validatedElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> description = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> descriptionElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<FhirIntegerDbObject> origin = ToMany<FhirIntegerDbObject>();
  final ToMany<PrimitiveElementDbObject> originElement =
      ToMany<PrimitiveElementDbObject>();
  final ToOne<FhirIntegerDbObject> destination = ToOne<FhirIntegerDbObject>();
  final ToOne<PrimitiveElementDbObject> destinationElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<FhirUriDbObject> link = ToMany<FhirUriDbObject>();
  final ToMany<PrimitiveElementDbObject> linkElement =
      ToMany<PrimitiveElementDbObject>();
  final ToOne<FhirCanonicalDbObject> capabilities =
...
class TestScriptFixtureDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> autocreateElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> autodelete = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> autodeleteElement =
      ToOne<PrimitiveElementDbObject>();
...
class TestScriptVariableDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> defaultValueElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> description = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> descriptionElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> headerFieldElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> hint = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> hintElement =
      ToOne<PrimitiveElementDbObject>();
...
class TestScriptSetupDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToMany<TestScriptActionDbObject> action =
      ToMany<TestScriptActionDbObject>();
...
class TestScriptActionDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<TestScriptOperationDbObject> operation =
      ToOne<TestScriptOperationDbObject>();
  final ToOne<TestScriptAssertDbObject> assert_ =
      ToOne<TestScriptAssertDbObject>();
...
class TestScriptOperationDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> acceptElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> destinationElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> encodeRequestUrl =
      ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> encodeRequestUrlElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> originElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> params = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> paramsElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<TestScriptRequestHeaderDbObject> requestHeader =
      ToMany<TestScriptRequestHeaderDbObject>();
  final ToOne<FhirIdDbObject> requestId = ToOne<FhirIdDbObject>();
  final ToOne<PrimitiveElementDbObject> requestIdElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirIdDbObject> responseId = ToOne<FhirIdDbObject>();
  final ToOne<PrimitiveElementDbObject> responseIdElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirIdDbObject> sourceId = ToOne<FhirIdDbObject>();
  final ToOne<PrimitiveElementDbObject> sourceIdElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirIdDbObject> targetId = ToOne<FhirIdDbObject>();
  final ToOne<PrimitiveElementDbObject> targetIdElement =
      ToOne<PrimitiveElementDbObject>();
...
class TestScriptRequestHeaderDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> fieldElement =
      ToOne<PrimitiveElementDbObject>();
...
class TestScriptAssertDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> compareToSourceIdElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> compareToSourceExpression =
      ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> compareToSourceExpressionElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> compareToSourcePath = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> compareToSourcePathElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> contentType = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> contentTypeElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> minimumIdElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> navigationLinks =
      ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> navigationLinksElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> operator_ = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> operatorElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> path = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> pathElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> requestMethod = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> requestMethodElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> requestURL = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> requestURLElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> resource = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> resourceElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> response = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> responseElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> responseCode = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> responseCodeElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirIdDbObject> sourceId = ToOne<FhirIdDbObject>();
  final ToOne<PrimitiveElementDbObject> sourceIdElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirIdDbObject> validateProfileId = ToOne<FhirIdDbObject>();
  final ToOne<PrimitiveElementDbObject> validateProfileIdElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> value = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> valueElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> warningOnly = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> warningOnlyElement =
      ToOne<PrimitiveElementDbObject>();
...
class TestScriptTestDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> descriptionElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<TestScriptAction1DbObject> action =
      ToMany<TestScriptAction1DbObject>();
...
class TestScriptTeardownDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToMany<TestScriptAction2DbObject> action =
      ToMany<TestScriptAction2DbObject>();
