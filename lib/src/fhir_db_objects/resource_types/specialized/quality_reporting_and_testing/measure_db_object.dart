...
class MeasureDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> disclaimerElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> scoring = ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> compositeScoring = ToOne<CodeableConceptDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> riskAdjustmentElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> rateAggregation = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> rateAggregationElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirMarkdownDbObject> rationale = ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> rationaleElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirMarkdownDbObject> clinicalRecommendationStatement = ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> clinicalRecommendationStatementElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> improvementNotation = ToOne<CodeableConceptDbObject>();
  final ToMany<FhirMarkdownDbObject> definition = ToMany<FhirMarkdownDbObject>();
  final ToMany<PrimitiveElementDbObject> definitionElement = ToMany<PrimitiveElementDbObject>();
  final ToOne<FhirMarkdownDbObject> guidance = ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> guidanceElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<MeasureGroupDbObject> group = ToMany<MeasureGroupDbObject>();
  final ToMany<MeasureSupplementalDataDbObject> supplementalData = ToMany<MeasureSupplementalDataDbObject>();
...
class MeasureGroupDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> descriptionElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<MeasurePopulationDbObject> population = ToMany<MeasurePopulationDbObject>();
  final ToMany<MeasureStratifierDbObject> stratifier = ToMany<MeasureStratifierDbObject>();
...
class MeasurePopulationDbObject {
  ...
  final ToOne<StringDbObject> description = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> descriptionElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirExpressionDbObject> criteria = ToOne<FhirExpressionDbObject>();
...
class MeasureStratifierDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> descriptionElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirExpressionDbObject> criteria = ToOne<FhirExpressionDbObject>();
  final ToMany<MeasureComponentDbObject> component = ToMany<MeasureComponentDbObject>();
...
class MeasureSupplementalDataDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> code = ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> usage = ToMany<CodeableConceptDbObject>();
  final ToOne<StringDbObject> description = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> descriptionElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirExpressionDbObject> criteria = ToOne<FhirExpressionDbObject>();
