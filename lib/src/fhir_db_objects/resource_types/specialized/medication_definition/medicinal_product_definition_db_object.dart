...
class MedicinalProductDefinitionDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> descriptionElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> combinedPharmaceuticalDoseForm =
      ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> route =
      ToMany<CodeableConceptDbObject>();
  final ToOne<FhirMarkdownDbObject> indication = ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> indicationElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> legalStatusOfSupply =
      ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> additionalMonitoringIndicator =
      ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> specialMeasures =
      ToMany<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> pediatricUseIndicator =
      ToOne<CodeableConceptDbObject>();
  ...
  final ToMany<CodeableConceptDbObject> packagedMedicinalProduct =
      ToMany<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> ingredient =
      ToMany<CodeableConceptDbObject>();
  final ToMany<CodeableReferenceDbObject> impurity =
      ToMany<CodeableReferenceDbObject>();
  final ToMany<ReferenceDbObject> attachedDocument =
      ToMany<ReferenceDbObject>();
  final ToMany<ReferenceDbObject> masterFile = ToMany<ReferenceDbObject>();
  final ToMany<MedicinalProductDefinitionContactDbObject> contact =
      ToMany<MedicinalProductDefinitionContactDbObject>();
  ...
  final ToMany<MedicinalProductDefinitionNameDbObject> name =
      ToMany<MedicinalProductDefinitionNameDbObject>();
  final ToMany<MedicinalProductDefinitionCrossReferenceDbObject>
      crossReference =
      ToMany<MedicinalProductDefinitionCrossReferenceDbObject>();
  final ToMany<MedicinalProductDefinitionOperationDbObject> operation =
      ToMany<MedicinalProductDefinitionOperationDbObject>();
  final ToMany<MedicinalProductDefinitionCharacteristicDbObject>
      characteristic =
      ToMany<MedicinalProductDefinitionCharacteristicDbObject>();
  MedicinalProductDefinitionDbObject({required this.id});
}
...
class MedicinalProductDefinitionNameDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> productNameElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> type = ToOne<CodeableConceptDbObject>();
  final ToMany<MedicinalProductDefinitionNamePartDbObject> namePart =
      ToMany<MedicinalProductDefinitionNamePartDbObject>();
  final ToMany<MedicinalProductDefinitionCountryLanguageDbObject>
      countryLanguage =
      ToMany<MedicinalProductDefinitionCountryLanguageDbObject>();
...
class MedicinalProductDefinitionNamePartDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> partElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> type = ToOne<CodeableConceptDbObject>();
...
class MedicinalProductDefinitionCrossReferenceDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableReferenceDbObject> product =
...
class MedicinalProductDefinitionOperationDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableReferenceDbObject> type =
      ToOne<CodeableReferenceDbObject>();
  ...
  final ToOne<CodeableConceptDbObject> confidentialityIndicator =
      ToOne<CodeableConceptDbObject>();
