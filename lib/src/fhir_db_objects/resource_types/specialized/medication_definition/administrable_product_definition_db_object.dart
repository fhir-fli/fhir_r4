...
class AdministrableProductDefinitionDbObject {
  ...
  final ToOne<CodeableConceptDbObject> administrableDoseForm =
  ...
  final ToMany<AdministrableProductDefinitionPropertyDbObject> property =
      ToMany<AdministrableProductDefinitionPropertyDbObject>();
  final ToMany<AdministrableProductDefinitionRouteOfAdministrationDbObject>
      routeOfAdministration =
      ToMany<AdministrableProductDefinitionRouteOfAdministrationDbObject>();
...
class AdministrableProductDefinitionRouteOfAdministrationDbObject {
  ...
  final ToOne<FhirDurationDbObject> maxTreatmentPeriod =
      ToOne<FhirDurationDbObject>();
  final ToMany<AdministrableProductDefinitionTargetSpeciesDbObject>
      targetSpecies =
      ToMany<AdministrableProductDefinitionTargetSpeciesDbObject>();
  AdministrableProductDefinitionRouteOfAdministrationDbObject(
      {required this.id});
}
...
class AdministrableProductDefinitionTargetSpeciesDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> code = ToOne<CodeableConceptDbObject>();
  final ToMany<AdministrableProductDefinitionWithdrawalPeriodDbObject>
      withdrawalPeriod =
      ToMany<AdministrableProductDefinitionWithdrawalPeriodDbObject>();
...
class AdministrableProductDefinitionWithdrawalPeriodDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> tissue =
      ToOne<CodeableConceptDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> supportingInformationElement =
      ToOne<PrimitiveElementDbObject>();
