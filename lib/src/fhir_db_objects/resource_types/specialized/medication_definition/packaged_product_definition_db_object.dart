...
class PackagedProductDefinitionDbObject {
  ...
  final ToMany<QuantityDbObject> containedItemQuantity = ToMany<QuantityDbObject>();
  ...
  final ToMany<PackagedProductDefinitionLegalStatusOfSupplyDbObject> legalStatusOfSupply = ToMany<PackagedProductDefinitionLegalStatusOfSupplyDbObject>();
  final ToMany<MarketingStatusDbObject> marketingStatus = ToMany<MarketingStatusDbObject>();
  final ToMany<CodeableConceptDbObject> characteristic = ToMany<CodeableConceptDbObject>();
  final ToOne<FhirBooleanDbObject> copackagedIndicator = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> copackagedIndicatorElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<ReferenceDbObject> manufacturer = ToMany<ReferenceDbObject>();
  final ToOne<PackagedProductDefinitionPackageDbObject> package = ToOne<PackagedProductDefinitionPackageDbObject>();
...
class PackagedProductDefinitionPackageDbObject {
  ...
  final ToMany<CodeableConceptDbObject> material = ToMany<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> alternateMaterial = ToMany<CodeableConceptDbObject>();
  final ToMany<PackagedProductDefinitionShelfLifeStorageDbObject> shelfLifeStorage = ToMany<PackagedProductDefinitionShelfLifeStorageDbObject>();
  final ToMany<ReferenceDbObject> manufacturer = ToMany<ReferenceDbObject>();
  final ToMany<PackagedProductDefinitionPropertyDbObject> property = ToMany<PackagedProductDefinitionPropertyDbObject>();
  final ToMany<PackagedProductDefinitionContainedItemDbObject> containedItem = ToMany<PackagedProductDefinitionContainedItemDbObject>();
  final ToMany<PackagedProductDefinitionPackageDbObject> package = ToMany<PackagedProductDefinitionPackageDbObject>();
...
class PackagedProductDefinitionShelfLifeStorageDbObject {
  ...
  final ToOne<CodeableConceptDbObject> type = ToOne<CodeableConceptDbObject>();
  final ToOne<FhirDurationDbObject> periodDuration = ToOne<FhirDurationDbObject>();
  final ToOne<StringDbObject> periodString = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> periodStringElement = ToOne<PrimitiveElementDbObject>();
