...
class ClinicalUseDefinitionDbObject {
  ...
  final ToOne<ClinicalUseDefinitionContraindicationDbObject> contraindication =
      ToOne<ClinicalUseDefinitionContraindicationDbObject>();
  final ToOne<ClinicalUseDefinitionIndicationDbObject> indication =
      ToOne<ClinicalUseDefinitionIndicationDbObject>();
  final ToOne<ClinicalUseDefinitionInteractionDbObject> interaction =
      ToOne<ClinicalUseDefinitionInteractionDbObject>();
  final ToMany<ReferenceDbObject> population = ToMany<ReferenceDbObject>();
  final ToOne<ClinicalUseDefinitionUndesirableEffectDbObject>
      undesirableEffect =
      ToOne<ClinicalUseDefinitionUndesirableEffectDbObject>();
  final ToOne<ClinicalUseDefinitionWarningDbObject> warning =
      ToOne<ClinicalUseDefinitionWarningDbObject>();
...
class ClinicalUseDefinitionContraindicationDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableReferenceDbObject> diseaseSymptomProcedure =
      ToOne<CodeableReferenceDbObject>();
  final ToOne<CodeableReferenceDbObject> diseaseStatus =
      ToOne<CodeableReferenceDbObject>();
  final ToMany<CodeableReferenceDbObject> comorbidity =
      ToMany<CodeableReferenceDbObject>();
  final ToMany<ReferenceDbObject> indication = ToMany<ReferenceDbObject>();
  final ToMany<ClinicalUseDefinitionOtherTherapyDbObject> otherTherapy =
      ToMany<ClinicalUseDefinitionOtherTherapyDbObject>();
...
class ClinicalUseDefinitionOtherTherapyDbObject {
  ...
  final ToOne<CodeableConceptDbObject> relationshipType =
      ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableReferenceDbObject> therapy =
      ToOne<CodeableReferenceDbObject>();
...
class ClinicalUseDefinitionIndicationDbObject {
  ...
  final ToMany<CodeableReferenceDbObject> comorbidity =
      ToMany<CodeableReferenceDbObject>();
  final ToOne<CodeableReferenceDbObject> intendedEffect =
      ToOne<CodeableReferenceDbObject>();
  final ToOne<RangeDbObject> durationRange = ToOne<RangeDbObject>();
  final ToOne<FhirMarkdownDbObject> durationString =
      ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> durationStringElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<ReferenceDbObject> undesirableEffect =
...
class ClinicalUseDefinitionInteractionDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToMany<ClinicalUseDefinitionInteractantDbObject> interactant =
      ToMany<ClinicalUseDefinitionInteractantDbObject>();
  final ToOne<CodeableConceptDbObject> type = ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableReferenceDbObject> effect =
      ToOne<CodeableReferenceDbObject>();
  final ToOne<CodeableConceptDbObject> incidence =
      ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> management =
      ToMany<CodeableConceptDbObject>();
...
class ClinicalUseDefinitionUndesirableEffectDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableReferenceDbObject> symptomConditionEffect =
      ToOne<CodeableReferenceDbObject>();
  final ToOne<CodeableConceptDbObject> classification =
      ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> frequencyOfOccurrence =
      ToOne<CodeableConceptDbObject>();
  ClinicalUseDefinitionUndesirableEffectDbObject({required this.id});
}
