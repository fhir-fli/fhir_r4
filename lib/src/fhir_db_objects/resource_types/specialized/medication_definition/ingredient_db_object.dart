...
class IngredientDbObject {
  ...
  final ToMany<CodeableConceptDbObject> function = ToMany<CodeableConceptDbObject>();
  ...
  final ToMany<IngredientManufacturerDbObject> manufacturer = ToMany<IngredientManufacturerDbObject>();
  final ToOne<IngredientSubstanceDbObject> substance = ToOne<IngredientSubstanceDbObject>();
...
class IngredientSubstanceDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableReferenceDbObject> code = ToOne<CodeableReferenceDbObject>();
  final ToMany<IngredientStrengthDbObject> strength = ToMany<IngredientStrengthDbObject>();
...
class IngredientStrengthDbObject {
  ...
  final ToOne<RatioRangeDbObject> presentationRatioRange = ToOne<RatioRangeDbObject>();
  final ToOne<StringDbObject> textPresentation = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> textPresentationElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<RatioDbObject> concentrationRatio = ToOne<RatioDbObject>();
  final ToOne<RatioRangeDbObject> concentrationRatioRange = ToOne<RatioRangeDbObject>();
  final ToOne<StringDbObject> textConcentration = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> textConcentrationElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> measurementPoint = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> measurementPointElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<CodeableConceptDbObject> country = ToMany<CodeableConceptDbObject>();
  final ToMany<IngredientReferenceStrengthDbObject> referenceStrength = ToMany<IngredientReferenceStrengthDbObject>();
...
class IngredientReferenceStrengthDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableReferenceDbObject> substance = ToOne<CodeableReferenceDbObject>();
  final ToOne<RatioDbObject> strengthRatio = ToOne<RatioDbObject>();
  final ToOne<RatioRangeDbObject> strengthRatioRange = ToOne<RatioRangeDbObject>();
