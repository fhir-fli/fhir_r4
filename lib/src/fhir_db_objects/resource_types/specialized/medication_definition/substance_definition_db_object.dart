...
class SubstanceDefinitionDbObject {
  ...
  final ToOne<CodeableConceptDbObject> domain =
      ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> grade =
      ToMany<CodeableConceptDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> descriptionElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<ReferenceDbObject> informationSource =
  ...
  final ToMany<SubstanceDefinitionMoietyDbObject> moiety =
      ToMany<SubstanceDefinitionMoietyDbObject>();
  final ToMany<SubstanceDefinitionPropertyDbObject> property =
      ToMany<SubstanceDefinitionPropertyDbObject>();
  final ToMany<SubstanceDefinitionMolecularWeightDbObject> molecularWeight =
      ToMany<SubstanceDefinitionMolecularWeightDbObject>();
  final ToOne<SubstanceDefinitionStructureDbObject> structure =
      ToOne<SubstanceDefinitionStructureDbObject>();
  final ToMany<SubstanceDefinitionCodeDbObject> code =
      ToMany<SubstanceDefinitionCodeDbObject>();
  final ToMany<SubstanceDefinitionNameDbObject> name =
      ToMany<SubstanceDefinitionNameDbObject>();
  final ToMany<SubstanceDefinitionRelationshipDbObject> relationship =
      ToMany<SubstanceDefinitionRelationshipDbObject>();
  final ToOne<SubstanceDefinitionSourceMaterialDbObject> sourceMaterial =
      ToOne<SubstanceDefinitionSourceMaterialDbObject>();
  SubstanceDefinitionDbObject({required this.id});
}
...
class SubstanceDefinitionMoietyDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> nameElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> stereochemistry =
      ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> opticalActivity =
      ToOne<CodeableConceptDbObject>();
  final ToOne<StringDbObject> molecularFormula = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> molecularFormulaElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<QuantityDbObject> amountQuantity = ToOne<QuantityDbObject>();
  final ToOne<FhirMarkdownDbObject> amountString =
      ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> amountStringElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> measurementType =
      ToOne<CodeableConceptDbObject>();
...
class SubstanceDefinitionStructureDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> molecularFormulaElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> molecularFormulaByMoiety =
      ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> molecularFormulaByMoietyElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<SubstanceDefinitionMolecularWeightDbObject> molecularWeight =
      ToOne<SubstanceDefinitionMolecularWeightDbObject>();
  final ToMany<CodeableConceptDbObject> technique =
      ToMany<CodeableConceptDbObject>();
  final ToMany<ReferenceDbObject> sourceDocument = ToMany<ReferenceDbObject>();
  final ToMany<SubstanceDefinitionRepresentationDbObject> representation =
      ToMany<SubstanceDefinitionRepresentationDbObject>();
...
class SubstanceDefinitionRepresentationDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> representationElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> format =
      ToOne<CodeableConceptDbObject>();
...
class SubstanceDefinitionNameDbObject {
  ...
  final ToMany<CodeableConceptDbObject> language =
      ToMany<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> domain =
      ToMany<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> jurisdiction =
      ToMany<CodeableConceptDbObject>();
  final ToMany<SubstanceDefinitionNameDbObject> synonym =
      ToMany<SubstanceDefinitionNameDbObject>();
  final ToMany<SubstanceDefinitionNameDbObject> translation =
      ToMany<SubstanceDefinitionNameDbObject>();
  final ToMany<SubstanceDefinitionOfficialDbObject> official =
      ToMany<SubstanceDefinitionOfficialDbObject>();
  final ToMany<ReferenceDbObject> source = ToMany<ReferenceDbObject>();
...
class SubstanceDefinitionOfficialDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> authority =
      ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> status =
      ToOne<CodeableConceptDbObject>();
...
class SubstanceDefinitionRelationshipDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<ReferenceDbObject> substanceDefinitionReference =
      ToOne<ReferenceDbObject>();
  final ToOne<CodeableConceptDbObject> substanceDefinitionCodeableConcept =
      ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> type = ToOne<CodeableConceptDbObject>();
  final ToOne<FhirBooleanDbObject> isDefining = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> isDefiningElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<QuantityDbObject> amountQuantity = ToOne<QuantityDbObject>();
  ...
  final ToOne<CodeableConceptDbObject> comparator =
      ToOne<CodeableConceptDbObject>();
  final ToMany<ReferenceDbObject> source = ToMany<ReferenceDbObject>();
...
class SubstanceDefinitionSourceMaterialDbObject {
  ...
  final ToOne<CodeableConceptDbObject> species =
      ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> part_ = ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> countryOfOrigin =
      ToMany<CodeableConceptDbObject>();
