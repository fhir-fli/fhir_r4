...
class RegulatedAuthorizationDbObject {
  ...
  final ToMany<CodeableConceptDbObject> region = ToMany<CodeableConceptDbObject>();
  ...
  final ToOne<CodeableReferenceDbObject> indication = ToOne<CodeableReferenceDbObject>();
  final ToOne<CodeableConceptDbObject> intendedUse = ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> basis = ToMany<CodeableConceptDbObject>();
  ...
  final ToOne<RegulatedAuthorizationCaseDbObject> case_ = ToOne<RegulatedAuthorizationCaseDbObject>();
...
class RegulatedAuthorizationCaseDbObject {
  ...
  final ToOne<FhirDateTimeDbObject> dateDateTime = ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> dateDateTimeElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<RegulatedAuthorizationCaseDbObject> application = ToMany<RegulatedAuthorizationCaseDbObject>();
