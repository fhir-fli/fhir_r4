...
class ObservationDefinitionDbObject {
  ...
  final ToMany<ElementDbObject> permittedDataTypeElement = ToMany<ElementDbObject>();
  final ToOne<FhirBooleanDbObject> multipleResultsAllowed = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> multipleResultsAllowedElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> preferredReportNameElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<ObservationDefinitionQuantitativeDetailsDbObject> quantitativeDetails = ToOne<ObservationDefinitionQuantitativeDetailsDbObject>();
  final ToMany<ObservationDefinitionQualifiedIntervalDbObject> qualifiedInterval = ToMany<ObservationDefinitionQualifiedIntervalDbObject>();
  final ToOne<ReferenceDbObject> validCodedValueSet = ToOne<ReferenceDbObject>();
  final ToOne<ReferenceDbObject> normalCodedValueSet = ToOne<ReferenceDbObject>();
  final ToOne<ReferenceDbObject> abnormalCodedValueSet = ToOne<ReferenceDbObject>();
  final ToOne<ReferenceDbObject> criticalCodedValueSet = ToOne<ReferenceDbObject>();
...
class ObservationDefinitionQuantitativeDetailsDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> customaryUnit = ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> unit = ToOne<CodeableConceptDbObject>();
  final ToOne<FhirDecimalDbObject> conversionFactor = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> conversionFactorElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirIntegerDbObject> decimalPrecision = ToOne<FhirIntegerDbObject>();
  final ToOne<PrimitiveElementDbObject> decimalPrecisionElement = ToOne<PrimitiveElementDbObject>();
...
class ObservationDefinitionQualifiedIntervalDbObject {
  ...
  final ToOne<CodeableConceptDbObject> context = ToOne<CodeableConceptDbObject>();
