...
class QuestionnaireDbObject {
  ...
  final ToMany<PrimitiveElementDbObject> subjectTypeElement =
  ...
  final ToMany<QuestionnaireItemDbObject> item =
      ToMany<QuestionnaireItemDbObject>();
...
class QuestionnaireItemDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> typeElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<QuestionnaireEnableWhenDbObject> enableWhen =
      ToMany<QuestionnaireEnableWhenDbObject>();
  final ToOne<FhirCodeDbObject> enableBehavior = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> enableBehaviorElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> repeatsElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> readOnly = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> readOnlyElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirIntegerDbObject> maxLength = ToOne<FhirIntegerDbObject>();
  final ToOne<PrimitiveElementDbObject> maxLengthElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCanonicalDbObject> answerValueSet =
      ToOne<FhirCanonicalDbObject>();
  final ToMany<QuestionnaireAnswerOptionDbObject> answerOption =
      ToMany<QuestionnaireAnswerOptionDbObject>();
  final ToMany<QuestionnaireInitialDbObject> initial =
      ToMany<QuestionnaireInitialDbObject>();
  final ToMany<QuestionnaireItemDbObject> item =
      ToMany<QuestionnaireItemDbObject>();
...
class QuestionnaireEnableWhenDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> questionElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> answerBooleanElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDecimalDbObject> answerDecimal = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> answerDecimalElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirIntegerDbObject> answerInteger = ToOne<FhirIntegerDbObject>();
  final ToOne<PrimitiveElementDbObject> answerIntegerElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDateDbObject> answerDate = ToOne<FhirDateDbObject>();
  final ToOne<PrimitiveElementDbObject> answerDateElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDateTimeDbObject> answerDateTime =
      ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> answerDateTimeElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirTimeDbObject> answerTime = ToOne<FhirTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> answerTimeElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> answerString = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> answerStringElement =
      ToOne<PrimitiveElementDbObject>();
...
class QuestionnaireAnswerOptionDbObject {
  ...
  final ToOne<FhirBooleanDbObject> initialSelected =
      ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> initialSelectedElement =
      ToOne<PrimitiveElementDbObject>();
