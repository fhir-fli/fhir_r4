...
class ActivityDefinitionDbObject {
  ...
  final ToMany<ActivityDefinitionParticipantDbObject> participant = ToMany<ActivityDefinitionParticipantDbObject>();
  ...
  final ToMany<ReferenceDbObject> specimenRequirement = ToMany<ReferenceDbObject>();
  final ToMany<ReferenceDbObject> observationRequirement = ToMany<ReferenceDbObject>();
  final ToMany<ReferenceDbObject> observationResultRequirement = ToMany<ReferenceDbObject>();
  final ToOne<FhirCanonicalDbObject> transform = ToOne<FhirCanonicalDbObject>();
  final ToMany<ActivityDefinitionDynamicValueDbObject> dynamicValue = ToMany<ActivityDefinitionDynamicValueDbObject>();
