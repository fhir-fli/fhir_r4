...
class DeviceDefinitionDbObject {
  ...
  final ToMany<DeviceDefinitionUdiDeviceIdentifierDbObject>
      udiDeviceIdentifier =
      ToMany<DeviceDefinitionUdiDeviceIdentifierDbObject>();
  final ToOne<StringDbObject> manufacturerString = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> manufacturerStringElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<ReferenceDbObject> manufacturerReference =
      ToOne<ReferenceDbObject>();
  final ToMany<DeviceDefinitionDeviceNameDbObject> deviceName =
      ToMany<DeviceDefinitionDeviceNameDbObject>();
  final ToOne<StringDbObject> modelNumber = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> modelNumberElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> type = ToOne<CodeableConceptDbObject>();
  final ToMany<DeviceDefinitionSpecializationDbObject> specialization =
      ToMany<DeviceDefinitionSpecializationDbObject>();
  final ToOne<StringDbObject> version = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> versionElement =
      ToMany<PrimitiveElementDbObject>();
  final ToMany<CodeableConceptDbObject> safety =
      ToMany<CodeableConceptDbObject>();
  final ToMany<ProductShelfLifeDbObject> shelfLifeStorage =
      ToMany<ProductShelfLifeDbObject>();
  final ToOne<ProdCharacteristicDbObject> physicalCharacteristics =
      ToOne<ProdCharacteristicDbObject>();
  final ToMany<CodeableConceptDbObject> languageCode =
      ToMany<CodeableConceptDbObject>();
  final ToMany<DeviceDefinitionCapabilityDbObject> capability =
      ToMany<DeviceDefinitionCapabilityDbObject>();
  final ToMany<DeviceDefinitionPropertyDbObject> property =
      ToMany<DeviceDefinitionPropertyDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> onlineInformationElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<DeviceDefinitionMaterialDbObject> material =
      ToMany<DeviceDefinitionMaterialDbObject>();
...
class DeviceDefinitionUdiDeviceIdentifierDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> deviceIdentifierElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirUriDbObject> issuer = ToOne<FhirUriDbObject>();
  final ToOne<PrimitiveElementDbObject> issuerElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirUriDbObject> jurisdiction = ToOne<FhirUriDbObject>();
  final ToOne<PrimitiveElementDbObject> jurisdictionElement =
      ToOne<PrimitiveElementDbObject>();
...
class DeviceDefinitionSpecializationDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> systemTypeElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> version = ToOne<StringDbObject>();
...
class DeviceDefinitionCapabilityDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> type = ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> description =
      ToMany<CodeableConceptDbObject>();
...
class DeviceDefinitionPropertyDbObject {
  ...
  final ToMany<CodeableConceptDbObject> valueCode =
      ToMany<CodeableConceptDbObject>();
...
class DeviceDefinitionMaterialDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> substance =
      ToOne<CodeableConceptDbObject>();
  final ToOne<FhirBooleanDbObject> alternate = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> alternateElement =
      ToOne<PrimitiveElementDbObject>();
