...
class PlanDefinitionDbObject {
  ...
  final ToMany<PlanDefinitionGoalDbObject> goal =
      ToMany<PlanDefinitionGoalDbObject>();
  final ToMany<PlanDefinitionActionDbObject> action =
      ToMany<PlanDefinitionActionDbObject>();
...
class PlanDefinitionGoalDbObject {
  ...
  final ToOne<CodeableConceptDbObject> category =
      ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> description =
      ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> priority =
      ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> start = ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> addresses =
      ToMany<CodeableConceptDbObject>();
  final ToMany<RelatedArtifactDbObject> documentation =
      ToMany<RelatedArtifactDbObject>();
  final ToMany<PlanDefinitionTargetDbObject> target =
      ToMany<PlanDefinitionTargetDbObject>();
...
class PlanDefinitionTargetDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> measure =
      ToOne<CodeableConceptDbObject>();
  ...
  final ToOne<CodeableConceptDbObject> detailCodeableConcept =
      ToOne<CodeableConceptDbObject>();
...
class PlanDefinitionActionDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> prefixElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> title = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> titleElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> textEquivalentElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<PrimitiveElementDbObject> goalIdElement =
  ...
  final ToOne<FhirCanonicalDbObject> subjectCanonical =
      ToOne<FhirCanonicalDbObject>();
  final ToMany<PrimitiveElementDbObject> subjectCanonicalElement =
      ToMany<PrimitiveElementDbObject>();
  final ToMany<TriggerDefinitionDbObject> trigger =
      ToMany<TriggerDefinitionDbObject>();
  final ToMany<PlanDefinitionConditionDbObject> condition =
      ToMany<PlanDefinitionConditionDbObject>();
  final ToMany<DataRequirementDbObject> input =
      ToMany<DataRequirementDbObject>();
  final ToMany<DataRequirementDbObject> output =
      ToMany<DataRequirementDbObject>();
  final ToMany<PlanDefinitionRelatedActionDbObject> relatedAction =
      ToMany<PlanDefinitionRelatedActionDbObject>();
  ...
  final ToMany<PlanDefinitionParticipantDbObject> participant =
      ToMany<PlanDefinitionParticipantDbObject>();
  final ToOne<CodeableConceptDbObject> type = ToOne<CodeableConceptDbObject>();
  final ToOne<FhirCodeDbObject> groupingBehavior = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> groupingBehaviorElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> selectionBehavior = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> selectionBehaviorElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> requiredBehavior = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> requiredBehaviorElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> precheckBehavior = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> precheckBehaviorElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> cardinalityBehavior = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> cardinalityBehaviorElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> definitionUriElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCanonicalDbObject> transform = ToOne<FhirCanonicalDbObject>();
  final ToMany<PlanDefinitionDynamicValueDbObject> dynamicValue =
      ToMany<PlanDefinitionDynamicValueDbObject>();
  final ToMany<PlanDefinitionActionDbObject> action =
      ToMany<PlanDefinitionActionDbObject>();
...
class PlanDefinitionRelatedActionDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> actionIdElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> relationship = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> relationshipElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDurationDbObject> offsetDuration =
      ToOne<FhirDurationDbObject>();
