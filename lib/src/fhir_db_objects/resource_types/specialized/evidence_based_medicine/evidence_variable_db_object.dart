...
class EvidenceVariableDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> actualElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> characteristicCombination =
      ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> characteristicCombinationElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<EvidenceVariableCharacteristicDbObject> characteristic =
      ToMany<EvidenceVariableCharacteristicDbObject>();
  final ToOne<FhirCodeDbObject> handling = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> handlingElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<EvidenceVariableCategoryDbObject> category =
      ToMany<EvidenceVariableCategoryDbObject>();
...
class EvidenceVariableCharacteristicDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> descriptionElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<ReferenceDbObject> definitionReference =
  ...
  final ToOne<PrimitiveElementDbObject> excludeElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<EvidenceVariableTimeFromStartDbObject> timeFromStart =
      ToOne<EvidenceVariableTimeFromStartDbObject>();
  final ToOne<FhirCodeDbObject> groupMeasure = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> groupMeasureElement =
      ToOne<PrimitiveElementDbObject>();
