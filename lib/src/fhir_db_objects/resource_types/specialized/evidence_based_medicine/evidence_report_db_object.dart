...
class EvidenceReportDbObject {
  ...
  final ToOne<FhirMarkdownDbObject> citeAsMarkdown = ToOne<FhirMarkdownDbObject>();
  ...
  final ToOne<EvidenceReportSubjectDbObject> subject = ToOne<EvidenceReportSubjectDbObject>();
  ...
  final ToMany<EvidenceReportRelatesToDbObject> relatesTo = ToMany<EvidenceReportRelatesToDbObject>();
  final ToMany<EvidenceReportSectionDbObject> section = ToMany<EvidenceReportSectionDbObject>();
...
class EvidenceReportSubjectDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToMany<EvidenceReportCharacteristicDbObject> characteristic = ToMany<EvidenceReportCharacteristicDbObject>();
  final ToMany<AnnotationDbObject> note = ToMany<AnnotationDbObject>();
...
class EvidenceReportSectionDbObject {
  ...
  final ToMany<CodeableConceptDbObject> entryClassifier = ToMany<CodeableConceptDbObject>();
