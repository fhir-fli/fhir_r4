...
class EvidenceDbObject {
  ...
  final ToOne<FhirMarkdownDbObject> citAsMarkdown = ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> citeAsMarkdownElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> assertionElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<AnnotationDbObject> note = ToMany<AnnotationDbObject>();
  final ToMany<EvidenceVariableDefinitionDbObject> variableDefinition = ToMany<EvidenceVariableDefinitionDbObject>();
  final ToOne<CodeableConceptDbObject> synthesisType = ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> studyType = ToOne<CodeableConceptDbObject>();
  final ToMany<EvidenceStatisticDbObject> statistic = ToMany<EvidenceStatisticDbObject>();
  final ToMany<EvidenceCertaintyDbObject> certainty = ToMany<EvidenceCertaintyDbObject>();
...
class EvidenceVariableDefinitionDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> descriptionElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<AnnotationDbObject> note = ToMany<AnnotationDbObject>();
  final ToOne<CodeableConceptDbObject> variableRole = ToOne<CodeableConceptDbObject>();
  ...
  final ToOne<CodeableConceptDbObject> directnessMatch = ToOne<CodeableConceptDbObject>();
...
class EvidenceStatisticDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> descriptionElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<AnnotationDbObject> note = ToMany<AnnotationDbObject>();
  final ToOne<CodeableConceptDbObject> statisticType = ToOne<CodeableConceptDbObject>();
  ...
  final ToOne<FhirUnsignedIntDbObject> numberOfEvents = ToOne<FhirUnsignedIntDbObject>();
  final ToOne<PrimitiveElementDbObject> numberOfEventsElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirUnsignedIntDbObject> numberAffected = ToOne<FhirUnsignedIntDbObject>();
  final ToOne<PrimitiveElementDbObject> numberAffectedElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<EvidenceSampleSizeDbObject> sampleSize = ToOne<EvidenceSampleSizeDbObject>();
  final ToMany<EvidenceAttributeEstimateDbObject> attributeEstimate = ToMany<EvidenceAttributeEstimateDbObject>();
  final ToMany<EvidenceModelCharacteristicDbObject> modelCharacteristic = ToMany<EvidenceModelCharacteristicDbObject>();
...
class EvidenceSampleSizeDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> descriptionElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<AnnotationDbObject> note = ToMany<AnnotationDbObject>();
  final ToOne<FhirUnsignedIntDbObject> numberOfStudies = ToOne<FhirUnsignedIntDbObject>();
  final ToOne<PrimitiveElementDbObject> numberOfStudiesElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirUnsignedIntDbObject> numberOfParticipants = ToOne<FhirUnsignedIntDbObject>();
  final ToOne<PrimitiveElementDbObject> numberOfParticipantsElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirUnsignedIntDbObject> knownDataCount = ToOne<FhirUnsignedIntDbObject>();
  final ToOne<PrimitiveElementDbObject> knownDataCountElement = ToOne<PrimitiveElementDbObject>();
...
class EvidenceAttributeEstimateDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> levelElement = ToOne<PrimitiveElementDbObject>();
...
class EvidenceVarDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<ReferenceDbObject> variableDefinition = ToOne<ReferenceDbObject>();
  ...
  final ToMany<CodeableConceptDbObject> valueCategory = ToMany<CodeableConceptDbObject>();
...
class EvidenceCertaintyDbObject {
  ...
  final ToMany<AnnotationDbObject> note = ToMany<AnnotationDbObject>();
  final ToOne<CodeableConceptDbObject> type = ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> rating = ToOne<CodeableConceptDbObject>();
  final ToOne<StringDbObject> rater = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> raterElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<EvidenceCertaintyDbObject> subcomponent = ToMany<EvidenceCertaintyDbObject>();
