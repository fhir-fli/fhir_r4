...
class ResearchElementDefinitionDbObject {
  ...
  final ToMany<PrimitiveElementDbObject> commentElement = ToMany<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> variableTypeElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<ResearchElementDefinitionCharacteristicDbObject> characteristic = ToMany<ResearchElementDefinitionCharacteristicDbObject>();
...
class ResearchElementDefinitionCharacteristicDbObject {
  ...
  final ToOne<DataRequirementDbObject> definitionDataRequirement = ToOne<DataRequirementDbObject>();
  final ToMany<UsageContextDbObject> usageContext = ToMany<UsageContextDbObject>();
  ...
  final ToOne<CodeableConceptDbObject> unitOfMeasure = ToOne<CodeableConceptDbObject>();
  final ToOne<StringDbObject> studyEffectiveDescription = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> studyEffectiveDescriptionElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDateTimeDbObject> studyEffectiveDateTime = ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> studyEffectiveDateTimeElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<PeriodDbObject> studyEffectivePeriod = ToOne<PeriodDbObject>();
  final ToOne<FhirDurationDbObject> studyEffectiveDuration = ToOne<FhirDurationDbObject>();
  final ToOne<TimingDbObject> studyEffectiveTiming = ToOne<TimingDbObject>();
  final ToOne<FhirDurationDbObject> studyEffectiveTimeFromStart = ToOne<FhirDurationDbObject>();
  final ToOne<FhirCodeDbObject> studyEffectiveGroupMeasure = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> studyEffectiveGroupMeasureElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> participantEffectiveDescription = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> participantEffectiveDescriptionElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDateTimeDbObject> participantEffectiveDateTime = ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> participantEffectiveDateTimeElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<PeriodDbObject> participantEffectivePeriod = ToOne<PeriodDbObject>();
  final ToOne<FhirDurationDbObject> participantEffectiveDuration = ToOne<FhirDurationDbObject>();
  final ToOne<TimingDbObject> participantEffectiveTiming = ToOne<TimingDbObject>();
  final ToOne<FhirDurationDbObject> participantEffectiveTimeFromStart = ToOne<FhirDurationDbObject>();
  final ToOne<FhirCodeDbObject> participantEffectiveGroupMeasure = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> participantEffectiveGroupMeasureElement = ToOne<PrimitiveElementDbObject>();
