...
class CitationDbObject {
  ...
  final ToMany<ContactDetailDbObject> endorser =
      ToMany<ContactDetailDbObject>();
  final ToMany<CitationSummaryDbObject> summary =
      ToMany<CitationSummaryDbObject>();
  final ToMany<CitationClassificationDbObject> classification =
      ToMany<CitationClassificationDbObject>();
  final ToMany<AnnotationDbObject> note = ToMany<AnnotationDbObject>();
  final ToMany<CodeableConceptDbObject> currentState =
      ToMany<CodeableConceptDbObject>();
  final ToMany<CitationStatusDateDbObject> statusDate =
      ToMany<CitationStatusDateDbObject>();
  final ToMany<CitationRelatesToDbObject> relatesTo =
      ToMany<CitationRelatesToDbObject>();
  final ToOne<CitationCitedArtifactDbObject> citedArtifact =
      ToOne<CitationCitedArtifactDbObject>();
  CitationDbObject({required this.id});
}
...
class CitationClassificationDbObject {
  ...
  final ToMany<CodeableConceptDbObject> classifier =
      ToMany<CodeableConceptDbObject>();
  CitationClassificationDbObject({required this.id});
}
...
class CitationStatusDateDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> actualElement =
      ToOne<PrimitiveElementDbObject>();
...
class CitationRelatesToDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> relationshipType =
      ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> targetClassifier =
      ToMany<CodeableConceptDbObject>();
  ...
  final ToOne<AttachmentDbObject> targetAttachment =
...
class CitationCitedArtifactDbObject {
  ...
  final ToOne<FhirDateTimeDbObject> dateAccessed =
      ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> dateAccessedElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CitationVersionDbObject> version =
      ToOne<CitationVersionDbObject>();
  final ToMany<CodeableConceptDbObject> currentState =
      ToMany<CodeableConceptDbObject>();
  final ToMany<CitationStatusDate1DbObject> statusDate =
      ToMany<CitationStatusDate1DbObject>();
  final ToMany<CitationTitleDbObject> title = ToMany<CitationTitleDbObject>();
  final ToMany<CitationAbstractDbObject> abstract_ =
      ToMany<CitationAbstractDbObject>();
  final ToOne<CitationPartDbObject> part_ = ToOne<CitationPartDbObject>();
  final ToMany<CitationRelatesTo1DbObject> relatesTo =
      ToMany<CitationRelatesTo1DbObject>();
  final ToMany<CitationPublicationFormDbObject> publicationForm =
      ToMany<CitationPublicationFormDbObject>();
  final ToMany<CitationWebLocationDbObject> webLocation =
      ToMany<CitationWebLocationDbObject>();
  final ToMany<CitationClassification1DbObject> classification =
      ToMany<CitationClassification1DbObject>();
  final ToOne<CitationContributorshipDbObject> contributorship =
      ToOne<CitationContributorshipDbObject>();
  final ToMany<AnnotationDbObject> note = ToMany<AnnotationDbObject>();
  CitationCitedArtifactDbObject({required this.id});
}
...
class CitationPublicationFormDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<CitationPublishedInDbObject> publishedIn =
      ToOne<CitationPublishedInDbObject>();
  final ToOne<CitationPeriodicReleaseDbObject> periodicRelease =
      ToOne<CitationPeriodicReleaseDbObject>();
  final ToOne<FhirDateTimeDbObject> articleDate = ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> articleDateElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDateTimeDbObject> lastRevisionDate =
      ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> lastRevisionDateElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<CodeableConceptDbObject> language =
      ToMany<CodeableConceptDbObject>();
  final ToOne<StringDbObject> accessionNumber = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> accessionNumberElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> pageString = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> pageStringElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> firstPage = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> firstPageElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> lastPage = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> lastPageElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> pageCount = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> pageCountElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirMarkdownDbObject> copyright = ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> copyrightElement =
      ToOne<PrimitiveElementDbObject>();
...
class CitationPublishedInDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> publisherLocationElement =
      ToOne<PrimitiveElementDbObject>();
...
class CitationPeriodicReleaseDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> citedMedium =
      ToOne<CodeableConceptDbObject>();
  final ToOne<StringDbObject> volume = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> volumeElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> issue = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> issueElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CitationDateOfPublicationDbObject> dateOfPublication =
      ToOne<CitationDateOfPublicationDbObject>();
...
class CitationDateOfPublicationDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> yearElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> month = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> monthElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> day = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> dayElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> season = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> seasonElement =
      ToOne<PrimitiveElementDbObject>();
...
class CitationClassification1DbObject {
  ...
  final ToMany<CodeableConceptDbObject> classifier =
      ToMany<CodeableConceptDbObject>();
  final ToOne<CitationWhoClassifiedDbObject> whoClassified =
      ToOne<CitationWhoClassifiedDbObject>();
  final ToMany<ReferenceDbObject> artifactAssessment =
      ToMany<ReferenceDbObject>();
  CitationClassification1DbObject({required this.id});
}
...
class CitationWhoClassifiedDbObject {
  ...
  final ToOne<ReferenceDbObject> publisher = ToOne<ReferenceDbObject>();
  final ToOne<StringDbObject> classifierCopyright = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> classifierCopyrightElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> freeToShare = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> freeToShareElement =
      ToOne<PrimitiveElementDbObject>();
  CitationWhoClassifiedDbObject({required this.id});
}
...
class CitationContributorshipDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> completeElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<CitationEntryDbObject> entry = ToMany<CitationEntryDbObject>();
  final ToMany<CitationSummary1DbObject> summary =
      ToMany<CitationSummary1DbObject>();
...
class CitationEntryDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> initialsElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> collectiveName = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> collectiveNameElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<IdentifierDbObject> identifier = ToMany<IdentifierDbObject>();
  final ToMany<CitationAffiliationInfoDbObject> affiliationInfo =
      ToMany<CitationAffiliationInfoDbObject>();
  ...
  final ToMany<CodeableConceptDbObject> contributionType =
      ToMany<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> role = ToOne<CodeableConceptDbObject>();
  final ToMany<CitationContributionInstanceDbObject> contributionInstance =
      ToMany<CitationContributionInstanceDbObject>();
  final ToOne<FhirBooleanDbObject> correspondingContact =
      ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> correspondingContactElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirPositiveIntDbObject> listOrder =
      ToOne<FhirPositiveIntDbObject>();
  final ToOne<PrimitiveElementDbObject> listOrderElement =
      ToOne<PrimitiveElementDbObject>();
...
class CitationAffiliationInfoDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> affiliationElement =
      ToOne<PrimitiveElementDbObject>();
...
class CitationSummary1DbObject {
  ...
  final ToOne<CodeableConceptDbObject> type = ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> style = ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> source =
      ToOne<CodeableConceptDbObject>();
