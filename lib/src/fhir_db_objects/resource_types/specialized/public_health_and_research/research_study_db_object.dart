...
class ResearchStudyDbObject {
  ...
  final ToOne<CodeableConceptDbObject> primaryPurposeType = ToOne<CodeableConceptDbObject>();
  ...
  final ToMany<CodeableConceptDbObject> focus = ToMany<CodeableConceptDbObject>();
  ...
  final ToMany<CodeableConceptDbObject> keyword = ToMany<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> location = ToMany<CodeableConceptDbObject>();
  ...
  final ToOne<ReferenceDbObject> principalInvestigator = ToOne<ReferenceDbObject>();
  final ToMany<ReferenceDbObject> site = ToMany<ReferenceDbObject>();
  final ToOne<CodeableConceptDbObject> reasonStopped = ToOne<CodeableConceptDbObject>();
  final ToMany<AnnotationDbObject> note = ToMany<AnnotationDbObject>();
  final ToMany<ResearchStudyArmDbObject> arm = ToMany<ResearchStudyArmDbObject>();
  final ToMany<ResearchStudyObjectiveDbObject> objective = ToMany<ResearchStudyObjectiveDbObject>();
