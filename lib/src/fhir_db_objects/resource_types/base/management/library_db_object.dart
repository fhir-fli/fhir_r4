...
class LibraryDbObject {
  ...
  final ToMany<ParameterDefinitionDbObject> parameter =
      ToMany<ParameterDefinitionDbObject>();
  final ToMany<DataRequirementDbObject> dataRequirement =
      ToMany<DataRequirementDbObject>();
  final ToMany<AttachmentDbObject> content = ToMany<AttachmentDbObject>();
  LibraryDbObject({required this.id});
}
