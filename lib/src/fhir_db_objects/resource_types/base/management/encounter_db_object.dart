...
class EncounterDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> statusElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<EncounterStatusHistoryDbObject> statusHistory =
      ToMany<EncounterStatusHistoryDbObject>();
  final ToOne<CodingDbObject> class_ = ToOne<CodingDbObject>();
  final ToMany<EncounterClassHistoryDbObject> classHistory =
      ToMany<EncounterClassHistoryDbObject>();
  final ToOne<CodeableConceptDbObject> serviceType =
  ...
  final ToMany<EncounterParticipantDbObject> participant =
      ToMany<EncounterParticipantDbObject>();
  ...
  final ToMany<EncounterDiagnosisDbObject> diagnosis =
      ToMany<EncounterDiagnosisDbObject>();
  final ToMany<ReferenceDbObject> account = ToMany<ReferenceDbObject>();
  final ToOne<EncounterHospitalizationDbObject> hospitalization =
      ToOne<EncounterHospitalizationDbObject>();
  final ToMany<EncounterLocationDbObject> location =
      ToMany<EncounterLocationDbObject>();
  ...
  EncounterDbObject({required this.id});
}
...
class EncounterClassHistoryDbObject {
  ...
  final ToOne<CodingDbObject> class_ = ToOne<CodingDbObject>();
  final ToOne<PeriodDbObject> period = ToOne<PeriodDbObject>();
  EncounterClassHistoryDbObject({required this.id});
}
...
class EncounterHospitalizationDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<IdentifierDbObject> preAdmissionIdentifier =
      ToOne<IdentifierDbObject>();
  final ToOne<ReferenceDbObject> origin = ToOne<ReferenceDbObject>();
  final ToOne<CodeableConceptDbObject> admitSource =
      ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> reAdmission =
      ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> dietPreference =
      ToMany<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> specialCourtesy =
      ToMany<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> specialArrangement =
      ToMany<CodeableConceptDbObject>();
  final ToOne<ReferenceDbObject> destination = ToOne<ReferenceDbObject>();
  final ToOne<CodeableConceptDbObject> dischargeDisposition =
      ToOne<CodeableConceptDbObject>();
