...
class EpisodeOfCareDbObject {
  ...
  final ToMany<EpisodeOfCareStatusHistoryDbObject> statusHistory = ToMany<EpisodeOfCareStatusHistoryDbObject>();
  final ToMany<CodeableConceptDbObject> type = ToMany<CodeableConceptDbObject>();
  final ToMany<EpisodeOfCareDiagnosisDbObject> diagnosis = ToMany<EpisodeOfCareDiagnosisDbObject>();
