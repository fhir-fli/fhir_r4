...
class TaskDbObject {
  ...
  final ToOne<FhirCanonicalDbObject> instantiatesCanonical = ToOne<FhirCanonicalDbObject>();
  ...
  final ToOne<CodeableConceptDbObject> businessStatus = ToOne<CodeableConceptDbObject>();
  ...
  final ToOne<FhirDateTimeDbObject> lastModified = ToOne<FhirDateTimeDbObject>();
  ...
  final ToOne<CodeableConceptDbObject> reasonCode = ToOne<CodeableConceptDbObject>();
  ...
  final ToOne<TaskRestrictionDbObject> restriction = ToOne<TaskRestrictionDbObject>();
...
class TaskRestrictionDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<FhirPositiveIntDbObject> repetitions = ToOne<FhirPositiveIntDbObject>();
  final ToOne<PrimitiveElementDbObject> repetitionsElement = ToOne<PrimitiveElementDbObject>();
...
class TaskInputDbObject {
  ...
  final ToOne<FhirCanonicalDbObject> valueCanonical = ToOne<FhirCanonicalDbObject>();
  final ToOne<PrimitiveElementDbObject> valueCanonicalElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> valueInstantElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<FhirMarkdownDbObject> valueMarkdown = ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> valueMarkdownElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirOidDbObject> valueOid = ToOne<FhirOidDbObject>();
  final ToOne<PrimitiveElementDbObject> valueOidElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirPositiveIntDbObject> valuePositiveInt = ToOne<FhirPositiveIntDbObject>();
  final ToOne<PrimitiveElementDbObject> valuePositiveIntElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<FhirUnsignedIntDbObject> valueUnsignedInt = ToOne<FhirUnsignedIntDbObject>();
  final ToOne<PrimitiveElementDbObject> valueUnsignedIntElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> valueUrlElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirUuidDbObject> valueUuid = ToOne<FhirUuidDbObject>();
  final ToOne<PrimitiveElementDbObject> valueUuidElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<ContactPointDbObject> valueContactPoint = ToOne<ContactPointDbObject>();
  ...
  final ToOne<ContactDetailDbObject> valueContactDetail = ToOne<ContactDetailDbObject>();
  final ToOne<ContributorDbObject> valueContributor = ToOne<ContributorDbObject>();
  final ToOne<DataRequirementDbObject> valueDataRequirement = ToOne<DataRequirementDbObject>();
  final ToOne<FhirExpressionDbObject> valueExpression = ToOne<FhirExpressionDbObject>();
  final ToOne<ParameterDefinitionDbObject> valueParameterDefinition = ToOne<ParameterDefinitionDbObject>();
  final ToOne<RelatedArtifactDbObject> valueRelatedArtifact = ToOne<RelatedArtifactDbObject>();
  final ToOne<TriggerDefinitionDbObject> valueTriggerDefinition = ToOne<TriggerDefinitionDbObject>();
  final ToOne<UsageContextDbObject> valueUsageContext = ToOne<UsageContextDbObject>();
