...
class AppointmentDbObject {
  ...
  final ToOne<CodeableConceptDbObject> cancelationReason = ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> serviceCategory = ToMany<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> serviceType = ToMany<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> specialty = ToMany<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> appointmentType = ToOne<CodeableConceptDbObject>();
  ...
  final ToOne<FhirUnsignedIntDbObject> priority = ToOne<FhirUnsignedIntDbObject>();
  ...
  final ToOne<FhirPositiveIntDbObject> minutesDuration = ToOne<FhirPositiveIntDbObject>();
  final ToOne<PrimitiveElementDbObject> minutesDurationElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<AppointmentParticipantDbObject> participant = ToMany<AppointmentParticipantDbObject>();
