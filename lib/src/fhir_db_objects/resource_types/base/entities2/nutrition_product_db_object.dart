...
class NutritionProductDbObject {
  ...
  final ToMany<NutritionProductNutrientDbObject> nutrient =
      ToMany<NutritionProductNutrientDbObject>();
  final ToMany<NutritionProductIngredientDbObject> ingredient =
      ToMany<NutritionProductIngredientDbObject>();
  final ToMany<CodeableReferenceDbObject> knownAllergen =
      ToMany<CodeableReferenceDbObject>();
  final ToMany<NutritionProductCharacteristicDbObject> productCharacteristic =
      ToMany<NutritionProductCharacteristicDbObject>();
  final ToMany<NutritionProductInstanceDbObject> instance =
      ToMany<NutritionProductInstanceDbObject>();
...
class NutritionProductInstanceDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> expiryElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDateTimeDbObject> useBy = ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> useByElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<IdentifierDbObject> biologicalSource =
