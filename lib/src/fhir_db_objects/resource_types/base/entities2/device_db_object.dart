...
class DeviceDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> distinctIdentifierElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> manufacturer = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> manufacturerElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDateTimeDbObject> manufactureDate =
      ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> manufactureDateElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> serialNumberElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<DeviceDeviceNameDbObject> deviceName =
      ToMany<DeviceDeviceNameDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> partNumberElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> type = ToOne<CodeableConceptDbObject>();
  final ToMany<DeviceSpecializationDbObject> specialization =
      ToMany<DeviceSpecializationDbObject>();
  final ToMany<DeviceVersionDbObject> version = ToMany<DeviceVersionDbObject>();
  final ToMany<DevicePropertyDbObject> property =
      ToMany<DevicePropertyDbObject>();
...
class DeviceUdiCarrierDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> jurisdictionElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBase64BinaryDbObject> carrierAIDC =
      ToOne<FhirBase64BinaryDbObject>();
  final ToOne<PrimitiveElementDbObject> carrierAIDCElement =
      ToOne<PrimitiveElementDbObject>();
...
class DeviceSpecializationDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> systemType =
