...
class SubstanceDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> descriptionElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<SubstanceInstanceDbObject> instance =
      ToMany<SubstanceInstanceDbObject>();
  final ToMany<SubstanceIngredientDbObject> ingredient =
      ToMany<SubstanceIngredientDbObject>();
...
class SubstanceIngredientDbObject {
  ...
  final ToOne<CodeableConceptDbObject> substanceCodeableConcept =
      ToOne<CodeableConceptDbObject>();
  final ToOne<ReferenceDbObject> substanceReference =
