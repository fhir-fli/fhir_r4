...
class FhirEndpointDbObject {
  ...
  final ToOne<EndpointStatusDbObject> status = ToOne<EndpointStatusDbObject>();
  ...
  final ToMany<CodeableConceptDbObject> payloadType = ToMany<CodeableConceptDbObject>();
  final ToMany<FhirCodeDbObject> payloadMimeType = ToMany<FhirCodeDbObject>();
  final ToMany<PrimitiveElementDbObject> payloadMimeTypeElement = ToMany<PrimitiveElementDbObject>();
