...
class LocationDbObject {
  ...
  final ToOne<LocationPositionDbObject> position = ToOne<LocationPositionDbObject>();
  ...
  final ToMany<LocationHoursOfOperationDbObject> hoursOfOperation = ToMany<LocationHoursOfOperationDbObject>();
...
class LocationPositionDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> longitudeElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDecimalDbObject> latitude = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> latitudeElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDecimalDbObject> altitude = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> altitudeElement = ToOne<PrimitiveElementDbObject>();
...
class LocationHoursOfOperationDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> openingTimeElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirTimeDbObject> closingTime = ToOne<FhirTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> closingTimeElement = ToOne<PrimitiveElementDbObject>();
