...
class HealthcareServiceDbObject {
  ...
  final ToOne<FhirMarkdownDbObject> extraDetails = ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> extraDetailsElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<CodeableConceptDbObject> serviceProvisionCode = ToMany<CodeableConceptDbObject>();
  final ToMany<HealthcareServiceEligibilityDbObject> eligibility = ToMany<HealthcareServiceEligibilityDbObject>();
  final ToMany<CodeableConceptDbObject> program = ToMany<CodeableConceptDbObject>();
  ...
  final ToMany<CodeableConceptDbObject> referralMethod = ToMany<CodeableConceptDbObject>();
  final ToOne<FhirBooleanDbObject> appointmentRequired = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> appointmentRequiredElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<HealthcareServiceAvailableTimeDbObject> availableTime = ToMany<HealthcareServiceAvailableTimeDbObject>();
  final ToMany<HealthcareServiceNotAvailableDbObject> notAvailable = ToMany<HealthcareServiceNotAvailableDbObject>();
...
class HealthcareServiceAvailableTimeDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToMany<HealthcareServiceAvailableTimeDaysOfWeekDbObject> daysOfWeek = ToMany<HealthcareServiceAvailableTimeDaysOfWeekDbObject>();
