...
class PractitionerRoleDbObject {
  ...
  final ToMany<ReferenceDbObject> healthcareService =
      ToMany<ReferenceDbObject>();
  final ToMany<ContactPointDbObject> telecom = ToMany<ContactPointDbObject>();
  final ToMany<PractitionerRoleAvailableTimeDbObject> availableTime =
      ToMany<PractitionerRoleAvailableTimeDbObject>();
  final ToMany<PractitionerRoleNotAvailableDbObject> notAvailable =
      ToMany<PractitionerRoleNotAvailableDbObject>();
