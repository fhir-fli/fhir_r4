...
class PatientDbObject {
  ...
  final ToOne<FhirDateTimeDbObject> deceasedDateTime = ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> deceasedDateTimeElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<AddressDbObject> address = ToMany<AddressDbObject>();
  final ToOne<CodeableConceptDbObject> maritalStatus = ToOne<CodeableConceptDbObject>();
  final ToOne<FhirBooleanDbObject> multipleBirthBoolean = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> multipleBirthBooleanElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirIntegerDbObject> multipleBirthInteger = ToOne<FhirIntegerDbObject>();
  final ToOne<PrimitiveElementDbObject> multipleBirthIntegerElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<AttachmentDbObject> photo = ToMany<AttachmentDbObject>();
  final ToMany<PatientContactDbObject> contact = ToMany<PatientContactDbObject>();
  final ToMany<PatientCommunicationDbObject> communication = ToMany<PatientCommunicationDbObject>();
  final ToMany<ReferenceDbObject> generalPractitioner = ToMany<ReferenceDbObject>();
  final ToOne<ReferenceDbObject> managingOrganization = ToOne<ReferenceDbObject>();
