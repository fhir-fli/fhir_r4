...
class InvoiceDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> cancelledReasonElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<InvoiceParticipantDbObject> participant = ToMany<InvoiceParticipantDbObject>();
  ...
  final ToMany<InvoiceLineItemDbObject> lineItem = ToMany<InvoiceLineItemDbObject>();
  final ToMany<InvoicePriceComponentDbObject> totalPriceComponent = ToMany<InvoicePriceComponentDbObject>();
  final ToOne<MoneyDbObject> totalNet = ToOne<MoneyDbObject>();
  final ToOne<MoneyDbObject> totalGross = ToOne<MoneyDbObject>();
  final ToOne<FhirMarkdownDbObject> paymentTerms = ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> paymentTermsElement = ToOne<PrimitiveElementDbObject>();
...
class InvoiceLineItemDbObject {
  ...
  final ToOne<ReferenceDbObject> chargeItemReference = ToOne<ReferenceDbObject>();
  final ToOne<CodeableConceptDbObject> chargeItemCodeableConcept = ToOne<CodeableConceptDbObject>();
  final ToMany<InvoicePriceComponentDbObject> priceComponent = ToMany<InvoicePriceComponentDbObject>();
