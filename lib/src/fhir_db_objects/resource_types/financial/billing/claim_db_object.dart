...
class ClaimDbObject {
  ...
  final ToMany<ClaimCareTeamDbObject> careTeam = ToMany<ClaimCareTeamDbObject>();
  final ToMany<ClaimSupportingInfoDbObject> supportingInfo = ToMany<ClaimSupportingInfoDbObject>();
  final ToMany<ClaimDiagnosisDbObject> diagnosis = ToMany<ClaimDiagnosisDbObject>();
  final ToMany<ClaimProcedureDbObject> procedure = ToMany<ClaimProcedureDbObject>();
  final ToMany<ClaimInsuranceDbObject> insurance = ToMany<ClaimInsuranceDbObject>();
...
class ClaimDetailDbObject {
  ...
  final ToOne<MoneyDbObject> net = ToOne<MoneyDbObject>();
  final ToMany<ReferenceDbObject> udi = ToMany<ReferenceDbObject>();
  final ToMany<ClaimSubDetailDbObject> subDetail = ToMany<ClaimSubDetailDbObject>();
