...
class ClaimResponseDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> preAuthRefElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<PeriodDbObject> preAuthPeriod = ToOne<PeriodDbObject>();
  final ToOne<CodeableConceptDbObject> payeeType = ToOne<CodeableConceptDbObject>();
  final ToMany<ClaimResponseItemDbObject> item = ToMany<ClaimResponseItemDbObject>();
  final ToMany<ClaimResponseAddItemDbObject> addItem = ToMany<ClaimResponseAddItemDbObject>();
  final ToMany<ClaimResponseAdjudicationDbObject> adjudication = ToMany<ClaimResponseAdjudicationDbObject>();
  final ToMany<ClaimResponseTotalDbObject> total = ToMany<ClaimResponseTotalDbObject>();
  final ToOne<ClaimResponsePaymentDbObject> payment = ToOne<ClaimResponsePaymentDbObject>();
  ...
  final ToMany<ClaimResponseProcessNoteDbObject> processNote = ToMany<ClaimResponseProcessNoteDbObject>();
  final ToMany<ReferenceDbObject> communicationRequest = ToMany<ReferenceDbObject>();
  final ToMany<ClaimResponseInsuranceDbObject> insurance = ToMany<ClaimResponseInsuranceDbObject>();
  final ToMany<ClaimResponseErrorDbObject> error = ToMany<ClaimResponseErrorDbObject>();
...
class ClaimResponseItemDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<FhirPositiveIntDbObject> itemSequence = ToOne<FhirPositiveIntDbObject>();
  final ToOne<PrimitiveElementDbObject> itemSequenceElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<ClaimResponseAdjudicationDbObject> adjudication = ToMany<ClaimResponseAdjudicationDbObject>();
  final ToMany<ClaimResponseDetailDbObject> detail = ToMany<ClaimResponseDetailDbObject>();
...
class ClaimResponseDetailDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<FhirPositiveIntDbObject> detailSequence = ToOne<FhirPositiveIntDbObject>();
  final ToOne<PrimitiveElementDbObject> detailSequenceElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<FhirPositiveIntDbObject> noteNumber = ToMany<FhirPositiveIntDbObject>();
  final ToMany<PrimitiveElementDbObject> noteNumberElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<ClaimResponseAdjudicationDbObject> adjudication = ToMany<ClaimResponseAdjudicationDbObject>();
  final ToMany<ClaimResponseSubDetailDbObject> subDetail = ToMany<ClaimResponseSubDetailDbObject>();
...
class ClaimResponseSubDetailDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<FhirPositiveIntDbObject> subDetailSequence = ToOne<FhirPositiveIntDbObject>();
  final ToOne<PrimitiveElementDbObject> subDetailSequenceElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<FhirPositiveIntDbObject> noteNumber = ToMany<FhirPositiveIntDbObject>();
  final ToMany<PrimitiveElementDbObject> noteNumberElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<ClaimResponseAdjudicationDbObject> adjudication = ToMany<ClaimResponseAdjudicationDbObject>();
...
class ClaimResponseAddItemDbObject {
  ...
  final ToMany<PrimitiveElementDbObject> noteNumberElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<ClaimResponseAdjudicationDbObject> adjudication = ToMany<ClaimResponseAdjudicationDbObject>();
  final ToMany<ClaimResponseDetail1DbObject> detail = ToMany<ClaimResponseDetail1DbObject>();
...
class ClaimResponseDetail1DbObject {
  ...
  final ToMany<PrimitiveElementDbObject> noteNumberElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<ClaimResponseAdjudicationDbObject> adjudication = ToMany<ClaimResponseAdjudicationDbObject>();
  final ToMany<ClaimResponseSubDetail1DbObject> subDetail = ToMany<ClaimResponseSubDetail1DbObject>();
