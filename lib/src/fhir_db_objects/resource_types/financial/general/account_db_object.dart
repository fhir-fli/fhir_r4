...
class AccountDbObject {
  ...
  final ToMany<AccountCoverageDbObject> coverage =
      ToMany<AccountCoverageDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> descriptionElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<AccountGuarantorDbObject> guarantor =
      ToMany<AccountGuarantorDbObject>();
...
class AccountCoverageDbObject {
  ...
  final ToOne<FhirPositiveIntDbObject> priority =
...
class AccountGuarantorDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> onHoldElement =
      ToOne<PrimitiveElementDbObject>();
