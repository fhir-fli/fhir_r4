...
class ContractDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> statusElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> legalState =
      ToOne<CodeableConceptDbObject>();
  final ToOne<ReferenceDbObject> instantiatesCanonical =
  ...
  final ToOne<PrimitiveElementDbObject> instantiatesUriElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> contentDerivative =
      ToOne<CodeableConceptDbObject>();
  ...
  final ToOne<CodeableConceptDbObject> expirationType =
      ToOne<CodeableConceptDbObject>();
  ...
  final ToOne<CodeableConceptDbObject> topicCodeableConcept =
      ToOne<CodeableConceptDbObject>();
  ...
  final ToMany<CodeableConceptDbObject> subType =
      ToMany<CodeableConceptDbObject>();
  final ToOne<ContractContentDefinitionDbObject> contentDefinition =
      ToOne<ContractContentDefinitionDbObject>();
  ...
  final ToMany<ContractSignerDbObject> signer =
      ToMany<ContractSignerDbObject>();
  final ToMany<ContractFriendlyDbObject> friendly =
      ToMany<ContractFriendlyDbObject>();
  ...
  final ToOne<AttachmentDbObject> legallyBindingAttachment =
      ToOne<AttachmentDbObject>();
  final ToOne<ReferenceDbObject> legallyBindingReference =
      ToOne<ReferenceDbObject>();
...
class ContractContentDefinitionDbObject {
  ...
  final ToOne<FhirDateTimeDbObject> publicationDate =
      ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> publicationDateElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> publicationStatus = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> publicationStatusElement =
      ToOne<PrimitiveElementDbObject>();
...
class ContractTermDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> textElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<ContractSecurityLabelDbObject> securityLabel =
      ToMany<ContractSecurityLabelDbObject>();
  ...
  final ToMany<ContractActionDbObject> action =
      ToMany<ContractActionDbObject>();
...
class ContractSecurityLabelDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToMany<FhirUnsignedIntDbObject> number =
      ToMany<FhirUnsignedIntDbObject>();
  final ToMany<PrimitiveElementDbObject> numberElement =
      ToMany<PrimitiveElementDbObject>();
  final ToMany<CodingDbObject> classification = ToMany<CodingDbObject>();
  final ToMany<CodingDbObject> category = ToMany<CodingDbObject>();
  final ToMany<CodingDbObject> control = ToMany<CodingDbObject>();
  ContractSecurityLabelDbObject({required this.id});
}
...
class ContractOfferDbObject {
  ...
  final ToOne<CodeableConceptDbObject> type = ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> decision =
      ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> decisionMode =
      ToMany<CodeableConceptDbObject>();
  final ToMany<ContractAnswerDbObject> answer =
      ToMany<ContractAnswerDbObject>();
  final ToOne<StringDbObject> text = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> textElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> linkId = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> linkIdElement =
      ToMany<PrimitiveElementDbObject>();
  final ToMany<FhirUnsignedIntDbObject> securityLabelNumber =
      ToMany<FhirUnsignedIntDbObject>();
  final ToMany<PrimitiveElementDbObject> securityLabelNumberElement =
      ToMany<PrimitiveElementDbObject>();
...
class ContractAssetDbObject {
  ...
  final ToMany<ContractContextDbObject> context =
      ToMany<ContractContextDbObject>();
  final ToOne<StringDbObject> condition = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> conditionElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<CodeableConceptDbObject> periodType =
      ToMany<CodeableConceptDbObject>();
  ...
  final ToMany<PrimitiveElementDbObject> securityLabelNumberElement =
      ToMany<PrimitiveElementDbObject>();
  final ToMany<ContractValuedItemDbObject> valuedItem =
      ToMany<ContractValuedItemDbObject>();
...
class ContractValuedItemDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> entityCodeableConcept =
      ToOne<CodeableConceptDbObject>();
  final ToOne<ReferenceDbObject> entityReference = ToOne<ReferenceDbObject>();
  final ToOne<IdentifierDbObject> identifier = ToOne<IdentifierDbObject>();
  final ToOne<FhirDateTimeDbObject> effectiveTime =
      ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> effectiveTimeElement =
      ToOne<PrimitiveElementDbObject>();
...
class ContractActionDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> doNotPerformElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CodeableConceptDbObject> type = ToOne<CodeableConceptDbObject>();
  final ToMany<ContractSubjectDbObject> subject =
      ToMany<ContractSubjectDbObject>();
  final ToOne<CodeableConceptDbObject> intent =
      ToOne<CodeableConceptDbObject>();
  final ToOne<StringDbObject> linkId = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> linkIdElement =
      ToMany<PrimitiveElementDbObject>();
  ...
  final ToMany<PrimitiveElementDbObject> contextLinkIdElement =
      ToMany<PrimitiveElementDbObject>();
  ...
  final ToMany<PrimitiveElementDbObject> requesterLinkIdElement =
      ToMany<PrimitiveElementDbObject>();
  final ToMany<CodeableConceptDbObject> performerType =
      ToMany<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> performerRole =
      ToOne<CodeableConceptDbObject>();
  ...
  final ToMany<PrimitiveElementDbObject> performerLinkIdElement =
      ToMany<PrimitiveElementDbObject>();
  ...
  final ToMany<PrimitiveElementDbObject> reasonElement =
      ToMany<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> reasonLinkId = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> reasonLinkIdElement =
      ToMany<PrimitiveElementDbObject>();
