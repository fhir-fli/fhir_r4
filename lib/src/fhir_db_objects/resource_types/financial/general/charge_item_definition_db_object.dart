...
class ChargeItemDefinitionDbObject {
  ...
  final ToMany<PrimitiveElementDbObject> derivedFromUriElement = ToMany<PrimitiveElementDbObject>();
  ...
  final ToMany<ChargeItemDefinitionApplicabilityDbObject> applicability = ToMany<ChargeItemDefinitionApplicabilityDbObject>();
  final ToMany<ChargeItemDefinitionPropertyGroupDbObject> propertyGroup = ToMany<ChargeItemDefinitionPropertyGroupDbObject>();
...
class ChargeItemDefinitionPropertyGroupDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToMany<ChargeItemDefinitionApplicabilityDbObject> applicability = ToMany<ChargeItemDefinitionApplicabilityDbObject>();
  final ToMany<ChargeItemDefinitionPriceComponentDbObject> priceComponent = ToMany<ChargeItemDefinitionPriceComponentDbObject>();
