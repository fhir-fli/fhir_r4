...
class ChargeItemDbObject {
  ...
  final ToMany<PrimitiveElementDbObject> definitionUriElement =
      ToMany<PrimitiveElementDbObject>();
  final ToMany<FhirCanonicalDbObject> definitionCanonical =
  ...
  final ToMany<ChargeItemPerformerDbObject> performer =
      ToMany<ChargeItemPerformerDbObject>();
  final ToOne<ReferenceDbObject> performingOrganization =
      ToOne<ReferenceDbObject>();
  final ToOne<ReferenceDbObject> requestingOrganization =
      ToOne<ReferenceDbObject>();
  ...
  final ToOne<FhirDecimalDbObject> factorOverride =
      ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> factorOverrideElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> overrideReasonElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> enteredDateElement =
      ToOne<PrimitiveElementDbObject>();
