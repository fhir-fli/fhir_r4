...
class ExplanationOfBenefitDbObject {
  ...
  final ToOne<CodeableConceptDbObject> fundsReserveRequested = ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> fundsReserve = ToOne<CodeableConceptDbObject>();
  final ToMany<ExplanationOfBenefitRelatedDbObject> related = ToMany<ExplanationOfBenefitRelatedDbObject>();
  final ToOne<ReferenceDbObject> prescription = ToOne<ReferenceDbObject>();
  final ToOne<ReferenceDbObject> originalPrescription = ToOne<ReferenceDbObject>();
  final ToOne<ExplanationOfBenefitPayeeDbObject> payee = ToOne<ExplanationOfBenefitPayeeDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> outcomeElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> disposition = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> dispositionElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> preAuthRef = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> preAuthRefElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<PeriodDbObject> preAuthRefPeriod = ToMany<PeriodDbObject>();
  final ToMany<ExplanationOfBenefitCareTeamDbObject> careTeam = ToMany<ExplanationOfBenefitCareTeamDbObject>();
  final ToMany<ExplanationOfBenefitSupportingInfoDbObject> supportingInfo = ToMany<ExplanationOfBenefitSupportingInfoDbObject>();
  final ToMany<ExplanationOfBenefitDiagnosisDbObject> diagnosis = ToMany<ExplanationOfBenefitDiagnosisDbObject>();
  final ToMany<ExplanationOfBenefitProcedureDbObject> procedure = ToMany<ExplanationOfBenefitProcedureDbObject>();
  final ToOne<FhirPositiveIntDbObject> precedence = ToOne<FhirPositiveIntDbObject>();
  final ToOne<PrimitiveElementDbObject> precedenceElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<ExplanationOfBenefitInsuranceDbObject> insurance = ToMany<ExplanationOfBenefitInsuranceDbObject>();
  final ToOne<ExplanationOfBenefitAccidentDbObject> accident = ToOne<ExplanationOfBenefitAccidentDbObject>();
  final ToMany<ExplanationOfBenefitItemDbObject> item = ToMany<ExplanationOfBenefitItemDbObject>();
  final ToMany<ExplanationOfBenefitAddItemDbObject> addItem = ToMany<ExplanationOfBenefitAddItemDbObject>();
  final ToMany<ExplanationOfBenefitAdjudicationDbObject> adjudication = ToMany<ExplanationOfBenefitAdjudicationDbObject>();
  final ToMany<ExplanationOfBenefitTotalDbObject> total = ToMany<ExplanationOfBenefitTotalDbObject>();
  final ToOne<ExplanationOfBenefitPaymentDbObject> payment = ToOne<ExplanationOfBenefitPaymentDbObject>();
  final ToOne<CodeableConceptDbObject> formCode = ToOne<CodeableConceptDbObject>();
  final ToOne<AttachmentDbObject> form = ToOne<AttachmentDbObject>();
  final ToMany<ExplanationOfBenefitProcessNoteDbObject> processNote = ToMany<ExplanationOfBenefitProcessNoteDbObject>();
  final ToOne<PeriodDbObject> benefitPeriod = ToOne<PeriodDbObject>();
  final ToMany<ExplanationOfBenefitBenefitBalanceDbObject> benefitBalance = ToMany<ExplanationOfBenefitBenefitBalanceDbObject>();
...
class ExplanationOfBenefitRelatedDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<ReferenceDbObject> claim = ToOne<ReferenceDbObject>();
  final ToOne<CodeableConceptDbObject> relationship = ToOne<CodeableConceptDbObject>();
...
class ExplanationOfBenefitCareTeamDbObject {
  ...
  final ToOne<CodeableConceptDbObject> qualification = ToOne<CodeableConceptDbObject>();
...
class ExplanationOfBenefitDiagnosisDbObject {
  ...
  final ToOne<CodeableConceptDbObject> onAdmission = ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> packageCode = ToOne<CodeableConceptDbObject>();
...
class ExplanationOfBenefitProcedureDbObject {
  ...
  final ToOne<CodeableConceptDbObject> procedureCodeableConcept = ToOne<CodeableConceptDbObject>();
  final ToOne<ReferenceDbObject> procedureReference = ToOne<ReferenceDbObject>();
...
class ExplanationOfBenefitItemDbObject {
  ...
  final ToOne<FhirPositiveIntDbObject> sequence = ToOne<FhirPositiveIntDbObject>();
  final ToOne<PrimitiveElementDbObject> sequenceElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<FhirPositiveIntDbObject> careTeamSequence = ToMany<FhirPositiveIntDbObject>();
  final ToMany<PrimitiveElementDbObject> careTeamSequenceElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<FhirPositiveIntDbObject> diagnosisSequence = ToMany<FhirPositiveIntDbObject>();
  final ToMany<ElementDbObject> diagnosisSequenceElement = ToMany<ElementDbObject>();
  final ToMany<FhirPositiveIntDbObject> procedureSequence = ToMany<FhirPositiveIntDbObject>();
  final ToMany<ElementDbObject> procedureSequenceElement = ToMany<ElementDbObject>();
  final ToMany<FhirPositiveIntDbObject> informationSequence = ToMany<FhirPositiveIntDbObject>();
  final ToMany<ElementDbObject> informationSequenceElement = ToMany<ElementDbObject>();
  final ToOne<CodeableConceptDbObject> revenue = ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> category = ToOne<CodeableConceptDbObject>();
  ...
  final ToMany<CodeableConceptDbObject> programCode = ToMany<CodeableConceptDbObject>();
  ...
  final ToOne<CodeableConceptDbObject> locationCodeableConcept = ToOne<CodeableConceptDbObject>();
  final ToOne<AddressDbObject> locationAddress = ToOne<AddressDbObject>();
  final ToOne<ReferenceDbObject> locationReference = ToOne<ReferenceDbObject>();
  ...
  final ToMany<CodeableConceptDbObject> subSite = ToMany<CodeableConceptDbObject>();
  final ToMany<ReferenceDbObject> encounter = ToMany<ReferenceDbObject>();
  final ToMany<FhirPositiveIntDbObject> noteNumber = ToMany<FhirPositiveIntDbObject>();
  final ToMany<PrimitiveElementDbObject> noteNumberElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<ExplanationOfBenefitAdjudicationDbObject> adjudication = ToMany<ExplanationOfBenefitAdjudicationDbObject>();
  final ToMany<ExplanationOfBenefitDetailDbObject> detail = ToMany<ExplanationOfBenefitDetailDbObject>();
...
class ExplanationOfBenefitDetailDbObject {
  ...
  final ToMany<PrimitiveElementDbObject> noteNumberElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<ExplanationOfBenefitAdjudicationDbObject> adjudication = ToMany<ExplanationOfBenefitAdjudicationDbObject>();
  final ToMany<ExplanationOfBenefitSubDetailDbObject> subDetail = ToMany<ExplanationOfBenefitSubDetailDbObject>();
...
class ExplanationOfBenefitAddItemDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirPositiveIntDbObject> itemSequence = ToMany<FhirPositiveIntDbObject>();
  final ToMany<PrimitiveElementDbObject> itemSequenceElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<FhirPositiveIntDbObject> detailSequence = ToMany<FhirPositiveIntDbObject>();
  final ToMany<PrimitiveElementDbObject> detailSequenceElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<FhirPositiveIntDbObject> subDetailSequence = ToMany<FhirPositiveIntDbObject>();
  final ToMany<ElementDbObject> subDetailSequenceElement = ToMany<ElementDbObject>();
  ...
  final ToMany<PrimitiveElementDbObject> noteNumberElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<ExplanationOfBenefitAdjudicationDbObject> adjudication = ToMany<ExplanationOfBenefitAdjudicationDbObject>();
  final ToMany<ExplanationOfBenefitDetail1DbObject> detail = ToMany<ExplanationOfBenefitDetail1DbObject>();
...
class ExplanationOfBenefitDetail1DbObject {
  ...
  final ToMany<PrimitiveElementDbObject> noteNumberElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<ExplanationOfBenefitAdjudicationDbObject> adjudication = ToMany<ExplanationOfBenefitAdjudicationDbObject>();
  final ToMany<ExplanationOfBenefitSubDetail1DbObject> subDetail = ToMany<ExplanationOfBenefitSubDetail1DbObject>();
...
class ExplanationOfBenefitPaymentDbObject {
  ...
  final ToOne<CodeableConceptDbObject> adjustmentReason = ToOne<CodeableConceptDbObject>();
  final ToOne<FhirDateDbObject> date = ToOne<FhirDateDbObject>();
  final ToOne<PrimitiveElementDbObject> dateElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<MoneyDbObject> amount = ToOne<MoneyDbObject>();
...
class ExplanationOfBenefitProcessNoteDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<FhirPositiveIntDbObject> number = ToOne<FhirPositiveIntDbObject>();
  final ToOne<PrimitiveElementDbObject> numberElement = ToOne<PrimitiveElementDbObject>();
...
class ExplanationOfBenefitBenefitBalanceDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> excludedElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<CodeableConceptDbObject> network = ToOne<CodeableConceptDbObject>();
  ...
  final ToMany<ExplanationOfBenefitFinancialDbObject> financial = ToMany<ExplanationOfBenefitFinancialDbObject>();
...
class ExplanationOfBenefitFinancialDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> type = ToOne<CodeableConceptDbObject>();
  final ToOne<FhirUnsignedIntDbObject> allowedUnsignedInt = ToOne<FhirUnsignedIntDbObject>();
  final ToOne<PrimitiveElementDbObject> allowedUnsignedIntElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> allowedString = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> allowedStringElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<MoneyDbObject> allowedMoney = ToOne<MoneyDbObject>();
  final ToOne<FhirUnsignedIntDbObject> usedUnsignedInt = ToOne<FhirUnsignedIntDbObject>();
  final ToOne<PrimitiveElementDbObject> usedUnsignedIntElement = ToOne<PrimitiveElementDbObject>();
