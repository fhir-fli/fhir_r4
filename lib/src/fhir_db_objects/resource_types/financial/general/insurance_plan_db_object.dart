...
class InsurancePlanDbObject {
  ...
  final ToMany<InsurancePlanContactDbObject> contact = ToMany<InsurancePlanContactDbObject>();
  ...
  final ToMany<InsurancePlanCoverageDbObject> coverage = ToMany<InsurancePlanCoverageDbObject>();
  final ToMany<InsurancePlanPlanDbObject> plan = ToMany<InsurancePlanPlanDbObject>();
...
class InsurancePlanCoverageDbObject {
  ...
  final ToMany<ReferenceDbObject> network = ToMany<ReferenceDbObject>();
  final ToMany<InsurancePlanBenefitDbObject> benefit = ToMany<InsurancePlanBenefitDbObject>();
...
class InsurancePlanBenefitDbObject {
  ...
  final ToMany<InsurancePlanLimitDbObject> limit = ToMany<InsurancePlanLimitDbObject>();
...
class InsurancePlanPlanDbObject {
  ...
  final ToMany<ReferenceDbObject> coverageArea = ToMany<ReferenceDbObject>();
  final ToMany<ReferenceDbObject> network = ToMany<ReferenceDbObject>();
  final ToMany<InsurancePlanGeneralCostDbObject> generalCost = ToMany<InsurancePlanGeneralCostDbObject>();
  final ToMany<InsurancePlanSpecificCostDbObject> specificCost = ToMany<InsurancePlanSpecificCostDbObject>();
...
class InsurancePlanGeneralCostDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> type = ToOne<CodeableConceptDbObject>();
  final ToOne<FhirPositiveIntDbObject> groupSize = ToOne<FhirPositiveIntDbObject>();
  final ToOne<PrimitiveElementDbObject> groupSizeElement = ToOne<PrimitiveElementDbObject>();
...
class InsurancePlanSpecificCostDbObject {
  ...
  final ToMany<InsurancePlanBenefit1DbObject> benefit = ToMany<InsurancePlanBenefit1DbObject>();
...
class InsurancePlanBenefit1DbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> type = ToOne<CodeableConceptDbObject>();
  final ToMany<InsurancePlanCostDbObject> cost = ToMany<InsurancePlanCostDbObject>();
...
class InsurancePlanCostDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToOne<CodeableConceptDbObject> type = ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> applicability = ToOne<CodeableConceptDbObject>();
  final ToMany<CodeableConceptDbObject> qualifiers = ToMany<CodeableConceptDbObject>();
  final ToOne<QuantityDbObject> value = ToOne<QuantityDbObject>();
