...
class PaymentReconciliationDbObject {
  ...
  final ToOne<IdentifierDbObject> paymentIdentifier = ToOne<IdentifierDbObject>();
  final ToMany<PaymentReconciliationDetailDbObject> detail = ToMany<PaymentReconciliationDetailDbObject>();
  final ToOne<CodeableConceptDbObject> formCode = ToOne<CodeableConceptDbObject>();
  final ToMany<PaymentReconciliationProcessNoteDbObject> processNote = ToMany<PaymentReconciliationProcessNoteDbObject>();
