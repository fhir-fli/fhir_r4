...
class CoverageEligibilityResponseDbObject {
  ...
  final ToMany<CoverageEligibilityResponseInsuranceDbObject> insurance = ToMany<CoverageEligibilityResponseInsuranceDbObject>();
  ...
  final ToMany<CoverageEligibilityResponseErrorDbObject> error = ToMany<CoverageEligibilityResponseErrorDbObject>();
...
class CoverageEligibilityResponseInsuranceDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> inforceElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<PeriodDbObject> benefitPeriod = ToOne<PeriodDbObject>();
  final ToMany<CoverageEligibilityResponseItemDbObject> item = ToMany<CoverageEligibilityResponseItemDbObject>();
...
class CoverageEligibilityResponseItemDbObject {
  ...
  final ToMany<CoverageEligibilityResponseBenefitDbObject> benefit = ToMany<CoverageEligibilityResponseBenefitDbObject>();
  final ToOne<FhirBooleanDbObject> authorizationRequired = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> authorizationRequiredElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<CodeableConceptDbObject> authorizationSupporting = ToMany<CodeableConceptDbObject>();
  final ToOne<FhirUriDbObject> authorizationUrl = ToOne<FhirUriDbObject>();
  final ToOne<PrimitiveElementDbObject> authorizationUrlElement = ToOne<PrimitiveElementDbObject>();
...
class CoverageEligibilityResponseBenefitDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> usedStringElement = ToOne<PrimitiveElementDbObject>();
