...
class CoverageDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> subscriberIdElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> dependentElement = ToOne<PrimitiveElementDbObject>();
...
@Entity()
class List<CoverageClass>?DbObject {
  @Id(assignable: true)
  int id;
  final ToOne<FhirPositiveIntDbObject> order = ToOne<FhirPositiveIntDbObject>();
  final ToOne<PrimitiveElementDbObject> orderElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> network = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> networkElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<CoverageCostToBeneficiaryDbObject> costToBeneficiary = ToMany<CoverageCostToBeneficiaryDbObject>();
...
class CoverageCostToBeneficiaryDbObject {
  ...
  final ToMany<CoverageExceptionDbObject> exception = ToMany<CoverageExceptionDbObject>();
