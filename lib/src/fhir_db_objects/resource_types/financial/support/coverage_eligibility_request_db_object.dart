...
class CoverageEligibilityRequestDbObject {
  ...
  final ToMany<CoverageEligibilityRequestSupportingInfoDbObject>
      supportingInfo =
      ToMany<CoverageEligibilityRequestSupportingInfoDbObject>();
  final ToMany<CoverageEligibilityRequestInsuranceDbObject> insurance =
      ToMany<CoverageEligibilityRequestInsuranceDbObject>();
  final ToMany<CoverageEligibilityRequestItemDbObject> item =
      ToMany<CoverageEligibilityRequestItemDbObject>();
...
class CoverageEligibilityRequestSupportingInfoDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> appliesToAllElement =
      ToOne<PrimitiveElementDbObject>();
...
class CoverageEligibilityRequestItemDbObject {
  ...
  final ToOne<ReferenceDbObject> facility = ToOne<ReferenceDbObject>();
  final ToMany<CoverageEligibilityRequestDiagnosisDbObject> diagnosis =
      ToMany<CoverageEligibilityRequestDiagnosisDbObject>();
