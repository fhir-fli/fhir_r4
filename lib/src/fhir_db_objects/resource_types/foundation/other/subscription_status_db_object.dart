...
class SubscriptionStatusDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> typeElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirInteger64DbObject> eventsSinceSubscriptionStart =
      ToOne<FhirInteger64DbObject>();
  final ToOne<PrimitiveElementDbObject> eventsSinceSubscriptionStartElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<SubscriptionStatusNotificationEventDbObject> notificationEvent =
      ToMany<SubscriptionStatusNotificationEventDbObject>();
  ...
  final ToMany<CodeableConceptDbObject> error =
...
class SubscriptionStatusNotificationEventDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToOne<FhirInteger64DbObject> eventNumber =
      ToOne<FhirInteger64DbObject>();
  final ToOne<PrimitiveElementDbObject> eventNumberElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<ReferenceDbObject> additionalContext =
