...
class MessageHeaderDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> eventUriElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<MessageHeaderDestinationDbObject> destination =
      ToMany<MessageHeaderDestinationDbObject>();
  ...
  final ToOne<MessageHeaderSourceDbObject> source =
      ToOne<MessageHeaderSourceDbObject>();
  ...
  final ToOne<MessageHeaderResponseDbObject> response =
      ToOne<MessageHeaderResponseDbObject>();
...
class MessageHeaderDestinationDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> endpointElement =
      ToOne<PrimitiveElementDbObject>();
...
class MessageHeaderSourceDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> softwareElement =
      ToOne<PrimitiveElementDbObject>();
