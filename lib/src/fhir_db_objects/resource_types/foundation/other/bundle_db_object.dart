...
class BundleLinkDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> relationElement = ToOne<PrimitiveElementDbObject>();
...
class BundleEntryDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> fullUrlElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<BundleResponseDbObject> response = ToOne<BundleResponseDbObject>();
...
class BundleRequestDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> ifNoneMatchElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirInstantDbObject> ifModifiedSince = ToOne<FhirInstantDbObject>();
  final ToOne<PrimitiveElementDbObject> ifModifiedSinceElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> ifMatch = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> ifMatchElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> ifNoneExist = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> ifNoneExistElement = ToOne<PrimitiveElementDbObject>();
...
class BundleResponseDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> locationElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> etag = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> etagElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirInstantDbObject> lastModified = ToOne<FhirInstantDbObject>();
  final ToOne<PrimitiveElementDbObject> lastModifiedElement = ToOne<PrimitiveElementDbObject>();
