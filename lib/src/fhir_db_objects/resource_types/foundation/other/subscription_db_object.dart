...
class SubscriptionDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> reasonElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> criteria = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> criteriaElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> error = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> errorElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<SubscriptionChannelDbObject> channel =
      ToOne<SubscriptionChannelDbObject>();
...
class SubscriptionChannelDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> payloadElement =
      ToOne<PrimitiveElementDbObject>();
