...
class SubscriptionTopicDbObject {
  ...
  final ToMany<SubscriptionTopicResourceTriggerDbObject> resourceTrigger = ToMany<SubscriptionTopicResourceTriggerDbObject>();
  final ToMany<SubscriptionTopicEventTriggerDbObject> eventTrigger = ToMany<SubscriptionTopicEventTriggerDbObject>();
  final ToMany<SubscriptionTopicCanFilterByDbObject> canFilterBy = ToMany<SubscriptionTopicCanFilterByDbObject>();
  final ToMany<SubscriptionTopicNotificationShapeDbObject> notificationShape = ToMany<SubscriptionTopicNotificationShapeDbObject>();
...
class SubscriptionTopicResourceTriggerDbObject {
  ...
  final ToMany<FhirCodeDbObject> supportedInteraction = ToMany<FhirCodeDbObject>();
  final ToMany<ElementDbObject> supportedInteractionElement = ToMany<ElementDbObject>();
  final ToOne<SubscriptionTopicQueryCriteriaDbObject> queryCriteria = ToOne<SubscriptionTopicQueryCriteriaDbObject>();
  final ToOne<StringDbObject> fhirPathCriteria = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> fhirPathCriteriaElement = ToOne<PrimitiveElementDbObject>();
...
class SubscriptionTopicQueryCriteriaDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> previousElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> resultForCreate = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> resultForCreateElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> current = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> currentElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> resultForDelete = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> resultForDeleteElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> requireBoth = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> requireBothElement = ToOne<PrimitiveElementDbObject>();
...
class SubscriptionTopicCanFilterByDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> filterParameterElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirUriDbObject> filterDefinition = ToOne<FhirUriDbObject>();
  final ToOne<PrimitiveElementDbObject> filterDefinitionElement = ToOne<PrimitiveElementDbObject>();
