...
class OperationOutcomeDbObject {
  ...
  final ToMany<OperationOutcomeIssueDbObject> issue = ToMany<OperationOutcomeIssueDbObject>();
...
class OperationOutcomeIssueDbObject {
  ...
  final ToOne<CodeableConceptDbObject> details = ToOne<CodeableConceptDbObject>();
  final ToOne<StringDbObject> diagnostics = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> diagnosticsElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> location = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> locationElement = ToMany<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> expression = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> expressionElement = ToMany<PrimitiveElementDbObject>();
