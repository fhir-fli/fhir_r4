...
class ProvenanceDbObject {
  ...
  final ToOne<FhirDateTimeDbObject> occurredDateTime = ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> occurredDateTimeElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<ProvenanceAgentDbObject> agent = ToMany<ProvenanceAgentDbObject>();
  final ToMany<ProvenanceEntityDbObject> entity = ToMany<ProvenanceEntityDbObject>();
