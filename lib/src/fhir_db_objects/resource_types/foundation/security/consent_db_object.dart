...
class ConsentDbObject {
  ...
  final ToOne<AttachmentDbObject> sourceAttachment =
  ...
  final ToOne<CodeableConceptDbObject> policyRule =
      ToOne<CodeableConceptDbObject>();
  final ToMany<ConsentVerificationDbObject> verification =
      ToMany<ConsentVerificationDbObject>();
  final ToOne<ConsentProvisionDbObject> provision =
      ToOne<ConsentProvisionDbObject>();
...
class ConsentPolicyDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> authorityElement =
      ToOne<PrimitiveElementDbObject>();
...
class ConsentVerificationDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> verifiedElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<ReferenceDbObject> verifiedWith = ToOne<ReferenceDbObject>();
  final ToOne<FhirDateTimeDbObject> verificationDate =
      ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> verificationDateElement =
      ToOne<PrimitiveElementDbObject>();
...
class ConsentDataDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> meaningElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<ReferenceDbObject> reference = ToOne<ReferenceDbObject>();
