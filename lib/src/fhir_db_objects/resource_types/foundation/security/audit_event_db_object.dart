...
class AuditEventDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> actionElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> outcomeDescElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<CodeableConceptDbObject> purposeOfEvent = ToMany<CodeableConceptDbObject>();
  final ToMany<AuditEventAgentDbObject> agent = ToMany<AuditEventAgentDbObject>();
  final ToOne<AuditEventSourceDbObject> source = ToOne<AuditEventSourceDbObject>();
  final ToMany<AuditEventEntityDbObject> entity = ToMany<AuditEventEntityDbObject>();
...
class AuditEventAgentDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> altIdElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> requestorElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<ReferenceDbObject> location = ToOne<ReferenceDbObject>();
  final ToMany<FhirUriDbObject> policy = ToMany<FhirUriDbObject>();
  final ToMany<PrimitiveElementDbObject> policyElement = ToMany<PrimitiveElementDbObject>();
  final ToOne<CodingDbObject> media = ToOne<CodingDbObject>();
  final ToOne<AuditEventNetworkDbObject> network = ToOne<AuditEventNetworkDbObject>();
  final ToMany<CodeableConceptDbObject> purposeOfUse = ToMany<CodeableConceptDbObject>();
...
class AuditEventSourceDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> siteElement = ToOne<PrimitiveElementDbObject>();
...
class AuditEventEntityDbObject {
  ...
  final ToOne<FhirBase64BinaryDbObject> query = ToOne<FhirBase64BinaryDbObject>();
  final ToOne<PrimitiveElementDbObject> queryElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<AuditEventDetailDbObject> detail = ToMany<AuditEventDetailDbObject>();
