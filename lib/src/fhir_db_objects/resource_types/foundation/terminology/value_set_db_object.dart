...
class ValueSetDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> immutableElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<ValueSetComposeDbObject> compose = ToOne<ValueSetComposeDbObject>();
  final ToOne<ValueSetExpansionDbObject> expansion = ToOne<ValueSetExpansionDbObject>();
...
class ValueSetComposeDbObject {
  ...
  final ToMany<ValueSetIncludeDbObject> include = ToMany<ValueSetIncludeDbObject>();
  final ToMany<ValueSetIncludeDbObject> exclude = ToMany<ValueSetIncludeDbObject>();
...
class ValueSetIncludeDbObject {
  ...
  final ToOne<StringDbObject> version = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> versionElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<ValueSetConceptDbObject> concept = ToMany<ValueSetConceptDbObject>();
  final ToMany<ValueSetFilterDbObject> filter = ToMany<ValueSetFilterDbObject>();
  final ToMany<FhirCanonicalDbObject> valueSet = ToMany<FhirCanonicalDbObject>();
...
class ValueSetConceptDbObject {
  ...
  final ToMany<ValueSetDesignationDbObject> designation = ToMany<ValueSetDesignationDbObject>();
...
class ValueSetFilterDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> propertyElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> op = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> opElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> value = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> valueElement = ToOne<PrimitiveElementDbObject>();
...
class ValueSetExpansionDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> totalElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<ValueSetParameterDbObject> parameter = ToMany<ValueSetParameterDbObject>();
  final ToMany<ValueSetContainsDbObject> contains = ToMany<ValueSetContainsDbObject>();
...
class ValueSetContainsDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> abstractElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> inactive = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> inactiveElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> version = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> versionElement = ToOne<PrimitiveElementDbObject>();
