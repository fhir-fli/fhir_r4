...
class TerminologyCapabilitiesDbObject {
  ...
  final ToOne<TerminologyCapabilitiesSoftwareDbObject> software = ToOne<TerminologyCapabilitiesSoftwareDbObject>();
  final ToOne<TerminologyCapabilitiesImplementationDbObject> implementation = ToOne<TerminologyCapabilitiesImplementationDbObject>();
  final ToOne<FhirBooleanDbObject> lockedDate = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> lockedDateElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<TerminologyCapabilitiesCodeSystemDbObject> codeSystem = ToMany<TerminologyCapabilitiesCodeSystemDbObject>();
  final ToOne<TerminologyCapabilitiesExpansionDbObject> expansion = ToOne<TerminologyCapabilitiesExpansionDbObject>();
  final ToOne<FhirCodeDbObject> codeSearch = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> codeSearchElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<TerminologyCapabilitiesValidateCodeDbObject> validateCode = ToOne<TerminologyCapabilitiesValidateCodeDbObject>();
  final ToOne<TerminologyCapabilitiesTranslationDbObject> translation = ToOne<TerminologyCapabilitiesTranslationDbObject>();
  final ToOne<TerminologyCapabilitiesClosureDbObject> closure = ToOne<TerminologyCapabilitiesClosureDbObject>();
...
class TerminologyCapabilitiesCodeSystemDbObject {
  ...
  final ToMany<TerminologyCapabilitiesVersionDbObject> version = ToMany<TerminologyCapabilitiesVersionDbObject>();
  final ToOne<FhirBooleanDbObject> subsumption = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> subsumptionElement = ToOne<PrimitiveElementDbObject>();
...
class TerminologyCapabilitiesVersionDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> isDefaultElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<PrimitiveElementDbObject> languageElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<TerminologyCapabilitiesFilterDbObject> filter = ToMany<TerminologyCapabilitiesFilterDbObject>();
  final ToMany<FhirCodeDbObject> property = ToMany<FhirCodeDbObject>();
  final ToMany<PrimitiveElementDbObject> propertyElement = ToMany<PrimitiveElementDbObject>();
...
class TerminologyCapabilitiesFilterDbObject {
  ...
  final ToMany<PrimitiveElementDbObject> opElement = ToMany<PrimitiveElementDbObject>();
...
class TerminologyCapabilitiesExpansionDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> hierarchicalElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> paging = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> pagingElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> incomplete = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> incompleteElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<TerminologyCapabilitiesParameterDbObject> parameter = ToMany<TerminologyCapabilitiesParameterDbObject>();
  final ToOne<FhirMarkdownDbObject> textFilter = ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> textFilterElement = ToOne<PrimitiveElementDbObject>();
...
class TerminologyCapabilitiesValidateCodeDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> translationsElement = ToOne<PrimitiveElementDbObject>();
...
class TerminologyCapabilitiesTranslationDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> needsMapElement = ToOne<PrimitiveElementDbObject>();
...
class TerminologyCapabilitiesClosureDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> translationElement = ToOne<PrimitiveElementDbObject>();
