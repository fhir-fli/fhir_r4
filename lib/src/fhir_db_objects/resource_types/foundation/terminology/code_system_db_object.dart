...
class CodeSystemDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> caseSensitiveElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> hierarchyMeaningElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> versionNeededElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> content = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> contentElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCanonicalDbObject> supplements =
  ...
  final ToOne<PrimitiveElementDbObject> countElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<CodeSystemFilterDbObject> filter =
      ToMany<CodeSystemFilterDbObject>();
  final ToMany<CodeSystemPropertyDbObject> property =
      ToMany<CodeSystemPropertyDbObject>();
  final ToMany<CodeSystemConceptDbObject> concept =
      ToMany<CodeSystemConceptDbObject>();
...
class CodeSystemFilterDbObject {
  ...
  final ToMany<PrimitiveElementDbObject> operatorElement =
...
class CodeSystemConceptDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> definitionElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<CodeSystemDesignationDbObject> designation =
      ToMany<CodeSystemDesignationDbObject>();
  final ToMany<CodeSystemProperty1DbObject> property =
      ToMany<CodeSystemProperty1DbObject>();
  final ToMany<CodeSystemConceptDbObject> concept =
      ToMany<CodeSystemConceptDbObject>();
