...
class ConceptMapDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> sourceUriElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCanonicalDbObject> sourceCanonical = ToOne<FhirCanonicalDbObject>();
  final ToOne<PrimitiveElementDbObject> sourceCanonicalElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<FhirCanonicalDbObject> targetCanonical = ToOne<FhirCanonicalDbObject>();
  final ToOne<PrimitiveElementDbObject> targetCanonicalElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<ConceptMapGroupDbObject> group = ToMany<ConceptMapGroupDbObject>();
...
class ConceptMapGroupDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> sourceVersionElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirUriDbObject> target = ToOne<FhirUriDbObject>();
  final ToOne<PrimitiveElementDbObject> targetElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> targetVersion = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> targetVersionElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<ConceptMapElementDbObject> element = ToMany<ConceptMapElementDbObject>();
  final ToOne<ConceptMapUnmappedDbObject> unmapped = ToOne<ConceptMapUnmappedDbObject>();
...
class ConceptMapElementDbObject {
  ...
  final ToMany<ConceptMapTargetDbObject> target = ToMany<ConceptMapTargetDbObject>();
...
class ConceptMapTargetDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> equivalenceElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<ConceptMapDependsOnDbObject> dependsOn = ToMany<ConceptMapDependsOnDbObject>();
  final ToMany<ConceptMapDependsOnDbObject> product = ToMany<ConceptMapDependsOnDbObject>();
