...
class ExampleScenarioDbObject {
  ...
  final ToMany<ExampleScenarioActorDbObject> actor = ToMany<ExampleScenarioActorDbObject>();
  final ToMany<ExampleScenarioInstanceDbObject> instance = ToMany<ExampleScenarioInstanceDbObject>();
  final ToMany<ExampleScenarioProcessDbObject> process = ToMany<ExampleScenarioProcessDbObject>();
  final ToMany<FhirCanonicalDbObject> workflow = ToMany<FhirCanonicalDbObject>();
...
class ExampleScenarioActorDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> actorIdElement = ToOne<PrimitiveElementDbObject>();
...
class ExampleScenarioInstanceDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> resourceIdElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> resourceType = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> resourceTypeElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> name = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> nameElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirMarkdownDbObject> description = ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> descriptionElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<ExampleScenarioVersionDbObject> version = ToMany<ExampleScenarioVersionDbObject>();
  final ToMany<ExampleScenarioContainedInstanceDbObject> containedInstance = ToMany<ExampleScenarioContainedInstanceDbObject>();
...
class ExampleScenarioVersionDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> versionIdElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirMarkdownDbObject> description = ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> descriptionElement = ToOne<PrimitiveElementDbObject>();
...
class ExampleScenarioProcessDbObject {
  ...
  final ToOne<FhirMarkdownDbObject> description = ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> descriptionElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirMarkdownDbObject> preConditions = ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> preConditionsElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirMarkdownDbObject> postConditions = ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> postConditionsElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<ExampleScenarioStepDbObject> step = ToMany<ExampleScenarioStepDbObject>();
...
class ExampleScenarioStepDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> pauseElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<ExampleScenarioOperationDbObject> operation = ToOne<ExampleScenarioOperationDbObject>();
  final ToMany<ExampleScenarioAlternativeDbObject> alternative = ToMany<ExampleScenarioAlternativeDbObject>();
...
class ExampleScenarioOperationDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> initiatorElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> receiver = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> receiverElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirMarkdownDbObject> description = ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> descriptionElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> initiatorActive = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> initiatorActiveElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> receiverActive = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> receiverActiveElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<ExampleScenarioContainedInstanceDbObject> request = ToOne<ExampleScenarioContainedInstanceDbObject>();
  final ToOne<ExampleScenarioContainedInstanceDbObject> response = ToOne<ExampleScenarioContainedInstanceDbObject>();
