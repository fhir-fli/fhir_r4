...
class StructureDefinitionDbObject {
  ...
  final ToMany<StructureDefinitionMappingDbObject> mapping = ToMany<StructureDefinitionMappingDbObject>();
  ...
  final ToMany<StructureDefinitionContextDbObject> context = ToMany<StructureDefinitionContextDbObject>();
  final ToOne<StringDbObject> contextInvariant = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> contextInvariantElement = ToMany<PrimitiveElementDbObject>();
  ...
  final ToOne<FhirCanonicalDbObject> baseDefinition = ToOne<FhirCanonicalDbObject>();
  final ToOne<PrimitiveElementDbObject> baseDefinitionElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> derivation = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> derivationElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StructureDefinitionSnapshotDbObject> snapshot = ToOne<StructureDefinitionSnapshotDbObject>();
  final ToOne<StructureDefinitionDifferentialDbObject> differential = ToOne<StructureDefinitionDifferentialDbObject>();
...
class StructureDefinitionMappingDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> identityElement = ToOne<PrimitiveElementDbObject>();
...
class StructureDefinitionSnapshotDbObject {
  ...
  final ToMany<FhirExtensionDbObject> extension_ = ToMany<FhirExtensionDbObject>();
  final ToMany<FhirExtensionDbObject> modifierExtension = ToMany<FhirExtensionDbObject>();
  final ToMany<ElementDefinitionDbObject> element = ToMany<ElementDefinitionDbObject>();
