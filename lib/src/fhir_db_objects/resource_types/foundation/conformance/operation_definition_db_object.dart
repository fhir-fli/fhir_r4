...
class OperationDefinitionDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> affectsStateElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<PrimitiveElementDbObject> resourceElement = ToMany<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> instanceElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCanonicalDbObject> inputProfile = ToOne<FhirCanonicalDbObject>();
  final ToOne<FhirCanonicalDbObject> outputProfile = ToOne<FhirCanonicalDbObject>();
  final ToMany<OperationDefinitionParameterDbObject> parameter = ToMany<OperationDefinitionParameterDbObject>();
  final ToMany<OperationDefinitionOverloadDbObject> overload = ToMany<OperationDefinitionOverloadDbObject>();
...
class OperationDefinitionParameterDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> typeElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<FhirCanonicalDbObject> targetProfile = ToMany<FhirCanonicalDbObject>();
  final ToOne<FhirCodeDbObject> searchType = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> searchTypeElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<OperationDefinitionBindingDbObject> binding = ToOne<OperationDefinitionBindingDbObject>();
  final ToMany<OperationDefinitionReferencedFromDbObject> referencedFrom = ToMany<OperationDefinitionReferencedFromDbObject>();
  final ToMany<OperationDefinitionParameterDbObject> part_ = ToMany<OperationDefinitionParameterDbObject>();
...
class OperationDefinitionBindingDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> strengthElement = ToOne<PrimitiveElementDbObject>();
...
class OperationDefinitionOverloadDbObject {
  ...
  final ToMany<PrimitiveElementDbObject> parameterNameElement = ToMany<PrimitiveElementDbObject>();
