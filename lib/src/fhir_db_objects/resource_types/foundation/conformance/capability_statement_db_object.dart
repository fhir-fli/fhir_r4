...
class CapabilityStatementDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> kindElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<FhirCanonicalDbObject> instantiates =
      ToMany<FhirCanonicalDbObject>();
  final ToMany<FhirCanonicalDbObject> imports = ToMany<FhirCanonicalDbObject>();
  final ToOne<CapabilityStatementSoftwareDbObject> software =
      ToOne<CapabilityStatementSoftwareDbObject>();
  final ToOne<CapabilityStatementImplementationDbObject> implementation =
      ToOne<CapabilityStatementImplementationDbObject>();
  ...
  final ToMany<PrimitiveElementDbObject> formatElement =
      ToMany<PrimitiveElementDbObject>();
  final ToMany<FhirCodeDbObject> patchFormat = ToMany<FhirCodeDbObject>();
  final ToMany<PrimitiveElementDbObject> patchFormatElement =
      ToMany<PrimitiveElementDbObject>();
  final ToMany<FhirCanonicalDbObject> implementationGuide =
      ToMany<FhirCanonicalDbObject>();
  final ToMany<CapabilityStatementRestDbObject> rest =
      ToMany<CapabilityStatementRestDbObject>();
  final ToMany<CapabilityStatementMessagingDbObject> messaging =
      ToMany<CapabilityStatementMessagingDbObject>();
  final ToMany<CapabilityStatementDocumentDbObject> document =
      ToMany<CapabilityStatementDocumentDbObject>();
...
class CapabilityStatementSoftwareDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> releaseDateElement =
      ToOne<PrimitiveElementDbObject>();
...
class CapabilityStatementRestDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> modeElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirMarkdownDbObject> documentation =
      ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> documentationElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<CapabilityStatementSecurityDbObject> security =
      ToOne<CapabilityStatementSecurityDbObject>();
  final ToMany<CapabilityStatementResourceDbObject> resource =
      ToMany<CapabilityStatementResourceDbObject>();
  final ToMany<CapabilityStatementInteraction1DbObject> interaction =
      ToMany<CapabilityStatementInteraction1DbObject>();
  final ToMany<CapabilityStatementSearchParamDbObject> searchParam =
      ToMany<CapabilityStatementSearchParamDbObject>();
  final ToMany<CapabilityStatementOperationDbObject> operation =
      ToMany<CapabilityStatementOperationDbObject>();
  final ToMany<FhirCanonicalDbObject> compartment =
      ToMany<FhirCanonicalDbObject>();
...
class CapabilityStatementSecurityDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> corsElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<CodeableConceptDbObject> service =
      ToMany<CodeableConceptDbObject>();
  final ToOne<FhirMarkdownDbObject> description = ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> descriptionElement =
      ToOne<PrimitiveElementDbObject>();
...
class CapabilityStatementResourceDbObject {
  ...
  final ToMany<FhirCanonicalDbObject> supportedProfile =
      ToMany<FhirCanonicalDbObject>();
  final ToOne<FhirMarkdownDbObject> documentation =
      ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> documentationElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<CapabilityStatementInteractionDbObject> interaction =
      ToMany<CapabilityStatementInteractionDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> readHistoryElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> updateCreate = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> updateCreateElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> conditionalCreate =
      ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> conditionalCreateElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> conditionalRead = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> conditionalReadElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> conditionalUpdate =
      ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> conditionalUpdateElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> conditionalDelete = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> conditionalDeleteElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<FhirCodeDbObject> referencePolicy = ToMany<FhirCodeDbObject>();
  final ToMany<PrimitiveElementDbObject> referencePolicyElement =
      ToMany<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> searchInclude = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> searchIncludeElement =
      ToMany<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> searchRevInclude = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> searchRevIncludeElement =
      ToMany<PrimitiveElementDbObject>();
  final ToMany<CapabilityStatementSearchParamDbObject> searchParam =
      ToMany<CapabilityStatementSearchParamDbObject>();
  final ToMany<CapabilityStatementOperationDbObject> operation =
...
class CapabilityStatementMessagingDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToMany<CapabilityStatementEndpointDbObject> endpoint =
      ToMany<CapabilityStatementEndpointDbObject>();
  final ToOne<FhirUnsignedIntDbObject> reliableCache =
      ToOne<FhirUnsignedIntDbObject>();
  final ToOne<PrimitiveElementDbObject> reliableCacheElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirMarkdownDbObject> documentation =
      ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> documentationElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<CapabilityStatementSupportedMessageDbObject> supportedMessage =
      ToMany<CapabilityStatementSupportedMessageDbObject>();
