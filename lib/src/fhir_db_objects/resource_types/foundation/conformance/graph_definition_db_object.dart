...
class GraphDefinitionDbObject {
  ...
  final ToMany<GraphDefinitionLinkDbObject> link = ToMany<GraphDefinitionLinkDbObject>();
...
class GraphDefinitionLinkDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> sliceNameElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> descriptionElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<GraphDefinitionTargetDbObject> target = ToMany<GraphDefinitionTargetDbObject>();
...
class GraphDefinitionTargetDbObject {
  ...
  final ToOne<FhirCanonicalDbObject> profile = ToOne<FhirCanonicalDbObject>();
  final ToMany<GraphDefinitionCompartmentDbObject> compartment = ToMany<GraphDefinitionCompartmentDbObject>();
  final ToMany<GraphDefinitionLinkDbObject> link = ToMany<GraphDefinitionLinkDbObject>();
...
class GraphDefinitionCompartmentDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> ruleElement = ToOne<PrimitiveElementDbObject>();
