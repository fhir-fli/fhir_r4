...
class MessageDefinitionDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> categoryElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<MessageDefinitionFocusDbObject> focus =
      ToMany<MessageDefinitionFocusDbObject>();
  final ToOne<FhirCodeDbObject> responseRequired = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> responseRequiredElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<MessageDefinitionAllowedResponseDbObject> allowedResponse =
      ToMany<MessageDefinitionAllowedResponseDbObject>();
...
class MessageDefinitionAllowedResponseDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> situationElement =
      ToOne<PrimitiveElementDbObject>();
