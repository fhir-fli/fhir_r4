...
class ImplementationGuideDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> packageIdElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> license = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> licenseElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<FhirCodeDbObject> fhirVersion = ToMany<FhirCodeDbObject>();
  final ToMany<PrimitiveElementDbObject> fhirVersionElement =
      ToMany<PrimitiveElementDbObject>();
  final ToMany<ImplementationGuideDependsOnDbObject> dependsOn =
      ToMany<ImplementationGuideDependsOnDbObject>();
  final ToMany<ImplementationGuideGlobalDbObject> global =
      ToMany<ImplementationGuideGlobalDbObject>();
  final ToOne<ImplementationGuideDefinitionDbObject> definition =
      ToOne<ImplementationGuideDefinitionDbObject>();
  final ToOne<ImplementationGuideManifestDbObject> manifest =
      ToOne<ImplementationGuideManifestDbObject>();
...
class ImplementationGuideDefinitionDbObject {
  ...
  final ToMany<FhirExtensionDbObject> modifierExtension =
      ToMany<FhirExtensionDbObject>();
  final ToMany<ImplementationGuideGroupingDbObject> grouping =
      ToMany<ImplementationGuideGroupingDbObject>();
  final ToMany<ImplementationGuideResourceDbObject> resource =
      ToMany<ImplementationGuideResourceDbObject>();
  final ToOne<ImplementationGuidePageDbObject> page =
      ToOne<ImplementationGuidePageDbObject>();
  final ToMany<ImplementationGuideParameterDbObject> parameter =
      ToMany<ImplementationGuideParameterDbObject>();
  final ToMany<ImplementationGuideTemplateDbObject> template =
      ToMany<ImplementationGuideTemplateDbObject>();
...
class ImplementationGuideResourceDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> descriptionElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> exampleBoolean =
      ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> exampleBooleanElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCanonicalDbObject> exampleCanonical =
      ToOne<FhirCanonicalDbObject>();
  final ToOne<PrimitiveElementDbObject> exampleCanonicalElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirIdDbObject> groupingId = ToOne<FhirIdDbObject>();
  final ToOne<PrimitiveElementDbObject> groupingIdElement =
      ToOne<PrimitiveElementDbObject>();
...
class ImplementationGuidePageDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> nameUrlElement =
      ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> generationElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<ImplementationGuidePageDbObject> page =
      ToMany<ImplementationGuidePageDbObject>();
...
class ImplementationGuideTemplateDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> scopeElement =
      ToOne<PrimitiveElementDbObject>();
...
class ImplementationGuideManifestDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> renderingElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<ImplementationGuideResource1DbObject> resource =
      ToMany<ImplementationGuideResource1DbObject>();
  final ToMany<ImplementationGuidePage1DbObject> page =
      ToMany<ImplementationGuidePage1DbObject>();
  final ToOne<StringDbObject> image = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> imageElement =
      ToMany<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> other = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> otherElement =
      ToMany<PrimitiveElementDbObject>();
...
class ImplementationGuideResource1DbObject {
  ...
  final ToOne<PrimitiveElementDbObject> relativePathElement =
      ToOne<PrimitiveElementDbObject>();
...
class ImplementationGuidePage1DbObject {
  ...
  final ToMany<PrimitiveElementDbObject> anchorElement =
      ToMany<PrimitiveElementDbObject>();
