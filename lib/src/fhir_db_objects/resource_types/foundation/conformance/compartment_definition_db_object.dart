...
@Entity()
class CompartmentDefinitionDbObject {
  @Id(assignable: true)
  int id;
  ...
  final ToOne<PrimitiveElementDbObject> codeElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> search = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> searchElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<CompartmentDefinitionResourceDbObject> resource =
      ToMany<CompartmentDefinitionResourceDbObject>();
  CompartmentDefinitionDbObject({required this.id});
}

@Entity()
class CompartmentDefinitionResourceDbObject {
  @Id(assignable: true)
  int id;
  final ToOne<StringDbObject> fhirId = ToOne<StringDbObject>();
  final ToMany<FhirExtensionDbObject> extension_ =
  ...
  final ToOne<PrimitiveElementDbObject> codeElement =
      ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> param = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> paramElement =
  ...
  final ToOne<PrimitiveElementDbObject> documentationElement =
      ToOne<PrimitiveElementDbObject>();
  CompartmentDefinitionResourceDbObject({required this.id});
}
