...
class SearchParameterDbObject {
  ...
  final ToOne<FhirCanonicalDbObject> derivedFrom = ToOne<FhirCanonicalDbObject>();
  ...
  final ToMany<PrimitiveElementDbObject> baseElement = ToMany<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> xpathElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> xpathUsage = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> xpathUsageElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<FhirCodeDbObject> target = ToMany<FhirCodeDbObject>();
  final ToMany<PrimitiveElementDbObject> targetElement = ToMany<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> multipleOr = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> multipleOrElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> multipleAnd = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> multipleAndElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<FhirCodeDbObject> comparator = ToMany<FhirCodeDbObject>();
  final ToMany<PrimitiveElementDbObject> comparatorElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<FhirCodeDbObject> modifier = ToMany<FhirCodeDbObject>();
  final ToMany<PrimitiveElementDbObject> modifierElement = ToMany<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> chain = ToOne<StringDbObject>();
  final ToMany<PrimitiveElementDbObject> chainElement = ToMany<PrimitiveElementDbObject>();
  final ToMany<SearchParameterComponentDbObject> component = ToMany<SearchParameterComponentDbObject>();
