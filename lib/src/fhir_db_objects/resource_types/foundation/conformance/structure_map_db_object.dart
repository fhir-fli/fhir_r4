...
class StructureMapDbObject {
  ...
  final ToMany<StructureMapStructureDbObject> structure = ToMany<StructureMapStructureDbObject>();
  final ToMany<FhirCanonicalDbObject> import_ = ToMany<FhirCanonicalDbObject>();
  final ToMany<StructureMapGroupDbObject> group = ToMany<StructureMapGroupDbObject>();
...
class StructureMapStructureDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> aliasElement = ToOne<PrimitiveElementDbObject>();
...
class StructureMapGroupDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> extendsElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> typeMode = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> typeModeElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> documentation = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> documentationElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<StructureMapInputDbObject> input = ToMany<StructureMapInputDbObject>();
  final ToMany<StructureMapRuleDbObject> rule = ToMany<StructureMapRuleDbObject>();
...
class StructureMapRuleDbObject {
  ...
  final ToOne<FhirIdDbObject> name = ToOne<FhirIdDbObject>();
  final ToOne<PrimitiveElementDbObject> nameElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<StructureMapSourceDbObject> source = ToMany<StructureMapSourceDbObject>();
  final ToMany<StructureMapTargetDbObject> target = ToMany<StructureMapTargetDbObject>();
  final ToMany<StructureMapRuleDbObject> rule = ToMany<StructureMapRuleDbObject>();
  final ToMany<StructureMapDependentDbObject> dependent = ToMany<StructureMapDependentDbObject>();
  final ToOne<StringDbObject> documentation = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> documentationElement = ToOne<PrimitiveElementDbObject>();
...
class StructureMapSourceDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> contextElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<StringDbObject> type = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> typeElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBase64BinaryDbObject> defaultValueBase64Binary = ToOne<FhirBase64BinaryDbObject>();
  final ToOne<PrimitiveElementDbObject> defaultValueBase64BinaryElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirBooleanDbObject> defaultValueBoolean = ToOne<FhirBooleanDbObject>();
  final ToOne<PrimitiveElementDbObject> defaultValueBooleanElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCanonicalDbObject> defaultValueCanonical = ToOne<FhirCanonicalDbObject>();
  final ToOne<PrimitiveElementDbObject> defaultValueCanonicalElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> defaultValueCode = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> defaultValueCodeElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDateDbObject> defaultValueDate = ToOne<FhirDateDbObject>();
  final ToOne<PrimitiveElementDbObject> defaultValueDateElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDateTimeDbObject> defaultValueDateTime = ToOne<FhirDateTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> defaultValueDateTimeElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirDecimalDbObject> defaultValueDecimal = ToOne<FhirDecimalDbObject>();
  final ToOne<PrimitiveElementDbObject> defaultValueDecimalElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirIdDbObject> defaultValueId = ToOne<FhirIdDbObject>();
  final ToOne<PrimitiveElementDbObject> defaultValueIdElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirInstantDbObject> defaultValueInstant = ToOne<FhirInstantDbObject>();
  final ToOne<PrimitiveElementDbObject> defaultValueInstantElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirIntegerDbObject> defaultValueInteger = ToOne<FhirIntegerDbObject>();
  final ToOne<PrimitiveElementDbObject> defaultValueIntegerElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirMarkdownDbObject> defaultValueMarkdown = ToOne<FhirMarkdownDbObject>();
  final ToOne<PrimitiveElementDbObject> defaultValueMarkdownElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirOidDbObject> defaultValueOid = ToOne<FhirOidDbObject>();
  final ToOne<PrimitiveElementDbObject> defaultValueOidElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirPositiveIntDbObject> defaultValuePositiveInt = ToOne<FhirPositiveIntDbObject>();
  final ToOne<PrimitiveElementDbObject> defaultValuePositiveIntElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> defaultValueString = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> defaultValueStringElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirTimeDbObject> defaultValueTime = ToOne<FhirTimeDbObject>();
  final ToOne<PrimitiveElementDbObject> defaultValueTimeElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirUnsignedIntDbObject> defaultValueUnsignedInt = ToOne<FhirUnsignedIntDbObject>();
  final ToOne<PrimitiveElementDbObject> defaultValueUnsignedIntElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirUriDbObject> defaultValueUri = ToOne<FhirUriDbObject>();
  final ToOne<PrimitiveElementDbObject> defaultValueUriElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirUrlDbObject> defaultValueUrl = ToOne<FhirUrlDbObject>();
  final ToOne<PrimitiveElementDbObject> defaultValueUrlElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirUuidDbObject> defaultValueUuid = ToOne<FhirUuidDbObject>();
  final ToOne<PrimitiveElementDbObject> defaultValueUuidElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<AnnotationDbObject> defaultValueAnnotation = ToOne<AnnotationDbObject>();
  final ToOne<AttachmentDbObject> defaultValueAttachment = ToOne<AttachmentDbObject>();
  final ToOne<CodeableConceptDbObject> defaultValueCodeableConcept = ToOne<CodeableConceptDbObject>();
  final ToOne<CodingDbObject> defaultValueCoding = ToOne<CodingDbObject>();
  final ToOne<ContactPointDbObject> defaultValueContactPoint = ToOne<ContactPointDbObject>();
  final ToOne<CountDbObject> defaultValueCount = ToOne<CountDbObject>();
  final ToOne<DistanceDbObject> defaultValueDistance = ToOne<DistanceDbObject>();
  final ToOne<FhirDurationDbObject> defaultValueDuration = ToOne<FhirDurationDbObject>();
  final ToOne<HumanNameDbObject> defaultValueHumanName = ToOne<HumanNameDbObject>();
  final ToOne<IdentifierDbObject> defaultValueIdentifier = ToOne<IdentifierDbObject>();
  ...
  final ToOne<QuantityDbObject> defaultValueQuantity = ToOne<QuantityDbObject>();
  ...
  final ToOne<ReferenceDbObject> defaultValueReference = ToOne<ReferenceDbObject>();
  final ToOne<SampledDataDbObject> defaultValueSampledData = ToOne<SampledDataDbObject>();
  final ToOne<SignatureDbObject> defaultValueSignature = ToOne<SignatureDbObject>();
  final ToOne<TimingDbObject> defaultValueTiming = ToOne<TimingDbObject>();
  final ToOne<ContactDetailDbObject> defaultValueContactDetail = ToOne<ContactDetailDbObject>();
  final ToOne<ContributorDbObject> defaultValueContributor = ToOne<ContributorDbObject>();
  final ToOne<DataRequirementDbObject> defaultValueDataRequirement = ToOne<DataRequirementDbObject>();
  final ToOne<FhirExpressionDbObject> defaultValueExpression = ToOne<FhirExpressionDbObject>();
  final ToOne<ParameterDefinitionDbObject> defaultValueParameterDefinition = ToOne<ParameterDefinitionDbObject>();
  final ToOne<RelatedArtifactDbObject> defaultValueRelatedArtifact = ToOne<RelatedArtifactDbObject>();
  final ToOne<TriggerDefinitionDbObject> defaultValueTriggerDefinition = ToOne<TriggerDefinitionDbObject>();
  final ToOne<UsageContextDbObject> defaultValueUsageContext = ToOne<UsageContextDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> elementElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> listMode = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> listModeElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirIdDbObject> variable = ToOne<FhirIdDbObject>();
  final ToOne<PrimitiveElementDbObject> variableElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToOne<PrimitiveElementDbObject> checkElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> logMessage = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> logMessageElement = ToOne<PrimitiveElementDbObject>();
...
class StructureMapTargetDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> contextTypeElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<StringDbObject> element = ToOne<StringDbObject>();
  final ToOne<PrimitiveElementDbObject> elementElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirIdDbObject> variable = ToOne<FhirIdDbObject>();
  final ToOne<PrimitiveElementDbObject> variableElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<FhirCodeDbObject> listMode = ToMany<FhirCodeDbObject>();
  final ToMany<PrimitiveElementDbObject> listModeElement = ToMany<PrimitiveElementDbObject>();
  final ToOne<FhirIdDbObject> listRuleId = ToOne<FhirIdDbObject>();
  final ToOne<PrimitiveElementDbObject> listRuleIdElement = ToOne<PrimitiveElementDbObject>();
  final ToOne<FhirCodeDbObject> transform = ToOne<FhirCodeDbObject>();
  final ToOne<PrimitiveElementDbObject> transformElement = ToOne<PrimitiveElementDbObject>();
  final ToMany<StructureMapParameterDbObject> parameter = ToMany<StructureMapParameterDbObject>();
...
class StructureMapParameterDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> valueIdElement = ToOne<PrimitiveElementDbObject>();
...
class StructureMapDependentDbObject {
  ...
  final ToMany<PrimitiveElementDbObject> variableElement = ToMany<PrimitiveElementDbObject>();
