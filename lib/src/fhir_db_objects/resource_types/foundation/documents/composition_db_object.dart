...
class CompositionDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> confidentialityElement =
      ToOne<PrimitiveElementDbObject>();
  final ToMany<CompositionAttesterDbObject> attester =
      ToMany<CompositionAttesterDbObject>();
  final ToOne<ReferenceDbObject> custodian = ToOne<ReferenceDbObject>();
  final ToMany<CompositionRelatesToDbObject> relatesTo =
      ToMany<CompositionRelatesToDbObject>();
  final ToMany<CompositionEventDbObject> event =
      ToMany<CompositionEventDbObject>();
  final ToMany<CompositionSectionDbObject> section =
      ToMany<CompositionSectionDbObject>();
