...
class DocumentReferenceDbObject {
  ...
  final ToOne<PrimitiveElementDbObject> docStatusElement = ToOne<PrimitiveElementDbObject>();
  ...
  final ToMany<DocumentReferenceRelatesToDbObject> relatesTo = ToMany<DocumentReferenceRelatesToDbObject>();
  ...
  final ToMany<CodeableConceptDbObject> securityLabel = ToMany<CodeableConceptDbObject>();
  final ToMany<DocumentReferenceContentDbObject> content = ToMany<DocumentReferenceContentDbObject>();
  final ToOne<DocumentReferenceContextDbObject> context = ToOne<DocumentReferenceContextDbObject>();
...
class DocumentReferenceContextDbObject {
  ...
  final ToMany<CodeableConceptDbObject> event = ToMany<CodeableConceptDbObject>();
  final ToOne<PeriodDbObject> period = ToOne<PeriodDbObject>();
  final ToOne<CodeableConceptDbObject> facilityType = ToOne<CodeableConceptDbObject>();
  final ToOne<CodeableConceptDbObject> practiceSetting = ToOne<CodeableConceptDbObject>();
