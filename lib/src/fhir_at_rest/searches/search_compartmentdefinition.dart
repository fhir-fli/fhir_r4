...
class SearchCompartmentDefinition {
  ...
  SearchCompartmentDefinition contextQuantity(FhirDecimal value,
  ...
  SearchCompartmentDefinition contextType(FhirString value,
      {FhirUri? system, SearchModifier? modifier}) {
  ...
  SearchCompartmentDefinition date(FhirDateTime value,
  ...
  SearchCompartmentDefinition status(FhirString value,
      {FhirUri? system, SearchModifier? modifier}) {
  ...
  SearchCompartmentDefinition version(FhirString value,
      {FhirUri? system, SearchModifier? modifier}) {
  ...
  SearchCompartmentDefinition code(FhirString value,
      {FhirUri? system, SearchModifier? modifier}) {
  ...
  SearchCompartmentDefinition resource(FhirString value,
      {FhirUri? system, SearchModifier? modifier}) {
