...
@RealmModel()
class _ResearchDefinitionRealm {
  ...
  late _ReferenceRealm population;
  late _ReferenceRealm exposure;
  late _ReferenceRealm exposureAlternative;
  late _ReferenceRealm outcome;
}
