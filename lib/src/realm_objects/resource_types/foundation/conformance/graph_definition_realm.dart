...
class _GraphDefinitionRealm {
  ...
  late _FhirCodeRealm start;
  late _PrimitiveElementRealm startElement;
  late _FhirCanonicalRealm profile;
  late List<_GraphDefinitionLinkRealm> link;
}
@RealmModel()
class _GraphDefinitionLinkRealm {
  @PrimaryKey() late String id;
  late List<_FhirExtensionRealm> extension_;
  late List<_FhirExtensionRealm> modifierExtension;
  late String path;
  ...
  late _PrimitiveElementRealm descriptionElement;
  late List<_GraphDefinitionTargetRealm> target;
}
@RealmModel()
class _GraphDefinitionTargetRealm {
  @PrimaryKey() late String id;
  late List<_FhirExtensionRealm> extension_;
  late List<_FhirExtensionRealm> modifierExtension;
  ...
  late _FhirCanonicalRealm profile;
  late List<_GraphDefinitionCompartmentRealm> compartment;
  late List<_GraphDefinitionLinkRealm> link;
}
@RealmModel()
class _GraphDefinitionCompartmentRealm {
  @PrimaryKey() late String id;
  late List<_FhirExtensionRealm> extension_;
  late List<_FhirExtensionRealm> modifierExtension;
  ...
  late _FhirCodeRealm rule;
  late _PrimitiveElementRealm ruleElement;
