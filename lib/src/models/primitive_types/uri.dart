...
class FhirUri extends PrimitiveType<Uri> {
  ...
  FhirUri(this.valueString, [Element? element])
      : super(
  ...
  FhirUri.fromUri(super.input, [super.element, this.valueString]);
  ...
  ///
  /// Returns `true` if the other object is a [FhirUri], [Uri], or a
