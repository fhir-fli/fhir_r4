...
abstract class CollectedXBiologicallyDerivedProductCollection
    extends DataType {}
...
abstract class ProductXChargeItem extends DataType {}
...
/// or completed.
abstract class ServicedXClaimItem extends DataType {}

/// Where the product or service was provided.
abstract class LocationXClaimItem extends DataType {}
...
abstract class SourceXConceptMap extends DataType {}
...
/// are made.
abstract class TargetXConceptMap extends DataType {}

/// Estimated or actual date or date-time the condition began, in the
/// opinion of the clinician.
abstract class OnsetXCondition extends DataType {}
...
abstract class TopicXContractTerm extends DataType {}
...
abstract class CodeXDeviceRequest extends DataType {}
...
abstract class CiteAsXEvidence extends DataType {}
...
abstract class StartXGoal extends DataType {}
...
abstract class DetailXGoalTarget extends DataType {}

/// Indicates either the date or the duration after start by which the goal
/// should be met.
abstract class DueXGoalTarget extends DataType {}
...
abstract class SubjectXLibrary extends DataType {}
...
/// anything.
abstract class SubjectXMeasure extends DataType {}

/// The date and time(s) at which the media was collected.
abstract class CreatedXMedia extends DataType {}
...
/// A value for the characteristic.
abstract class ValueXMedicinalProductDefinitionCharacteristic
    extends DataType {}
...
abstract class ValueXObservation extends DataType {}
...
/// used.
abstract class PeriodXPackagedProductDefinitionShelfLifeStorage
    extends DataType {}
...
abstract class DeceasedXPatient extends DataType {}
...
abstract class ItemXSupplyRequest extends DataType {}
...
abstract class ValueXTaskInput extends DataType {}

/// The value of the Output parameter as a basic type.
abstract class ValueXTaskOutput extends DataType {}

/// The value of the parameter.
abstract class ValueXValueSetParameter extends DataType {}

/// The individual responsible for making the annotation.
abstract class AuthorXAnnotation extends DataType {}
...
abstract class AsNeededXDosage extends DataType {}
...
abstract class ValueXExtension extends DataType {}

/// The age of the specific population.
abstract class AgeXPopulation extends DataType {}
...
abstract class ValueXUsageContext extends DataType {}
