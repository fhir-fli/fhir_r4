...
class TerminologyCapabilities extends CanonicalResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (codeSearch != o.codeSearch) {
      return false;
    }
    if (validateCode != o.validateCode) {
      return false;
    }
    if (translation != o.translation) {
      return false;
    }
    if (closure != o.closure) {
      return false;
    }
    return true;
  }
...
class TerminologyCapabilitiesExpansion extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (hierarchical != o.hierarchical) {
      return false;
    }
    if (paging != o.paging) {
      return false;
    }
    if (incomplete != o.incomplete) {
      return false;
    }
