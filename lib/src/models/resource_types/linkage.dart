...
class Linkage extends DomainResource {
  ...
  @override
  Linkage createProperty(String propertyName) {
    switch (propertyName) {
      case 'id':
        {
      ...
      case 'item':
        {
          return copyWith(item: <LinkageItem>[]);
        }
      default:
...
class LinkageItem extends BackboneElement {
  ...
  /// `.empty()` variant (or list of `.empty()`).
  @override
  LinkageItem createProperty(String propertyName) {
    switch (propertyName) {
      case 'id':
        {
          return copyWith(id: FhirString.empty());
      ...
      case 'type':
        {
          return copyWith(type: LinkageType.empty());
        }
      case 'resource':
        {
