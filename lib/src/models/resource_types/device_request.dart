...
class DeviceRequest extends DomainResource {
  ...
  factory DeviceRequest.fromJson(
    ...
    return DeviceRequest(
      ...
      codeX: JsonParser.parsePolymorphic<CodeXDeviceRequest>(json, {
      ...
      occurrenceX: JsonParser.parsePolymorphic<OccurrenceXDeviceRequest>(json, {
...
class DeviceRequestParameter extends BackboneElement {
  ...
  factory DeviceRequestParameter.fromJson(
    ...
    return DeviceRequestParameter(
      ...
      valueX: JsonParser.parsePolymorphic<ValueXDeviceRequestParameter>(json, {
