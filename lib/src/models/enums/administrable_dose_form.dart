...
class AdministrableDoseForm extends PrimitiveType<String> {
  ...
  factory AdministrableDoseForm.fromJson(
    ...
    return AdministrableDoseForm._(value: value, element: element);
  }
  ...
  static final AdministrableDoseForm elementOnly =
      AdministrableDoseForm._(value: '');
  ...
  AdministrableDoseForm withElement(Element? newElement) {
    return AdministrableDoseForm._(value: value, element: newElement);
  }
