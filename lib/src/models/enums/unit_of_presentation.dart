...
class UnitOfPresentation extends PrimitiveType<String> {
  ...
  factory UnitOfPresentation.fromJson(
    ...
    return UnitOfPresentation._(value: value, element: element);
  }
  ...
  static final UnitOfPresentation elementOnly = UnitOfPresentation._(value: '');
  ...
  UnitOfPresentation withElement(Element? newElement) {
    return UnitOfPresentation._(value: value, element: newElement);
  }
