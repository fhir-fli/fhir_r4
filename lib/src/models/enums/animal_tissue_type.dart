...
class AnimalTissueType extends PrimitiveType<String> {
  ...
  factory AnimalTissueType.fromJson(
    ...
    return AnimalTissueType._(value: value, element: element);
  }
  ...
  static final AnimalTissueType elementOnly = AnimalTissueType._(value: '');
  ...
  AnimalTissueType withElement(Element? newElement) {
    return AnimalTissueType._(value: value, element: newElement);
  }
