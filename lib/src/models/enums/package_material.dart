...
class PackageMaterial extends PrimitiveType<String> {
  ...
  factory PackageMaterial.fromJson(
    ...
    if (value == null && element != null) {
      ...
      throw ArgumentError(
        'PackageMaterial cannot be constructed from JSON.',
      );
    }
    return PackageMaterial._(value: value, element: element);
  }
  ...
  static final PackageMaterial elementOnly = PackageMaterial._(value: '');
  ...
  PackageMaterial withElement(Element? newElement) {
    return PackageMaterial._(value: value, element: newElement);
  }
