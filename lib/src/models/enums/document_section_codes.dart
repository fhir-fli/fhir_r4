...
class DocumentSectionCodes extends PrimitiveType<String> {
  ...
  factory DocumentSectionCodes.fromJson(
    ...
    return DocumentSectionCodes._(value: value, element: element);
  }
  ...
  static final DocumentSectionCodes elementOnly =
      DocumentSectionCodes._(value: '');
  ...
  DocumentSectionCodes withElement(Element? newElement) {
    return DocumentSectionCodes._(value: value, element: newElement);
  }
