...
class LegalStatusOfSupply extends PrimitiveType<String> {
  ...
  factory LegalStatusOfSupply.fromJson(
    ...
    return LegalStatusOfSupply._(value: value, element: element);
  }
  ...
  static final LegalStatusOfSupply elementOnly =
      LegalStatusOfSupply._(value: '');
  ...
  LegalStatusOfSupply withElement(Element? newElement) {
    return LegalStatusOfSupply._(value: value, element: newElement);
  }
