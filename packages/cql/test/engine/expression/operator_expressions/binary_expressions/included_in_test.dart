...
void includedInTest() {
  group('included in', () {
    test('define "IncludedInIsTrue": Interval[1, 5] included in Interval[0, 5]',
      ...
      final result = includedIn.execute({});
      expect(result, equals(FhirBoolean(true)));
    });
    test('define "IncludedInIsFalse": -1 during Interval[0, 7]', () {
    ...
    test('define "IncludedInIsTrue": 5 included in { 1, 3, 5, 7 }', () {
    ...
    test('define "IncludedInIsNull": null included in { 1, 3, 5 }', () {
