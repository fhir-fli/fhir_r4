...
void populationVarianceTest() {
  group('populationVariance', () {
    ...
    test(
        ...
        () {
      final result = PopulationVariance(source: LiteralNull()).execute({});
      expect(result, equals(null));
    });
    test('PopulationVariance({ 1, 2, 3, null }) = 0.66666666', () {
      final list = ListExpression(element: [
        LiteralDecimal(1),
        LiteralDecimal(2),
        LiteralDecimal(3),
    ...
    test('PopulationStdDev({ 1, 2, 3, null }) = 0.816496580927726', () {
      final list = ListExpression(element: [
        LiteralDecimal(1),
        LiteralDecimal(2),
        LiteralDecimal(3),
