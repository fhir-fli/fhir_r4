...
abstract class BackboneElementBuilder extends DataTypeBuilder {
  ...
  void removeModifierExtension(String url) {
    modifierExtension
        ?.removeWhere((FhirExtensionBuilder ext) => ext.url.equals(url));
  }
  ...
  @override
  BackboneElementBuilder createProperty(String propertyName);

  @override
  BackboneElementBuilder clear({bool extension_ = false, bool id = false});
}
