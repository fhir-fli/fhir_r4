...
class CarePlanDetailBuilder extends BackboneElementBuilder {
  ...
  factory CarePlanDetailBuilder.empty() => CarePlanDetailBuilder(
        status: CarePlanActivityStatusBuilder.values.first,
      );
      ...
      case 'kind':
        {
          if (child is CarePlanActivityKindBuilder) {
            ...
            try {
              ...
              // For enums, try to create directly from the string value
              try {
                final converted = CarePlanActivityKindBuilder(stringValue);
                kind = converted;
                return;
              } catch (e) {
                // Continue if enum creation fails
      ...
      case 'status':
        {
          if (child is CarePlanActivityStatusBuilder) {
            ...
            try {
              ...
              // For enums, try to create directly from the string value
              try {
                final converted = CarePlanActivityStatusBuilder(stringValue);
                status = converted;
                return;
              } catch (e) {
                // Continue if enum creation fails
