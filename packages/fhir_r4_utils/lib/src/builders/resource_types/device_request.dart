...
class DeviceRequestBuilder extends DomainResourceBuilder {
  ...
  factory DeviceRequestBuilder.fromJson(
    ...
    return DeviceRequestBuilder(
      ...
      codeX: JsonParser.parsePolymorphic<CodeXDeviceRequestBuilder>(
        json,
        {
          'codeReference': ReferenceBuilder.fromJson,
          'codeCodeableConcept': CodeableConceptBuilder.fromJson,
        },
        objectPath,
      ),
  ...
  /// request(s).
  List<ReferenceBuilder>? priorRequest;
  ...
  /// Getter for [codeReference] as a ReferenceBuilder
  ReferenceBuilder? get codeReference => codeX?.isAs<ReferenceBuilder>();

  /// Getter for [codeCodeableConcept] as a CodeableConceptBuilder
  CodeableConceptBuilder? get codeCodeableConcept =>
      codeX?.isAs<CodeableConceptBuilder>();
  ...
  List<FhirBaseBuilder> getChildrenByName(
    ...
    switch (fieldName) {
      ...
      case 'codeReference':
        if (codeX is ReferenceBuilder) {
          fields.add(codeX!);
        }
      case 'codeCodeableConcept':
        if (codeX is CodeableConceptBuilder) {
          fields.add(codeX!);
        }
      case 'parameter':
        if (parameter != null) {
      ...
      case 'priorRequest':
        {
          if (child is List<ReferenceBuilder>) {
            ...
            // Add single element to existing list or create new list
            priorRequest = [...(priorRequest ?? []), child];
            return;
          } else {
            throw Exception('Invalid child type for $childName');
          }
  ...
  void createProperty(String propertyName) {
    switch (propertyName) {
      ...
      case 'codeReference':
        {
          codeX = ReferenceBuilder.empty();
          return;
        }
      case 'codeCodeableConcept':
        {
          codeX = CodeableConceptBuilder.empty();
          return;
        }
      case 'parameter':
        {
