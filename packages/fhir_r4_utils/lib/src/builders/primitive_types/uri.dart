...
/// Extension to convert a [FhirUri] to a [FhirUriBuilder]
extension BuilderFhirUri on FhirUri {
  /// Converts this instance to a [FhirUriBuilder]
  FhirUriBuilder get toBuilder => FhirUriBuilder.fromJson(toJson());
}

/// Extension to convert a [String] to a [FhirUriBuilder]
extension FhirUriBuilderExtension on String {
  /// Converts a [String] to a [FhirUriBuilder]
  FhirUriBuilder get toFhirUriBuilder => FhirUriBuilder(this);
}

/// Extension to convert a [Uri] to a [FhirUriBuilder]
extension FhirUriBuilderUriExtension on Uri {
  /// Converts a [Uri] to a [FhirUriBuilder]
...
class FhirUriBuilder extends PrimitiveTypeBuilder<Uri>
    implements
  ...
  factory FhirUriBuilder(
    ...
    if (rawInput == null && element == null) {
      throw ArgumentError('A value or element is required for FhirUriBuilder.');
      ...
      throw ArgumentError(
        'FhirUriBuilder only supports a String or Uri, got: $rawInput',
      );
    }
  ...
  /// Creates empty [FhirUriBuilder] object
  factory FhirUriBuilder.empty() =>
      FhirUriBuilder(null, element: ElementBuilder.empty());

  /// Constructs a [FhirUriBuilder] from a [Uri] object
  ...
  /// Named constructor to create [FhirUriBuilder] from JSON
  ...
  /// Named constructor to create [FhirUriBuilder] from YAML
  static FhirUriBuilder fromYaml(dynamic yaml) {
    if (yaml is String) {
      ...
      throw ArgumentError(
        'FhirUriBuilder cannot be constructed from the provided input. '
        'It is neither a YAML string nor a YAML map.',
      );
    }
  }

  /// Attempts to parse the input as a [FhirUriBuilder].
  ...
  /// Converts a list of JSON values to a list of [FhirUriBuilder] instances
  ...
  /// Converts a list of [FhirUriBuilder] to a JSON map
  static Map<String, dynamic> toJsonList(List<FhirUriBuilder> canonicals) => {
  ...
  bool equals(Object other) =>
      ...
      (other is FhirUriBuilder && other.value == value) ||
  ...
  /// Clones this [FhirUriBuilder] instance
  @override
