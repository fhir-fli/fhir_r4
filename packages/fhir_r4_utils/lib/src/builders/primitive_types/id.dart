...
/// Extension to convert a [FhirId] to a [FhirIdBuilder]
extension BuilderFhirId on FhirId {
  /// Converts this instance to a [FhirIdBuilder]
  FhirIdBuilder get toBuilder => FhirIdBuilder.fromJson(toJson());
}
