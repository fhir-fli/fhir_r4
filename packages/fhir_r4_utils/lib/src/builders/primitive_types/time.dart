...
/// Extension to convert a [FhirTime] to a [FhirTimeBuilder]
extension BuilderFhirTime on FhirTime {
  /// Converts this instance to a [FhirTimeBuilder]
  FhirTimeBuilder get toBuilder => FhirTimeBuilder.fromJson(toJson());
}
