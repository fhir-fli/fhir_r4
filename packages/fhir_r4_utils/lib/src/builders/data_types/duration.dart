...
import 'package:fhir_r4/fhir_r4.dart'
    show FhirDuration, StringExtensionForFHIR, yamlMapToJson, yamlToJson;
...
class FhirDurationBuilder extends QuantityBuilder
  ...
  FhirDurationBuilder({
    ...
    super.objectPath = 'FhirDurationBuilder',
  });

  /// An empty constructor for partial usage.
  /// For Builder classes, no fields are required
  factory FhirDurationBuilder.empty() => FhirDurationBuilder();

  /// Factory constructor that accepts [Map<String, dynamic>] as an argument
  factory FhirDurationBuilder.fromJson(
  ...
  /// Deserialize [FhirDurationBuilder]
  /// from a [String] or [YamlMap] object
  factory FhirDurationBuilder.fromYaml(
    dynamic yaml,
  ) {
    if (yaml is String) {
  ...
  factory FhirDurationBuilder.fromJsonString(
    String source,
  ) {
    final dynamic json = jsonDecode(source);
    if (json is Map<String, dynamic>) {
      return FhirDurationBuilder.fromJson(json);
    } else {
  ...
  /// Converts a [FhirDurationBuilder]
  /// to [FhirDuration]
  @override
  ...
  /// Creates a new [FhirDurationBuilder]
  ...
  @override
  FhirDurationBuilder clone() => throw UnimplementedError();
  @override
  FhirDurationBuilder copyWith({
    ...
    final newResult = FhirDurationBuilder(
      id: id ?? this.id,
