...
class SearchSearchParameter extends SearchResource {
  ...
  /// [SearchParameter]
  SearchSearchParameter name(FhirString value) {
  ...
  /// [SearchParameter]
  SearchSearchParameter url(FhirUri value) {
  ...
  SearchSearchParameter base(
    ...
    final paramValue = system != null ? '$system|$value' : value.toString();
    addParameterValue('base', paramValue);
    return this;
  }
  ...
  SearchSearchParameter target(
    ...
    final paramValue = system != null ? '$system|$value' : value.toString();
    addParameterValue('target', paramValue);
    return this;
  }
