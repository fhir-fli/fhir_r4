...
class DeviceMetricCalibrationTypeBuilder extends FhirCodeEnumBuilder {
  ...
  factory DeviceMetricCalibrationTypeBuilder.fromJson(
    ...
    final known =
        _known(DeviceMetricCalibrationTypeBuilderEnum.fromString(value));
    return DeviceMetricCalibrationTypeBuilder._(
      valueString: value,
  ...
  static DeviceMetricCalibrationTypeBuilder? _known(
      DeviceMetricCalibrationTypeBuilderEnum? valueEnum) {
