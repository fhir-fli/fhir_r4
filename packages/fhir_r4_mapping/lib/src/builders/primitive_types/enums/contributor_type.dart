...
class ContributorTypeBuilder extends FhirCodeEnumBuilder {
  ...
  factory ContributorTypeBuilder.fromJson(
    ...
    final known = _known(ContributorTypeBuilderEnum.fromString(value));
    return ContributorTypeBuilder._(
      valueString: value,
  ...
  static ContributorTypeBuilder? _known(ContributorTypeBuilderEnum? valueEnum) {
  ...
  static ContributorTypeBuilder author = ContributorTypeBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/contributor-type',
    ),
