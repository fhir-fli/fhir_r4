...
class DocumentReferenceStatusBuilder extends FhirCodeEnumBuilder {
  ...
  factory DocumentReferenceStatusBuilder.fromJson(
    ...
    final known = _known(DocumentReferenceStatusBuilderEnum.fromString(value));
    return DocumentReferenceStatusBuilder._(
      valueString: value,
  ...
  static DocumentReferenceStatusBuilder? _known(
      DocumentReferenceStatusBuilderEnum? valueEnum) {
