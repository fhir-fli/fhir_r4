...
class CodeSystemHierarchyMeaningBuilder extends FhirCodeEnumBuilder {
  ...
  factory CodeSystemHierarchyMeaningBuilder.fromJson(
    ...
    final known =
        _known(CodeSystemHierarchyMeaningBuilderEnum.fromString(value));
    return CodeSystemHierarchyMeaningBuilder._(
      valueString: value,
  ...
  static CodeSystemHierarchyMeaningBuilder? _known(
      CodeSystemHierarchyMeaningBuilderEnum? valueEnum) {
