...
class StructureMapSourceListModeBuilder extends FhirCodeEnumBuilder {
  ...
  factory StructureMapSourceListModeBuilder.fromJson(
    ...
    final known =
        _known(StructureMapSourceListModeBuilderEnum.fromString(value));
    return StructureMapSourceListModeBuilder._(
      valueString: value,
  ...
  static StructureMapSourceListModeBuilder? _known(
      StructureMapSourceListModeBuilderEnum? valueEnum) {
