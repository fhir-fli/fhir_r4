...
class OperationKindBuilder extends FhirCodeEnumBuilder {
  ...
  factory OperationKindBuilder.fromJson(
    ...
    final known = _known(OperationKindBuilderEnum.fromString(value));
    return OperationKindBuilder._(
      valueString: value,
  ...
  static OperationKindBuilder? _known(OperationKindBuilderEnum? valueEnum) {
  ...
  static OperationKindBuilder operation = OperationKindBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/operation-kind',
    ),
