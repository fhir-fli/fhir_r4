...
class TestReportStatusBuilder extends FhirCodeEnumBuilder {
  ...
  factory TestReportStatusBuilder.fromJson(
    ...
    final known = _known(TestReportStatusBuilderEnum.fromString(value));
    return TestReportStatusBuilder._(
      valueString: value,
  ...
  static TestReportStatusBuilder? _known(
      TestReportStatusBuilderEnum? valueEnum) {
  ...
  static TestReportStatusBuilder completed = TestReportStatusBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/report-status-codes',
    ),
