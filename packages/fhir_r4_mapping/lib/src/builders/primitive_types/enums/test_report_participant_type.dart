...
class TestReportParticipantTypeBuilder extends FhirCodeEnumBuilder {
  ...
  factory TestReportParticipantTypeBuilder.fromJson(
    ...
    final known =
        _known(TestReportParticipantTypeBuilderEnum.fromString(value));
    return TestReportParticipantTypeBuilder._(
      valueString: value,
  ...
  static TestReportParticipantTypeBuilder? _known(
      TestReportParticipantTypeBuilderEnum? valueEnum) {
