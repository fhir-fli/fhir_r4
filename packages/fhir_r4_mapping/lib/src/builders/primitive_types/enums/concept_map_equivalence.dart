...
class ConceptMapEquivalenceBuilder extends FhirCodeEnumBuilder {
  ...
  factory ConceptMapEquivalenceBuilder.fromJson(
    ...
    final known = _known(ConceptMapEquivalenceBuilderEnum.fromString(value));
    return ConceptMapEquivalenceBuilder._(
      valueString: value,
  ...
  static ConceptMapEquivalenceBuilder? _known(
      ConceptMapEquivalenceBuilderEnum? valueEnum) {
  ...
  static ConceptMapEquivalenceBuilder relatedto =
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/concept-map-equivalence',
    ),
