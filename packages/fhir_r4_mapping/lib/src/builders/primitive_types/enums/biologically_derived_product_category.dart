...
class BiologicallyDerivedProductCategoryBuilder extends FhirCodeEnumBuilder {
  ...
  factory BiologicallyDerivedProductCategoryBuilder.fromJson(
    ...
    final known =
        _known(BiologicallyDerivedProductCategoryBuilderEnum.fromString(value));
    return BiologicallyDerivedProductCategoryBuilder._(
      valueString: value,
  ...
  static BiologicallyDerivedProductCategoryBuilder? _known(
      BiologicallyDerivedProductCategoryBuilderEnum? valueEnum) {
