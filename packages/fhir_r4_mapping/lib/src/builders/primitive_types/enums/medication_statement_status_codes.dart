...
class MedicationStatementStatusCodesBuilder extends FhirCodeEnumBuilder {
  ...
  factory MedicationStatementStatusCodesBuilder.fromJson(
    ...
    final known =
        _known(MedicationStatementStatusCodesBuilderEnum.fromString(value));
    return MedicationStatementStatusCodesBuilder._(
      valueString: value,
  ...
  static MedicationStatementStatusCodesBuilder? _known(
      MedicationStatementStatusCodesBuilderEnum? valueEnum) {
