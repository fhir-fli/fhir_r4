...
class CareTeamStatusBuilder extends FhirCodeEnumBuilder {
  ...
  factory CareTeamStatusBuilder.fromJson(
    ...
    final known = _known(CareTeamStatusBuilderEnum.fromString(value));
    return CareTeamStatusBuilder._(
      valueString: value,
  ...
  static CareTeamStatusBuilder? _known(CareTeamStatusBuilderEnum? valueEnum) {
  ...
  static CareTeamStatusBuilder proposed = CareTeamStatusBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/care-team-status',
    ),
