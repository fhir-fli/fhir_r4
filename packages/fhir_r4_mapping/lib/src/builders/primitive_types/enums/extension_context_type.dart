...
class ExtensionContextTypeBuilder extends FhirCodeEnumBuilder {
  ...
  factory ExtensionContextTypeBuilder.fromJson(
    ...
    final known = _known(ExtensionContextTypeBuilderEnum.fromString(value));
    return ExtensionContextTypeBuilder._(
      valueString: value,
  ...
  static ExtensionContextTypeBuilder? _known(
      ExtensionContextTypeBuilderEnum? valueEnum) {
  ...
  static ExtensionContextTypeBuilder fhirpath = ExtensionContextTypeBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/extension-context-type',
    ),
