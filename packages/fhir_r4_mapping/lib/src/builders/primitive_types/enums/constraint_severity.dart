...
class ConstraintSeverityBuilder extends FhirCodeEnumBuilder {
  ...
  factory ConstraintSeverityBuilder.fromJson(
    ...
    final known = _known(ConstraintSeverityBuilderEnum.fromString(value));
    return ConstraintSeverityBuilder._(
      valueString: value,
  ...
  static ConstraintSeverityBuilder? _known(
      ConstraintSeverityBuilderEnum? valueEnum) {
  ...
  static ConstraintSeverityBuilder error = ConstraintSeverityBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/constraint-severity',
    ),
