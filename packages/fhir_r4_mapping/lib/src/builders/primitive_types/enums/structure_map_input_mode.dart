...
class StructureMapInputModeBuilder extends FhirCodeEnumBuilder {
  ...
  factory StructureMapInputModeBuilder.fromJson(
    ...
    final known = _known(StructureMapInputModeBuilderEnum.fromString(value));
    return StructureMapInputModeBuilder._(
      valueString: value,
  ...
  static StructureMapInputModeBuilder? _known(
      StructureMapInputModeBuilderEnum? valueEnum) {
