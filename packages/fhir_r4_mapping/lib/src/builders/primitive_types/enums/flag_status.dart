...
class FlagStatusBuilder extends FhirCodeEnumBuilder {
  ...
  factory FlagStatusBuilder.fromJson(
    ...
    final known = _known(FlagStatusBuilderEnum.fromString(value));
    return FlagStatusBuilder._(
      valueString: value,
  ...
  static FlagStatusBuilder? _known(FlagStatusBuilderEnum? valueEnum) {
  ...
  static FlagStatusBuilder active = FlagStatusBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/flag-status',
    ),
