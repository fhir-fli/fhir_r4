...
class ContractResourcePublicationStatusCodesBuilder
  ...
  factory ContractResourcePublicationStatusCodesBuilder.fromJson(
    ...
    final known = _known(
        ContractResourcePublicationStatusCodesBuilderEnum.fromString(value));
    return ContractResourcePublicationStatusCodesBuilder._(
      valueString: value,
  ...
  static ContractResourcePublicationStatusCodesBuilder? _known(
      ContractResourcePublicationStatusCodesBuilderEnum? valueEnum) {
  ...
  static ContractResourcePublicationStatusCodesBuilder amended =
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/contract-publicationstatus',
    ),
