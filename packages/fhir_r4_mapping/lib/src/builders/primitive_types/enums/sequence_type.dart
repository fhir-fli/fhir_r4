...
class SequenceTypeBuilder extends FhirCodeEnumBuilder {
  ...
  factory SequenceTypeBuilder.fromJson(
    ...
    final known = _known(SequenceTypeBuilderEnum.fromString(value));
    return SequenceTypeBuilder._(
      valueString: value,
  ...
  static SequenceTypeBuilder? _known(SequenceTypeBuilderEnum? valueEnum) {
  ...
  static SequenceTypeBuilder aa = SequenceTypeBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/sequence-type',
    ),
