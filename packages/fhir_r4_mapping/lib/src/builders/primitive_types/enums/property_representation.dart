...
class PropertyRepresentationBuilder extends FhirCodeEnumBuilder {
  ...
  factory PropertyRepresentationBuilder.fromJson(
    ...
    final known = _known(PropertyRepresentationBuilderEnum.fromString(value));
    return PropertyRepresentationBuilder._(
      valueString: value,
  ...
  static PropertyRepresentationBuilder? _known(
      PropertyRepresentationBuilderEnum? valueEnum) {
  ...
  static PropertyRepresentationBuilder xmlAttr =
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/property-representation',
    ),
