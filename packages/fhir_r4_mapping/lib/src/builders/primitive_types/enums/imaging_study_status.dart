...
class ImagingStudyStatusBuilder extends FhirCodeEnumBuilder {
  ...
  factory ImagingStudyStatusBuilder.fromJson(
    ...
    final known = _known(ImagingStudyStatusBuilderEnum.fromString(value));
    return ImagingStudyStatusBuilder._(
      valueString: value,
  ...
  static ImagingStudyStatusBuilder? _known(
      ImagingStudyStatusBuilderEnum? valueEnum) {
  ...
  static ImagingStudyStatusBuilder registered = ImagingStudyStatusBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/imagingstudy-status',
    ),
