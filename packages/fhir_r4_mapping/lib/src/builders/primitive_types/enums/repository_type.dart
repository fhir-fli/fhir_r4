...
class RepositoryTypeBuilder extends FhirCodeEnumBuilder {
  ...
  factory RepositoryTypeBuilder.fromJson(
    ...
    final known = _known(RepositoryTypeBuilderEnum.fromString(value));
    return RepositoryTypeBuilder._(
      valueString: value,
  ...
  static RepositoryTypeBuilder? _known(RepositoryTypeBuilderEnum? valueEnum) {
  ...
  static RepositoryTypeBuilder directlink = RepositoryTypeBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/repository-type',
    ),
