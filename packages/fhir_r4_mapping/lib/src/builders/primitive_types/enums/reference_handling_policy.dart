...
class ReferenceHandlingPolicyBuilder extends FhirCodeEnumBuilder {
  ...
  factory ReferenceHandlingPolicyBuilder.fromJson(
    ...
    final known = _known(ReferenceHandlingPolicyBuilderEnum.fromString(value));
    return ReferenceHandlingPolicyBuilder._(
      valueString: value,
  ...
  static ReferenceHandlingPolicyBuilder? _known(
      ReferenceHandlingPolicyBuilderEnum? valueEnum) {
  ...
  static ReferenceHandlingPolicyBuilder literal =
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/reference-handling-policy',
    ),
