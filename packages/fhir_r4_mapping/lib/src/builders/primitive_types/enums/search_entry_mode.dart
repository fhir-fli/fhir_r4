...
class SearchEntryModeBuilder extends FhirCodeEnumBuilder {
  ...
  factory SearchEntryModeBuilder.fromJson(
    ...
    final known = _known(SearchEntryModeBuilderEnum.fromString(value));
    return SearchEntryModeBuilder._(
      valueString: value,
  ...
  static SearchEntryModeBuilder? _known(SearchEntryModeBuilderEnum? valueEnum) {
  ...
  static SearchEntryModeBuilder match = SearchEntryModeBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/search-entry-mode',
    ),
