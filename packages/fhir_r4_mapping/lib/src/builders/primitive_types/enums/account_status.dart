...
class AccountStatusBuilder extends FhirCodeEnumBuilder {
  ...
  factory AccountStatusBuilder.fromJson(
    ...
    final known = _known(AccountStatusBuilderEnum.fromString(value));
    return AccountStatusBuilder._(
      valueString: value,
  ...
  static AccountStatusBuilder? _known(AccountStatusBuilderEnum? valueEnum) {
  ...
  static AccountStatusBuilder active = AccountStatusBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/account-status',
    ),
