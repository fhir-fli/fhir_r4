...
class LinkageTypeBuilder extends FhirCodeEnumBuilder {
  ...
  factory LinkageTypeBuilder.fromJson(
    ...
    final known = _known(LinkageTypeBuilderEnum.fromString(value));
    return LinkageTypeBuilder._(
      valueString: value,
  ...
  static LinkageTypeBuilder? _known(LinkageTypeBuilderEnum? valueEnum) {
  ...
  static LinkageTypeBuilder source = LinkageTypeBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/linkage-type',
    ),
