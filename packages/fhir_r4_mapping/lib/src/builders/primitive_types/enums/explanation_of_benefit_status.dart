...
class ExplanationOfBenefitStatusBuilder extends FhirCodeEnumBuilder {
  ...
  factory ExplanationOfBenefitStatusBuilder.fromJson(
    ...
    final known =
        _known(ExplanationOfBenefitStatusBuilderEnum.fromString(value));
    return ExplanationOfBenefitStatusBuilder._(
      valueString: value,
  ...
  static ExplanationOfBenefitStatusBuilder? _known(
      ExplanationOfBenefitStatusBuilderEnum? valueEnum) {
