...
class AuditEventAgentNetworkTypeBuilder extends FhirCodeEnumBuilder {
  ...
  factory AuditEventAgentNetworkTypeBuilder.fromJson(
    ...
    final known =
        _known(AuditEventAgentNetworkTypeBuilderEnum.fromString(value));
    return AuditEventAgentNetworkTypeBuilder._(
      valueString: value,
  ...
  static AuditEventAgentNetworkTypeBuilder? _known(
      AuditEventAgentNetworkTypeBuilderEnum? valueEnum) {
