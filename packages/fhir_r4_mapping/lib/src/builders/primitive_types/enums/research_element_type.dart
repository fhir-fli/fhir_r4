...
class ResearchElementTypeBuilder extends FhirCodeEnumBuilder {
  ...
  factory ResearchElementTypeBuilder.fromJson(
    ...
    final known = _known(ResearchElementTypeBuilderEnum.fromString(value));
    return ResearchElementTypeBuilder._(
      valueString: value,
  ...
  static ResearchElementTypeBuilder? _known(
      ResearchElementTypeBuilderEnum? valueEnum) {
  ...
  static ResearchElementTypeBuilder population = ResearchElementTypeBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/research-element-type',
    ),
