...
class SpecimenContainedPreferenceBuilder extends FhirCodeEnumBuilder {
  ...
  factory SpecimenContainedPreferenceBuilder.fromJson(
    ...
    final known =
        _known(SpecimenContainedPreferenceBuilderEnum.fromString(value));
    return SpecimenContainedPreferenceBuilder._(
      valueString: value,
  ...
  static SpecimenContainedPreferenceBuilder? _known(
      SpecimenContainedPreferenceBuilderEnum? valueEnum) {
  ...
  static SpecimenContainedPreferenceBuilder preferred =
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/specimen-contained-preference',
    ),
