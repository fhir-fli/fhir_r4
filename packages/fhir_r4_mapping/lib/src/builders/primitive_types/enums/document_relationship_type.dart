...
class DocumentRelationshipTypeBuilder extends FhirCodeEnumBuilder {
  ...
  factory DocumentRelationshipTypeBuilder.fromJson(
    ...
    final known = _known(DocumentRelationshipTypeBuilderEnum.fromString(value));
    return DocumentRelationshipTypeBuilder._(
      valueString: value,
  ...
  static DocumentRelationshipTypeBuilder? _known(
      DocumentRelationshipTypeBuilderEnum? valueEnum) {
