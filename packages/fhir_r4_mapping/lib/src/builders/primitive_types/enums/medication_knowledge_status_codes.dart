...
class MedicationKnowledgeStatusCodesBuilder extends FhirCodeEnumBuilder {
  ...
  factory MedicationKnowledgeStatusCodesBuilder.fromJson(
    ...
    final known =
        _known(MedicationKnowledgeStatusCodesBuilderEnum.fromString(value));
    return MedicationKnowledgeStatusCodesBuilder._(
      valueString: value,
  ...
  static MedicationKnowledgeStatusCodesBuilder? _known(
      MedicationKnowledgeStatusCodesBuilderEnum? valueEnum) {
