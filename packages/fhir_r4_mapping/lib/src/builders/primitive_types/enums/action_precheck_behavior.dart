...
class ActionPrecheckBehaviorBuilder extends FhirCodeEnumBuilder {
  ...
  factory ActionPrecheckBehaviorBuilder.fromJson(
    ...
    final known = _known(ActionPrecheckBehaviorBuilderEnum.fromString(value));
    return ActionPrecheckBehaviorBuilder._(
      valueString: value,
  ...
  static ActionPrecheckBehaviorBuilder? _known(
      ActionPrecheckBehaviorBuilderEnum? valueEnum) {
  ...
  static ActionPrecheckBehaviorBuilder yes = ActionPrecheckBehaviorBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/action-precheck-behavior',
    ),
