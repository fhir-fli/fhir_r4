...
class ReferenceVersionRulesBuilder extends FhirCodeEnumBuilder {
  ...
  factory ReferenceVersionRulesBuilder.fromJson(
    ...
    final known = _known(ReferenceVersionRulesBuilderEnum.fromString(value));
    return ReferenceVersionRulesBuilder._(
      valueString: value,
  ...
  static ReferenceVersionRulesBuilder? _known(
      ReferenceVersionRulesBuilderEnum? valueEnum) {
