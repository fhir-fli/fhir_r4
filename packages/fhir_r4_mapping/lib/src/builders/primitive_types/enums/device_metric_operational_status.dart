...
class DeviceMetricOperationalStatusBuilder extends FhirCodeEnumBuilder {
  ...
  factory DeviceMetricOperationalStatusBuilder.fromJson(
    ...
    final known =
        _known(DeviceMetricOperationalStatusBuilderEnum.fromString(value));
    return DeviceMetricOperationalStatusBuilder._(
      valueString: value,
  ...
  static DeviceMetricOperationalStatusBuilder? _known(
      DeviceMetricOperationalStatusBuilderEnum? valueEnum) {
  ...
  static DeviceMetricOperationalStatusBuilder on_ =
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/metric-operational-status',
    ),
