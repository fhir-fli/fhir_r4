...
class ResourceVersionPolicyBuilder extends FhirCodeEnumBuilder {
  ...
  factory ResourceVersionPolicyBuilder.fromJson(
    ...
    final known = _known(ResourceVersionPolicyBuilderEnum.fromString(value));
    return ResourceVersionPolicyBuilder._(
      valueString: value,
  ...
  static ResourceVersionPolicyBuilder? _known(
      ResourceVersionPolicyBuilderEnum? valueEnum) {
  ...
  static ResourceVersionPolicyBuilder noVersion =
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/versioning-policy',
    ),
