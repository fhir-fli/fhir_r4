...
class IssueSeverityBuilder extends FhirCodeEnumBuilder {
  ...
  factory IssueSeverityBuilder.fromJson(
    ...
    final known = _known(IssueSeverityBuilderEnum.fromString(value));
    return IssueSeverityBuilder._(
      valueString: value,
  ...
  static IssueSeverityBuilder? _known(IssueSeverityBuilderEnum? valueEnum) {
  ...
  static IssueSeverityBuilder fatal = IssueSeverityBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/issue-severity',
    ),
