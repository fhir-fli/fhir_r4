...
class DaysOfWeekBuilder extends FhirCodeEnumBuilder {
  ...
  factory DaysOfWeekBuilder.fromJson(
    ...
    final known = _known(DaysOfWeekBuilderEnum.fromString(value));
    return DaysOfWeekBuilder._(
      valueString: value,
  ...
  static DaysOfWeekBuilder? _known(DaysOfWeekBuilderEnum? valueEnum) {
  ...
  static DaysOfWeekBuilder mon = DaysOfWeekBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/days-of-week',
    ),
