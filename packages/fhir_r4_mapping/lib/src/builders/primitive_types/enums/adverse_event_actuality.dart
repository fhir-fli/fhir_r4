...
class AdverseEventActualityBuilder extends FhirCodeEnumBuilder {
  ...
  factory AdverseEventActualityBuilder.fromJson(
    ...
    final known = _known(AdverseEventActualityBuilderEnum.fromString(value));
    return AdverseEventActualityBuilder._(
      valueString: value,
  ...
  static AdverseEventActualityBuilder? _known(
      AdverseEventActualityBuilderEnum? valueEnum) {
  ...
  static AdverseEventActualityBuilder actual = AdverseEventActualityBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/adverse-event-actuality',
    ),
