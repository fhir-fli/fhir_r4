...
class AddressTypeBuilder extends FhirCodeEnumBuilder {
  ...
  factory AddressTypeBuilder.fromJson(
    ...
    final known = _known(AddressTypeBuilderEnum.fromString(value));
    return AddressTypeBuilder._(
      valueString: value,
  ...
  static AddressTypeBuilder? _known(AddressTypeBuilderEnum? valueEnum) {
  ...
  static AddressTypeBuilder postal = AddressTypeBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/address-type',
    ),
