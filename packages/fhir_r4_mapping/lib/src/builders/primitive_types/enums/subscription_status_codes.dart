...
class SubscriptionStatusCodesBuilder extends FhirCodeEnumBuilder {
  ...
  factory SubscriptionStatusCodesBuilder.fromJson(
    ...
    final known = _known(SubscriptionStatusCodesBuilderEnum.fromString(value));
    return SubscriptionStatusCodesBuilder._(
      valueString: value,
  ...
  static SubscriptionStatusCodesBuilder? _known(
      SubscriptionStatusCodesBuilderEnum? valueEnum) {
