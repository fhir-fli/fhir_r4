...
class StructureDefinitionKindBuilder extends FhirCodeEnumBuilder {
  ...
  factory StructureDefinitionKindBuilder.fromJson(
    ...
    final known = _known(StructureDefinitionKindBuilderEnum.fromString(value));
    return StructureDefinitionKindBuilder._(
      valueString: value,
  ...
  static StructureDefinitionKindBuilder? _known(
      StructureDefinitionKindBuilderEnum? valueEnum) {
  ...
  static StructureDefinitionKindBuilder primitiveType =
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/structure-definition-kind',
    ),
