...
class ExpressionLanguageBuilder extends FhirCodeEnumBuilder {
  ...
  factory ExpressionLanguageBuilder.fromJson(
    ...
    final known = _known(ExpressionLanguageBuilderEnum.fromString(value));
    return ExpressionLanguageBuilder._(
      valueString: value,
  ...
  static ExpressionLanguageBuilder? _known(
      ExpressionLanguageBuilderEnum? valueEnum) {
  ...
  static ExpressionLanguageBuilder textCql = ExpressionLanguageBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/expression-language',
    ),
