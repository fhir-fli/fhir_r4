...
class AggregationModeBuilder extends FhirCodeEnumBuilder {
  ...
  factory AggregationModeBuilder.fromJson(
    ...
    final known = _known(AggregationModeBuilderEnum.fromString(value));
    return AggregationModeBuilder._(
      valueString: value,
  ...
  static AggregationModeBuilder? _known(AggregationModeBuilderEnum? valueEnum) {
  ...
  static AggregationModeBuilder contained = AggregationModeBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/resource-aggregation-mode',
    ),
