...
class StrandTypeBuilder extends FhirCodeEnumBuilder {
  ...
  factory StrandTypeBuilder.fromJson(
    ...
    final known = _known(StrandTypeBuilderEnum.fromString(value));
    return StrandTypeBuilder._(
      valueString: value,
  ...
  static StrandTypeBuilder? _known(StrandTypeBuilderEnum? valueEnum) {
  ...
  static StrandTypeBuilder watson = StrandTypeBuilder._(
    ...
    system: FhirUriBuilder._(
      valueString: 'http://hl7.org/fhir/strand-type',
    ),
