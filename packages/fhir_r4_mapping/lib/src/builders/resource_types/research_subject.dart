...
import 'package:fhir_r4/fhir_r4.dart'
    show R4ResourceType, ResearchSubject, yamlMapToJson, yamlToJson;
...
class ResearchSubjectBuilder extends DomainResourceBuilder {
  ...
  factory ResearchSubjectBuilder.empty() => ResearchSubjectBuilder(
        status: ResearchSubjectStatusBuilder.values.first,
      ...
      case 'status':
        {
          if (child is ResearchSubjectStatusBuilder) {
            ...
            try {
              ...
              // For enums, try to create directly from the string value
              try {
                final converted = ResearchSubjectStatusBuilder(stringValue);
                status = converted;
                return;
              } catch (e) {
                // Continue if enum creation fails
