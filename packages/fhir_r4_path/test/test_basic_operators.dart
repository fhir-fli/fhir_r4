...
void testBasicOperators() {
  group('Operators: ', () {
    test('= : ', () {
      ...
      expect(
        testEngine.evaluate(patient3, node1),
        [false.toFhirBoolean],
      );

      final node2 = testEngine.parse('10.0 = 10');
      expect(
        testEngine.evaluate(patient3, node2),
        [true.toFhirBoolean],
      );

      final node3 = testEngine.parse('10.9 = 9.1');
      expect(
        testEngine.evaluate(patient3, node3),
        [false.toFhirBoolean],
      );

      final node4 = testEngine.parse('10.9 = 10.9');
      expect(
        testEngine.evaluate(patient3, node4),
        [true.toFhirBoolean],
      );
      ...
      expect(
        testEngine.evaluate(patient3, node5),
        [true.toFhirBoolean],
      );

      final node6 = testEngine.parse('false = true');
      expect(
        testEngine.evaluate(patient3, node6),
        [false.toFhirBoolean],
      );
      ...
      expect(
        testEngine.evaluate(patient3, node13),
        [true.toFhirBoolean],
      );
      ...
      expect(
        testEngine.evaluate(patient3, node14),
        [false.toFhirBoolean],
      );

      final node15 = testEngine.parse('@T12:25 = @T12:25');
      expect(
        testEngine.evaluate(patient3, node15),
        [true.toFhirBoolean],
      );

      final node16 = testEngine.parse('@T12:25 = @T12:27');
      expect(
        testEngine.evaluate(patient3, node16),
        [false.toFhirBoolean],
      );
      ...
      expect(
        testEngine.evaluate(patient3, node17),
        [true.toFhirBoolean],
      );

      final node18 = testEngine.parse("'String' = 'string'");
      expect(
        testEngine.evaluate(patient3, node18),
        [false.toFhirBoolean],
      );
      ...
      expect(
        testEngine.evaluate(patient3, node19),
        [true.toFhirBoolean],
      );
      ...
      expect(
        testEngine.evaluate(patient3, node21),
        <FhirBase>[],
      );

      final node22 = testEngine.parse('@2012-01-01T10:30 = @2012-01-01T10:30');
      expect(
        testEngine.evaluate(patient3, node22),
        [true.toFhirBoolean],
      );
      ...
      expect(
        testEngine.evaluate(patient3, node24),
        <FhirBase>[],
      );
      ...
      final node25 =
          testEngine.parse('@2012-01-01T10:30:31.0 = @2012-01-01T10:30:31');
      expect(
        testEngine.evaluate(patient3, node25),
        [true.toFhirBoolean],
      );
      ...
      final node26 =
          testEngine.parse('@2012-01-01T10:30:31.1 = @2012-01-01T10:30:31');
      expect(
        testEngine.evaluate(patient3, node26),
        [false.toFhirBoolean],
      );
    });
    ...
    group('Operators: ', () {
      test('~ : ', () {
        ...
        expect(
          testEngine.evaluate(patient3, node27),
          [true.toFhirBoolean],
        );
      });
    });
  ...
  group(
    ...
    () {
      ...
      test('Math Operators: Precedence', () {
        ...
        expect(
          testEngine.evaluate(patient3, nodeTest),
          [-6.toFhirInteger],
        );
