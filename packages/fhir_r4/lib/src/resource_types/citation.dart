...
class Citation extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<CitationSummary>(
      summary,
      o.summary,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<CitationClassification>(
      classification,
      o.classification,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<CitationStatusDate>(
      statusDate,
      o.statusDate,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<CitationRelatesTo>(
      relatesTo,
      o.relatesTo,
    )) {
      return false;
...
class CitationCitedArtifact extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<CitationTitle>(
      title,
      o.title,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<CitationAbstract>(
      abstract_,
      o.abstract_,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<CitationPublicationForm>(
      publicationForm,
      o.publicationForm,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<CitationWebLocation>(
      webLocation,
      o.webLocation,
    )) {
      return false;
...
class CitationContributorship extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<CitationEntry>(
      entry,
      o.entry,
    )) {
      return false;
...
class CitationEntry extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<CitationAffiliationInfo>(
      affiliationInfo,
      o.affiliationInfo,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<CitationContributionInstance>(
      contributionInstance,
