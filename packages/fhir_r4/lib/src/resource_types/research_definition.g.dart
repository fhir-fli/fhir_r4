...
abstract class $ResearchDefinitionCopyWith<T>
...
class _$ResearchDefinitionCopyWithImpl<T>
    implements $ResearchDefinitionCopyWith<T> {
  final ResearchDefinition _value;
  final T Function(ResearchDefinition) _then;
  ...
  T call({
    ...
    Object? exposure = fhirSentinel,
    Object? exposureAlternative = fhirSentinel,
    ...
    return _then(
      ResearchDefinition(
        ...
        subjectX: identical(subjectX, fhirSentinel)
            ? _value.subjectX
            : subjectX as SubjectXResearchDefinition?,
        date:
        ...
        exposureAlternative: identical(exposureAlternative, fhirSentinel)
            ? _value.exposureAlternative
            : exposureAlternative as Reference?,
        outcome: identical(outcome, fhirSentinel)
            ? _value.outcome
            : outcome as Reference?,
      ),
    );
  }
}

extension ResearchDefinitionCopyWithExtension on ResearchDefinition {
  $ResearchDefinitionCopyWith<ResearchDefinition> get copyWith =>
      _$ResearchDefinitionCopyWithImpl<ResearchDefinition>(
        this,
        (value) => value,
      );
}
