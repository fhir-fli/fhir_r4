...
class ConceptMap extends CanonicalResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ConceptMapGroup>(
      group,
      o.group,
    )) {
      return false;
...
class ConceptMapGroup extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ConceptMapElement>(
      element,
      o.element,
    )) {
      return false;
...
class ConceptMapElement extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ConceptMapTarget>(
      target,
      o.target,
    )) {
      return false;
...
class ConceptMapTarget extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ConceptMapDependsOn>(
      dependsOn,
      o.dependsOn,
    )) {
      return false;
