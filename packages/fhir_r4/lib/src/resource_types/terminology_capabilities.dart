...
class TerminologyCapabilities extends CanonicalResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<TerminologyCapabilitiesCodeSystem>(
      codeSystem,
      o.codeSystem,
    )) {
      return false;
...
class TerminologyCapabilitiesCodeSystem extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<TerminologyCapabilitiesVersion>(
      version,
      o.version,
    )) {
      return false;
...
class TerminologyCapabilitiesVersion extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<TerminologyCapabilitiesFilter>(
      filter,
      o.filter,
    )) {
      return false;
...
class TerminologyCapabilitiesExpansion extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<TerminologyCapabilitiesParameter>(
      parameter,
      o.parameter,
    )) {
      return false;
