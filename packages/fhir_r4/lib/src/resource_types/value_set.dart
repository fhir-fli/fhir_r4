...
class ValueSetCompose extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ValueSetInclude>(
      include,
      o.include,
    )) {
      return false;
...
class ValueSetInclude extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ValueSetConcept>(
      concept,
      o.concept,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<ValueSetFilter>(
      filter,
      o.filter,
    )) {
      return false;
...
class ValueSetConcept extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ValueSetDesignation>(
      designation,
      o.designation,
    )) {
      return false;
...
class ValueSetExpansion extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ValueSetParameter>(
      parameter,
      o.parameter,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<ValueSetContains>(
      contains,
      o.contains,
    )) {
      return false;
