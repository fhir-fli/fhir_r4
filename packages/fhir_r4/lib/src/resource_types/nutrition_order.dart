...
class NutritionOrder extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<NutritionOrderSupplement>(
      supplement,
      o.supplement,
    )) {
      return false;
...
class NutritionOrderOralDiet extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<Timing>(
      schedule,
      o.schedule,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<NutritionOrderNutrient>(
      nutrient,
      o.nutrient,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<NutritionOrderTexture>(
      texture,
      o.texture,
    )) {
      return false;
...
class NutritionOrderEnteralFormula extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<NutritionOrderAdministration>(
      administration,
      o.administration,
    )) {
      return false;
