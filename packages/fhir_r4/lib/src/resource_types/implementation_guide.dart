...
class ImplementationGuide extends CanonicalResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<FHIRVersion>(
      fhirVersion,
      o.fhirVersion,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<ImplementationGuideDependsOn>(
      dependsOn,
      o.dependsOn,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<ImplementationGuideGlobal>(
      global,
      o.global,
    )) {
      return false;
...
class ImplementationGuideDefinition extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ImplementationGuideGrouping>(
      grouping,
      o.grouping,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<ImplementationGuideResource>(
      resource,
      o.resource,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<ImplementationGuideParameter>(
      parameter,
      o.parameter,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<ImplementationGuideTemplate>(
      template,
      o.template,
    )) {
      return false;
...
class ImplementationGuidePage extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ImplementationGuidePage>(
      page,
      o.page,
    )) {
      return false;
...
class ImplementationGuideManifest extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ImplementationGuideResource1>(
      resource,
      o.resource,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<ImplementationGuidePage1>(
      page,
      o.page,
    )) {
      return false;
