...
class MeasureReport extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<MeasureReportGroup>(
      group,
      o.group,
    )) {
      return false;
...
class MeasureReportGroup extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<MeasureReportPopulation>(
      population,
      o.population,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<MeasureReportStratifier>(
      stratifier,
      o.stratifier,
    )) {
      return false;
...
class MeasureReportStratifier extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<MeasureReportStratum>(
      stratum,
      o.stratum,
    )) {
      return false;
...
class MeasureReportStratum extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<MeasureReportComponent>(
      component,
      o.component,
    )) {
      return false;
