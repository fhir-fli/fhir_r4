...
class Contract extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ContractTerm>(
      term,
      o.term,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<ContractSigner>(
      signer,
      o.signer,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<ContractFriendly>(
      friendly,
      o.friendly,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<ContractLegal>(
      legal,
      o.legal,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<ContractRule>(
      rule,
      o.rule,
    )) {
      return false;
...
class ContractTerm extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ContractSecurityLabel>(
      securityLabel,
      o.securityLabel,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<ContractAsset>(
      asset,
      o.asset,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<ContractAction>(
      action,
      o.action,
    )) {
      return false;
...
class ContractSecurityLabel extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<FhirUnsignedInt>(
      number,
      o.number,
    )) {
      return false;
...
class ContractOffer extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ContractParty>(
      party,
      o.party,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<ContractAnswer>(
      answer,
      o.answer,
    )) {
      return false;
...
class ContractAsset extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ContractContext>(
      context,
      o.context,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<ContractValuedItem>(
      valuedItem,
      o.valuedItem,
    )) {
      return false;
...
class ContractAction extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ContractSubject>(
      subject,
      o.subject,
    )) {
      return false;
...
class ContractSigner extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<Signature>(
      signature,
      o.signature,
    )) {
      return false;
