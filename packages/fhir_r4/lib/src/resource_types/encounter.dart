...
class Encounter extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<EncounterStatusHistory>(
      statusHistory,
      o.statusHistory,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<EncounterClassHistory>(
      classHistory,
      o.classHistory,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<EncounterParticipant>(
      participant,
      o.participant,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<EncounterDiagnosis>(
      diagnosis,
      o.diagnosis,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<EncounterLocation>(
      location,
      o.location,
    )) {
      return false;
