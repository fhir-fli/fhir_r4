...
class StructureMap extends CanonicalResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<StructureMapStructure>(
      structure,
      o.structure,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<StructureMapGroup>(
      group,
      o.group,
    )) {
      return false;
...
class StructureMapGroup extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<StructureMapInput>(
      input,
      o.input,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<StructureMapRule>(
      rule,
      o.rule,
    )) {
      return false;
...
class StructureMapRule extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<StructureMapSource>(
      source,
      o.source,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<StructureMapTarget>(
      target,
      o.target,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<StructureMapDependent>(
      dependent,
      o.dependent,
    )) {
      return false;
...
class StructureMapTarget extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<StructureMapTargetListMode>(
      listMode,
      o.listMode,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<StructureMapParameter>(
      parameter,
      o.parameter,
    )) {
      return false;
