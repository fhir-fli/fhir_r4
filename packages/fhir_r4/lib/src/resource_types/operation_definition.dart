...
class OperationDefinition extends CanonicalResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<OperationDefinitionParameter>(
      parameter,
      o.parameter,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<OperationDefinitionOverload>(
      overload,
      o.overload,
    )) {
      return false;
...
class OperationDefinitionParameter extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<OperationDefinitionReferencedFrom>(
      referencedFrom,
      o.referencedFrom,
    )) {
      return false;
