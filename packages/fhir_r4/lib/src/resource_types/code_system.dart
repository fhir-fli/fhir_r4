...
class CodeSystem extends CanonicalResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<CodeSystemFilter>(
      filter,
      o.filter,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<CodeSystemProperty>(
      property,
      o.property,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<CodeSystemConcept>(
      concept,
      o.concept,
    )) {
      return false;
...
class CodeSystemFilter extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<FilterOperator>(
      operator_,
      o.operator_,
    )) {
      return false;
...
class CodeSystemConcept extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<CodeSystemDesignation>(
      designation,
      o.designation,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<CodeSystemProperty1>(
      property,
      o.property,
    )) {
      return false;
