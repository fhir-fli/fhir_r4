...
class ChargeItemDefinition extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ChargeItemDefinitionApplicability>(
      applicability,
      o.applicability,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<ChargeItemDefinitionPropertyGroup>(
      propertyGroup,
      o.propertyGroup,
    )) {
      return false;
...
class ChargeItemDefinitionPropertyGroup extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ChargeItemDefinitionPriceComponent>(
      priceComponent,
      o.priceComponent,
    )) {
      return false;
