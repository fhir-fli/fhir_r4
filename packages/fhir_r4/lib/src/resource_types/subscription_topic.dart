...
class SubscriptionTopic extends CanonicalResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<SubscriptionTopicResourceTrigger>(
      resourceTrigger,
      o.resourceTrigger,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<SubscriptionTopicEventTrigger>(
      eventTrigger,
      o.eventTrigger,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<SubscriptionTopicCanFilterBy>(
      canFilterBy,
      o.canFilterBy,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<SubscriptionTopicNotificationShape>(
      notificationShape,
      o.notificationShape,
    )) {
      return false;
...
class SubscriptionTopicResourceTrigger extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<InteractionTrigger>(
      supportedInteraction,
...
class SubscriptionTopicCanFilterBy extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<SubscriptionSearchModifier>(
      modifier,
      o.modifier,
    )) {
      return false;
