...
class AdministrableProductDefinition extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<AdministrableProductDefinitionProperty>(
      property,
      o.property,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<
...
class AdministrableProductDefinitionRouteOfAdministration
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<AdministrableProductDefinitionTargetSpecies>(
      targetSpecies,
      o.targetSpecies,
    )) {
      return false;
...
class AdministrableProductDefinitionTargetSpecies extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<AdministrableProductDefinitionWithdrawalPeriod>(
      withdrawalPeriod,
      o.withdrawalPeriod,
    )) {
      return false;
