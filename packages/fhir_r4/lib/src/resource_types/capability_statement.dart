...
class CapabilityStatement extends CanonicalResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<CapabilityStatementRest>(
      rest,
      o.rest,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<CapabilityStatementMessaging>(
      messaging,
      o.messaging,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<CapabilityStatementDocument>(
      document,
      o.document,
    )) {
      return false;
...
class CapabilityStatementRest extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<CapabilityStatementResource>(
      resource,
      o.resource,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<CapabilityStatementInteraction>(
      interaction,
      o.interaction,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<CapabilityStatementSearchParam>(
      searchParam,
      o.searchParam,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<CapabilityStatementOperation>(
      operation,
      o.operation,
    )) {
      return false;
...
class CapabilityStatementResource extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<ReferenceHandlingPolicy>(
      referencePolicy,
      o.referencePolicy,
    )) {
      return false;
...
class CapabilityStatementMessaging extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<CapabilityStatementEndpoint>(
      endpoint,
      o.endpoint,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<CapabilityStatementSupportedMessage>(
      supportedMessage,
      o.supportedMessage,
    )) {
      return false;
