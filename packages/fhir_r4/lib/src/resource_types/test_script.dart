...
class TestScript extends CanonicalResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<TestScriptOrigin>(
      origin,
      o.origin,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<TestScriptDestination>(
      destination,
      o.destination,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<TestScriptFixture>(
      fixture,
      o.fixture,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<TestScriptVariable>(
      variable,
      o.variable,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<TestScriptTest>(
      test,
      o.test,
    )) {
      return false;
...
class TestScriptMetadata extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<TestScriptLink>(
      link,
      o.link,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<TestScriptCapability>(
      capability,
      o.capability,
    )) {
      return false;
...
class TestScriptSetup extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<TestScriptAction>(
      action,
      o.action,
    )) {
      return false;
...
class TestScriptOperation extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<TestScriptRequestHeader>(
      requestHeader,
      o.requestHeader,
    )) {
      return false;
