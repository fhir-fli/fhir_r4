...
class Questionnaire extends CanonicalResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<QuestionnaireItem>(
      item,
      o.item,
    )) {
      return false;
...
class QuestionnaireItem extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<QuestionnaireEnableWhen>(
      enableWhen,
      o.enableWhen,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<QuestionnaireAnswerOption>(
      answerOption,
      o.answerOption,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<QuestionnaireInitial>(
      initial,
      o.initial,
    )) {
      return false;
