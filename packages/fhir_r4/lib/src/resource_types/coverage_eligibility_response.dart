...
class CoverageEligibilityResponse extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<EligibilityResponsePurpose>(
      purpose,
      o.purpose,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<CoverageEligibilityResponseInsurance>(
      insurance,
      o.insurance,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<CoverageEligibilityResponseError>(
      error,
      o.error,
    )) {
      return false;
...
class CoverageEligibilityResponseInsurance extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<CoverageEligibilityResponseItem>(
      item,
      o.item,
    )) {
      return false;
...
class CoverageEligibilityResponseItem extends BackboneElement {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<CoverageEligibilityResponseBenefit>(
      benefit,
      o.benefit,
    )) {
      return false;
