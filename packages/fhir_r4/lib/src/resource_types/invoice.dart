...
class Invoice extends DomainResource {
  ...
  bool equalsDeep(FhirBase? o) {
    ...
    if (!FhirBase.listEquals<InvoiceParticipant>(
      participant,
      o.participant,
    )) {
      return false;
    ...
    if (!FhirBase.listEquals<InvoiceLineItem>(
      lineItem,
      o.lineItem,
    )) {
      return false;
    }
    if (!FhirBase.listEquals<InvoicePriceComponent>(
      totalPriceComponent,
...
class InvoicePriceComponent extends BackboneElement {
  ...
  @override
  InvoicePriceComponent clone() => copyWith();

  /// Copy function for [InvoicePriceComponent]
  /// Returns a copy of the current instance with the provided fields modified.
  /// If a field is not provided, it will retain its original value.
  /// If a null is provided, this will clearn the field, unless the
  /// field is required, in which case it will keep its current value.
