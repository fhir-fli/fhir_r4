...
final qicoremodelinfo410 = ModelInfo.fromJson({
  "name": "QICore",
  ...
  "typeInfo": [
    ...
    },
    {
      ...
      "element": [
        ...
        {"name": "sender", "elementType": "Reference"},
        {
          ...
          "target":
              "System.Concept:FHIRHelpers.ToConcept(%value);System.ValueSet:FHIRHelpers.ToValueSet(%parent.reasonCode.extension[url='http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-notDoneValueSet'].value.value)"
        },
        {
          "name": "reasonReference",
          "elementTypeSpecifier": {"type": "ListTypeSpecifier"}
    ...
    },
    {
      ...
      "baseType": "DataAbsentReason",
      "retrievable": false,
      "identifier":
          "http://hl7.org/fhir/StructureDefinition/data-absent-reason",
      "label": "Why value is missing"
    },
    {
      "type": "ClassInfo",
      "namespace": "QICore",
      ...
      "element": [
        {
          ...
          "target": "%parent.extension[url='null']"
        },
        {
    ...
    },
    {
      ...
      "element": [
        ...
        },
        {
          ...
          "elementType": "DiagnosisPresentOnAdmissionExtension",
          "target":
    ...
    },
    {
      ...
      "element": [
        ...
        },
        {
          ...
          "target":
              "System.Concept:FHIRHelpers.ToConcept(%value);System.ValueSet:FHIRHelpers.ToValueSet(%parent.code.extension[url='http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-notDoneValueSet'].value.value)"
        },
        {"name": "subject", "elementType": "Reference"},
        {
          "name": "focus",
    ...
    },
    {
      ...
      "element": [
        ...
        {"name": "ccn", "elementType": "Identifier"},
        {"name": "ein", "elementType": "Identifier"},
        {
          "name": "active",
          "elementType": "System.Boolean",
          "target": "%value.value"
    ...
    },
    {
      ...
      "retrievable": true,
      "identifier":
          "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-tasknotdone",
      "label": "TaskNotDone",
      "target": "Task",
      "primaryCodePath": "code",
      "element": [
