...
Future<void> fhirMappingTest() async {
  loadResourceCache();

  group('1', () {
    resourceCache.saveCanonicalResource(
      resource: structureDefinitionTLeft1,
    );
    resourceCache.saveCanonicalResource(
      resource: structureDefinitionTRight1,
    );
    ...
    // TODO(Dokotela): - empty map or error
    ...
    //   expect(await fhirMappingEngine(source1, structureMapStep1b, resourceCache),
    //       equals(resultStep1bSource1));
    // });
  });
  ...
  group('9', () {
    ...
    test('Test Step 9check Source 9b', ()  async {
      expect(
      await fhirMappingEngine(source9b, structureMapStep9check, resourceCache),
