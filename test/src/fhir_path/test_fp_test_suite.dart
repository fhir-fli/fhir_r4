...
void testFpTestSuite() {
  ...
  group('Literals & Conversions', () {
    ...
    //   expect(walkFhirPath(context: patient1, pathExpression: r"'1' is Integer.not()"), [true]);
    // });
    ...
    //   expect(walkFhirPath(context: patient1, pathExpression: r"true is Integer.not()"), [true]);
    // });
    ...
    //   expect(walkFhirPath(context: patient1, pathExpression: r"@2013-04-05 is Integer.not()"),
    //       [true]);
    // });
    ...
    //   expect(walkFhirPath(context: patient1, pathExpression: r"'1' is Decimal.not()"), [true]);
    // });
  ...
  group('testSubSetOf', () {
    ...
    //   expect(
    //       walkFhirPath(
    //           context: patient1, pathExpression: r"Patient.name.first().subsetOf($this.name)"),
    //       [true]);
    // });
    ...
    // test("testSubSetOf2", () {
    //     expect(
    //         walkFhirPath(context: patient1, pathExpression: r"Patient.name.subsetOf($this.name.first()).not()"),
    //         [true]);
    //   });
  ...
  group('testSuperSetOf', () {
    ...
    //   expect(
    //       walkFhirPath(context: patient1, pathExpression: r"Patient.name.first().supersetOf($this.name).not()"),
    //       [true]);
    // });
  ...
  group('testQuantity', () {
    ...
    test('testQuantity2', () {
      ...
      //   expect(
      //       walkFhirPath(
      //           context: patient1, pathExpression: r"4 'g' ~ 4000 'mg'"),
      //       [true]);
    });
    ...
    //   expect(
    //       walkFhirPath(
    //           context: patient1, pathExpression: r"4 'g' ~ 4040 'mg'"),
    //       [true]);
    // });
  ...
  //   //   expect(
  //   //       walkFhirPath(
  //   //           context: patient1, pathExpression: r"Patient.name[0].given = 'Peter' | 'James'"),
  //   //       [true]);
  //   // });
  ...
  //   // test("testFirstLast1", () {
  //   //   expect(
  //   //       walkFhirPath(context: patient1, pathExpression: r"Patient.name.first().given = 'Peter' | 'James'"),
  //   //       [true]);
  //   // });
  ...
  group('testSkip', () {
    ...
    // test("testSkip3", () {
    //   expect(
    //       walkFhirPath(context: patient1, pathExpression: r"Patient.name.skip(1).given.trace('test') = 'Jim' | 'Peter' | 'James'"),
    //       [true]);
    // });
  ...
  group('testTake', () {
    ...
    //     expect(
    //         walkFhirPath(
    //             context: patient1, pathExpression: r"true is Boolean"),
    //         [true]);
    //   });
    ...
    //     expect(
    //         walkFhirPath(
    //             context: patient1, pathExpression: r"Patient is Patient"),
    //         [true]);
    //   });
