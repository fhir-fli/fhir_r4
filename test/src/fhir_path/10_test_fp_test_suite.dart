...
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "birthDate"),
//         ["1974-12-25"],
//       );
//     });
...
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "-3 != 3"),
//         [true],
//       );
//     });
...
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "1 < 2"),
//         [true],
//       );
//     });
...
//     test("testQuantity2", () {
//       // TODO(Dokotela): You've beaten me for now significant figures
//       //   expect(
//       //       walkFhirPath(
...
//     test("testEquality1", () {
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "1 = 1"),
//         [true],
//       );
//     });
...
//     test("testEquality9", () {
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "'a' = 'a'"),
//         [true],
//       );
//     });
...
//     test("testEquality11", () {
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "'a' = 'b'"),
//         [false],
//       );
//     });
...
//     test("testEquality12", () {
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "1.1 = 1.1"),
//         [true],
//       );
//     });
...
//     test("testEquality13", () {
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "1.1 = 1.2"),
//         [false],
//       );
//     });
...
//     test("testEquality15", () {
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "0 = 0"),
//         [true],
//       );
//     });
...
//     test("testEquality16", () {
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "0.0 = 0"),
//         [true],
//       );
//     });
...
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "1 ~ {}"),
//         [false],
//       );
//     });
...
//     test("testLessThan2", () {
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "1.0 < 1.2"),
//         [true],
//       );
//     });
...
//     test("testLessThan9", () {
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "1.0 < 1.0"),
//         [false],
//       );
//     });
...
//     test("testLessThan15", () {
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "2 < 1"),
//         [false],
//       );
//     });
...
//     test("testLessThan16", () {
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "1.1 < 1.0"),
//         [false],
//       );
//     });
...
//     test("testLessThan17", () {
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "'b' < 'a'"),
//         [false],
//       );
//     });
...
//     test("testPlus1", () {
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "1 + 1 = 2"),
//         [true],
//       );
//     });
...
//     test("testPlus2", () {
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "1 + 0 = 1"),
//         [true],
//       );
//     });
...
//     test("testMinus1", () {
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "1 - 1 = 0"),
//         [true],
//       );
//     });
...
//     test("testMultiply2", () {
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "1 * 1 = 1"),
//         [true],
//       );
//     });
...
//     test("testMultiply3", () {
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "1 * 0 = 0"),
//         [true],
//       );
//     });
//   });
...
//     test("testDivide2", () {
//       expect(
//         walkFhirPath(context: patientExample(), pathExpression: "4 / 2 = 2"),
//         [true],
//       );
//     });
