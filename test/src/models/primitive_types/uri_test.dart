...
void main() {
  group('FhirUri Tests', () {
    test('Valid Canonical URI', () {
      ...
      final canonical = FhirUri(input: validCanonicalString);
    ...
    test('Valid Relative Canonical URI', () {
      ...
      final canonical = FhirUri(input: relativeCanonicalString);
    ...
    test('Equality - FhirUri', () {
      const validCanonicalString = 'http://example.com/Patient/123';
      final canonical1 = FhirUri(input: validCanonicalString);
      final canonical2 = FhirUri(input: validCanonicalString);
    ...
    test('Inequality - FhirUri', () {
      ...
      final canonical1 = FhirUri(input: validCanonicalString1);
      final canonical2 = FhirUri(input: validCanonicalString2);
