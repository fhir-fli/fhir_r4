...
void main() {
  ...
  group('FhirInstantTests', () {
    test('FhirInstant fromDateTime should handle various DateTime inputs', () {
      ...
      final DateTime dateTime = DateTime(2020, 1, 15, 13, 45, 30);
      final FhirInstant instant = FhirInstant.fromDateTime(dateTime);
  ...
  test('Check Instant type with the regex', () {
    final String issued = FhirInstant.fromDateTime(DateTime.now()).toString();
  ...
  test('Valid FhirInstant String', () {
    final FhirInstant fhirInstant =
        FhirInstant.fromString('2023-12-22T12:34:56.789Z');
  ...
  test('Invalid FhirDate from string with Offset', () {
    expect(() => FhirInstant.fromString('invalid_instant'),
        throwsA(isA<ArgumentError>()));
  });

  test('FhirInstant Comparison', () {
    final FhirInstant fhirInstant1 =
        FhirInstant.fromString('2023-12-22T12:34:56.789Z');
    final FhirInstant fhirInstant2 =
        FhirInstant.fromString('2024-01-01T00:00:00.000Z');
    final FhirInstant fhirInstant3 =
        FhirInstant.fromString('2023-12-22T12:34:56.789Z');
  ...
  final String yyyyEmptyTimeZoneString = '2012-01-01T00:00:00.000$offset';

  final FhirInstant dateyyyyFromDateTime =
      FhirInstant.fromDateTime(yyyyDateTime);
  ...
  final String yyyyMMddTHHmmssSSSEmptyString = '2012-01-31T12:30:59.123$offset';

  final FhirInstant dateyyyyMMddTHHmmssSSSFromString =
      FhirInstant.fromString(yyyyMMddTHHmmssSSSEmptyString);
  final FhirInstant dateyyyyMMddTHHmmssSSSFromUnits = FhirInstant.fromUnits(
    year: 2012,
    month: 1,
    day: 31,
    hour: 12,
  ...
  final String yyyyMMddTHHmmssSSSmmm = '2012-01-31T12:30:59.123456$offset';
  final DateTime yyyyMMddTHHmmssSSSmmmDateTime =
      DateTime(2012, 1, 31, 12, 30, 59, 123, 456);
  final FhirInstant dateyyyyMMddTHHmmssSSSmmmFromString =
      FhirInstant.fromString(yyyyMMddTHHmmssSSSmmm);
  final FhirInstant dateyyyyMMddTHHmmssSSSmmmFromDateTime =
      FhirInstant.fromDateTime(yyyyMMddTHHmmssSSSmmmDateTime);
  final FhirInstant dateyyyyMMddTHHmmssSSSmmmFromUnits = FhirInstant.fromUnits(
      year: 2012,
      month: 1,
      day: 31,
      hour: 12,
  ...
  const String yyyyMMddTHHmmssSSSmmmEmptyString =
      '2012-01-31T12:30:59.123456-05:00';
  final String yyyyMMddTHHmmssSSSmmmEmptyTimeZoneString =
  ...
  test('dateyyyyMMddTHHmmssSSSmmmFromDateTime', () {
    expect(dateyyyyMMddTHHmmssSSSmmmFromDateTime.valueString,
        equals(yyyyMMddTHHmmssSSSmmmEmptyTimeZoneString));
    expect(dateyyyyMMddTHHmmssSSSmmmFromDateTime.valueDateTime,
        equals(yyyyMMddTHHmmssSSSmmmDateTime));
    expect(dateyyyyMMddTHHmmssSSSmmmFromDateTime.toJson(),
        equals(yyyyMMddTHHmmssSSSmmm));
  });
