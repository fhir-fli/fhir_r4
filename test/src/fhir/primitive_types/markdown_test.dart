...
void main() {
  group('FhirMarkdown Tests', () {
    ...
    test('Code', () {
      ...
      expect(FhirMarkdown('http://Patient.com/123456').toString(),
          'http://Patient.com/123456');
      expect(FhirMarkdown('http://Patient.com/123456').toJson(),
          'http://Patient.com/123456');
      expect(FhirMarkdown('http://Patient.com/123456').value,
          'http://Patient.com/123456');
    ...
    test('Valid FhirMarkdown from String', () {
      final FhirMarkdown fhirMarkdown = FhirMarkdown(validCode);
    ...
    test('FhirMarkdown tryParse with valid String', () {
      final FhirMarkdown? fhirMarkdown = FhirMarkdown.tryParse(validCode);
      expect(fhirMarkdown?.value, equals(validCode));
      expect(fhirMarkdown?.toString(), equals(validCode));
      expect(fhirMarkdown?.toJson(), equals(validCode));
    });
    ...
    test('FhirMarkdown tryParse with invalid String', () {
      final FhirMarkdown? fhirMarkdown = FhirMarkdown.tryParse(invalidCode);
      expect(fhirMarkdown, isNull);
    });

    test('FhirMarkdown fromJson with valid String', () {
      final FhirMarkdown fhirMarkdown = FhirMarkdown.fromJson(jsonCode);
    ...
    test('FhirMarkdown fromYaml with valid YAML', () {
      final FhirMarkdown fhirMarkdown = FhirMarkdown.fromYaml(yamlCode);
    ...
    test('FhirMarkdown equality with another FhirMarkdown', () {
      final FhirMarkdown fhirMarkdown1 = FhirMarkdown(validCode);
      final FhirMarkdown fhirMarkdown2 = FhirMarkdown(validCode);
    ...
    test('FhirMarkdown clone', () {
      final FhirMarkdown originalCode = FhirMarkdown(validCode);
      final FhirMarkdown clonedCode = originalCode.clone();
    ...
    test('FhirMarkdown copyWith new value', () {
      final FhirMarkdown originalCode = FhirMarkdown(validCode);
      final FhirMarkdown copiedCode =
          originalCode.copyWith(newValue: 'NEW_CODE');
    ...
    test('FhirMarkdown setElement', () {
      final FhirMarkdown originalCode = FhirMarkdown(validCode);
      final FhirMarkdown updatedCode =
