...
void testBasicTypes() {
  group('Basic Types', () {
    ...
    test('Date', () {
      expect(
        ((parseResult('@2015-02-04') as ParserList).first as ValueParser).value,
        (ParserList([DateParser(FhirDate.fromString('2015-02-04'))]).first
                as ValueParser)
            .value,
      );
      expect(
        ((parseResult('@2018-06-12') as ParserList).first as ValueParser).value,
    ...
    test('DateTime', () {
      ...
      expect(
        ((parseResult('@2014-01T // A partial DateTime with year and month')
                ...
                .first as ValueParser)
            .value,
        (ParserList([DateTimeParser(FhirDateTime.fromString('2014-01T'))]).first
                as ValueParser)
            .value,
      );
      expect(
    ...
    test('Time', () {
      expect(
        ((parseResult('@T14:34:28') as ParserList).first as ValueParser).value,
        (ParserList([TimeParser(FhirTime('14:34:28'))]).first as ValueParser)
            .value,
      );
      expect(
        ((parseResult('@T06:55:28') as ParserList).first as ValueParser).value,
        FhirTime('06:55:28'),
      );
      expect(
