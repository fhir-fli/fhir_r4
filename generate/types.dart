...
const Map<String, String> typeNames = <String, String>{
  'string': 'FhirString',
...
const Map<String, List<String>> byType = <String, List<String>>{
  ...
  'public_health_and_research': <String>[
    'ResearchStudy',
    'ResearchSubject',
  ],
  'definitional_artifacts': <String>[
    'ActivityDefinition',
    'ConditionDefinition',
    'DeviceDefinition',
    'EventDefinition',
  ...
  'evidence_based_medicine': <String>[
    'ArtifactAssessment',
    'Citation',
    'Evidence',
    'EvidenceReport',
  ...
  'quality_reporting_and_testing': <String>[
    'Measure',
    'MeasureReport',
    'TestPlan',
    'TestScript',
...
List<String> get resourceTypesAsStrings => <String>[
      'Account',
      'ActivityDefinition',
      'AdministrableProductDefinition',
      'AdverseEvent',
