...
@freezed
class ClaimResponse_ProcessNote with _$ClaimResponse_ProcessNote {
  const ClaimResponse_ProcessNote._();

  const factory ClaimResponse_ProcessNote({
...
/// /// [language] A code to define the language used in the text of the note.
  ...
  }) = _$ClaimResponse_ProcessNote;

  @override
  String get fhirType => 'ClaimResponse_ProcessNote';
  ...
  factory ClaimResponse_ProcessNote.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ClaimResponse_ProcessNote.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
