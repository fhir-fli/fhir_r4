...
import '../../r4.dart';
/// [ExplanationOfBenefit_Payment] This resource provides: the claim
...
@freezed
class ExplanationOfBenefit_Payment with _$ExplanationOfBenefit_Payment {
  const ExplanationOfBenefit_Payment._();

  const factory ExplanationOfBenefit_Payment({
...
/// [identifier] Issuer's unique identifier for the payment instrument.
  ...
  }) = _$ExplanationOfBenefit_Payment;

  @override
  String get fhirType => 'ExplanationOfBenefit_Payment';
  ...
  factory ExplanationOfBenefit_Payment.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ExplanationOfBenefit_Payment.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
