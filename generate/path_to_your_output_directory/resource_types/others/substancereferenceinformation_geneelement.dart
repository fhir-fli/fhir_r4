...
@freezed
class SubstanceReferenceInformation_GeneElement with _$SubstanceReferenceInformation_GeneElement {
  const SubstanceReferenceInformation_GeneElement._();

  const factory SubstanceReferenceInformation_GeneElement({
...
/// /// [element] Todo.
    ...
    @JsonKey(name: 'element') Identifier? element,
/// /// [source] Todo.

    @JsonKey(name: 'source') List<List<Reference>>? source,
  }) = _$SubstanceReferenceInformation_GeneElement;

  @override
  String get fhirType => 'SubstanceReferenceInformation_GeneElement';
  ...
  factory SubstanceReferenceInformation_GeneElement.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? SubstanceReferenceInformation_GeneElement.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
