...
@freezed
class ResearchStudy_Label with _$ResearchStudy_Label {
...
/// [_value] Extensions for value
  ...
  @override
  String get fhirType => 'ResearchStudy_Label';
  ...
  factory ResearchStudy_Label.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ResearchStudy_Label.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
