...
@freezed
class MedicationKnowledge_Monograph with _$MedicationKnowledge_Monograph {
  const MedicationKnowledge_Monograph._();

  const factory MedicationKnowledge_Monograph({
...
/// [source] Associated documentation about the medication.
  ...
  }) = _$MedicationKnowledge_Monograph;

  @override
  String get fhirType => 'MedicationKnowledge_Monograph';
  ...
  factory MedicationKnowledge_Monograph.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? MedicationKnowledge_Monograph.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
