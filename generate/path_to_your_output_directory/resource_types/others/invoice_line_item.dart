...
@freezed
class Invoice_LineItem with _$Invoice_LineItem {
  const Invoice_LineItem._();

  const factory Invoice_LineItem({
...
/// type instead of the Reference.
    ...
    @JsonKey(name: 'chargeItemReference') Reference? chargeItemReference,
...
/// data type instead of the Reference.
    ...
    @JsonKey(name: 'chargeItemCodeableConcept') CodeableConcept? chargeItemCodeableConcept,
...
/// of the Invoice as to how the prices have been calculated.
  ...
  @override
  String get fhirType => 'Invoice_LineItem';
  ...
  factory Invoice_LineItem.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Invoice_LineItem.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
