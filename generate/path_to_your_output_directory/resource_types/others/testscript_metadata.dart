/// /// [TestScript_Metadata] A structured set of tests against a FHIR server
/// or client implementation to determine compliance against the FHIR
/// specification.

@freezed
class TestScript_Metadata with _$TestScript_Metadata {
  const TestScript_Metadata._();

  const factory TestScript_Metadata({
...
/// /// [link] A link to the FHIR specification that this test is covering.
    ...
    @JsonKey(name: 'link') List<List<TestScript_Link>>? link,
/// /// [capability] Capabilities that must exist and are assumed to function
/// correctly on the FHIR server being tested.

    @JsonKey(name: 'capability') List<List<TestScript_Capability>>? capability,
  }) = _$TestScript_Metadata;

  @override
  String get fhirType => 'TestScript_Metadata';
  ...
  factory TestScript_Metadata.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? TestScript_Metadata.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
