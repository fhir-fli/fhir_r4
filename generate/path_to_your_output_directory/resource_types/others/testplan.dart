/// /// [TestPlan] A plan for executing testing on an artifact or
/// specifications.
...
/// literal address at which an authoritative instance of this test plan is (or
...
/// instance.  This is an arbitrary value managed by the test plan author and
...
/// /// [testTools] A description of test tools to be used in the test plan.
    ...
    @JsonKey(name: 'testTools') FhirMarkdown? testTools,
/// /// [_testTools] Extensions for testTools

    @JsonKey(name: '_testTools') FhirElement? testToolsElement,
/// /// [dependency] The required criteria to execute the test plan - e.g.
/// preconditions, previous tests...

    @JsonKey(name: 'dependency') List<List<TestPlan_Dependency>>? dependency,
/// /// [exitCriteria] The threshold or criteria for the test plan to be
/// considered successfully executed - narrative.

    @JsonKey(name: 'exitCriteria') FhirMarkdown? exitCriteria,
/// /// [_exitCriteria] Extensions for exitCriteria

    @JsonKey(name: '_exitCriteria') FhirElement? exitCriteriaElement,
/// /// [testCase] The individual test cases that are part of this plan, when
/// they they are made explicit.

    @JsonKey(name: 'testCase') List<List<TestPlan_TestCase>>? testCase,
  }) = _$TestPlan;
  ...
  factory TestPlan.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? TestPlan.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
