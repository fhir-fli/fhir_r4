...
import '../../r4.dart';
/// [ExplanationOfBenefit_Detail1] This resource provides: the claim
...
@freezed
class ExplanationOfBenefit_Detail1 with _$ExplanationOfBenefit_Detail1 {
  const ExplanationOfBenefit_Detail1._();

  const factory ExplanationOfBenefit_Detail1({
...
/// services.
    ...
    @JsonKey(name: 'subDetail') List<List<ExplanationOfBenefit_SubDetail1>>? subDetail,
  }) = _$ExplanationOfBenefit_Detail1;

  @override
  String get fhirType => 'ExplanationOfBenefit_Detail1';
  ...
  factory ExplanationOfBenefit_Detail1.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ExplanationOfBenefit_Detail1.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
