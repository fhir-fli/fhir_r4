...
@freezed
class ManufacturedItemDefinition_Component with _$ManufacturedItemDefinition_Component {
...
/// [component] A component that this component contains or is made from.
  ...
  @override
  String get fhirType => 'ManufacturedItemDefinition_Component';

  factory ManufacturedItemDefinition_Component.fromJson(Map<String, dynamic> json) =>
      _$ManufacturedItemDefinition_ComponentFromJson(json);

  factory ManufacturedItemDefinition_Component.fromYaml(dynamic yaml) => yaml is String
      ? ManufacturedItemDefinition_Component.fromJson(
          jsonDecode(jsonEncode(loadYaml(yaml))) as Map<String, dynamic>)
      : yaml is YamlMap
          ? ManufacturedItemDefinition_Component.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
              'ManufacturedItemDefinition_Component cannot be constructed from input provided,'
              ' it is neither a yaml string nor a yaml map.');

  factory ManufacturedItemDefinition_Component.fromJsonString(String source) {
    final dynamic json = jsonDecode(source);
    if (json is Map<String, dynamic>) {
      return _$ManufacturedItemDefinition_ComponentFromJson(json);
    } else {
