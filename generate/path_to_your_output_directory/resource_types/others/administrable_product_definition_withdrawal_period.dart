...
@freezed
class AdministrableProductDefinition_WithdrawalPeriod with _$AdministrableProductDefinition_WithdrawalPeriod {
...
/// [_supportingInformation] Extensions for supportingInformation
  ...
  @override
  String get fhirType => 'AdministrableProductDefinition_WithdrawalPeriod';
  ...
  factory AdministrableProductDefinition_WithdrawalPeriod.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? AdministrableProductDefinition_WithdrawalPeriod.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
