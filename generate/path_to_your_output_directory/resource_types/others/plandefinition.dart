/// /// [PlanDefinition] This resource allows for the definition of various
...
@freezed
class PlanDefinition with _$PlanDefinition {
...
/// SHOULD be a literal address at which an authoritative instance of this plan
...
/// definition. Topics provide a high-level categorization of the definition
...
/// reference that describes  or identifies the intended subject of the plan
/// definition. Canonical references are allowed to support the definition of
...
/// activity of daily living, obtaining herd immunity via immunization, meeting
/// a process improvement objective, meeting the acceptance criteria for a test
/// as specified by a quality specification, etc.

    @JsonKey(name: 'goal') List<List<PlanDefinition_Goal>>? goal,
/// /// [actor] Actors represent the individuals or groups involved in the
/// execution of the defined set of activities.

    @JsonKey(name: 'actor') List<List<PlanDefinition_Actor>>? actor,
/// /// [action] An action or group of actions to be taken as part of the plan.
/// For example, in clinical care, an action would be to prescribe a particular
...
/// /// [_asNeededBoolean] Extensions for asNeededBoolean
    ...
    @JsonKey(name: '_asNeededBoolean') FhirElement? asNeededBooleanElement,
...
/// flare-up", etc.
  ...
  factory PlanDefinition.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? PlanDefinition.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
