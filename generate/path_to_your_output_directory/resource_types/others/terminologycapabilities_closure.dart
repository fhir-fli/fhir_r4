...
@freezed
class TerminologyCapabilities_Closure with _$TerminologyCapabilities_Closure {
  const TerminologyCapabilities_Closure._();

  const factory TerminologyCapabilities_Closure({
...
/// /// [translation] If cross-system closure is supported.
    ...
    @JsonKey(name: 'translation') FhirBoolean? translation,
/// /// [_translation] Extensions for translation

    @JsonKey(name: '_translation') FhirElement? translationElement,
  }) = _$TerminologyCapabilities_Closure;

  @override
  String get fhirType => 'TerminologyCapabilities_Closure';
  ...
  factory TerminologyCapabilities_Closure.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? TerminologyCapabilities_Closure.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
