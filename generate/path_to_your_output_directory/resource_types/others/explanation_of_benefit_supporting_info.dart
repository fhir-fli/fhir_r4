...
@freezed
class ExplanationOfBenefit_SupportingInfo with _$ExplanationOfBenefit_SupportingInfo {
...
/// required in addition to the content.
  ...
  }) = _$ExplanationOfBenefit_SupportingInfo;

  @override
  String get fhirType => 'ExplanationOfBenefit_SupportingInfo';
  ...
  factory ExplanationOfBenefit_SupportingInfo.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ExplanationOfBenefit_SupportingInfo.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
