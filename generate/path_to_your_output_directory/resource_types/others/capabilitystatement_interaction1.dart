...
import '../../r4.dart';
/// [CapabilityStatement_Interaction1] A Capability Statement documents a
...
@freezed
class CapabilityStatement_Interaction1 with _$CapabilityStatement_Interaction1 {
  const CapabilityStatement_Interaction1._();

  const factory CapabilityStatement_Interaction1({
...
/// [_documentation] Extensions for documentation
  ...
  }) = _$CapabilityStatement_Interaction1;

  @override
  String get fhirType => 'CapabilityStatement_Interaction1';
  ...
  factory CapabilityStatement_Interaction1.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? CapabilityStatement_Interaction1.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
