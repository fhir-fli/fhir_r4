...
@freezed
class SubstanceReferenceInformation_Gene with _$SubstanceReferenceInformation_Gene {
  const SubstanceReferenceInformation_Gene._();

  const factory SubstanceReferenceInformation_Gene({
...
/// [geneSequenceOrigin] Todo.
    ...
    @JsonKey(name: 'geneSequenceOrigin') CodeableConcept? geneSequenceOrigin,
/// [gene] Todo.

    @JsonKey(name: 'gene') CodeableConcept? gene,
/// [source] Todo.

    @JsonKey(name: 'source') List<List<Reference>>? source,
  }) = _$SubstanceReferenceInformation_Gene;

  @override
  String get fhirType => 'SubstanceReferenceInformation_Gene';
  ...
  factory SubstanceReferenceInformation_Gene.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? SubstanceReferenceInformation_Gene.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
