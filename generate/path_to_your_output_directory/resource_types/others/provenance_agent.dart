...
@freezed
class Provenance_Agent with _$Provenance_Agent {
  const Provenance_Agent._();

  const factory Provenance_Agent({
...
/// performed by the agent.who element.
  ...
  @override
  String get fhirType => 'Provenance_Agent';
  ...
  factory Provenance_Agent.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Provenance_Agent.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
