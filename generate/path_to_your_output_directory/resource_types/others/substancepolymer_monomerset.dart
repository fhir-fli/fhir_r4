/// /// [SubstancePolymer_MonomerSet] Properties of a substance specific to it
/// being a polymer.

@freezed
class SubstancePolymer_MonomerSet with _$SubstancePolymer_MonomerSet {
  const SubstancePolymer_MonomerSet._();

  const factory SubstancePolymer_MonomerSet({
...
/// Monomer/Polymer ratio, SRU/Polymer Ratio.
    ...
    @JsonKey(name: 'ratioType') CodeableConcept? ratioType,
/// /// [startingMaterial] The starting materials - monomer(s) used in the
/// synthesis of the polymer.

    @JsonKey(name: 'startingMaterial') List<List<SubstancePolymer_StartingMaterial>>? startingMaterial,
  }) = _$SubstancePolymer_MonomerSet;

  @override
  String get fhirType => 'SubstancePolymer_MonomerSet';
  ...
  factory SubstancePolymer_MonomerSet.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? SubstancePolymer_MonomerSet.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
