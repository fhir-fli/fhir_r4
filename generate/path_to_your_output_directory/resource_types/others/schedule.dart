...
/// are currently accepting appointments. This does not define a "template" for
/// planning outside these dates.

    @JsonKey(name: 'planningHorizon') Period? planningHorizon,
...
/// [_comment] Extensions for comment
  ...
  factory Schedule.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Schedule.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
