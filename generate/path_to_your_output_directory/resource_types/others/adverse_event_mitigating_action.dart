...
import '../../r4.dart';
/// [AdverseEvent_MitigatingAction] An event (i.e. any change to current
...
@freezed
class AdverseEvent_MitigatingAction with _$AdverseEvent_MitigatingAction {
  const AdverseEvent_MitigatingAction._();

  const factory AdverseEvent_MitigatingAction({
...
/// event occured in order to reduce the extent of harm.
  ...
  }) = _$AdverseEvent_MitigatingAction;

  @override
  String get fhirType => 'AdverseEvent_MitigatingAction';
  ...
  factory AdverseEvent_MitigatingAction.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? AdverseEvent_MitigatingAction.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
