...
@freezed
class TerminologyCapabilities_Filter with _$TerminologyCapabilities_Filter {
...
/// [_op] Extensions for op
  ...
  @override
  String get fhirType => 'TerminologyCapabilities_Filter';
  ...
  factory TerminologyCapabilities_Filter.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? TerminologyCapabilities_Filter.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
