...
@freezed
class MedicationKnowledge_Packaging with _$MedicationKnowledge_Packaging {
  const MedicationKnowledge_Packaging._();

  const factory MedicationKnowledge_Packaging({
...
/// provides the details of the product that is in the packaging and is being
/// priced.

    @JsonKey(name: 'packagedProduct') Reference? packagedProduct,
  }) = _$MedicationKnowledge_Packaging;

  @override
  String get fhirType => 'MedicationKnowledge_Packaging';
  ...
  factory MedicationKnowledge_Packaging.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? MedicationKnowledge_Packaging.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
