...
@freezed
class TerminologyCapabilities_Software with _$TerminologyCapabilities_Software {
  const TerminologyCapabilities_Software._();

  const factory TerminologyCapabilities_Software({
...
/// [_version] Extensions for version
  ...
  }) = _$TerminologyCapabilities_Software;

  @override
  String get fhirType => 'TerminologyCapabilities_Software';
  ...
  factory TerminologyCapabilities_Software.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? TerminologyCapabilities_Software.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
