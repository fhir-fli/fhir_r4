/// /// [Citation_StatusDate1] The Citation Resource enables reference to any
...
@freezed
class Citation_StatusDate1 with _$Citation_StatusDate1 {
  const Citation_StatusDate1._();

  const factory Citation_StatusDate1({
...
/// /// [period] When the status started and/or ended.
  ...
  }) = _$Citation_StatusDate1;

  @override
  String get fhirType => 'Citation_StatusDate1';
  ...
  factory Citation_StatusDate1.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Citation_StatusDate1.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
