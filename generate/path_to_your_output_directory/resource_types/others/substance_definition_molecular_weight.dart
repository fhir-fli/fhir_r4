...
import '../../r4.dart';
/// [SubstanceDefinition_MolecularWeight] The detailed description of a
/// substance, typically at a level beyond what is used for prescribing.

@freezed
class SubstanceDefinition_MolecularWeight with _$SubstanceDefinition_MolecularWeight {
  const SubstanceDefinition_MolecularWeight._();

  const factory SubstanceDefinition_MolecularWeight({
...
/// If only limits are given, the arithmetic mean would be the average. If only
/// a single definite value for a given element is given, it would be captured
/// in this field.

    @JsonKey(name: 'amount') Quantity? amount,
  }) = _$SubstanceDefinition_MolecularWeight;

  @override
  String get fhirType => 'SubstanceDefinition_MolecularWeight';
  ...
  factory SubstanceDefinition_MolecularWeight.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? SubstanceDefinition_MolecularWeight.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
