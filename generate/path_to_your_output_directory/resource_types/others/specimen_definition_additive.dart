...
@freezed
class SpecimenDefinition_Additive with _$SpecimenDefinition_Additive {
  const SpecimenDefinition_Additive._();

  const factory SpecimenDefinition_Additive({
...
/// to preserve, maintain or enhance the specimen. Examples: Formalin, Citrate,
/// EDTA.

    @JsonKey(name: 'additiveCodeableConcept') CodeableConcept? additiveCodeableConcept,
...
/// EDTA.
    ...
    @JsonKey(name: 'additiveReference') Reference? additiveReference,
  }) = _$SpecimenDefinition_Additive;

  @override
  String get fhirType => 'SpecimenDefinition_Additive';
  ...
  factory SpecimenDefinition_Additive.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? SpecimenDefinition_Additive.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
