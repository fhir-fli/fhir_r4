...
@freezed
class ExplanationOfBenefit_Accident with _$ExplanationOfBenefit_Accident {
...
/// [locationReference] The physical location of the accident event.
  ...
  @override
  String get fhirType => 'ExplanationOfBenefit_Accident';
  ...
  factory ExplanationOfBenefit_Accident.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ExplanationOfBenefit_Accident.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
