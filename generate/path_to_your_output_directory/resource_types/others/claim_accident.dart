...
@freezed
class Claim_Accident with _$Claim_Accident {
  const Claim_Accident._();

  const factory Claim_Accident({
...
/// [locationReference] The physical location of the accident event.
  ...
  @override
  String get fhirType => 'Claim_Accident';
  ...
  factory Claim_Accident.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Claim_Accident.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
