...
@freezed
class Device_Property with _$Device_Property {
  const Device_Property._();

  const factory Device_Property({
...
/// property.type code.
  ...
  @override
  String get fhirType => 'Device_Property';
  ...
  factory Device_Property.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Device_Property.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
