...
@freezed
class ClaimResponse_Detail1 with _$ClaimResponse_Detail1 {
  const ClaimResponse_Detail1._();

  const factory ClaimResponse_Detail1({
...
/// services.
    ...
    @JsonKey(name: 'subDetail') List<List<ClaimResponse_SubDetail1>>? subDetail,
  }) = _$ClaimResponse_Detail1;

  @override
  String get fhirType => 'ClaimResponse_Detail1';
  ...
  factory ClaimResponse_Detail1.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ClaimResponse_Detail1.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
