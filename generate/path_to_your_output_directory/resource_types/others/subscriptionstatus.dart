...
import '../../r4.dart';
/// [SubscriptionStatus] The SubscriptionStatus resource describes the
/// state of a Subscription during notifications.
...
/// have been generated since the Subscription was created (inclusive of this
/// notification) - regardless of how many have been successfully communicated.
///  This number is NOT incremented for handshake and heartbeat notifications.

    @JsonKey(name: 'eventsSinceSubscriptionStart') FhirInteger64? eventsSinceSubscriptionStart,
/// [_eventsSinceSubscriptionStart] Extensions for
/// eventsSinceSubscriptionStart

    @JsonKey(name: '_eventsSinceSubscriptionStart') PrimitiveElement? eventsSinceSubscriptionStartElement,
/// [notificationEvent] Detailed information about events relevant to this
/// subscription notification.

    @JsonKey(name: 'notificationEvent') List<List<SubscriptionStatus_NotificationEvent>>? notificationEvent,
/// [subscription] The reference to the Subscription which generated this
/// notification.

    @JsonKey(name: 'subscription') Reference? subscription,
...
/// notification.
    ...
    @JsonKey(name: 'error') List<List<CodeableConcept>>? error,
  ...
  factory SubscriptionStatus.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? SubscriptionStatus.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
