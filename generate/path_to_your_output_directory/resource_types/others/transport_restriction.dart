...
/// recipient/target, to identify who is fulfillment is sought for.
  ...
  }) = _$Transport_Restriction;

  @override
  String get fhirType => 'Transport_Restriction';

  factory Transport_Restriction.fromJson(Map<String, dynamic> json) =>
      _$Transport_RestrictionFromJson(json);

  factory Transport_Restriction.fromYaml(dynamic yaml) => yaml is String
      ? Transport_Restriction.fromJson(
          jsonDecode(jsonEncode(loadYaml(yaml))) as Map<String, dynamic>)
      : yaml is YamlMap
          ? Transport_Restriction.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
              'Transport_Restriction cannot be constructed from input provided,'
              ' it is neither a yaml string nor a yaml map.');

  factory Transport_Restriction.fromJsonString(String source) {
    final dynamic json = jsonDecode(source);
    if (json is Map<String, dynamic>) {
      return _$Transport_RestrictionFromJson(json);
    } else {
