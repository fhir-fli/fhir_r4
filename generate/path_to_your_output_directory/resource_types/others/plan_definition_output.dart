...
import '../../r4.dart';
/// [PlanDefinition_Output] This resource allows for the definition of
...
@freezed
class PlanDefinition_Output with _$PlanDefinition_Output {
  const PlanDefinition_Output._();

  const factory PlanDefinition_Output({
...
/// [_relatedData] Extensions for relatedData
  ...
  }) = _$PlanDefinition_Output;

  @override
  String get fhirType => 'PlanDefinition_Output';
  ...
  factory PlanDefinition_Output.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? PlanDefinition_Output.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
