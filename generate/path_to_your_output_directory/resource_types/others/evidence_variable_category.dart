...
import '../../r4.dart';
/// [EvidenceVariable_Category] The EvidenceVariable resource describes an
/// element that knowledge (Evidence) is about.

@freezed
class EvidenceVariable_Category with _$EvidenceVariable_Category {
  const EvidenceVariable_Category._();

  const factory EvidenceVariable_Category({
...
/// [valueReference] Definition of the grouping.
  ...
  }) = _$EvidenceVariable_Category;

  @override
  String get fhirType => 'EvidenceVariable_Category';
  ...
  factory EvidenceVariable_Category.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? EvidenceVariable_Category.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
