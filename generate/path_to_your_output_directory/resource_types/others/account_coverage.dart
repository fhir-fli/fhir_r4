...
@freezed
class Account_Coverage with _$Account_Coverage {
...
/// [_priority] Extensions for priority
  ...
  @override
  String get fhirType => 'Account_Coverage';
  ...
  factory Account_Coverage.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Account_Coverage.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
