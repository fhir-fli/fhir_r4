/// /// [MedicationKnowledge_Substitution] Information about a medication that
/// is used to support knowledge.

@freezed
class MedicationKnowledge_Substitution with _$MedicationKnowledge_Substitution {
  const MedicationKnowledge_Substitution._();

  const factory MedicationKnowledge_Substitution({
...
/// when dispensing.
    ...
    @JsonKey(name: 'allowed') FhirBoolean? allowed,
/// /// [_allowed] Extensions for allowed

    @JsonKey(name: '_allowed') FhirElement? allowedElement,
  }) = _$MedicationKnowledge_Substitution;

  @override
  String get fhirType => 'MedicationKnowledge_Substitution';
  ...
  factory MedicationKnowledge_Substitution.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? MedicationKnowledge_Substitution.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
