...
@freezed
class ClaimResponse_Total with _$ClaimResponse_Total {
  const ClaimResponse_Total._();

  const factory ClaimResponse_Total({
...
/// [amount] Monetary total amount associated with the category.
  ...
  }) = _$ClaimResponse_Total;

  @override
  String get fhirType => 'ClaimResponse_Total';
  ...
  factory ClaimResponse_Total.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ClaimResponse_Total.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
