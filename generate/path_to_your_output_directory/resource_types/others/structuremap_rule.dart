...
import '../../r4.dart';
/// [StructureMap_Rule] A Map of relationships between 2 structures that
/// can be used to transform data.

@freezed
class StructureMap_Rule with _$StructureMap_Rule {
  const StructureMap_Rule._();

  const factory StructureMap_Rule({
...
/// [source] Source inputs to the mapping.
    ...
    @JsonKey(name: 'source') List<List<StructureMap_Source>>? source,
/// [target] Content to create because of this mapping rule.

    @JsonKey(name: 'target') List<List<StructureMap_Target>>? target,
...
/// [dependent] Which other rules to apply in the context of this rule.
    ...
    @JsonKey(name: 'dependent') List<List<StructureMap_Dependent>>? dependent,
...
/// [_documentation] Extensions for documentation
  ...
  @override
  String get fhirType => 'StructureMap_Rule';
  ...
  factory StructureMap_Rule.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? StructureMap_Rule.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
