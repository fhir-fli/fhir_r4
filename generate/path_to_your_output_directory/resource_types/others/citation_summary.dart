/// /// [Citation_Summary] The Citation Resource enables reference to any
...
@freezed
class Citation_Summary with _$Citation_Summary {
  const Citation_Summary._();

  const factory Citation_Summary({
...
/// /// [_text] Extensions for text
  ...
  @override
  String get fhirType => 'Citation_Summary';
  ...
  factory Citation_Summary.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Citation_Summary.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
