...
@freezed
class ClaimResponse_ReviewOutcome with _$ClaimResponse_ReviewOutcome {
...
/// effective.
  ...
  }) = _$ClaimResponse_ReviewOutcome;

  @override
  String get fhirType => 'ClaimResponse_ReviewOutcome';

  factory ClaimResponse_ReviewOutcome.fromJson(Map<String, dynamic> json) =>
      _$ClaimResponse_ReviewOutcomeFromJson(json);

  factory ClaimResponse_ReviewOutcome.fromYaml(dynamic yaml) => yaml is String
      ? ClaimResponse_ReviewOutcome.fromJson(
          jsonDecode(jsonEncode(loadYaml(yaml))) as Map<String, dynamic>)
      : yaml is YamlMap
          ? ClaimResponse_ReviewOutcome.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
              'ClaimResponse_ReviewOutcome cannot be constructed from input provided,'
              ' it is neither a yaml string nor a yaml map.');

  factory ClaimResponse_ReviewOutcome.fromJsonString(String source) {
    final dynamic json = jsonDecode(source);
    if (json is Map<String, dynamic>) {
      return _$ClaimResponse_ReviewOutcomeFromJson(json);
    } else {
