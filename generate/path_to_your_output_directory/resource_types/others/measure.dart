...
/// Topics provide a high-level categorization grouping types of measures that
...
/// /// [_usage] Extensions for usage
    ...
    @JsonKey(name: '_usage') FhirElement? usageElement,
...
/// or related to intellectual property (such as code systems) referenced by
/// the measure.

    @JsonKey(name: 'disclaimer') FhirMarkdown? disclaimer,
/// /// [_disclaimer] Extensions for disclaimer

    @JsonKey(name: '_disclaimer') FhirElement? disclaimerElement,
...
/// used to combine the component measures to determine the composite score.
    ...
    @JsonKey(name: 'compositeScoring') CodeableConcept? compositeScoring,
...
/// for when computing and reporting measure results.
    ...
    @JsonKey(name: 'riskAdjustment') FhirMarkdown? riskAdjustment,
/// /// [_riskAdjustment] Extensions for riskAdjustment

    @JsonKey(name: '_riskAdjustment') FhirElement? riskAdjustmentElement,
...
/// Usually includes statements pertaining to importance criterion: impact, gap
/// in care, and evidence.

    @JsonKey(name: 'rationale') FhirMarkdown? rationale,
...
/// measure.
    ...
    @JsonKey(name: 'clinicalRecommendationStatement') FhirMarkdown? clinicalRecommendationStatement,
/// /// [_clinicalRecommendationStatement] Extensions for
/// clinicalRecommendationStatement

    @JsonKey(name: '_clinicalRecommendationStatement') FhirElement? clinicalRecommendationStatementElement,
...
/// measure.
    ...
    @JsonKey(name: 'term') List<List<Measure_Term>>? term,
...
/// used in a clinical context, and the intent of the measure.
    ...
    @JsonKey(name: 'guidance') FhirMarkdown? guidance,
/// /// [_guidance] Extensions for guidance

    @JsonKey(name: '_guidance') FhirElement? guidanceElement,
/// /// [group] A group of population criteria for the measure.

    @JsonKey(name: 'group') List<List<Measure_Group>>? group,
/// /// [supplementalData] The supplemental data criteria for the measure
/// report, specified as either the name of a valid CQL expression within a
/// referenced library, or a valid FHIR Resource Path.

    @JsonKey(name: 'supplementalData') List<List<Measure_SupplementalData>>? supplementalData,
  }) = _$Measure;
