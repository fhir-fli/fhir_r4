...
@freezed
class ImplementationGuide_Grouping with _$ImplementationGuide_Grouping {
  const ImplementationGuide_Grouping._();

  const factory ImplementationGuide_Grouping({
...
/// [_description] Extensions for description
  ...
  }) = _$ImplementationGuide_Grouping;

  @override
  String get fhirType => 'ImplementationGuide_Grouping';
  ...
  factory ImplementationGuide_Grouping.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ImplementationGuide_Grouping.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
