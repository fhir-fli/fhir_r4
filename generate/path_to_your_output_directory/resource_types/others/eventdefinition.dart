...
@freezed
class EventDefinition with _$EventDefinition {
...
/// event definition is (or will be) published. This URL can be the target of a
...
/// event definition when it is referenced in a specification, model, design or
...
/// than one trigger condition is specified, the event fires whenever any one
/// of the trigger conditions is met.
  ...
  factory EventDefinition.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? EventDefinition.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
