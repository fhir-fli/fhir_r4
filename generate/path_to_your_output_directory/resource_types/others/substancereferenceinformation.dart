...
@freezed
class SubstanceReferenceInformation with _$SubstanceReferenceInformation {
...
/// [gene] Todo.
    ...
    @JsonKey(name: 'gene') List<List<SubstanceReferenceInformation_Gene>>? gene,
/// [geneElement] Todo.

    @JsonKey(name: 'geneElement') List<List<SubstanceReferenceInformation_GeneElement>>? geneElement,
/// [target] Todo.

    @JsonKey(name: 'target') List<List<SubstanceReferenceInformation_Target>>? target,
  }) = _$SubstanceReferenceInformation;
  ...
  factory SubstanceReferenceInformation.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? SubstanceReferenceInformation.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
