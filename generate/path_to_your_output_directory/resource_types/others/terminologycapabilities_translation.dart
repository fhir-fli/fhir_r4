/// /// [TerminologyCapabilities_Translation] A TerminologyCapabilities
...
@freezed
class TerminologyCapabilities_Translation with _$TerminologyCapabilities_Translation {
  const TerminologyCapabilities_Translation._();

  const factory TerminologyCapabilities_Translation({
...
/// /// [needsMap] Whether the client must identify the map.
    ...
    @JsonKey(name: 'needsMap') FhirBoolean? needsMap,
/// /// [_needsMap] Extensions for needsMap

    @JsonKey(name: '_needsMap') FhirElement? needsMapElement,
  }) = _$TerminologyCapabilities_Translation;

  @override
  String get fhirType => 'TerminologyCapabilities_Translation';
  ...
  factory TerminologyCapabilities_Translation.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? TerminologyCapabilities_Translation.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
