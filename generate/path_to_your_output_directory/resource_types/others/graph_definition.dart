...
import '../../r4.dart';
/// [GraphDefinition] A formal computable definition of a graph of
...
@freezed
class GraphDefinition with _$GraphDefinition {
...
/// graph definition is (or will be) published. This URL can be the target of a
...
/// GraphDefinition when it is represented in other formats, or referenced in a
/// specification, model, design or an instance.

    @JsonKey(name: 'identifier') List<List<Identifier>>? identifier,
/// [version] The identifier that is used to identify this version of the
/// graph definition when it is referenced in a specification, model, design or
...
/// on the use and publishing of the graph definition.
...
/// [link] Links this graph makes rules about.
  ...
  factory GraphDefinition.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? GraphDefinition.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
