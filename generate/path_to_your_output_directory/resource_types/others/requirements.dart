/// /// [Requirements] A set of requirements - a list of features or behaviors
/// of designed systems that are necessary to achieve organizational or
/// regulatory goals.
...
/// instance. This is an arbitrary value managed by the Requirements author and
...
/// /// [_reference] Extensions for reference
    ...
    @JsonKey(name: '_reference') List<FhirElement>? referenceElement,
/// /// [actor] An actor these requirements are in regard to.

    @JsonKey(name: 'actor') List<List<FhirCanonical>>? actor,
/// /// [statement] The actual statement of requirement, in markdown format.

    @JsonKey(name: 'statement') List<List<Requirements_Statement>>? statement,
  }) = _$Requirements;
  ...
  factory Requirements.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Requirements.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
