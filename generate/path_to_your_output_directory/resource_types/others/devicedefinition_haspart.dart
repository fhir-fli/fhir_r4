/// /// [DeviceDefinition_HasPart] The characteristics, operational status and
/// capabilities of a medical-related component of a medical device.

@freezed
class DeviceDefinition_HasPart with _$DeviceDefinition_HasPart {
  const DeviceDefinition_HasPart._();

  const factory DeviceDefinition_HasPart({
...
/// /// [_count] Extensions for count
  ...
  }) = _$DeviceDefinition_HasPart;

  @override
  String get fhirType => 'DeviceDefinition_HasPart';
  ...
  factory DeviceDefinition_HasPart.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? DeviceDefinition_HasPart.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
