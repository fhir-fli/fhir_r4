...
@freezed
class Citation_Abstract with _$Citation_Abstract {
...
/// [_copyright] Extensions for copyright
  ...
  @override
  String get fhirType => 'Citation_Abstract';
  ...
  factory Citation_Abstract.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Citation_Abstract.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
