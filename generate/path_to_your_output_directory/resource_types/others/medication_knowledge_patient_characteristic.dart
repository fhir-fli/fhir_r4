...
import '../../r4.dart';
/// [MedicationKnowledge_PatientCharacteristic] Information about a
/// medication that is used to support knowledge.

@freezed
class MedicationKnowledge_PatientCharacteristic with _$MedicationKnowledge_PatientCharacteristic {
  const MedicationKnowledge_PatientCharacteristic._();

  const factory MedicationKnowledge_PatientCharacteristic({
...
/// etc.).
  ...
  }) = _$MedicationKnowledge_PatientCharacteristic;

  @override
  String get fhirType => 'MedicationKnowledge_PatientCharacteristic';
  ...
  factory MedicationKnowledge_PatientCharacteristic.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? MedicationKnowledge_PatientCharacteristic.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
