...
@freezed
class Ingredient_Manufacturer with _$Ingredient_Manufacturer {
...
/// [manufacturer] An organization that manufactures this ingredient.
  ...
  @override
  String get fhirType => 'Ingredient_Manufacturer';

  factory Ingredient_Manufacturer.fromJson(Map<String, dynamic> json) =>
      _$Ingredient_ManufacturerFromJson(json);

  factory Ingredient_Manufacturer.fromYaml(dynamic yaml) => yaml is String
      ? Ingredient_Manufacturer.fromJson(
          jsonDecode(jsonEncode(loadYaml(yaml))) as Map<String, dynamic>)
      : yaml is YamlMap
          ? Ingredient_Manufacturer.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
              'Ingredient_Manufacturer cannot be constructed from input provided,'
              ' it is neither a yaml string nor a yaml map.');

  factory Ingredient_Manufacturer.fromJsonString(String source) {
    final dynamic json = jsonDecode(source);
    if (json is Map<String, dynamic>) {
      return _$Ingredient_ManufacturerFromJson(json);
    } else {
