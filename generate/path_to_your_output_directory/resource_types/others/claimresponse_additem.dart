...
@freezed
class ClaimResponse_AddItem with _$ClaimResponse_AddItem {
  const ClaimResponse_AddItem._();

  const factory ClaimResponse_AddItem({
...
/// /// [_itemSequence] Extensions for itemSequence
    ...
    @JsonKey(name: '_itemSequence') List<FhirElement>? itemSequenceElement,
...
/// /// [_detailSequence] Extensions for detailSequence
    ...
    @JsonKey(name: '_detailSequence') List<FhirElement>? detailSequenceElement,
...
/// /// [_subdetailSequence] Extensions for subdetailSequence
    ...
    @JsonKey(name: '_subdetailSequence') List<FhirElement>? subdetailSequenceElement,
...
/// /// [bodySite] Physical location where the service is performed or applies.
    ...
    @JsonKey(name: 'bodySite') List<List<ClaimResponse_BodySite>>? bodySite,
...
/// services.
    ...
    @JsonKey(name: 'detail') List<List<ClaimResponse_Detail1>>? detail,
  }) = _$ClaimResponse_AddItem;

  @override
  String get fhirType => 'ClaimResponse_AddItem';
  ...
  factory ClaimResponse_AddItem.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ClaimResponse_AddItem.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
