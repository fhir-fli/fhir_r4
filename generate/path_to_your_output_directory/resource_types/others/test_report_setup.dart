...
@freezed
class TestReport_Setup with _$TestReport_Setup {
  const TestReport_Setup._();

  const factory TestReport_Setup({
...
/// [action] Action would contain either an operation or an assertion.
    ...
    @JsonKey(name: 'action') List<List<TestReport_Action>>? action,
  }) = _$TestReport_Setup;

  @override
  String get fhirType => 'TestReport_Setup';
  ...
  factory TestReport_Setup.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? TestReport_Setup.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
