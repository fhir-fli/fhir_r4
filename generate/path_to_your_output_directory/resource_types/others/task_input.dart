...
import '../../r4.dart';
/// [Task_Input] A task to be performed as a part of a workflow and the
...
@freezed
class Task_Input with _$Task_Input {
  const Task_Input._();

  const factory Task_Input({
...
/// [valueMeta] The value of the input parameter as a basic type.
  ...
  @override
  String get fhirType => 'Task_Input';

  factory Task_Input.fromJson(Map<String, dynamic> json) =>
      _$Task_InputFromJson(json);

  factory Task_Input.fromYaml(dynamic yaml) => yaml is String
      ? Task_Input.fromJson(
          jsonDecode(jsonEncode(loadYaml(yaml))) as Map<String, dynamic>)
      : yaml is YamlMap
          ? Task_Input.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
              'Task_Input cannot be constructed from input provided,'
              ' it is neither a yaml string nor a yaml map.');

  factory Task_Input.fromJsonString(String source) {
    final dynamic json = jsonDecode(source);
    if (json is Map<String, dynamic>) {
      return _$Task_InputFromJson(json);
    } else {
