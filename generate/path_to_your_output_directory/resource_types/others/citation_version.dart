...
import '../../r4.dart';
/// [Citation_Version] The Citation Resource enables reference to any
...
@freezed
class Citation_Version with _$Citation_Version {
  const Citation_Version._();

  const factory Citation_Version({
...
/// [baseCitation] Citation for the main version of the cited artifact.
    ...
    @JsonKey(name: 'baseCitation') Reference? baseCitation,
  }) = _$Citation_Version;

  @override
  String get fhirType => 'Citation_Version';
  ...
  factory Citation_Version.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Citation_Version.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
