...
import '../../r4.dart';
/// [ConditionDefinition_Precondition] A definition of a condition and
/// information relevant to managing it.

@freezed
class ConditionDefinition_Precondition with _$ConditionDefinition_Precondition {
  const ConditionDefinition_Precondition._();

  const factory ConditionDefinition_Precondition({
...
/// [valueQuantity] Value of Observation.
  ...
  }) = _$ConditionDefinition_Precondition;

  @override
  String get fhirType => 'ConditionDefinition_Precondition';
  ...
  factory ConditionDefinition_Precondition.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ConditionDefinition_Precondition.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
