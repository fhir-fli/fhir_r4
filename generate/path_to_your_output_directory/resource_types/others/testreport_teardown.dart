...
@freezed
class TestReport_Teardown with _$TestReport_Teardown {
  const TestReport_Teardown._();

  const factory TestReport_Teardown({
...
/// /// [action] The teardown action will only contain an operation.
    ...
    @JsonKey(name: 'action') List<List<TestReport_Action2>>? action,
  }) = _$TestReport_Teardown;

  @override
  String get fhirType => 'TestReport_Teardown';
  ...
  factory TestReport_Teardown.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? TestReport_Teardown.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
