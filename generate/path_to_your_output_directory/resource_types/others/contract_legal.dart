...
@freezed
class Contract_Legal with _$Contract_Legal {
  const Contract_Legal._();

  const factory Contract_Legal({
...
/// /// [contentReference] Contract legal text in human renderable form.
  ...
  @override
  String get fhirType => 'Contract_Legal';
  ...
  factory Contract_Legal.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Contract_Legal.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
