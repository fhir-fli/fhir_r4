...
@freezed
class ExplanationOfBenefit_Adjudication with _$ExplanationOfBenefit_Adjudication {
  const ExplanationOfBenefit_Adjudication._();

  const factory ExplanationOfBenefit_Adjudication({
...
/// is responsible for in-aggregate or pertaining to this item, amounts paid by
...
/// exclusive to the amount element above.
  ...
  }) = _$ExplanationOfBenefit_Adjudication;

  @override
  String get fhirType => 'ExplanationOfBenefit_Adjudication';
  ...
  factory ExplanationOfBenefit_Adjudication.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ExplanationOfBenefit_Adjudication.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
