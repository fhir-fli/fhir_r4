/// /// [Citation_ContributionInstance] The Citation Resource enables reference
/// to any knowledge artifact for purposes of identification and attribution.
/// The Citation Resource supports existing reference structures and developing
/// publication practices such as versioning, expressing complex
/// contributorship roles, and referencing computable resources.

@freezed
class Citation_ContributionInstance with _$Citation_ContributionInstance {
  const Citation_ContributionInstance._();

  const factory Citation_ContributionInstance({
...
/// /// [_time] Extensions for time
  ...
  }) = _$Citation_ContributionInstance;

  @override
  String get fhirType => 'Citation_ContributionInstance';
  ...
  factory Citation_ContributionInstance.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Citation_ContributionInstance.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
