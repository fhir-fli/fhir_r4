...
import '../../r4.dart';
/// [Citation_PublishedIn] The Citation Resource enables reference to any
...
@freezed
class Citation_PublishedIn with _$Citation_PublishedIn {
  const Citation_PublishedIn._();

  const factory Citation_PublishedIn({
...
/// [publisherLocation] Geographic location of the publisher.
    ...
    @JsonKey(name: 'publisherLocation') String? publisherLocation,
/// [_publisherLocation] Extensions for publisherLocation

    @JsonKey(name: '_publisherLocation') PrimitiveElement? publisherLocationElement,
  }) = _$Citation_PublishedIn;

  @override
  String get fhirType => 'Citation_PublishedIn';
  ...
  factory Citation_PublishedIn.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Citation_PublishedIn.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
