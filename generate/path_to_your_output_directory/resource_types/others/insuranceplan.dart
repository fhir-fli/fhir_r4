...
@freezed
class InsurancePlan with _$InsurancePlan {
...
/// [generalCost] Overall costs associated with the plan.
    ...
    @JsonKey(name: 'generalCost') List<List<InsurancePlan_GeneralCost>>? generalCost,
/// [specificCost] Costs associated with the coverage provided by the
/// product-plan.

    @JsonKey(name: 'specificCost') List<List<InsurancePlan_SpecificCost>>? specificCost,
  }) = _$InsurancePlan;
  ...
  factory InsurancePlan.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? InsurancePlan.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
