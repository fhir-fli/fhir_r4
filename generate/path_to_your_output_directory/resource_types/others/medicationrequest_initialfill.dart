...
@freezed
class MedicationRequest_InitialFill with _$MedicationRequest_InitialFill {
  const MedicationRequest_InitialFill._();

  const factory MedicationRequest_InitialFill({
...
/// last.
  ...
  }) = _$MedicationRequest_InitialFill;

  @override
  String get fhirType => 'MedicationRequest_InitialFill';
  ...
  factory MedicationRequest_InitialFill.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? MedicationRequest_InitialFill.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
