...
@freezed
class Subscription_Parameter with _$Subscription_Parameter {
...
/// [_value] Extensions for value
  ...
  @override
  String get fhirType => 'Subscription_Parameter';

  factory Subscription_Parameter.fromJson(Map<String, dynamic> json) =>
      _$Subscription_ParameterFromJson(json);

  factory Subscription_Parameter.fromYaml(dynamic yaml) => yaml is String
      ? Subscription_Parameter.fromJson(
          jsonDecode(jsonEncode(loadYaml(yaml))) as Map<String, dynamic>)
      : yaml is YamlMap
          ? Subscription_Parameter.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
              'Subscription_Parameter cannot be constructed from input provided,'
              ' it is neither a yaml string nor a yaml map.');

  factory Subscription_Parameter.fromJsonString(String source) {
    final dynamic json = jsonDecode(source);
    if (json is Map<String, dynamic>) {
      return _$Subscription_ParameterFromJson(json);
    } else {
