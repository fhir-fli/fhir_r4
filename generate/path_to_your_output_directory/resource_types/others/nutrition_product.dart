...
@freezed
class NutritionProduct with _$NutritionProduct {
...
/// nutrients.
    ...
    @JsonKey(name: 'nutrient') List<List<NutritionProduct_Nutrient>>? nutrient,
/// [ingredient] Ingredients contained in this product.

    @JsonKey(name: 'ingredient') List<List<NutritionProduct_Ingredient>>? ingredient,
/// [knownAllergen] Allergens that are known or suspected to be a part of
/// this nutrition product.

    @JsonKey(name: 'knownAllergen') List<List<CodeableReference>>? knownAllergen,
/// [characteristic] Specifies descriptive properties of the nutrition
/// product.

    @JsonKey(name: 'characteristic') List<List<NutritionProduct_Characteristic>>? characteristic,
/// [instance] Conveys instance-level information about this product item.
/// One or several physical, countable instances or occurrences of the product.

    @JsonKey(name: 'instance') List<List<NutritionProduct_Instance>>? instance,
/// [note] Comments made about the product.
  ...
  factory NutritionProduct.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? NutritionProduct.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
