...
@freezed
class ActorDefinition with _$ActorDefinition {
...
/// actor definition is (or will be) published. This URL can be the target of a
...
/// actor definition when it is referenced in a specification, model, design or
/// instance. This is an arbitrary value managed by the actor definition author
...
/// on the use and publishing of the actor definition.
...
/// inherits all the obligations etc. as defined in the other IG.
  ...
  factory ActorDefinition.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ActorDefinition.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
