...
@freezed
class BiologicallyDerivedProduct_Property with _$BiologicallyDerivedProduct_Property {
...
/// [valueAttachment] Property values.
  ...
  @override
  String get fhirType => 'BiologicallyDerivedProduct_Property';

  factory BiologicallyDerivedProduct_Property.fromJson(Map<String, dynamic> json) =>
      _$BiologicallyDerivedProduct_PropertyFromJson(json);

  factory BiologicallyDerivedProduct_Property.fromYaml(dynamic yaml) => yaml is String
      ? BiologicallyDerivedProduct_Property.fromJson(
          jsonDecode(jsonEncode(loadYaml(yaml))) as Map<String, dynamic>)
      : yaml is YamlMap
          ? BiologicallyDerivedProduct_Property.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
              'BiologicallyDerivedProduct_Property cannot be constructed from input provided,'
              ' it is neither a yaml string nor a yaml map.');

  factory BiologicallyDerivedProduct_Property.fromJsonString(String source) {
    final dynamic json = jsonDecode(source);
    if (json is Map<String, dynamic>) {
      return _$BiologicallyDerivedProduct_PropertyFromJson(json);
    } else {
