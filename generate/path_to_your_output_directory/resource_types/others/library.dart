...
/// knowledge asset definitions. It can be used to describe and expose existing
...
/// library.
    ...
    @JsonKey(name: 'parameter') List<List<ParameterDefinition>>? parameter,
/// /// [dataRequirement] Describes a set of data that must be provided in
/// order to be able to successfully perform the computations defined by the
/// library.
...
/// be a reference to a url, or may be directly embedded as a base-64 string.
/// Either way, the contentType of the attachment determines how to interpret
/// the content.

    @JsonKey(name: 'content') List<List<Attachment>>? content,
  }) = _$Library;
  ...
  factory Library.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Library.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
