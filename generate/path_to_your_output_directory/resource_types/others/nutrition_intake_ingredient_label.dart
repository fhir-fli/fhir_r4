...
import '../../r4.dart';
/// [NutritionIntake_IngredientLabel] A record of food or fluid that is
/// being consumed by a patient.   A NutritionIntake may indicate that the
/// patient may be consuming the food or fluid now or has consumed the food or
/// fluid in the past.  The source of this information can be the patient,
...
/// taking process during a patient visit or stay or through an app that tracks
...
@freezed
class NutritionIntake_IngredientLabel with _$NutritionIntake_IngredientLabel {
  const NutritionIntake_IngredientLabel._();

  const factory NutritionIntake_IngredientLabel({
...
/// (protein, fat, carbohydrate), or a vitamin and mineral.
    ...
    @JsonKey(name: 'nutrient') CodeableReference? nutrient,
/// [amount] Total amount of nutrient consumed.

    @JsonKey(name: 'amount') Quantity? amount,
  }) = _$NutritionIntake_IngredientLabel;

  @override
  String get fhirType => 'NutritionIntake_IngredientLabel';
  ...
  factory NutritionIntake_IngredientLabel.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? NutritionIntake_IngredientLabel.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
