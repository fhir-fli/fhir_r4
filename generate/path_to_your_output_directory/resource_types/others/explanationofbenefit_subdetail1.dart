...
@freezed
class ExplanationOfBenefit_SubDetail1 with _$ExplanationOfBenefit_SubDetail1 {
  const ExplanationOfBenefit_SubDetail1._();

  const factory ExplanationOfBenefit_SubDetail1({
...
/// /// [adjudication] The adjudication results.
  ...
  }) = _$ExplanationOfBenefit_SubDetail1;

  @override
  String get fhirType => 'ExplanationOfBenefit_SubDetail1';
  ...
  factory ExplanationOfBenefit_SubDetail1.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ExplanationOfBenefit_SubDetail1.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
