...
@freezed
class PlanDefinition_Participant with _$PlanDefinition_Participant {
  const PlanDefinition_Participant._();

  const factory PlanDefinition_Participant({
...
/// /// [_actorId] Extensions for actorId
    ...
    @JsonKey(name: '_actorId') FhirElement? actorIdElement,
...
/// author, reviewer, witness, etc.
  ...
  }) = _$PlanDefinition_Participant;

  @override
  String get fhirType => 'PlanDefinition_Participant';
  ...
  factory PlanDefinition_Participant.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? PlanDefinition_Participant.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
