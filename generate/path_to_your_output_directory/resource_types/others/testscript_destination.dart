...
import '../../r4.dart';
/// [TestScript_Destination] A structured set of tests against a FHIR
/// server or client implementation to determine compliance against the FHIR
/// specification.

@freezed
class TestScript_Destination with _$TestScript_Destination {
  const TestScript_Destination._();

  const factory TestScript_Destination({
...
/// [_url] Extensions for url
  ...
  }) = _$TestScript_Destination;

  @override
  String get fhirType => 'TestScript_Destination';
  ...
  factory TestScript_Destination.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? TestScript_Destination.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
