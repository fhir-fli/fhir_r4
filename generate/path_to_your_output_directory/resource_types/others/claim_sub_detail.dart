...
@freezed
class Claim_SubDetail with _$Claim_SubDetail {
  const Claim_SubDetail._();

  const factory Claim_SubDetail({
...
/// [udi] Unique Device Identifiers associated with this line item.
  ...
  @override
  String get fhirType => 'Claim_SubDetail';
  ...
  factory Claim_SubDetail.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Claim_SubDetail.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
