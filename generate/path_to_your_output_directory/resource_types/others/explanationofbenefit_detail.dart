/// /// [ExplanationOfBenefit_Detail] This resource provides: the claim
...
@freezed
class ExplanationOfBenefit_Detail with _$ExplanationOfBenefit_Detail {
  const ExplanationOfBenefit_Detail._();

  const factory ExplanationOfBenefit_Detail({
...
/// /// [subDetail] Third-tier of goods and services.
    ...
    @JsonKey(name: 'subDetail') List<List<ExplanationOfBenefit_SubDetail>>? subDetail,
  }) = _$ExplanationOfBenefit_Detail;

  @override
  String get fhirType => 'ExplanationOfBenefit_Detail';
  ...
  factory ExplanationOfBenefit_Detail.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ExplanationOfBenefit_Detail.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
