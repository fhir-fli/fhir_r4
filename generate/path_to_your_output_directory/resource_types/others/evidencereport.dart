...
/// is this report about?".
    ...
    @JsonKey(name: 'subject') EvidenceReport_Subject? subject,
/// /// [relatesTo] Relationships that this composition has with other
/// compositions or documents that already exist.

    @JsonKey(name: 'relatesTo') List<List<EvidenceReport_RelatesTo>>? relatesTo,
/// /// [section] The root of the sections that make up the composition.
  ...
  factory EvidenceReport.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? EvidenceReport.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
