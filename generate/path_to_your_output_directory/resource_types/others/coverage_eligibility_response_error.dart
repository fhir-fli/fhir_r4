...
@freezed
class CoverageEligibilityResponse_Error with _$CoverageEligibilityResponse_Error {
  const CoverageEligibilityResponse_Error._();

  const factory CoverageEligibilityResponse_Error({
...
/// [_expression] Extensions for expression
  ...
  }) = _$CoverageEligibilityResponse_Error;

  @override
  String get fhirType => 'CoverageEligibilityResponse_Error';
  ...
  factory CoverageEligibilityResponse_Error.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? CoverageEligibilityResponse_Error.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
