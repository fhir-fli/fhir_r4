...
@freezed
class ConditionDefinition with _$ConditionDefinition {
...
/// of this condition definition is (or will be) published. This URL can be the
...
/// condition definition when it is represented in other formats, or referenced
...
/// it should change when the substantive content of the condition definition
/// changes.
...
/// severity assessments.
    ...
    @JsonKey(name: 'stage') CodeableConcept? stage,
/// /// [hasSeverity] Whether Severity is appropriate to collect for this
/// condition.

    @JsonKey(name: 'hasSeverity') FhirBoolean? hasSeverity,
/// /// [_hasSeverity] Extensions for hasSeverity

    @JsonKey(name: '_hasSeverity') FhirElement? hasSeverityElement,
/// /// [hasBodySite] Whether bodySite is appropriate to collect for this
/// condition.

    @JsonKey(name: 'hasBodySite') FhirBoolean? hasBodySite,
/// /// [_hasBodySite] Extensions for hasBodySite

    @JsonKey(name: '_hasBodySite') FhirElement? hasBodySiteElement,
/// /// [hasStage] Whether stage is appropriate to collect for this condition.

    @JsonKey(name: 'hasStage') FhirBoolean? hasStage,
/// /// [_hasStage] Extensions for hasStage

    @JsonKey(name: '_hasStage') FhirElement? hasStageElement,
/// /// [definition] Formal definitions of the condition. These may be
/// references to ontologies, published clinical protocols or research papers.

    @JsonKey(name: 'definition') List<List<FhirUri>>? definition,
/// /// [_definition] Extensions for definition

    @JsonKey(name: '_definition') List<FhirElement>? definitionElement,
/// /// [observation] Observations particularly relevant to this condition.

    @JsonKey(name: 'observation') List<List<FhirCanonical>>? observation,
/// /// [medication] Medications particularly relevant for this condition.

    @JsonKey(name: 'medication') List<List<ConditionDefinition_Medication>>? medication,
/// /// [precondition] An observation that suggests that this condition
/// applies.

    @JsonKey(name: 'precondition') List<List<ConditionDefinition_Precondition>>? precondition,
/// /// [team] Appropriate team for this condition.

    @JsonKey(name: 'team') List<List<Reference>>? team,
/// /// [questionnaire] Questionnaire for this condition.

    @JsonKey(name: 'questionnaire') List<List<ConditionDefinition_Questionnaire>>? questionnaire,
/// /// [plan] Plan that is appropriate.

    @JsonKey(name: 'plan') List<List<ConditionDefinition_Plan>>? plan,
  ...
  factory ConditionDefinition.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ConditionDefinition.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
