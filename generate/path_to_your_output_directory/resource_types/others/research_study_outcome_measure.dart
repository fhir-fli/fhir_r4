...
import '../../r4.dart';
/// [ResearchStudy_OutcomeMeasure] A scientific study of nature that
...
@freezed
class ResearchStudy_OutcomeMeasure with _$ResearchStudy_OutcomeMeasure {
  const ResearchStudy_OutcomeMeasure._();

  const factory ResearchStudy_OutcomeMeasure({
...
/// [reference] Structured outcome definition.
  ...
  }) = _$ResearchStudy_OutcomeMeasure;

  @override
  String get fhirType => 'ResearchStudy_OutcomeMeasure';
  ...
  factory ResearchStudy_OutcomeMeasure.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ResearchStudy_OutcomeMeasure.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
