...
@freezed
class Claim_Related with _$Claim_Related {
  const Claim_Related._();

  const factory Claim_Related({
...
/// to which this particular claim pertains.
  ...
  @override
  String get fhirType => 'Claim_Related';
  ...
  factory Claim_Related.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Claim_Related.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
