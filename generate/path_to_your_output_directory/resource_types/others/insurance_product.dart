...
@freezed
class InsuranceProduct with _$InsuranceProduct {
...
/// to create relationships to parents or families of products.
  ...
  factory InsuranceProduct.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? InsuranceProduct.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
              'InsuranceProduct cannot be constructed from input provided,'
              ' it is neither a yaml string nor a yaml map.');

  factory InsuranceProduct.fromJsonString(String source) {
    final dynamic json = jsonDecode(source);
    if (json is Map<String, dynamic>) {
      return _$InsuranceProductFromJson(json);
    } else {
