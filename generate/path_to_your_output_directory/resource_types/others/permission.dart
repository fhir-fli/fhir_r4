/// /// [Permission] Permission resource holds access rules for a given data
/// and context.
...
/// /// [date] The date that permission was asserted.
    ...
    @JsonKey(name: 'date') List<List<FhirDateTime>>? date,
/// /// [_date] Extensions for date

    @JsonKey(name: '_date') List<FhirElement>? dateElement,
/// /// [validity] The period in which the permission is active.

    @JsonKey(name: 'validity') Period? validity,
/// /// [justification] The asserted justification for using the data.

    @JsonKey(name: 'justification') Permission_Justification? justification,
/// /// [combining] Defines a procedure for arriving at an access decision
/// given the set of rules.

    @JsonKey(name: 'combining') FhirCode? combining,
/// /// [_combining] Extensions for combining

    @JsonKey(name: '_combining') FhirElement? combiningElement,
/// /// [rule] A set of rules.

    @JsonKey(name: 'rule') List<List<Permission_Rule>>? rule,
  }) = _$Permission;
  ...
  factory Permission.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Permission.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
