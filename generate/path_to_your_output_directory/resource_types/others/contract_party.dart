...
@freezed
class Contract_Party with _$Contract_Party {
  const Contract_Party._();

  const factory Contract_Party({
...
/// [role] How the party participates in the offer.
  ...
  @override
  String get fhirType => 'Contract_Party';
  ...
  factory Contract_Party.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Contract_Party.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
