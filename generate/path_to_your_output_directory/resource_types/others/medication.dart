...
/// manufacturing of the product to one or more companies (organizations).
    ...
    @JsonKey(name: 'marketingAuthorizationHolder') Reference? marketingAuthorizationHolder,
...
/// information about this medication.
  ...
  factory Medication.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Medication.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
