...
@freezed
class CompartmentDefinition with _$CompartmentDefinition {
...
/// it should change when the substantive content of the compartment definition
/// changes.
...
/// /// [search] Whether the search syntax is supported,.
    ...
    @JsonKey(name: 'search') FhirBoolean? search,
/// /// [_search] Extensions for search

    @JsonKey(name: '_search') FhirElement? searchElement,
/// /// [resource] Information about how a resource is related to the
/// compartment.

    @JsonKey(name: 'resource') List<List<CompartmentDefinition_Resource>>? resource,
  ...
  factory CompartmentDefinition.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? CompartmentDefinition.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
