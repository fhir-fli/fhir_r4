...
import '../../r4.dart';
/// [MedicinalProductDefinition_CrossReference] A medicinal product, being
...
@freezed
class MedicinalProductDefinition_CrossReference with _$MedicinalProductDefinition_CrossReference {
  const MedicinalProductDefinition_CrossReference._();

  const factory MedicinalProductDefinition_CrossReference({
...
/// investigational product.
    ...
    @JsonKey(name: 'product') CodeableReference? product,
...
/// (investigational), parallel import version.
  ...
  }) = _$MedicinalProductDefinition_CrossReference;

  @override
  String get fhirType => 'MedicinalProductDefinition_CrossReference';
  ...
  factory MedicinalProductDefinition_CrossReference.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? MedicinalProductDefinition_CrossReference.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
