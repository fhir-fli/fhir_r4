/// /// [NamingSystem] A curated namespace that issues unique symbols within
/// that namespace for the identification of concepts, people, devices, etc.
/// Represents a "System" used within the Identifier and Coding data types.

@freezed
class NamingSystem with _$NamingSystem {
...
/// reference. It SHALL remain the same when the naming system is stored on
/// different servers.
...
/// /// [title] A short, descriptive, user-friendly title for the naming
/// system.
...
/// be responsible for officially endorsing the NamingSystem for use in some
/// setting.
...
/// non-collision.
    ...
    @JsonKey(name: 'responsible') String? responsible,
/// /// [_responsible] Extensions for responsible

    @JsonKey(name: '_responsible') FhirElement? responsibleElement,
...
/// handling of formatting characters, use of upper vs. lower case, etc.
    ...
    @JsonKey(name: 'usage') String? usage,
...
/// in electronic exchange.
    ...
    @JsonKey(name: 'uniqueId') List<List<NamingSystem_UniqueId>>? uniqueId,
  }) = _$NamingSystem;
  ...
  factory NamingSystem.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? NamingSystem.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
