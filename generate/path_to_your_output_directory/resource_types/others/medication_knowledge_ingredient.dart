...
@freezed
class MedicationKnowledge_Ingredient with _$MedicationKnowledge_Ingredient {
  const MedicationKnowledge_Ingredient._();

  const factory MedicationKnowledge_Ingredient({
...
/// tablet.
  ...
  }) = _$MedicationKnowledge_Ingredient;

  @override
  String get fhirType => 'MedicationKnowledge_Ingredient';
  ...
  factory MedicationKnowledge_Ingredient.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? MedicationKnowledge_Ingredient.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
