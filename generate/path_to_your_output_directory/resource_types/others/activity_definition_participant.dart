...
@freezed
class ActivityDefinition_Participant with _$ActivityDefinition_Participant {
...
/// author, reviewer, witness, etc.
  ...
  }) = _$ActivityDefinition_Participant;

  @override
  String get fhirType => 'ActivityDefinition_Participant';
  ...
  factory ActivityDefinition_Participant.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ActivityDefinition_Participant.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
