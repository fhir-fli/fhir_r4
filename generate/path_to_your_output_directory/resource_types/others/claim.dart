...
/// which have been provided, or are to be provided, to a patient which is sent
...
/// submissions or claims for related services or for the same event.
    ...
    @JsonKey(name: 'related') List<List<Claim_Related>>? related,
...
/// services according to the terms of the policy.
    ...
    @JsonKey(name: 'payee') Claim_Payee? payee,
...
/// period.
    ...
    @JsonKey(name: 'event') List<List<Claim_Event>>? event,
/// /// [careTeam] The members of the team who provided the products and
/// services.

    @JsonKey(name: 'careTeam') List<List<Claim_CareTeam>>? careTeam,
...
/// of details which can each be a simple items or groups of sub-details.
    ...
    @JsonKey(name: 'item') List<List<Claim_Item>>? item,
/// /// [total] The total value of the all the items in the claim.

    @JsonKey(name: 'total') Money? total,
  }) = _$Claim;
