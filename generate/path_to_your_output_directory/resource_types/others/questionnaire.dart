...
/// responses created for the questionnaire.
    ...
    @JsonKey(name: 'subjectType') List<List<FhirCode>>? subjectType,
/// /// [_subjectType] Extensions for subjectType

    @JsonKey(name: '_subjectType') List<FhirElement>? subjectTypeElement,
...
/// part of the questionnaire.
  ...
  factory Questionnaire.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Questionnaire.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
