...
@freezed
class Contract_Context with _$Contract_Context {
  const Contract_Context._();

  const factory Contract_Context({
...
/// [_text] Extensions for text
  ...
  @override
  String get fhirType => 'Contract_Context';
  ...
  factory Contract_Context.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Contract_Context.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
