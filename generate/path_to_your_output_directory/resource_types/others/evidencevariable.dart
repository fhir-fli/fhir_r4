...
See guidance around (not) making local changes to
...
/// necessary.
    ...
    @JsonKey(name: 'shortTitle') String? shortTitle,
/// /// [_shortTitle] Extensions for shortTitle

    @JsonKey(name: '_shortTitle') FhirElement? shortTitleElement,
...
/// /// [category] A grouping for ordinal or polychotomous variables.
    ...
    @JsonKey(name: 'category') List<List<EvidenceVariable_Category>>? category,
  }) = _$EvidenceVariable;
  ...
  factory EvidenceVariable.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? EvidenceVariable.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
