...
@freezed
class TerminologyCapabilities_Implementation with _$TerminologyCapabilities_Implementation {
  const TerminologyCapabilities_Implementation._();

  const factory TerminologyCapabilities_Implementation({
...
/// [_url] Extensions for url
  ...
  }) = _$TerminologyCapabilities_Implementation;

  @override
  String get fhirType => 'TerminologyCapabilities_Implementation';
  ...
  factory TerminologyCapabilities_Implementation.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? TerminologyCapabilities_Implementation.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
