...
@freezed
class EnrollmentRequest with _$EnrollmentRequest {
...
/// [candidate] Patient Resource.
    ...
    @JsonKey(name: 'candidate') Reference? candidate,
...
/// or payor.
  ...
  factory EnrollmentRequest.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? EnrollmentRequest.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
