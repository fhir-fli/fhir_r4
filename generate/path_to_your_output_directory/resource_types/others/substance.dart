...
/// /// [_instance] Extensions for instance
    ...
    @JsonKey(name: '_instance') FhirElement? instanceElement,
...
/// /// [ingredient] A substance can be composed of other substances.
    ...
    @JsonKey(name: 'ingredient') List<List<Substance_Ingredient>>? ingredient,
  }) = _$Substance;
  ...
  factory Substance.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Substance.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
