...
import '../../r4.dart';
/// [ConditionDefinition_Plan] A definition of a condition and information
/// relevant to managing it.

@freezed
class ConditionDefinition_Plan with _$ConditionDefinition_Plan {
  const ConditionDefinition_Plan._();

  const factory ConditionDefinition_Plan({
...
/// [reference] The actual plan.
  ...
  }) = _$ConditionDefinition_Plan;

  @override
  String get fhirType => 'ConditionDefinition_Plan';
  ...
  factory ConditionDefinition_Plan.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ConditionDefinition_Plan.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
