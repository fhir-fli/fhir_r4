...
@freezed
class ImplementationGuide_Parameter with _$ImplementationGuide_Parameter {
  const ImplementationGuide_Parameter._();

  const factory ImplementationGuide_Parameter({
...
/// /// [_value] Extensions for value
  ...
  }) = _$ImplementationGuide_Parameter;

  @override
  String get fhirType => 'ImplementationGuide_Parameter';
  ...
  factory ImplementationGuide_Parameter.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ImplementationGuide_Parameter.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
