...
@freezed
class TestReport_Operation with _$TestReport_Operation {
  const TestReport_Operation._();

  const factory TestReport_Operation({
...
/// /// [detail] A link to further details on the result.
    ...
    @JsonKey(name: 'detail') FhirUri? detail,
/// /// [_detail] Extensions for detail

    @JsonKey(name: '_detail') FhirElement? detailElement,
  }) = _$TestReport_Operation;

  @override
  String get fhirType => 'TestReport_Operation';
  ...
  factory TestReport_Operation.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? TestReport_Operation.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
