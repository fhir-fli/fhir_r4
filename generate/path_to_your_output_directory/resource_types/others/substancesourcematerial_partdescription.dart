...
@freezed
class SubstanceSourceMaterial_PartDescription with _$SubstanceSourceMaterial_PartDescription {
  const SubstanceSourceMaterial_PartDescription._();

  const factory SubstanceSourceMaterial_PartDescription({
...
/// [part] Entity of anatomical origin of source material within an
/// organism.
...
/// alternative locations may apply.
    ...
    @JsonKey(name: 'partLocation') CodeableConcept? partLocation,
  }) = _$SubstanceSourceMaterial_PartDescription;

  @override
  String get fhirType => 'SubstanceSourceMaterial_PartDescription';
  ...
  factory SubstanceSourceMaterial_PartDescription.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? SubstanceSourceMaterial_PartDescription.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
