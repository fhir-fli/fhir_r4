...
@freezed
class ExplanationOfBenefit_Total with _$ExplanationOfBenefit_Total {
  const ExplanationOfBenefit_Total._();

  const factory ExplanationOfBenefit_Total({
...
/// [amount] Monetary total amount associated with the category.
  ...
  }) = _$ExplanationOfBenefit_Total;

  @override
  String get fhirType => 'ExplanationOfBenefit_Total';
  ...
  factory ExplanationOfBenefit_Total.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ExplanationOfBenefit_Total.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
