...
@freezed
class Device_ConformsTo with _$Device_ConformsTo {
...
/// [_version] Extensions for version
  ...
  @override
  String get fhirType => 'Device_ConformsTo';

  factory Device_ConformsTo.fromJson(Map<String, dynamic> json) =>
      _$Device_ConformsToFromJson(json);

  factory Device_ConformsTo.fromYaml(dynamic yaml) => yaml is String
      ? Device_ConformsTo.fromJson(
          jsonDecode(jsonEncode(loadYaml(yaml))) as Map<String, dynamic>)
      : yaml is YamlMap
          ? Device_ConformsTo.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
              'Device_ConformsTo cannot be constructed from input provided,'
              ' it is neither a yaml string nor a yaml map.');

  factory Device_ConformsTo.fromJsonString(String source) {
    final dynamic json = jsonDecode(source);
    if (json is Map<String, dynamic>) {
      return _$Device_ConformsToFromJson(json);
    } else {
