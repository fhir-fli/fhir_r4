/// /// [CodeSystem] The CodeSystem resource is used to declare the existence
...
@freezed
class CodeSystem with _$CodeSystem {
  const CodeSystem._();
...
/// expectation that versions can be placed in a lexicographical sequence. This
/// is used in [Coding](datatypes.html#Coding).version.
...
/// this system are compared to each other.
    ...
    @JsonKey(name: 'caseSensitive') FhirBoolean? caseSensitive,
/// /// [_caseSensitive] Extensions for caseSensitive

    @JsonKey(name: '_caseSensitive') FhirElement? caseSensitiveElement,
...
/// represented in this resource.
    ...
    @JsonKey(name: 'hierarchyMeaning') FhirCode? hierarchyMeaning,
/// /// [_hierarchyMeaning] Extensions for hierarchyMeaning

    @JsonKey(name: '_hierarchyMeaning') FhirElement? hierarchyMeaningElement,
...
/// /// [_compositional] Extensions for compositional
    ...
    @JsonKey(name: '_compositional') FhirElement? compositionalElement,
...
/// be specified when referencing this code system.
    ...
    @JsonKey(name: 'versionNeeded') FhirBoolean? versionNeeded,
/// /// [_versionNeeded] Extensions for versionNeeded

    @JsonKey(name: '_versionNeeded') FhirElement? versionNeededElement,
...
/// /// [_content] Extensions for content
    ...
    @JsonKey(name: '_content') FhirElement? contentElement,
...
/// system supplement is adding designations and properties to.
    ...
    @JsonKey(name: 'supplements') FhirCanonical? supplements,
...
/// defined by the system steward.
    ...
    @JsonKey(name: 'count') FhirUnsignedInt? count,
...
/// when selecting concepts using a filter.
    ...
    @JsonKey(name: 'filter') List<List<CodeSystem_Filter>>? filter,
/// /// [property] A property defines an additional slot through which
/// additional information can be provided about a concept.

    @JsonKey(name: 'property') List<List<CodeSystem_Property>>? property,
...
/// determine what the meanings of the hierarchical relationships are.
  ...
  factory CodeSystem.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? CodeSystem.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
