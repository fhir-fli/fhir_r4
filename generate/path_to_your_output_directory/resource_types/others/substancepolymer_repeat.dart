...
@freezed
class SubstancePolymer_Repeat with _$SubstancePolymer_Repeat {
...
/// /// [repeatUnit] An SRU - Structural Repeat Unit.
  ...
  @override
  String get fhirType => 'SubstancePolymer_Repeat';
  ...
  factory SubstancePolymer_Repeat.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? SubstancePolymer_Repeat.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
