...
@freezed
class OperationOutcome with _$OperationOutcome {
...
/// system action.
    ...
    @JsonKey(name: 'issue') List<List<OperationOutcome_Issue>>? issue,
  }) = _$OperationOutcome;
  ...
  factory OperationOutcome.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? OperationOutcome.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
