...
@freezed
class TestScript_Test with _$TestScript_Test {
  const TestScript_Test._();

  const factory TestScript_Test({
...
/// [action] Action would contain either an operation or an assertion.
    ...
    @JsonKey(name: 'action') List<List<TestScript_Action1>>? action,
  }) = _$TestScript_Test;

  @override
  String get fhirType => 'TestScript_Test';
  ...
  factory TestScript_Test.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? TestScript_Test.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
