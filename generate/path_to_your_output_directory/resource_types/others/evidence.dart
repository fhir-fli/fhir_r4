...
/// /// [assertion] Declarative description of the Evidence.
    ...
    @JsonKey(name: 'assertion') FhirMarkdown? assertion,
/// /// [_assertion] Extensions for assertion

    @JsonKey(name: '_assertion') FhirElement? assertionElement,
...
/// outcome.
    ...
    @JsonKey(name: 'variableDefinition') List<List<Evidence_VariableDefinition>>? variableDefinition,
/// /// [synthesisType] The method to combine studies.

    @JsonKey(name: 'synthesisType') CodeableConcept? synthesisType,
...
/// /// [statistic] Values and parameters for a single statistic.
    ...
    @JsonKey(name: 'statistic') List<List<Evidence_Statistic>>? statistic,
/// /// [certainty] Assessment of certainty, confidence in the estimates, or
/// quality of the evidence.

    @JsonKey(name: 'certainty') List<List<Evidence_Certainty>>? certainty,
  }) = _$Evidence;
  ...
  factory Evidence.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Evidence.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
