...
@freezed
class TestScript_Action2 with _$TestScript_Action2 {
  const TestScript_Action2._();

  const factory TestScript_Action2({
...
/// [operation] An operation would involve a REST request to a server.
  ...
  }) = _$TestScript_Action2;

  @override
  String get fhirType => 'TestScript_Action2';
  ...
  factory TestScript_Action2.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? TestScript_Action2.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
