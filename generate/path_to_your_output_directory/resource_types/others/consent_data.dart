...
import '../../r4.dart';
/// [Consent_Data] A record of a healthcare consumer’s  choices  or choices
...
@freezed
class Consent_Data with _$Consent_Data {
  const Consent_Data._();

  const factory Consent_Data({
...
/// resources are covered by this consent.
  ...
  @override
  String get fhirType => 'Consent_Data';
  ...
  factory Consent_Data.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Consent_Data.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
