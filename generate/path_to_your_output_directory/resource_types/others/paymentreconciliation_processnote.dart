...
@freezed
class PaymentReconciliation_ProcessNote with _$PaymentReconciliation_ProcessNote {
  const PaymentReconciliation_ProcessNote._();

  const factory PaymentReconciliation_ProcessNote({
...
/// /// [_text] Extensions for text
  ...
  }) = _$PaymentReconciliation_ProcessNote;

  @override
  String get fhirType => 'PaymentReconciliation_ProcessNote';
  ...
  factory PaymentReconciliation_ProcessNote.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? PaymentReconciliation_ProcessNote.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
