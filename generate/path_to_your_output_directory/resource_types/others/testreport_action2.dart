...
@freezed
class TestReport_Action2 with _$TestReport_Action2 {
  const TestReport_Action2._();

  const factory TestReport_Action2({
...
/// [operation] An operation would involve a REST request to a server.
  ...
  }) = _$TestReport_Action2;

  @override
  String get fhirType => 'TestReport_Action2';
  ...
  factory TestReport_Action2.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? TestReport_Action2.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
