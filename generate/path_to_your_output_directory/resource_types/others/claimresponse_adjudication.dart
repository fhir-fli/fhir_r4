...
@freezed
class ClaimResponse_Adjudication with _$ClaimResponse_Adjudication {
  const ClaimResponse_Adjudication._();

  const factory ClaimResponse_Adjudication({
...
/// exclusive to the amount element above.
  ...
  }) = _$ClaimResponse_Adjudication;

  @override
  String get fhirType => 'ClaimResponse_Adjudication';
  ...
  factory ClaimResponse_Adjudication.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ClaimResponse_Adjudication.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
