...
/// Value sets link between [CodeSystem](codesystem.html) definitions and their
/// use in [coded elements](terminologies.html).

@freezed
class ValueSet with _$ValueSet {
  const ValueSet._();
...
/// literal address at which an authoritative instance of this value set is (or
...
/// instance. This is an arbitrary value managed by the value set author and is
...
/// of meanings for concepts to be included within the Value Set Expansion, and
...
/// still change.
    ...
    @JsonKey(name: 'immutable') FhirBoolean? immutable,
/// /// [_immutable] Extensions for immutable

    @JsonKey(name: '_immutable') FhirElement? immutableElement,
/// /// [compose] A set of criteria that define the contents of the value set
/// by including or excluding codes selected from the specified code system(s)
/// that the value set draws from. This is also known as the Content Logical
/// Definition (CLD).

    @JsonKey(name: 'compose') ValueSet_Compose? compose,
/// /// [expansion] A value set can also be "expanded", where the value set is
/// turned into a simple collection of enumerated codes. This element holds the
/// expansion, if it has been performed.

    @JsonKey(name: 'expansion') ValueSet_Expansion? expansion,
...
/// ValueSet.description.
    ...
    @JsonKey(name: 'scope') ValueSet_Scope? scope,
  }) = _$ValueSet;
  ...
  factory ValueSet.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ValueSet.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
