/// /// [TerminologyCapabilities_ValidateCode] A TerminologyCapabilities
...
@freezed
class TerminologyCapabilities_ValidateCode with _$TerminologyCapabilities_ValidateCode {
  const TerminologyCapabilities_ValidateCode._();

  const factory TerminologyCapabilities_ValidateCode({
...
/// /// [translations] Whether translations are validated.
    ...
    @JsonKey(name: 'translations') FhirBoolean? translations,
/// /// [_translations] Extensions for translations

    @JsonKey(name: '_translations') FhirElement? translationsElement,
  }) = _$TerminologyCapabilities_ValidateCode;

  @override
  String get fhirType => 'TerminologyCapabilities_ValidateCode';
  ...
  factory TerminologyCapabilities_ValidateCode.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? TerminologyCapabilities_ValidateCode.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
