...
import '../../r4.dart';
/// [Citation_Part] The Citation Resource enables reference to any
...
@freezed
class Citation_Part with _$Citation_Part {
  const Citation_Part._();

  const factory Citation_Part({
...
/// [baseCitation] The citation for the full article or artifact.
  ...
  @override
  String get fhirType => 'Citation_Part';
  ...
  factory Citation_Part.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? Citation_Part.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
