...
@freezed
class ImmunizationRecommendation with _$ImmunizationRecommendation {
...
/// [recommendation] Vaccine administration recommendations.
    ...
    @JsonKey(name: 'recommendation') List<List<ImmunizationRecommendation_Recommendation>>? recommendation,
  ...
  factory ImmunizationRecommendation.fromYaml(dynamic yaml) => yaml is String
      ...
      : yaml is YamlMap
          ? ImmunizationRecommendation.fromJson(jsonDecode(jsonEncode(yaml)) as Map<String, dynamic>)
          : throw ArgumentError(
